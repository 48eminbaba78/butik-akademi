-- ═══════════════════════════════════════════════════════════════════
-- ROSTRUM AKADEMI — MIGRATION V34
-- Sektör Bağımsız Modüler Koçluk Blokları Mimarisi (blocks JSONB)
-- ═══════════════════════════════════════════════════════════════════

ALTER TABLE coach_profiles
ADD COLUMN IF NOT EXISTS blocks JSONB DEFAULT '[]'::jsonb;

-- Update get_coach_by_slug RPC function to include blocks column
