(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const l={students:[],tasks:{},appointments:[],exams:[],messages:{},coachTodos:{},weekOffset:0,calMonth:new Date().getMonth(),calYear:new Date().getFullYear(),calSelDay:null,activeStuId:null,msgThread:null,workspace:null,studentSpeeds:[],konuHaftaSoru:[]},b={role:null,studentId:null,dbUser:null,coachId:null,childName:null};window.S=l;window.session=b;window._loginMode="email";window.STU_DEFAULT_PASS="Rostrum"+Math.floor(1e3+Math.random()*9e3);window.DAYS_TR=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"];window.MONTHS_TR=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];window.EXAM_DEFS={TYT:["Türkçe","Matematik","Fen","Sosyal"],"AYT-SAY":["Matematik","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Edebiyat","Tarih","Coğrafya"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.EXAM_SORU={TYT:{Türkçe:40,Matematik:40,Fen:20,Sosyal:20},"AYT-SAY":{Matematik:40,Fizik:14,Kimya:13,Biyoloji:13},"AYT-EA":{Matematik:40,Edebiyat:24,Tarih:10,Coğrafya:6},"AYT-SOZ":{Edebiyat:24,Tarih1:10,Tarih2:11,Coğrafya1:6,Coğrafya2:11,Felsefe:12,Din:6}};window.EXAM_KONU_MAP={TYT_Türkçe:["Dil Bilgisi"],TYT_Matematik:["TYT Matematik","Geometri"],TYT_Fen:["TYT Fizik","TYT Kimya","TYT Biyoloji"],TYT_Sosyal:[],"AYT-SAY_Matematik":["AYT Matematik","Geometri"],"AYT-SAY_Fizik":["AYT Fizik"],"AYT-SAY_Kimya":["AYT Kimya"],"AYT-SAY_Biyoloji":["AYT Biyoloji"],"AYT-EA_Matematik":["AYT Matematik","Geometri"],"AYT-EA_Edebiyat":["Dil Bilgisi"]};window.SUBJECT_MAP={TYT:["Türkçe","Matematik","Geometri","Fizik","Kimya","Biyoloji","Tarih","Coğrafya","Felsefe","Din"],"AYT-SAY":["Matematik","Geometri","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Geometri","Edebiyat","Tarih","Coğrafya","Felsefe"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.currentTab="";window._clipboardTask=null;window._editingTaskId=null;window._regRole=null;window._onbRole=null;window._oauthUser=null;const Ja="https://imyhenrwmsmyikpollur.supabase.co",Xa="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlteWhlbnJ3bXNteWlrcG9sbHVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxNDE3ODYsImV4cCI6MjA5NTcxNzc4Nn0._ySJ5ArD1GYthyitHjdyEjLaUhextIwEqpRoF5ScI34",y=supabase.createClient(Ja,Xa);window.db=y;function we(){var e;try{localStorage.setItem("ba_ui_"+(((e=b.dbUser)==null?void 0:e.id)||"x"),JSON.stringify({weekOffset:l.weekOffset,activeStuId:l.activeStuId,calMonth:l.calMonth,calYear:l.calYear}))}catch{}}function lt(){we()}function M(e,t){let n=document.getElementById("loadingOverlay");if(document.querySelectorAll(".btn-login, .btn-accent, .btn").forEach(i=>{e?(i.setAttribute("disabled","true"),i.style.opacity="0.6",i.style.pointerEvents="none"):(i.removeAttribute("disabled"),i.style.opacity="",i.style.pointerEvents="")}),e&&!n){n=document.createElement("div"),n.id="loadingOverlay",n.style.cssText="position:fixed;inset:0;background:rgba(15,14,12,.82);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:14px;backdrop-filter:blur(6px)";const i=t||"Yükleniyor...",o=t?'<div style="font-size:36px;animation:overlayPop .3s cubic-bezier(.34,1.56,.64,1) both">🗑️</div>':'<div style="width:38px;height:38px;border:3px solid rgba(255,255,255,.12);border-top-color:var(--accent);border-radius:50%;animation:spin .7s linear infinite"></div>';if(n.innerHTML=`${o}<div style="font-size:14px;font-weight:600;color:#fff;letter-spacing:.2px">${i}</div>`,!document.getElementById("spinStyle")){const s=document.createElement("style");s.id="spinStyle",s.textContent="@keyframes spin{to{transform:rotate(360deg)}}@keyframes overlayPop{from{transform:scale(.6);opacity:0}to{transform:scale(1);opacity:1}}",document.head.appendChild(s)}document.body.appendChild(n)}else!e&&n&&n.remove()}function v(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function O(e){return e instanceof Date?e.toISOString().split("T")[0]:e}function J(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function ue(){return O(new Date)}function qt(e){return e>=20?"good":e>=12?"mid":"low"}function dt(e){return{deneme:"📊 Deneme",soru:"📚 Soru",konu:"🎯 Konu",diger:"⭐ Diğer"}[e]||e}function G(e){document.getElementById(e).classList.add("open")}function q(e){document.getElementById(e).classList.remove("open")}function x(e){const t=document.getElementById("toast");t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),2300)}document.addEventListener("click",e=>{e.target.classList.contains("modal-bg")&&e.target.id!=="trialExpiredModal"&&e.target.classList.remove("open")});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".modal-bg.open").forEach(t=>{t.id!=="trialExpiredModal"&&t.classList.remove("open")})});function Qa(e){let t=e.value.replace(/\D/g,"");t.startsWith("0")&&(t=t.slice(1)),t=t.slice(0,10);let n="";t.length>0&&(n="0 ("+t.slice(0,3)),t.length>=3&&(n+=") "+t.slice(3,6)),t.length>=6&&(n+=" "+t.slice(6,8)),t.length>=8&&(n+=" "+t.slice(8,10)),e.value=n}function Wt(){const e=new Date;let t=e.getFullYear(),n=new Date(t,5,14);return e>n&&(t+=1,n=new Date(t,5,14)),{year:t,days:Math.max(1,Math.ceil((n-e)/864e5))}}function ne(e,t=0){const n=new Date,a=n.getDay(),o=(a===0?6:a-1)-t,s=new Date(n);return s.setDate(n.getDate()-(o+7)%7+e*7),s.setHours(0,0,0,0),s}function ei(){const e=l.students.find(t=>t.id===l.activeStuId);return(e==null?void 0:e.weekStart)??0}async function Ye(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return[...new Uint8Array(t)].map(n=>n.toString(16).padStart(2,"0")).join("")}function Pe(e){return e?e.trim().toLowerCase().replace(/ç/g,"c").replace(/ğ/g,"g").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ş/g,"s").replace(/ü/g,"u").replace(/i̇/g,"i").replace(/ı/g,"i").replace(/i/g,"i").replace(/\s+/g,"").replace(/\u0307/g,""):""}function ti(){if(!("Notification"in window)){console.log("Bu tarayıcı anlık bildirimleri desteklemiyor.");return}Notification.permission!=="granted"&&Notification.permission!=="denied"?Notification.requestPermission().then(e=>{e==="granted"&&x("Bildirim izinleri onaylandı ✓")}):Notification.permission==="granted"?x("Bildirim izinleri zaten açık ✓"):x("Bildirim izinleri tarayıcı ayarlarından engellenmiş.")}window.saveUI=we;window.saveS=lt;window.showLoading=M;window.esc=v;window.fmtDate=O;window.addDays=J;window.todayStr=ue;window.netColor=qt;window.typeLabel=dt;window.om=G;window.cm=q;window.showToast=x;window.getWeekStart=ne;window.getNextYks=Wt;window.maskPhoneTR=Qa;window.getStudentWeekStart=ei;window.sha256=Ye;window.normalizeUsername=Pe;window.requestNotificationPermission=ti;function ni(e,t){const n=document.getElementById(e),a=document.getElementById(t);n&&a&&(n.type==="password"?(n.type="text",a.textContent="🙈"):(n.type="password",a.textContent="👁️"))}window.togglePasswordVisibility=ni;async function ai(e,t={}){let n=y.from(e).select("*");Object.entries(t).forEach(([o,s])=>{n=n.eq(o,s)});const{data:a,error:i}=await n;return i&&console.error(e,i),a||[]}const ii=4*60*1e3;function Vt(){return"ra_d_"+(b.coachId||b.studentId||"x")}function Ln(){try{localStorage.removeItem(Vt())}catch{}}function wn(){try{localStorage.setItem(Vt(),JSON.stringify({ts:Date.now(),students:l.students,tasks:l.tasks,appointments:l.appointments,exams:l.exams,messages:l.messages,coachTodos:l.coachTodos,studentSpeeds:l.studentSpeeds,workspace:l.workspace,konuHaftaSoru:l.konuHaftaSoru}))}catch{}}function oi(){try{const e=localStorage.getItem(Vt());if(!e)return!1;const t=JSON.parse(e);return!t.ts||Date.now()-t.ts>ii?!1:(t.students&&(l.students=t.students),t.tasks&&(l.tasks=t.tasks),t.appointments&&(l.appointments=t.appointments),t.exams&&(l.exams=t.exams),t.messages&&(l.messages=t.messages),t.coachTodos&&(l.coachTodos=t.coachTodos),t.studentSpeeds&&(l.studentSpeeds=t.studentSpeeds),t.workspace&&(l.workspace=t.workspace),t.konuHaftaSoru&&(l.konuHaftaSoru=t.konuHaftaSoru),!0)}catch{return!1}}async function $n(){var L;const e=b.coachId,t=b.role,n=t==="coach"||t==="developer"?y.from("workspaces").select("*").eq("coach_id",e).single():Promise.resolve({data:null});let a=y.from("users").select("*").eq("role","student");t==="student"?a=a.eq("id",b.studentId):(t==="coach"||t==="developer")&&(a=a.eq("coach_id",e));const i=a,o=new Date;o.setDate(o.getDate()-60);const s=o.toISOString().split("T")[0],r=new Date;r.setDate(r.getDate()-30);const d=r.toISOString().split("T")[0],c=t==="student"?y.from("tasks").select("*").eq("student_id",b.studentId).gte("date",s):t==="coach"||t==="developer"?y.from("tasks").select("*").eq("coach_id",e).gte("date",s):y.from("tasks").select("*").gte("date",s),p=t==="student"?y.from("appointments").select("*").eq("student_id",b.studentId).gte("date",d):t==="coach"||t==="developer"?y.from("appointments").select("*").eq("coach_id",e).gte("date",d):y.from("appointments").select("*").gte("date",d),m=t==="student"?y.from("exams").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?y.from("exams").select("*").eq("coach_id",e):y.from("exams").select("*"),u=t==="student"?y.from("messages").select("*").eq("student_id",b.studentId).order("created_at",{ascending:!1}).limit(200):t==="coach"||t==="developer"?y.from("messages").select("*").eq("coach_id",e).order("created_at",{ascending:!1}).limit(200):y.from("messages").select("*").order("created_at",{ascending:!1}).limit(200),g=t==="coach"||t==="developer"?y.from("coach_todos").select("*").eq("coach_id",e):Promise.resolve({data:[]}),_=t==="student"?y.from("student_speeds").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?y.from("student_speeds").select("*").eq("coach_id",e):y.from("student_speeds").select("*"),T=t==="coach"||t==="developer"?y.from("konu_mastery").select("*").eq("coach_id",e):t==="student"?y.from("konu_mastery").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),f=t==="coach"||t==="developer"?y.from("konu_tekrar_log").select("*").eq("coach_id",e):t==="student"?y.from("konu_tekrar_log").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),[w,k,B,h,S,I,z,E,A,C]=await Promise.all([n,i,c,p,m,u,g,_,T,f]);(t==="coach"||t==="developer")&&(l.workspace=w.data||null),l.students=(k.data||[]).map($=>({id:$.id,name:$.full_name||$.username||"Öğrenci",target:$.target||"",color:$.color||"#4da6ff",progress:$.progress||0,weekStart:$.week_start||0,username:$.username,coachId:$.coach_id,yksArea:$.yks_area||"SAY"})),l.tasks={},(B.data||[]).forEach($=>{const D=`${$.student_id}_${$.date}`;l.tasks[D]||(l.tasks[D]=[]),l.tasks[D].push({_id:$.id,type:$.type,exam:$.exam_type,subject:$.subject,duration:$.duration,note:$.note,done:$.done,student_note:$.student_note||"",student_result:$.student_result||null,student_feedback:$.student_feedback||null,task_items:$.task_items,start_time:$.start_time})}),l.appointments=(h.data||[]).map($=>({id:$.id,studentId:$.student_id,date:$.date,time:$.time,duration:$.duration,type:$.type,note:$.note,meetLink:$.meet_link,google_event_id:$.google_event_id||null})),l.exams=(S.data||[]).map($=>({id:$.id,studentId:$.student_id,name:$.name,date:$.date,type:$.exam_type,nets:$.nets||{},examDetails:$.exam_details||{},note:$.student_note,coachComment:$.coach_comment})),l.messages={},(I.data||[]).forEach($=>{l.messages[$.student_id]||(l.messages[$.student_id]=[]),l.messages[$.student_id].push({_id:$.id,from:$.from_role,text:$.text||"",image_url:$.image_url||null,read:$.read,time:new Date($.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})})}),Object.keys(l.messages).forEach($=>l.messages[$].sort((D,j)=>D._id>j._id?1:-1)),l.coachTodos={},(z.data||[]).forEach($=>{l.coachTodos[$.date]||(l.coachTodos[$.date]=[]),l.coachTodos[$.date].push({_id:$.id,task:$.task,note:$.note,done:$.done})}),l.studentSpeeds=E.data||[],l.konuMastery={},(A.data||[]).forEach($=>{l.konuMastery[$.student_id]||(l.konuMastery[$.student_id]={}),l.konuMastery[$.student_id][$.subject]||(l.konuMastery[$.student_id][$.subject]={}),l.konuMastery[$.student_id][$.subject][$.konu]=$}),l.konuTekrarLog={},(C.data||[]).forEach($=>{l.konuTekrarLog[$.student_id]||(l.konuTekrarLog[$.student_id]={}),l.konuTekrarLog[$.student_id][$.subject]||(l.konuTekrarLog[$.student_id][$.subject]={}),l.konuTekrarLog[$.student_id][$.subject][$.konu]||(l.konuTekrarLog[$.student_id][$.subject][$.konu]={}),l.konuTekrarLog[$.student_id][$.subject][$.konu][$.period_start]=$});try{const $=JSON.parse(localStorage.getItem("ba_ui_"+((L=b.dbUser)==null?void 0:L.id))||"{}");$.weekOffset!==void 0&&(l.weekOffset=$.weekOffset),$.activeStuId&&(l.activeStuId=$.activeStuId),$.calMonth!==void 0&&(l.calMonth=$.calMonth,l.calYear=$.calYear)}catch{}}async function jn(){if(oi()){$n().then(()=>{if(wn(),window.currentTab)try{window.switchTab(window.currentTab)}catch{}}).catch(t=>console.error("Arka plan yenileme hatası:",t));return}M(!0);try{await $n(),wn()}catch(t){console.error("loadAllData error",t)}M(!1)}window.dbQ=ai;window.loadAllData=jn;window.invalidateCache=Ln;let Be=!1;window.location.hash.includes("type=recovery")&&(window.isPasswordRecoveryActive=!0);function oe(e){const t=document.getElementById("loginErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Me(e){const t=document.getElementById("regErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Zt(e){document.getElementById("loginPanel").style.display=e==="login"?"block":"none",document.getElementById("registerPanel").style.display=e==="register"?"block":"none",document.getElementById("lmtLogin").classList.toggle("active",e==="login"),document.getElementById("lmtRegister").classList.toggle("active",e==="register")}function si(e){window._loginMode=e,document.querySelectorAll("#loginTabs .login-tab").forEach((t,n)=>t.classList.toggle("active",n===(e==="email"?0:1))),document.getElementById("loginEmailField").style.display=e==="email"?"block":"none",document.getElementById("loginUserField").style.display=e==="username"?"block":"none"}function Pn(e){window._regRole=e,[["rrbCoach","coach"],["rrbStudent","student"]].forEach(([t,n])=>{const a=document.getElementById(t);if(!a)return;const i=e===n;a.classList.toggle("sel",i),a.style.borderColor=i?"var(--accent)":"var(--border)",a.style.background=i?"var(--accent-dim)":"var(--surface2)",a.style.boxShadow=i?"0 0 0 1px var(--accent)":"none"})}function ri(e){window._onbRole=e,document.getElementById("onbRoleCoach").classList.toggle("sel",e==="coach"),document.getElementById("onbRoleStudent").classList.toggle("sel",e==="student")}async function li(){if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.protocol==="file:"){Hn();return}await Rn()}async function Rn(){Jt(),M(!0);try{const{error:e}=await y.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin+"/app.html",queryParams:{access_type:"offline",prompt:"select_account"}}});e&&(M(!0),console.warn("Google Auth failed:",e),oe("Google Girişi Başlatılamadı: "+e.message))}catch(e){M(!1),oe("Google Girişi Başlatılamadı: "+e.message)}}function Hn(){document.getElementById("googleSimulatorModal").style.display="flex"}function Jt(){document.getElementById("googleSimulatorModal").style.display="none"}async function di(e){if(Jt(),M(!0),e==="demokoc"){const{data:t,error:n}=await y.from("users").select("*").eq("username","demokoc").maybeSingle();if(n||!t){M(!1),oe("Demo koç profili bulunamadı!");return}await Re(t)}else if(e==="demoogrenci"){const{data:t,error:n}=await y.from("users").select("*").eq("username","demoogrenci").maybeSingle();if(n||!t){M(!1),oe("Demo öğrenci profili bulunamadı!");return}await Re(t)}else if(e==="new"){M(!1),document.getElementById("newUserOnboarding").style.display="flex";const t=Math.floor(1e3+Math.random()*9e3),n=`yeni.kullanici${t}@gmail.com`;document.getElementById("onbEmail").textContent=n,document.getElementById("onbName").value=`Yeni Kullanıcı ${t}`,window._oauthUser={id:`mock-google-id-${t}`,email:n,user_metadata:{full_name:`Yeni Kullanıcı ${t}`}}}}async function Nn(){var t,n,a;if(window.location.hash.includes("type=recovery")||window.isPasswordRecoveryActive){console.log("[Auth] Recovery session active, skipping checkOAuthSession");return}if(Be)return;Be=!0;let e=null;try{console.log("[Auth] 1/4 getSession...");const{data:{session:i}}=await y.auth.getSession();if(console.log("[Auth] 2/4 session:",((t=i==null?void 0:i.user)==null?void 0:t.email)||"yok"),!(i!=null&&i.user)){Be=!1;return}if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible")){Be=!1;return}M(!0),e=setTimeout(()=>{console.warn("[Auth] timeout — Supabase yanıt vermedi, spinner kapatılıyor"),Be=!1,M(!1)},1e4),console.log("[Auth] 3/4 profil yükleniyor...");const{data:o,error:s}=await y.from("users").select("*").eq("id",i.user.id).maybeSingle();console.log("[Auth] 4/4 profil:",o==null?void 0:o.role,(s==null?void 0:s.message)||""),clearTimeout(e);let r=!1;if(o){if(o.role==="coach"){const{data:d}=await y.from("workspaces").select("*").eq("coach_id",o.id).maybeSingle();(!d||!d.onboarding_done)&&(r=!0)}}else r=!0;if(o&&!r){if(o.active===!1){M(!1),y.auth.signOut(),alert("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");return}await Re(o)}else M(!1),document.getElementById("newUserOnboarding").style.display="flex",document.getElementById("onbEmail").textContent=i.user.email,document.getElementById("onbName").value=((a=i.user.user_metadata)==null?void 0:a.full_name)||"",window._oauthUser=i.user}catch(i){clearTimeout(e),Be=!1,M(!1),console.warn("[checkOAuthSession]",i)}}async function ci(){const e=document.getElementById("onbName").value.trim();if(!e){document.getElementById("onbErr").textContent="Ad soyad zorunlu",document.getElementById("onbErr").style.display="block";return}if(!window._onbRole){document.getElementById("onbErr").textContent="Hesap türü seçin",document.getElementById("onbErr").style.display="block";return}document.getElementById("onbErr").style.display="none",M(!0);const t=window._oauthUser,n=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""),a={id:t.id,full_name:e,email:t.email,role:window._onbRole,username:n+"_"+Math.random().toString(36).slice(2,6),password_hash:"supabase_managed",color:window._onbRole==="coach"?"#f0a500":"#4da6ff",week_start:0,progress:0,target:""},{data:i,error:o}=await y.from("users").upsert(a).select().single();if(o){M(!1),document.getElementById("onbErr").textContent="Hata: "+o.message,document.getElementById("onbErr").style.display="block";return}document.getElementById("newUserOnboarding").style.display="none",await Re(i)}let ee=0;function pi(e,t){document.getElementById("regBrandColor").value=e,t.parentElement.querySelectorAll("div").forEach(n=>n.style.outline="none"),t.style.outline="3px solid white"}function mi(){const e=document.getElementById("regErr0");if(e&&(e.style.display="none"),ee===0){if(!window._regRole){e&&(e.textContent="Lütfen bir hesap türü seçin.",e.style.display="block");return}window._regRole==="student"?ee=3:ee=1}else if(ee===1){if(!document.getElementById("regBrandName").value.trim()){alert("Lütfen akademi / koçluk adını girin.");return}ee=2}else ee===2&&(ee=3);_t(ee)}function ui(){ee===3?window._regRole==="student"?ee=0:ee=2:ee===2?ee=1:ee===1&&(ee=0),_t(ee)}function _t(e){document.getElementById("regWizardStep0").style.display=e===0?"block":"none",document.getElementById("regWizardStepCoach1").style.display=e===1?"block":"none",document.getElementById("regWizardStepCoach2").style.display=e===2?"block":"none",document.getElementById("regWizardStepFinal").style.display=e===3?"block":"none";const t=document.getElementById("regInviteWrap");t&&(t.style.display=e===3&&window._regRole==="student"?"block":"none")}function gi(e){if(e=(e||"").toUpperCase().replace(/[^0-9A-Z]/g,"").slice(0,6),e.length!==6)return;Zt("register"),Pn("student"),ee=3,_t(3);const t=document.getElementById("regInviteCode");t&&(t.value=e,t.readOnly=!0,t.style.opacity=".75",Yn(),t.readOnly=!0)}let En=null,Yt=!1;function Yn(){const e=document.getElementById("regInviteCode"),t=document.getElementById("regInviteStatus"),n=(e.value||"").toUpperCase().replace(/[^0-9A-Z]/g,"");if(e.value=n,Yt=!1,clearTimeout(En),n.length<6){t.style.display="none";return}t.style.display="block",t.style.background="var(--surface2)",t.style.color="var(--text-mid)",t.textContent="Kod kontrol ediliyor…",En=setTimeout(async()=>{try{const{data:a,error:i}=await y.rpc("check_invite_code",{p_code:n}),o=!i&&a&&a.length?a[0].brand_name:null;o?(Yt=!0,t.style.background="rgba(5,150,105,.1)",t.style.color="var(--green)",t.textContent="✓ "+o+" akademisine katılacaksın"):(t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="✗ Kod bulunamadı — koçundan doğru kodu iste")}catch{t.style.display="none"}},450)}async function vi(){var i;const e=document.getElementById("regName").value.trim(),t=document.getElementById("regEmail").value.trim().toLowerCase(),n=document.getElementById("regPass").value;if(!e||!t||!n)return Me("Tüm hesap bilgileri zorunludur");if(n.length<8)return Me("Şifre en az 8 karakter olmalıdır");let a="";if(window._regRole==="student"){if(a=(((i=document.getElementById("regInviteCode"))==null?void 0:i.value)||"").toUpperCase().trim(),a.length!==6)return Me("Koç davet kodu gerekli — 6 haneli kodu koçundan iste.");if(!Yt)try{const{data:o}=await y.rpc("check_invite_code",{p_code:a});if(!o||!o.length)return Me("Davet kodu geçersiz — koçundan doğru kodu iste.")}catch{return Me("Kod doğrulanamadı, tekrar dene.")}}M(!0);try{let o={full_name:e,role:window._regRole};if(a&&(o.invite_code=a),window._regRole==="coach"){const d=document.getElementById("regBrandName").value.trim(),c=document.getElementById("regBrandColor").value||"#f0a500",p=document.getElementById("regPhone").value.trim(),m=[...document.querySelectorAll("#regExamTypesWrap .ob-exam-sel input")].map(_=>_.value),u=m.length>0?m.join(","):"YKS",g=document.getElementById("regStudentCountRange").value||"1-5";o.ob_brand=d,o.ob_color=c,o.ob_phone=p,o.ob_examtypes=u,o.ob_studentcount=g}const{data:s,error:r}=await y.auth.signUp({email:t,password:n,options:{data:o}});if(r)throw r;if(s!=null&&s.user){M(!1),document.getElementById("regName").value="",document.getElementById("regEmail").value="",document.getElementById("regPass").value="",document.getElementById("regBrandName")&&(document.getElementById("regBrandName").value=""),document.getElementById("regPhone")&&(document.getElementById("regPhone").value="");const d=document.getElementById("regSuccess");d.textContent="Kayıt başarılı! E-posta adresinize bir doğrulama bağlantısı gönderildi. Lütfen doğrulama yaptıktan sonra giriş yapın.",d.style.display="block",setTimeout(()=>d.style.display="none",1e4),ee=0,_t(0),Zt("login")}}catch(o){M(!1),Me("Kayıt Hatası: "+o.message)}}async function fi(){const e=(document.getElementById("loginEmail").value||document.getElementById("loginUser").value||"").trim(),t=document.getElementById("loginPass").value;if(!e||!t)return oe("Kullanıcı adı ve şifre zorunlu");M(!0);const n=setTimeout(()=>{M(!1),oe("Bağlantı zaman aşımına uğradı. Supabase yanıt vermiyor — lütfen tekrar deneyin.")},15e3);try{let a=e;a.includes("@")?a=a.toLowerCase():a=Pe(e)+"@rostrumakademi.com";const{data:i,error:o}=await y.auth.signInWithPassword({email:a,password:t});if(!o&&(i!=null&&i.user)){const{data:s,error:r}=await y.from("users").select("*").eq("id",i.user.id).maybeSingle();if(r&&console.error("Profile fetch error:",r),s){if(s.active===!1)return M(!1),y.auth.signOut(),oe("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");clearTimeout(n),await Re(s);return}return M(!1),oe("Hesabınız veritabanında aktif değil.")}try{const s=Pe(e.includes("@")?e.split("@")[0]:e),r=await Ye(t),{data:d}=await y.rpc("get_user_by_credentials",{p_username:s,p_password_hash:r}),c=Array.isArray(d)?d[0]:d;if(c){if(c.active===!1)return M(!1),oe("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");clearTimeout(n),await Re(c);return}}catch(s){console.warn("Fallback RPC error:",s)}return M(!1),oe(o?"Giriş başarısız: "+o.message:"Kullanıcı adı veya şifre hatalı.")}catch(a){return M(!1),console.error("[doLogin]",a),oe("Giriş hatası: "+a.message)}finally{clearTimeout(n)}}async function Re(e){var n,a,i,o,s;M(!1);const t=e.role==="coach"||e.role==="developer"?e.id:e.role==="student"||e.role==="parent"?e.coach_id:null;b.role=e.role,b.studentId=e.role==="student"?e.id:null,b.dbUser=e,b.coachId=t,document.getElementById("loginScreen").style.display="none",document.getElementById("appShell").classList.add("visible");try{if(await jn(),(b.role==="coach"||b.role==="developer")&&!l.workspace){console.log("[Auth] Workspace not found, auto-creating from signup metadata...");const{data:{user:m}}=await y.auth.getUser();if(m){const u=((n=m.user_metadata)==null?void 0:n.ob_brand)||"Akademi",g=((a=m.user_metadata)==null?void 0:a.ob_color)||"#f0a500",_=((i=m.user_metadata)==null?void 0:i.ob_phone)||null,T=((o=m.user_metadata)==null?void 0:o.ob_examtypes)||"YKS",f=((s=m.user_metadata)==null?void 0:s.ob_studentcount)||"1-5",w={coach_id:e.id,brand_name:u,brand_color:g,phone:_,exam_types:T,student_count_range:f,onboarding_done:!1},{data:k,error:B}=await y.from("workspaces").upsert(w,{onConflict:"coach_id"}).select().maybeSingle();B?console.error("[finishLogin] Create workspace error:",B):k&&(l.workspace=k)}}if(b.role==="student"&&(l.activeStuId=e.id,b.studentId=e.id,l.students.find(m=>m.id===e.id)||l.students.push({id:e.id,name:e.full_name||e.username||"Öğrenci",target:e.target||"",color:e.color||"#4da6ff",progress:e.progress||0,weekStart:e.week_start||0,username:e.username,coachId:e.coach_id})),b.role==="parent"){const{data:m}=await y.from("users").select("*").eq("parent_id",e.id).single();m&&(l.activeStuId=m.id,b.studentId=m.id,b.childName=m.full_name||m.username)}window.setupShell();const r=new URLSearchParams(window.location.search);if(r.get("state")==="google_calendar"&&r.get("code")&&(b.role==="coach"||b.role==="developer")){const m=r.get("code");window.history.replaceState({},"",window.location.pathname+window.location.hash),document.getElementById("aiChatBubble").style.display="flex",setTimeout(()=>window.switchTab("appointments"),50),y.auth.getSession().then(({data:{session:u}})=>{u!=null&&u.access_token&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${u.access_token}`},body:JSON.stringify({type:"google_oauth_exchange",code:m})}).then(g=>g.json()).then(g=>{g.success?(l.workspace&&(l.workspace.google_calendar_connected=!0),x("Google Takvim bağlandı ✓"),window.renderAppointments&&window.renderAppointments()):x("Google bağlanamadı: "+(g.error||"Bilinmeyen hata"))}).catch(()=>x("Google Takvim bağlanamadı"))});return}if(document.getElementById("aiChatBubble").style.display="flex",(b.role==="coach"||b.role==="developer")&&(!l.workspace||!l.workspace.onboarding_done)){window.switchTab("home"),window.showOnboarding();return}if(b.role==="student"){const{data:m}=await y.from("student_profiles").select("onboarding_done").eq("id",b.studentId||e.id).maybeSingle();if(!m||!m.onboarding_done){const u=window.location.hash.substring(1),g=u&&document.getElementById("view-"+u)?u:"portal";setTimeout(()=>{window.switchTab(g),window.showStudentWelcome&&window.showStudentWelcome()},100);return}}const d=window.location.hash.substring(1),c={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[b.role]||"portal",p=d&&document.getElementById("view-"+d)?d:c;setTimeout(()=>window.switchTab(p),50)}catch(r){M(!1),console.error("[doLogin] HATA:",r),oe("Hata: "+r.message),document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible")}}function yi(){window._fcInstance&&(window._fcInstance.destroy(),window._fcInstance=null),window.destroyRealtime&&window.destroyRealtime(),y.auth.signOut().catch(()=>{}),Ln(),b.role=null,b.studentId=null,b.dbUser=null,b.coachId=null,b.childName=null,l.workspace=null,document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible"),document.getElementById("aiChatBubble").style.display="none",document.getElementById("aiChatPanel").classList.remove("open"),document.getElementById("loginEmail")&&(document.getElementById("loginEmail").value=""),document.getElementById("loginUser")&&(document.getElementById("loginUser").value=""),document.getElementById("loginPass").value="",window.location.hash=""}function xi(){var t,n;const e=(((t=document.getElementById("loginEmail"))==null?void 0:t.value)||((n=document.getElementById("loginUser"))==null?void 0:n.value)||"").trim();e&&document.getElementById("forgotEmail")&&(document.getElementById("forgotEmail").value=e),window.om("forgotPassModal")}async function bi(){const e=document.getElementById("forgotEmail").value.trim();if(!e)return;const t=document.getElementById("forgotMsg"),n=document.getElementById("btnSendReset");n&&(n.disabled=!0,n.textContent="Gönderiliyor..."),t.style.display="none";try{const a=await fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"password_reset",email:e})}),i=await a.json();if(!a.ok)throw new Error(i.error||"Sunucu hatası");t.style.display="block",t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="Sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin."}catch(a){t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Hata: "+(a.message||"Bir sorun oluştu.")}finally{n&&(n.disabled=!1,n.textContent="Sıfırlama Linki Gönder →")}}async function hi(){const e=document.getElementById("newPasswordInput").value;if(!e||e.length<8){alert("Şifre en az 8 karakter olmalıdır.");return}M(!0);try{const{error:t}=await y.auth.updateUser({password:e});if(t)throw t;const n=await Ye(e),{data:{user:a}}=await y.auth.getUser();a&&await y.from("users").update({password_hash:n}).eq("id",a.id),alert("Şifreniz başarıyla güncellendi! Lütfen yeni şifrenizle giriş yapın."),window.cm("resetPasswordModal"),await y.auth.signOut(),window.location.hash="",window.location.reload()}catch(t){alert("Şifre güncellenirken hata oluştu: "+t.message)}finally{M(!1)}}window.loginErr=oe;window.regErr=Me;window.setAuthMode=Zt;window.setLoginMode=si;window.setRegRole=Pn;window.setOnbRole=ri;window.loginWithGoogle=li;window.triggerRealGoogleLogin=Rn;window.showGoogleSimulator=Hn;window.closeGoogleSimulator=Jt;window.simOAuthLogin=di;window.checkOAuthSession=Nn;window.completeOnboarding=ci;window.doRegister=vi;window.doLogin=fi;window.finishLogin=Re;window.doLogout=yi;window.showForgotPassword=xi;window.sendResetEmail=bi;window.updateUserPassword=hi;window.nextRegWizardStep=mi;window.prevRegWizardStep=ui;window.setRegBrandColor=pi;window.onInviteCodeInput=Yn;window.applyInviteFromUrl=gi;y.auth.onAuthStateChange(async(e,t)=>{var a;if(e==="PASSWORD_RECOVERY"||window.location.hash.includes("type=recovery")||window.isPasswordRecoveryActive){window.isPasswordRecoveryActive=!0,console.log("[Auth] Password recovery flow active, showing resetPasswordModal"),M(!1),window.om("resetPasswordModal");return}if(e==="SIGNED_IN"&&(t!=null&&t.user)){if((a=document.getElementById("appShell"))!=null&&a.classList.contains("visible"))return;await Nn()}e==="SIGNED_OUT"&&(Be=!1,M(!1))});function _n(){const e=document.getElementById("loginEmail"),t=document.getElementById("loginUser");e&&t&&(e.addEventListener("input",n=>{t.value=n.target.value}),t.addEventListener("input",n=>{e.value=n.target.value}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_n):_n();if(new URLSearchParams(window.location.search).get("new_coach")==="1"){const e=sessionStorage.getItem("ra_new_coach_email"),t=sessionStorage.getItem("ra_new_coach_pass");if(e&&t){sessionStorage.removeItem("ra_new_coach_email"),sessionStorage.removeItem("ra_new_coach_pass");const n=()=>{const a=document.getElementById("loginEmail"),i=document.getElementById("loginPass");a&&i&&(a.value=e,i.value=t,setTimeout(()=>window.doLogin&&window.doLogin(),400))};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}function at(e){if(!e||e<=0)return"0 sa";const t=Math.floor(e/60),n=e%60;return t>0&&n>0?`${t} sa ${n} dk`:t>0?`${t} sa`:`${n} dk`}window.formatMinToHours=at;function ie(e){return new Promise(t=>{let n=document.getElementById("customConfirmModal");n||(n=document.createElement("div"),n.id="customConfirmModal",n.className="modal-bg",n.style.zIndex="999999",n.innerHTML=`
    ...
    <button class="mnav-btn" id="mntab_${m.id}" onclick="switchTab('${m.id}')">${m.lbl}<span style="font-size:9px;display:block">${m.name}</span></button>`).join(""),document.getElementById("mainContent").innerHTML=[...e,{id:"student-detail"},{id:"profile"},{id:"settings"},{id:"coach-resources"},{id:"coach-applications"},{id:"coach-notes"},{id:"coach-profile"},{id:"messages"},{id:"todolist"},{id:"suyelik"},{id:"program"},{id:"appointments"},{id:"exams"}].map(m=>`<div class="view" id="view-${m.id}"></div>`).join("");const t=b.dbUser,n=b.role==="student"?l.students.find(m=>m.id===b.studentId):null,a=(t==null?void 0:t.full_name)||(n==null?void 0:n.name)||"",i=a.split(" ").map(m=>m[0]).join("").slice(0,2).toUpperCase(),o={coach:"#E8613A",student:(n==null?void 0:n.color)||"#4da6ff",developer:"#c084fc",parent:"#3ecf8e"},s={coach:"KOÇ",student:"ÖĞRENCİ",developer:"DEV",parent:"VELİ"};if(document.getElementById("sbAv").textContent=i,document.getElementById("sbAv").style.background=o[b.role]||"#888",document.getElementById("sbName").textContent=a,document.getElementById("sbRole").textContent=s[b.role]||b.role,(b.role==="coach"||b.role==="developer")&&((p=l.workspace)!=null&&p.brand_name)){const m=document.querySelector(".sb-logo-text");m&&(m.textContent=l.workspace.brand_name);const u=document.querySelector(".tn-logo .sb-logo-icon");u&&u.tagName!=="IMG"&&(u.textContent=l.workspace.brand_name.slice(0,1).toUpperCase())}const r=document.getElementById("sb-site-admin");r&&(r.style.display=b.role==="developer"?"flex":"none");const d=document.getElementById("tnCoachProfileItem");d&&(d.style.display=b.role==="coach"||b.role==="developer"?"flex":"none");const c=document.getElementById("tnUyelikItem");c&&(c.style.display=b.role==="coach"||b.role==="developer"?"flex":"none"),setTimeout(Ct,200),Ra(),setTimeout($a,600),(b.role==="coach"||b.role==="developer")&&y.from("match_requests").select("id",{count:"exact",head:!0}).eq("matched_coach_id",b.coachId).eq("status","pending").then(({count:m})=>{if(m>0){const u=document.getElementById("sbi_coach-applications");if(u&&!u.querySelector(".sb-badge")){const g=document.createElement("span");g.className="sb-badge",g.textContent=m,u.appendChild(g)}}})}function se(e,t=!0){var p,m,u;if(!e)return;currentTab=e,t&&(window.location.hash=e),document.querySelectorAll(".tn-nav-item").forEach(g=>g.classList.remove("active"));const n=document.getElementById("sbi_"+e)||document.getElementById("sb-"+e);n&&n.classList.add("active"),document.querySelectorAll(".mnav-btn").forEach(g=>g.classList.remove("active"));const a=document.getElementById("mntab_"+e);a&&a.classList.add("active"),document.querySelectorAll(".view").forEach(g=>g.classList.remove("active"));const i=document.getElementById("view-"+e);i&&i.classList.add("active");const s=[...Kt,...On,...Fn,...Un,{id:"profile",name:"Profil"},{id:"settings",name:"Ayarlar"},{id:"student-detail",name:((p=l.students.find(g=>g.id===l.activeStuId))==null?void 0:p.name)||"Öğrenci"},{id:"program",name:"Program"},{id:"appointments",name:"Randevular"},{id:"exams",name:"Denemeler"}].find(g=>g.id===e),r=document.getElementById("tbarTitle");r&&(r.textContent=(s==null?void 0:s.name)||e);const d={home:qn,students:ct,messages:xa,"coach-applications":bn,"coach-notes":qa,todolist:da,portal:Mt,sportal:ze,sexams:on,smessages:Ft,suyelik:Ks,sprofil:Ia,profile:Jn,settings:Xn,"student-detail":()=>{l.activeStuId?Wn(l.activeStuId):se("students")},program:()=>{l.activeStuId?Qt(l.activeStuId):se("students")},exams:()=>{l.activeStuId?Je():se("students")},appointments:()=>{l.activeStuId?Ze():se("students")},"dev-dashboard":ka,"dev-users":Xe,"dev-resources":pt,"dev-finance":mt,"dev-announce":ut,"dev-tickets":Qe,"parent-home":Ya,"parent-progress":Ka,"parent-messages":Ft,"parent-ai":Oa,"coach-profile":za,"dev-matches":mn,"coach-resources":gt};try{(m=d[e])==null||m.call(d)}catch(g){console.error("[switchTab] Render error for tab:",e,g),i&&(i.innerHTML=`<div style="padding:24px;color:var(--text)"><b>Hata Oluştu ⚠️</b><p style="color:var(--text-mid);margin-top:6px">${v(g.message)}</p><pre style="font-size:10px;color:var(--text-dim);white-space:pre-wrap;margin-top:8px">${v((g.stack||"").slice(0,400))}</pre></div>`)}e==="messages"||e==="smessages"?rn():ln();const c=document.getElementById("aiChatBubble");c&&(e==="dev-tickets"||e.startsWith("dev-")||e==="messages"||e==="smessages"?(c.style.display="none",(u=document.getElementById("aiChatPanel"))==null||u.classList.remove("open")):(b.role==="student"||b.role==="coach"||b.role==="parent")&&(c.style.display="flex"))}function qn(){var t,n;const e=document.getElementById("view-home");if(e)try{const a=new Date,i=["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],o=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],s=O(a);let r=0;Object.values(l.messages).forEach(I=>{r+=I.filter(z=>z.from==="student"&&!z.read).length});const d=l.appointments.filter(I=>I.date===s).sort((I,z)=>I.time.localeCompare(z.time)),c=[],p=ne(0,0);(l.students||[]).forEach(I=>{let z=0,E=0;for(let D=0;D<7;D++){const j=O(J(p,D)),P=l.tasks[`${I.id}_${j}`]||[];z+=P.length,E+=P.filter(Y=>Y.done).length}const A=z>0?Math.round(E/z*100):0;z>0&&A<30&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"tasks",icon:"📋",title:"Düşük Görev",desc:`Bu haftaki görev tamamlama oranı <b>%${A}</b>'de kaldı (${E}/${z} görev tamamlandı).`});const C=(l.exams||[]).filter(D=>D.studentId===I.id).sort((D,j)=>new Date(j.date).getTime()-new Date(D.date).getTime()),L={};if(C.forEach(D=>{L[D.type]||(L[D.type]=[]),L[D.type].push(D)}),Object.entries(L).forEach(([D,j])=>{if(j.length>=2){const P=j[0],Y=j[1],N=Object.values(P.nets||{}).reduce((Z,te)=>Z+Number(te||0),0),F=Object.values(Y.nets||{}).reduce((Z,te)=>Z+Number(te||0),0),V=N-F;V<-5&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"exams",icon:"📉",title:`Net Düşüşü (${D})`,desc:`Son denemede <b>${N} net</b> yaptı. Önceki denemesine (${F} net) göre <b>${Math.abs(V).toFixed(1)} net düşüş</b>.`})}}),z===0&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"noplan",icon:"📭",title:"Program Yok",desc:"Bu hafta için henüz hiç görev eklenmemiş."}),z>0&&E===0){let D=!1;for(let j=0;j<3;j++){const P=O(J(a,-j));if((l.tasks[`${I.id}_${P}`]||[]).length>0){D=!0;break}}D&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"inactive",icon:"💤",title:"3 Gündür Pasif",desc:"Son 3 gündür hiçbir görev tamamlanmadı. İletişime geç!"})}z>0&&E===z&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"perfect",icon:"🏆",title:"Harika Hafta!",desc:`Bu haftaki tüm ${z} görevi tamamladı! Tebrik et.`}),(l.studentSpeeds||[]).filter(D=>D.student_id===I.id).forEach(D=>{let j=120;D.exam_type==="TYT"?["Türkçe","Sosyal"].includes(D.subject)?j=100:["Matematik","Fen"].includes(D.subject)&&(j=130):D.exam_type&&D.exam_type.startsWith("AYT")&&(j=180),D.secs_per_question>j&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"speed",icon:"⚡",title:`Hız Aşımı (${D.exam_type} - ${D.subject})`,desc:`Soru çözüm hızı <b>${D.secs_per_question} sn/soru</b> (Limit: ${j} sn).`})})});let m="";if(c.length===0)l.students.length===0?m=`
        ...
        ${L}
      </div>`}).join("")}const u=a.getHours(),g=u<6?"İyi geceler":u<12?"Günaydın":u<18?"İyi günler":"İyi akşamlar",_=`${String(u).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`,T=d.find(I=>I.time>=_),f=Wt(),w=f.days,k=ne(0,0);let B=0,h=0;l.students.forEach(I=>{for(let z=0;z<7;z++){const E=l.tasks[`${I.id}_${O(J(k,z))}`]||[];B+=E.length,h+=E.filter(A=>A.done).length}});const S=B>0?Math.round(h/B*100):0;e.innerHTML=`
    <!-- HERO -->
    <div class="home-hero">
    ...
    <div class="home-bottom-grid">
      ...
      <div class="home-section-card">
        ...
        <div class="hsc-body">
          ...
          ${d.map(I=>{const z=l.students.find(F=>F.id===I.studentId),E=I.time<_,[A,C]=I.time.split(":").map(Number),L=A*60+C,[$,D]=_.split(":").map(Number),j=$*60+D,P=L-j,Y=P>=-(I.duration||60)&&P<=15,N=Y&&I.meet_link?`<a href="${v(I.meet_link)}" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;background:${P<=0?"var(--red)":"var(--accent)"};color:#fff;font-size:11px;font-weight:800;text-decoration:none;animation:${P<=0?"pulse 1.5s infinite":"none"};white-space:nowrap;flex-shrink:0">${P<=0?"🔴 Ders Sürüyor":"🟡 Derse Gir"}</a>`:"";return`<div class="hsc-appt-row ${E&&!Y?"hsc-appt-past":""}">
              ...
              ${N||(E?'<span class="hsc-appt-done">✓</span>':"")}
            </div>`}).join("")}
        </div>
      </div>
    </div>
    ...
    <div class="card" style="margin-top:16px; border: 1px dashed var(--accent); padding: 18px; border-radius: 14px; background: var(--surface)">
      ...
      <div id="aiCopilotResultArea" style="display:none; margin-top:12px">
    ...
    </div>`,currentTab!=="student-detail"&&se("student-detail");const c=document.getElementById("tbarTitle");c&&(c.textContent=t.name)}const Oe=[{stars:0,label:"Başlanmadı",color:"#6b7280",bg:"rgba(107,114,128,.08)",border:"rgba(107,114,128,.2)"},{stars:1,label:"Anlamadım",color:"#ef4444",bg:"rgba(239,68,68,.08)",border:"rgba(239,68,68,.2)"},{stars:2,label:"Temel Zorluk",color:"#f97316",bg:"rgba(249,115,22,.08)",border:"rgba(249,115,22,.2)"},{stars:3,label:"Temel OK",color:"#eab308",bg:"rgba(234,179,8,.08)",border:"rgba(234,179,8,.2)"},{stars:4,label:"Orta Seviye",color:"#84cc16",bg:"rgba(132,204,22,.08)",border:"rgba(132,204,22,.2)"},{stars:5,label:"İleri Seviye",color:"#22c55e",bg:"rgba(34,197,94,.08)",border:"rgba(34,197,94,.2)"},{stars:6,label:"Uzman",color:"#10b981",bg:"rgba(16,185,129,.08)",border:"rgba(16,185,129,.2)"},{stars:7,label:"Tekrar Dışı (TD)",color:"#3b82f6",bg:"rgba(59,130,246,.1)",border:"rgba(59,130,246,.3)"}];function Vn(e){const t=new Date(e),n=t.getDate(),a=n<=10?1:n<=20?11:21;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function _i(e=6){const t=[],n=new Date;let a=new Date(n);for(let i=0;i<e;i++){const o=Vn(a);t.find(c=>c.start===o)||t.unshift({start:o,label:Ti(o)});const[s,r,d]=o.split("-").map(Number);if(d===21?a=new Date(s,r-1,11):d===11?a=new Date(s,r-1,1):a=new Date(s,r-2,21),t.length>=e)break}return t.slice(-e)}function Ti(e){const[t,n,a]=e.split("-").map(Number),i=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],o=a===1?10:a===11?20:new Date(t,n,0).getDate();return`${a}-${o} ${i[n-1]}`}const Tn={SAY:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","TYT Fizik","AYT Fizik","TYT Kimya","AYT Kimya","TYT Biyoloji","AYT Biyoloji"],EA:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],SOZ:["Dil Bilgisi","TYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],DIL:["Dil Bilgisi","TYT Matematik","Geometri","YDT İngilizce"]};async function Si(e){const t=l.students.find(f=>f.id===e);if(!t)return;const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button><div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`;const a=b.role==="coach"||b.role==="developer",i=t.yksArea||"SAY",o=Tn[i]||Tn.SAY;let s=o[0],r="mastery";function d(f,w){var k,B;return((B=(k=l.konuMastery[e])==null?void 0:k[f])==null?void 0:B[w])||null}function c(f,w){var k,B;return((B=(k=l.konuTekrarLog[e])==null?void 0:k[f])==null?void 0:B[w])||{}}async function p(f,w,k,B){const h=d(f,w),S=new Date().toISOString(),I=B||(k>=7?"td":k>0?"active":"not_started"),z={student_id:e,coach_id:b.coachId,subject:f,konu:w,stars:k,status:I,updated_at:S,...I==="active"&&!(h!=null&&h.ka_date)?{ka_date:S}:{},...I==="td"&&!(h!=null&&h.td_date)?{td_date:S}:{},...I==="active"&&(h==null?void 0:h.status)==="td"?{td_date:null}:{}},{data:E,error:A}=await y.from("konu_mastery").upsert(z,{onConflict:"student_id,subject,konu"}).select().single();if(A){x("Hata: "+A.message);return}return l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][w]=E,E}async function m(f,w,k,B){const h=new Date().toISOString(),S={student_id:e,coach_id:b.coachId,subject:f,konu:w,period_start:k,review_count:B,updated_at:h},{data:I,error:z}=await y.from("konu_tekrar_log").upsert(S,{onConflict:"student_id,subject,konu,period_start"}).select().single();if(z){x("Hata: "+z.message);return}return l.konuTekrarLog[e]||(l.konuTekrarLog[e]={}),l.konuTekrarLog[e][f]||(l.konuTekrarLog[e][f]={}),l.konuTekrarLog[e][f][w]||(l.konuTekrarLog[e][f][w]={}),l.konuTekrarLog[e][f][w][k]=I,I}function u(f){const w=it[f]||[],k=w.map((E,A)=>{const C=d(f,E),L=(C==null?void 0:C.stars)||0,$=(C==null?void 0:C.status)||"not_started",D=Oe[L],j=$==="td",P=A%2===0?"var(--surface)":"var(--surface2)",Y=c(f,E),N=Object.values(Y).reduce((Q,R)=>Q+(R.review_count||0),0),F=C!=null&&C.last_review_date?new Date(C.last_review_date).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"}):"—",V=a?Array.from({length:7},(Q,R)=>{const H=R+1,K=H<=L,re=f.replace(/'/g,"\\'"),xe=E.replace(/'/g,"\\'");return`<span class="km-star${K?" km-star-on":""}" data-stars="${H}" 
          onclick="window._kmSetStars('${re}','${xe}',${H})"
          title="${Oe[H].label}"
        ...
        <td style="padding:8px 10px;text-align:center;font-size:11px;color:var(--text-mid);white-space:nowrap">
          ${N>0?`<b style="color:var(--text)">${N}×</b>`:"—"}
        </td>
      ...
      <div style="flex:1;height:6px;background:var(--surface3);border-radius:99px;overflow:hidden;min-width:80px;max-width:200px">
        <div style="height:100%;width:${w.length>0?Math.round(S/w.length*100):0}%;background:#3b82f6;border-radius:99px"></div>
      </div>
      <span style="font-size:11px;color:#3b82f6;font-weight:700">${w.length>0?Math.round(S/w.length*100):0}% TD</span>
    ...
    </div>`}function g(f){const w=it[f]||[],k=_i(6),B=Vn(new Date),h=`<tr style="background:var(--surface2)">
      <th style="padding:8px 14px;text-align:left;font-size:10px;font-weight:800;color:var(--text-dim);border-right:1px solid var(--border);position:sticky;left:0;z-index:2;background:var(--surface2);white-space:nowrap;min-width:200px">KONU</th>
      ...
      ${k.map(I=>`<th style="padding:8px 10px;text-align:center;font-size:10px;font-weight:800;color:${I.start===B?"var(--accent)":"var(--text-dim)"};background:${I.start===B?"var(--accent-dim)":"var(--surface2)"};white-space:nowrap;min-width:100px;border-left:1px solid var(--border)">${I.label}</th>`).join("")}
      <th style="padding:8px 10px;text-align:center;font-size:10px;font-weight:800;color:var(--text-dim);white-space:nowrap;border-left:2px solid var(--border)">TOPLAM</th>
    </tr>`,S=w.map((I,z)=>{const E=d(f,I),A=(E==null?void 0:E.stars)||0,L=((E==null?void 0:E.status)||"not_started")==="td",$=Oe[A],D=z%2===0?"var(--surface)":"var(--surface2)",j=c(f,I);let P=0;const Y=k.map(F=>{const V=j[F.start],Z=(V==null?void 0:V.review_count)||0;P+=Z;const te=F.start===B;if(a){const Q=Array.from({length:6},(R,H)=>{const K=H<Z,re=f.replace(/'/g,"\\'"),xe=I.replace(/'/g,"\\'");return`<span class="kt-box${K?" kt-box-on":""}"
              onclick="window._ktToggleBox('${re}','${xe}','${F.start}',${H+1})"
              style="display:inline-block;width:14px;height:14px;border-radius:3px;border:1.5px solid ${K?$.color:"var(--border2)"};background:${K?$.bg:"transparent"};cursor:pointer;transition:all .15s;margin:1px"
              title="${H+1}. tekrar"
            ></span>`}).join("");return`<td style="padding:6px 10px;border-left:1px solid var(--border);background:${te?"var(--accent-dim)":D};text-align:center">${Q}</td>`}else{const Q=Array.from({length:6},(R,H)=>{const K=H<Z;return`<span style="display:inline-block;width:12px;height:12px;border-radius:3px;border:1.5px solid ${K?$.color:"var(--border2)"};background:${K?$.bg:"transparent"};margin:1px"></span>`}).join("");return`<td style="padding:6px 10px;border-left:1px solid var(--border);background:${te?"var(--accent-dim)":D};text-align:center">${Q}</td>`}}).join(""),N=L?'<span style="font-size:9px;font-weight:800;color:#3b82f6;background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.3);border-radius:4px;padding:1px 5px;margin-left:4px">TD</span>':"";return`<tr style="background:${D}">
        ...
        ${Y}
        <td style="padding:8px 10px;text-align:center;font-size:12px;font-weight:800;color:${P>0?$.color:"var(--text-dim)"};border-left:2px solid var(--border)">${P||0}</td>
      </tr>`}).join("");return`<div style="overflow-x:auto"><table style="border-collapse:collapse;width:max-content;min-width:100%"><thead>${h}</thead><tbody>${S}</tbody></table></div>`}window._kmSetStars=async function(f,w,k){const B=d(f,w),h=(B==null?void 0:B.status)==="td"&&k<7?"active":null;await p(f,w,k,h);const S="km_"+btoa(encodeURIComponent(f+"|"+w)).replace(/[^a-zA-Z0-9]/g,"");if(document.getElementById(S)){const z=u(f);document.getElementById("khTable").innerHTML=z}x(`${w}: ${Oe[k].label} ✓`)},window._kmToggleKA=async function(f,w){const k=d(f,w),B=new Date().toISOString(),h=!!(k!=null&&k.ka_date),S={student_id:e,coach_id:b.coachId,subject:f,konu:w,stars:(k==null?void 0:k.stars)||1,status:(k==null?void 0:k.status)||"active",ka_date:h?null:B,updated_at:B},{data:I,error:z}=await y.from("konu_mastery").upsert(S,{onConflict:"student_id,subject,konu"}).select().single();if(z){x("Hata: "+z.message);return}l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][w]=I,document.getElementById("khTable").innerHTML=u(f),x(h?"KA tarihi kaldırıldı":"KA ✓ tamamlandı olarak işaretlendi")},window._kmToggleTD=async function(f,w){const k=d(f,w),B=(k==null?void 0:k.status)==="td",h=B?(k==null?void 0:k.stars)>=7?5:k==null?void 0:k.stars:7;await p(f,w,h,B?"active":"td"),document.getElementById("khTable").innerHTML=r==="mastery"?u(f):g(f),x(B?`${w} tekrar listesine geri döndü`:`${w} → TD ✓`)},window._ktToggleBox=async function(f,w,k,B){const S=c(f,w)[k],z=((S==null?void 0:S.review_count)||0)>=B?B-1:B;if(await m(f,w,k,z),z>0){const E=d(f,w),A=new Date().toISOString(),C={student_id:e,coach_id:b.coachId,subject:f,konu:w,stars:(E==null?void 0:E.stars)||0,status:(E==null?void 0:E.status)||"active",last_review_date:A,review_count:((E==null?void 0:E.review_count)||0)+1,updated_at:A},{data:L}=await y.from("konu_mastery").upsert(C,{onConflict:"student_id,subject,konu"}).select().single();L&&(l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][w]=L)}document.getElementById("khTable").innerHTML=g(f)};function _(){const f=window._khActiveSub||s;document.getElementById("khTable").innerHTML=r==="mastery"?u(f):g(f)}const T=o.map(f=>`<button class="kh-tab" onclick="window._khActiveSub='${f}';document.querySelectorAll('.kh-tab').forEach(b=>{b.style.color='var(--text-mid)';b.style.borderBottom='2px solid transparent';b.style.fontWeight='600'});this.style.color='var(--accent)';this.style.borderBottom='2px solid var(--accent)';this.style.fontWeight='700';window._khRefresh()"
    ...
    ${c}`}function Mi(e){document.getElementById("sbModalTitle").textContent="Kaynak Ekle",document.getElementById("sbId").value="",document.getElementById("sbStuId").value=e,document.getElementById("sbName").value="",document.getElementById("sbTotal").value="0",document.getElementById("sbCompleted").value="0",document.getElementById("sbPctPreview").innerHTML="",G("sbModal")}function Di(e,t){const n=(ye[e]||[]).find(a=>a.id===t);n&&(document.getElementById("sbModalTitle").textContent="Kaynağı Düzenle",document.getElementById("sbId").value=t,document.getElementById("sbStuId").value=e,document.getElementById("sbName").value=n.name,document.getElementById("sbTotal").value=n.total_tests,document.getElementById("sbCompleted").value=n.completed_tests,Zn(),G("sbModal"))}function Zn(){var o,s;const e=parseInt((o=document.getElementById("sbTotal"))==null?void 0:o.value)||0,t=parseInt((s=document.getElementById("sbCompleted"))==null?void 0:s.value)||0,n=document.getElementById("sbPctPreview");if(!n||!e){n&&(n.innerHTML="");return}const a=Math.min(100,Math.round(t/e*100)),i=a>=75?"var(--green)":a>=40?"var(--accent)":"var(--red)";n.innerHTML=`<div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;height:8px;background:var(--surface3);border-radius:99px;overflow:hidden">
    ...
    </div>`}function ji(){const e=document.getElementById("geminiApiKeyInput").value.trim();e?(localStorage.setItem("gemini_api_key",e),x("API Anahtarı kaydedildi ✓")):(localStorage.removeItem("gemini_api_key"),x("API Anahtarı kaldırıldı."))}let Ae="";function X(){const e=document.getElementById("view-program"),t=l.students.find(d=>d.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=ne(l.weekOffset,n),i=J(a,6),o=ue(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let d=0;d<7;d++){const c=J(a,d),p=O(c),m=p===o,u=`${l.activeStuId}_${p}`,g=l.tasks[u]||[],_=g.reduce((h,S)=>h+Number(S.duration),0),T=g.reduce((h,S)=>h+(S.done?Number(S.duration):0),0),f=DAYS_TR[(n+d)%7],w=[...g];s==="hourly"&&w.sort((h,S)=>h.start_time&&!S.start_time?-1:!h.start_time&&S.start_time?1:h.start_time&&S.start_time?h.start_time.localeCompare(S.start_time):0);const k=w.map(h=>{const S=g.indexOf(h),I=h.start_time?`<div class="tc-time-badge">🕒 ${h.start_time}</div>`:"";return`
    ...
    <div class="week-grid">${r}</div>`}function Pi(e){l.activeStuId=e||null,lt(),X()}function Ri(e){l.weekOffset+=e,lt(),X()}function Hi(){l.weekOffset=0,lt(),X()}function Ni(e){localStorage.setItem("ra_program_mode",e),b.role==="student"?ze():X()}window.setProgramMode=Ni;(()=>{const e=document.createElement("style");e.textContent=`
    .tc-time-badge {
      font-size: 11px;
      font-weight: 800;
      color: var(--accent);
  ...
  `,document.head.appendChild(e)})();let de=[];function Yi(){if(!l.activeStuId)return x("Önce öğrenci seçin");const e=l.students.find(i=>i.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=ne(l.weekOffset,t);de=[];let a="";for(let i=0;i<7;i++){const o=J(n,i),s=O(o);DAYS_TR[(t+i)%7];const r=(l.tasks[`${l.activeStuId}_${s}`]||[]).length>0,d=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(t+i)%7];a+=`<button class="day-sel-btn" id="dsbtn_${i}" data-ds="${s}" onclick="toggleDaySel(${i},'${s}')">
    ...
    <div onclick="selectBook(${p})" style="padding:10px 14px;cursor:pointer;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;transition:background .15s"
      ...
      </label>`}).join(""),Ve()}function Qi(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!0),Ve()}function eo(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!1),Ve()}function Ve(){if(!W)return;const e=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")],t=document.getElementById("tmTestSummary"),n=document.getElementById("tmTestSummaryText"),a=document.getElementById("tmSuggestedDuration"),i=document.getElementById("tmSpeedRow"),o=W.resource_type==="playlist";if(e.length===0){t.style.display="none";return}let s=0,r=0;e.forEach(m=>{const u=parseInt(m.value),g=W.testler[u];o?r+=(g==null?void 0:g.soru)||0:s+=(g==null?void 0:g.soru)||0});const d=document.querySelector("[data-mspeed].speed-active"),c=d?parseFloat(d.dataset.mspeed):1;let p=0;if(o)p=r>0?Math.ceil(r/c):0,n.textContent=`${e.length} video · ${r} dk`,i&&(i.style.display="");else{const m=document.getElementById("tmExam").value,u=document.getElementById("tmSubjectSel").value||"",g=`${l.activeStuId}_${m}_${u}`,_=ht[g]||180;p=s>0?Math.ceil(s*_/60):0,n.textContent=`${e.length} test · ${s} soru${p>0?" · Önerilen: "+p+" dk":""}`,i&&(i.style.display="none")}a.style.display=p>0?"":"none",vt=p,a.setAttribute("data-dur",p),t.style.display="",p>0&&(document.getElementById("tmDuration").value=p)}function to(e){document.querySelectorAll("[data-mspeed]").forEach(t=>{const n=t.dataset.mspeed===e;t.classList.toggle("speed-active",n),t.style.borderColor=n?"var(--accent)":"var(--border)",t.style.background=n?"var(--accent-dim)":"var(--surface2)",t.style.color=n?"var(--accent)":"var(--text-mid)"}),Ve()}let vt=0;function no(){vt>0&&(document.getElementById("tmDuration").value=vt,x("Süre uygulandı: "+vt+" dk"))}let ht={};async function ia(){if(!l.activeStuId)return;const{data:e}=await y.from("student_speeds").select("*").eq("student_id",l.activeStuId);ht={},(e||[]).forEach(t=>{const n=`${t.student_id}_${t.exam_type}_${t.subject}`;ht[n]=t.secs_per_question})}async function oa(e,t,n,a){const{data:i}=await y.from("student_speeds").select("id").eq("student_id",e).eq("exam_type",t).eq("subject",n).single();i?await y.from("student_speeds").update({secs_per_question:a,updated_at:new Date().toISOString()}).eq("id",i.id):await y.from("student_speeds").insert({student_id:e,coach_id:b.coachId,exam_type:t,subject:n,secs_per_question:a}),ht[`${e}_${t}_${n}`]=a,x("Hız kaydedildi ✓")}let Sn=null,nt=null;function zt(){clearTimeout(Sn),Sn=setTimeout(ao,400)}async function ao(){var i,o,s,r,d;const e=document.getElementById("tmSmartBadge");if(!e)return;const t=parseInt((i=document.getElementById("tmQCount"))==null?void 0:i.value)||0,n=(((o=document.getElementById("tmSubjectSel"))==null?void 0:o.style.display)!=="none"?(s=document.getElementById("tmSubjectSel"))==null?void 0:s.value:(r=document.getElementById("tmSubjectFree"))==null?void 0:r.value)||"",a=((d=document.getElementById("tmExam"))==null?void 0:d.value)||"TYT";if(!t||!n||!l.activeStuId){e.style.display="none",nt=null;return}try{const{data:c,error:p}=await y.rpc("calculate_smart_duration",{p_student_id:l.activeStuId,p_exam_type:a,p_subject:n,p_question_count:t,p_video_minutes:0,p_speed_multiplier:1});if(p||!c){e.style.display="none";return}nt=c.estimated_minutes;const m=c.speed_source==="student";e.style.display="block",e.style.background=m?"var(--green-dim)":"var(--blue-dim)",e.style.borderColor=m?"rgba(5,150,105,.3)":"rgba(37,99,235,.3)",e.style.color=m?"var(--green)":"var(--blue)",e.innerHTML=`⚡ Akıllı Süre: <b>${c.estimated_minutes} dk</b> — ${m?`öğrencinin gerçek hızına göre (${c.secs_per_question} sn/soru)`:`sistem varsayılanına göre (${c.secs_per_question} sn/soru)`} · <u>süreye uygula</u>`}catch{e.style.display="none"}}function io(){nt&&(document.getElementById("tmDuration").value=nt,x("⚡ Akıllı süre uygulandı: "+nt+" dk"))}document.getElementById("tmType").addEventListener("change",Tt);var Dn;(Dn=document.getElementById("tmExam"))==null||Dn.addEventListener("change",zt);var An;(An=document.getElementById("tmSubjectSel"))==null||An.addEventListener("change",zt);var Cn;(Cn=document.getElementById("tmSubjectFree"))==null||Cn.addEventListener("input",zt);let Lt=!1;async function oo(){var n;if(Lt)return;Lt=!0;const e=document.querySelector('#taskModal button[onclick*="saveTask"]'),t=e?e.textContent:"Programa Ekle";e&&(e.disabled=!0,e.textContent="Kaydediliyor...");try{const a=document.getElementById("tmType").value,i=document.getElementById("tmSubjectSel"),o=document.getElementById("tmSubjectFree"),s=document.getElementById("tmExam").value,r=parseInt(document.getElementById("tmDuration").value)||60,d=document.getElementById("tmStartTime").value||null,c=document.getElementById("tmNote").value.trim();if((n=document.getElementById("tmNewResourceToggle"))==null?void 0:n.checked){const k=document.getElementById("tmManualKaynak").value.trim();if(!k)return x("Kaynak adı girin!");const B=i.style.display!=="none"?i.value:o.value.trim(),h=B?`${B} - ${k}`:k,S=fe.map(C=>({label:C,url:"",soru:0}));let I=c;fe.length>0&&(I=`${fe.length} test: ${fe.slice(0,3).join(", ")}${fe.length>3?` +${fe.length-3} daha`:""}`);const z={student_id:l.activeStuId,coach_id:b.coachId,date:Ae,type:a,exam_type:s,subject:h,duration:r,note:I,done:!1,task_items:S.length>0?S:null,start_time:d};M(!0);const{error:E}=await y.from("tasks").insert(z);if(M(!1),E)return x("Hata: "+E.message);const A=`${l.activeStuId}_${Ae}`;l.tasks[A]||(l.tasks[A]=[]),l.tasks[A].push({type:a,exam:s,subject:h,duration:r,note:I,done:!1,task_items:z.task_items,start_time:d}),q("taskModal"),X(),x("Görev eklendi ✓");return}const m=document.getElementById("tmBookVal").value,u=(W==null?void 0:W.resource_type)==="playlist";let g="";if((a==="soru"||a==="konu")&&m){const k=i.style.display!=="none"?i.value:"";g=k?`${k} - ${m}`:`${m}`}else g=(i.style.display!=="none"?i.value:o.value).trim();if(!g)return x("Ders adı girin!");const _=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")];let T=c,f=[];if(_.length>0&&W){const k=_.map(B=>{const h=W.testler[parseInt(B.value)];return(h==null?void 0:h.label)||h||""});if(f=_.map(B=>{const h=W.testler[parseInt(B.value)];return{label:(h==null?void 0:h.label)||h||"",url:(h==null?void 0:h.url)||"",soru:(h==null?void 0:h.soru)||0}}),u){const B=h=>h.length>14?h.slice(0,13)+"…":h;T=`${k.length} video: ${k.slice(0,5).map(B).join(", ")}${k.length>5?` +${k.length-5}`:""}`}else{const B=h=>h.length>14?h.slice(0,13)+"…":h;T=`${k.length} test: ${k.slice(0,5).map(B).join(", ")}${k.length>5?` +${k.length-5}`:""}`}}const w={student_id:l.activeStuId,coach_id:b.coachId,date:Ae,type:a,exam_type:s,subject:g,duration:r,note:T,done:!1,task_items:f.length>0?f:null,start_time:d};if(_editingTaskId){M(!0);const{error:k}=await y.from("tasks").update({type:w.type,exam_type:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,task_items:w.task_items,start_time:w.start_time}).eq("id",_editingTaskId);if(M(!1),k)return x("Hata: "+k.message);const B=`${l.activeStuId}_${Ae}`;if(l.tasks[B]){const h=l.tasks[B].findIndex(S=>S._id===_editingTaskId);h!==-1&&(l.tasks[B][h]={_id:_editingTaskId,type:w.type,exam:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,done:l.tasks[B][h].done,student_note:l.tasks[B][h].student_note||"",task_items:w.task_items,start_time:w.start_time})}q("taskModal"),X(),x("Görev güncellendi ✓"),_editingTaskId=null}else{const{data:k,error:B}=await y.from("tasks").insert(w).select().single();if(B)return x("Hata: "+B.message);const h=`${l.activeStuId}_${Ae}`;l.tasks[h]||(l.tasks[h]=[]),l.tasks[h].push({_id:k.id,type:k.type,exam:k.exam_type,subject:k.subject,duration:k.duration,note:k.note,done:!1,student_note:"",task_items:k.task_items||null,start_time:k.start_time}),q("taskModal"),X(),x("Görev eklendi ✓")}}finally{Lt=!1,e&&(e.disabled=!1,e.textContent=t)}}async function so(e,t){var o;const n=`${l.activeStuId}_${e}`,a=(o=l.tasks[n])==null?void 0:o[t];if(!a)return;const i=!a.done;await y.from("tasks").update({done:i}).eq("id",a._id),a.done=i,X()}let ft=null;function tn(){ft&&(ft.remove(),ft=null)}document.addEventListener("click",tn);function ro(e,t,n){tn();const a=n.getBoundingClientRect(),i=document.createElement("div");i.className="tc-dropdown",i.innerHTML=`
...
`)],{type:"text/calendar;charset=utf-8"}),a=URL.createObjectURL(n),i=document.createElement("a");i.href=a,i.download="rostrum-ajanda.ics",i.click(),URL.revokeObjectURL(a),x("Ajanda indirildi ✓")}function la(e,t){t.stopPropagation();const n=document.getElementById("apptDetailPopup");if(n){const g=n.dataset.id;if(n.remove(),g===e)return}const a=l.appointments.find(g=>g.id===e);if(!a)return;const i=l.students.find(g=>g.id===a.studentId),o=ra(a.type),s=document.createElement("div");s.id="apptDetailPopup",s.dataset.id=e;const r=window.innerWidth,d=window.innerHeight,c=264;let p=Math.min(t.clientX+12,r-c-12),m=Math.min(t.clientY+12,d-220);s.style.cssText=`position:fixed;left:${p}px;top:${m}px;z-index:600;width:${c}px;background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:14px 16px;box-shadow:0 8px 32px rgba(0,0,0,.18);animation:viewIn .15s ease`;const u=a.meetLink||a.meet_link;s.innerHTML=`
    ...
    <div style="display:flex;gap:6px;flex-wrap:wrap">
      ...
      <a href="${uo(a)}" target="_blank" style="font-size:11px;font-weight:700;color:var(--green);background:var(--green-dim);padding:4px 10px;border-radius:99px;text-decoration:none">📅 GCal</a>
    ...
    </div>`,document.body.appendChild(s),setTimeout(()=>{document.addEventListener("click",function g(_){s.contains(_.target)||(s.remove(),document.removeEventListener("click",g))})},50)}async function bo(e,t){e.preventDefault();const n=window._draggingApptId;if(!n)return;window._draggingApptId=null;const a=e.currentTarget,i=a.getBoundingClientRect(),o=a.closest("[data-tl-scroll]"),s=o?o.scrollTop:0,d=(e.clientY-i.top+s)/mo*60+In*60,c=Math.max(In,Math.min(po-1,Math.floor(d/60))),p=Math.round(d%60/15)*15,m=p>=60?0:p,u=`${String(c).padStart(2,"0")}:${String(m).padStart(2,"0")}`,{error:g}=await y.from("appointments").update({date:t,time:u}).eq("id",n);if(g){x("Hata: "+g.message);return}const _=l.appointments.find(T=>T.id===n);_&&(_.date=t,_.time=u),$e(),x("Randevu taşındı ✓")}function da(){$e()}function $e(){const e=document.getElementById("view-todolist");if(!e)return;if(!document.getElementById("fc-styles")){const r=document.createElement("style");r.id="fc-styles",r.textContent=`
      .fc {
...
🔗 Davet Linki: ${n}`);a.innerHTML=`<div class="modal" style="max-width:480px">
  ...
  </div>`,window._pendingInvite={name:e,email:t,inviteUrl:n},G("inviteModal")}function Eo(e){navigator.clipboard.writeText(e).then(()=>x("Bağlantı kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),x("Bağlantı kopyalandı ✓")})}async function _o(e){var a;if(!await ie("Bu öğrenciyi silmek istediğinizden emin misiniz?"))return;const t=document.getElementById(`sturow_${e}`);t&&(t.style.transition="all 0.3s ease",t.style.opacity="0",t.style.transform="translateX(30px)",t.innerHTML='<div style="color:var(--red); font-weight:700; font-size:13px; display:flex; align-items:center; gap:6px">🗑️ Siliniyor...</div>'),await new Promise(i=>setTimeout(i,300));const{error:n}=await y.from("users").delete().eq("id",e);if(n)return x("Hata: "+n.message);l.students=l.students.filter(i=>i.id!==e),l.activeStuId===e&&(l.activeStuId=((a=l.students[0])==null?void 0:a.id)||null),we(),pa(),x("Silindi")}function To(){const e="217851738834-1cp3fk66hfhm0mr2aklsk3jphqmub2s3.apps.googleusercontent.com",t=encodeURIComponent("https://www.rostrumakademi.com/app.html"),n=encodeURIComponent("https://www.googleapis.com/auth/calendar.events"),a=`https://accounts.google.com/o/oauth2/v2/auth?client_id=${e}&redirect_uri=${t}&response_type=code&scope=${n}&access_type=offline&prompt=consent&state=google_calendar`;window.location.href=a}window.connectGoogleCalendar=To;function Ze(){var a,i;const e=document.getElementById("view-appointments"),n=((a=l.workspace)==null?void 0:a.google_calendar_connected)?'<span style="font-size:12px;color:var(--green);font-weight:600;display:flex;align-items:center;gap:4px">✓ Google Takvim</span>':'<button class="btn btn-ghost btn-sm" onclick="connectGoogleCalendar()">🔗 Google Takvim Bağla</button>';e.innerHTML=`
...
`)],{type:"text/calendar;charset=utf-8"}),o=URL.createObjectURL(i),s=document.createElement("a");s.href=o,s.download="rostrum-randevular.ics",s.click(),setTimeout(()=>URL.revokeObjectURL(o),1e3),x(`${t.length} randevu takvim dosyasına aktarıldı ✓`)}function kt(e){return 100+(Number(e.Türkçe||0)+Number(e.Matematik||0)+Number(e.Fen||0)+Number(e.Sosyal||0))*(400/120)}function ua(e,t){const n=a=>Number(t[a]||0);return e==="AYT-SAY"?100+(n("Matematik")+n("Fizik")+n("Kimya")+n("Biyoloji"))*5:e==="AYT-EA"?100+(n("Matematik")+n("Edebiyat")+n("Tarih")+n("Coğrafya"))*5:e==="AYT-SOZ"?100+(n("Edebiyat")+n("Tarih1")+n("Tarih2")+n("Coğrafya1")+n("Coğrafya2")+n("Felsefe")+n("Din"))*5:null}const ga={"AYT-SAY":"SAY","AYT-EA":"EA","AYT-SOZ":"SÖZ"},wt={TYT:"#3B82F6",SAY:"#8B5CF6",EA:"#10B981",SÖZ:"#F59E0B"};function va(e,t){const{type:n,nets:a}=e;if(n==="TYT"){const d=kt(a),c=wt.TYT;return`<div style="margin-top:10px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
  ...
  </div>`,_=o.map(R=>{var kn;const H=Number(((kn=a.nets)==null?void 0:kn[R])||0),K=(EXAM_SORU[a.type]||{})[R]||40,re=Math.min(100,Math.max(0,H/K*100)),xe=H>=K*.6?"#3ecf8e":H>=K*.35?"#f0a500":"#ef4444";return`<div style="margin-bottom:11px">
      <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:4px">
        <span style="font-size:12px;font-weight:600;color:var(--text)">${v(R)}</span>
        <span style="font-size:14px;font-weight:800;color:${xe};font-family:'Inter',sans-serif">${H.toFixed(1)}</span>
      </div>
    ...
    ${_}
  </div>`;const T=n.map(R=>(EXAM_DEFS[R.type]||[]).reduce((K,re)=>{var xe;return K+Number(((xe=R.nets)==null?void 0:xe[re])||0)},0)),f=Math.max(...T,10),w=600,k=160,B=40,h=16,S=28,I=30,z=w-B-h,E=k-S-I,A=n.length,C=R=>B+(A<=1?z/2:R/(A-1)*z),L=R=>S+E-R/f*E,$=f/4,D=$<=10?10:$<=20?20:$<=25?25:50,j=[];for(let R=0;R<=f+D;R+=D)R<=f*1.12&&j.push(R);const P=j.map(R=>{const H=L(R).toFixed(1);return`<line x1="${B}" y1="${H}" x2="${w-h}" y2="${H}" stroke="rgba(255,255,255,0.05)" stroke-width="1"/><text x="${B-5}" y="${(L(R)+3.5).toFixed(1)}" text-anchor="end" font-size="9" fill="rgba(200,215,230,0.28)" font-family="system-ui,sans-serif">${R}</text>`}).join(""),Y=n.map((R,H)=>`${C(H).toFixed(1)},${L(T[H]).toFixed(1)}`).join(" "),N=`M ${C(0).toFixed(1)},${L(T[0]).toFixed(1)} `+n.slice(1).map((R,H)=>`L ${C(H+1).toFixed(1)},${L(T[H+1]).toFixed(1)}`).join(" ")+` L ${C(A-1).toFixed(1)},${(S+E).toFixed(1)} L ${C(0).toFixed(1)},${(S+E).toFixed(1)} Z`,F="ag"+Math.random().toString(36).slice(2,7),V=n.map((R,H)=>{const K=C(H).toFixed(1),re=L(T[H]).toFixed(1);return`<circle cx="${K}" cy="${re}" r="5" fill="${s}" stroke="#0d0d0f" stroke-width="2.5"/><text x="${K}" y="${(L(T[H])-10).toFixed(1)}" text-anchor="middle" font-size="9.5" font-weight="700" fill="${s}" font-family="system-ui,sans-serif">${T[H].toFixed(0)}</text>`}).join(""),Z=n.map((R,H)=>{let K=R.name.replace(/Deneme\s+/,"#").replace(/^(TYT|AYT-SAY|AYT-EA|AYT-SOZ)\s+/,"");return K.length>7&&(K=K.slice(0,6)+"…"),`<text x="${C(H).toFixed(1)}" y="${(k-I+14).toFixed(1)}" text-anchor="middle" font-size="9" fill="rgba(200,215,230,0.35)" font-family="system-ui,sans-serif">${v(K)}</text>`}).join(""),te=`<svg viewBox="0 0 ${w} ${k}" style="width:100%;height:auto;display:block" xmlns="http://www.w3.org/2000/svg">
  ...
  ${V}${Z}
    ...
    ${o}`}window._krRenderBody=ya;function Ro(e){fa=e;const t=l.exams.find(n=>n.studentId===e&&n.examDetails&&Object.keys(n.examDetails).length);De=(t==null?void 0:t.type)||"TYT",ya(),G("konuRaporuModal")}window.openKonuRaporu=Ro;function Ho(e){const t=l.exams.find(n=>n.id===e);document.getElementById("cmExamId").value=e,document.getElementById("cmText").value=(t==null?void 0:t.coachComment)||"",G("commentModal")}async function No(){const e=document.getElementById("cmExamId").value,t=document.getElementById("cmText").value.trim();await y.from("exams").update({coach_comment:t}).eq("id",e);const n=l.exams.find(a=>a.id===e);n&&(n.coachComment=t),q("commentModal"),Je(),x("Yorum kaydedildi ✓")}async function Yo(e){await ie("Bu denemeyi silmek istediğinizden emin misiniz?")&&(await y.from("exams").delete().eq("id",e),l.exams=l.exams.filter(t=>t.id!==e),Je(),x("Silindi"))}function xa(){const e=document.getElementById("view-messages");e.innerHTML=`<div class="sh" style="margin-bottom:14px"><h2>Mesajlar</h2></div>
  ...
  <div class="msg-input-area">
    ...
    <div class="portal-grid">
    ...
    </div>`}async function Fo(e,t){var s;const n=l.students.find(r=>r.id===b.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(s=l.tasks[a])==null?void 0:s[t];if(!i)return;const o=!i.done;await y.from("tasks").update({done:o}).eq("id",i._id),i.done=o,Mt()}function ze(){const e=l.students.find(p=>p.id===b.studentId);if(!e)return;const t=document.getElementById("view-sportal"),n=e.weekStart??0,a=ne(l.weekOffset,n),i=J(a,6),o=ue(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let p=0;p<7;p++){const m=J(a,p),u=O(m),g=u===o,_=`${e.id}_${u}`,T=l.tasks[_]||[],f=T.reduce((S,I)=>S+Number(I.duration),0),w=T.reduce((S,I)=>S+(I.done?Number(I.duration):0),0);DAYS_TR[(n+p)%7];const k=[...T];s==="hourly"&&k.sort((S,I)=>S.start_time&&!I.start_time?-1:!S.start_time&&I.start_time?1:S.start_time&&I.start_time?S.start_time.localeCompare(I.start_time):0);const B=k.map(S=>{const I=T.indexOf(S),z=S.start_time?`<div class="tc-time-badge">🕒 ${S.start_time}</div>`:"";return`
      ...
      <div class="day-hd">
        ...
        <span class="day-badge" style="font-size:8.5px">${at(w)} / ${at(f)}</span>
      </div>
  ...
  </div>`}async function an(e,t,n){var g,_,T,f;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(g=l.tasks[i])==null?void 0:g[t];if(!o)return;if(n==="coach"&&o._id){const{data:w}=await y.from("tasks").select("*").eq("id",o._id).single();w&&(o.done=w.done,o.student_note=w.student_note||"",o.student_result=w.student_result||null,o.student_feedback=w.student_feedback||null)}let s=document.getElementById("taskDetailModal");s||(s=document.createElement("div"),s.id="taskDetailModal",s.className="modal-bg",document.body.appendChild(s),s.addEventListener("click",w=>{w.target===s&&s.classList.remove("open")}));const r={soru:"var(--blue)",konu:"#c084fc",deneme:"var(--accent)",diger:"var(--text-mid)"},d={soru:"Soru Bankası",konu:"Konu Anlatımı",deneme:"Deneme",diger:"Diğer"},c=r[o.type]||"var(--accent)",p=o.type==="konu",m=o.task_items||[];let u="";m.length>0?u=`<div style="margin-bottom:14px">
      ...
      <div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;overflow:hidden;max-height:200px;overflow-y:auto">
        ${m.map((w,k)=>`
          <label style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid var(--border);${k===m.length-1?"border-bottom:none":""};cursor:${n==="coach"?"default":"pointer"};transition:background .1s"
            ...
            <div style="flex:1;min-width:0">
              <div style="font-size:13px;font-weight:600;line-height:1.4;${w.done?"text-decoration:line-through;color:var(--text-dim);":""}">${v(w.label||`Ders ${k+1}`)}</div>
              <div style="font-size:11px;color:var(--text-mid);margin-top:2px">⏱ ${w.soru>0?p?w.soru+" dk":w.soru+" soru":"?"}</div>
            </div>
            ${w.url?`<a href="${v(w.url)}" target="_blank" onclick="event.stopPropagation()"
    ...
    ${(()=>{var k;const w=Ui(o.exam,o.subject);return w?(pe=[...((k=o.student_result)==null?void 0:k.yanlis_konular)||[]],`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:14px 16px;margin-bottom:14px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:0">${w.map(B=>{const h=pe.includes(B);return`<span ${n==="coach"?"":`onclick="toggleKonuChip(this,'${B.replace(/'/g,"\\'")}')"`}
  ...
  </div>`,G("taskDetailModal")}async function Zo(e,t,n){var s;if(n==="coach")return;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(s=l.tasks[i])==null?void 0:s[t];o&&(o.done=!o.done,o.task_items&&Array.isArray(o.task_items)&&o.task_items.forEach(r=>{r.done=o.done}),await y.from("tasks").update({done:o.done,task_items:o.task_items||null}).eq("id",o._id),an(e,t,n),n==="student"?ze():X())}async function Jo(e,t,n,a){var d;if(a==="coach")return;const o=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,s=(d=l.tasks[o])==null?void 0:d[t];if(!s||!s.task_items)return;s.task_items[n].done=!s.task_items[n].done;const r=s.task_items.every(c=>c.done);s.done=r,M(!0),await y.from("tasks").update({task_items:s.task_items,done:s.done}).eq("id",s._id),M(!1),an(e,t,a),a==="student"?ze():X(),x("İlerleme kaydedildi ✓")}function Xo(e,t){var i,o,s;e.closest("div").querySelectorAll("button[data-speed]").forEach(r=>{const d=r.dataset.speed===t;r.style.borderColor=d?"var(--accent)":"var(--border)",r.style.background=d?"var(--accent-dim)":"var(--surface2)",r.style.color=d?"var(--accent)":"var(--text-mid)"}),document.getElementById("tdSpeed").value=t;const n=parseFloat(t),a=document.getElementById("speedCalc");if(a){const r=parseInt(((s=(o=(i=a.closest("[id=speedInfo]"))==null?void 0:i.textContent)==null?void 0:o.match(/Toplam (\d+) dk/))==null?void 0:s[1])||0);a.textContent=Math.ceil(r/n)+" dk",document.getElementById("tdDuration").value=Math.ceil(r/n)}}async function Qo(e,t,n){var f,w,k,B,h;if(n==="coach")return;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(f=l.tasks[i])==null?void 0:f[t];if(!o)return;const s=((w=document.getElementById("tdNote"))==null?void 0:w.value.trim())||"",r={student_note:s},d=parseInt((k=document.getElementById("fbHour"))==null?void 0:k.value)||0,c=parseInt((B=document.getElementById("fbMin"))==null?void 0:B.value)||0,p=d*60+c,m={status:Le.status||null,time_spent:p>0?p:((h=o.student_feedback)==null?void 0:h.time_spent)||null,focus:Le.focus||null,difficulty:Le.difficulty||null,blocker:Le.blocker||null};(m.status||m.focus||m.difficulty||p>0)&&(r.student_feedback=m,o.student_feedback=m,m.status&&(r.done=m.status!=="failed",o.done=r.done));const u=document.getElementById("tdDogru"),g=document.getElementById("tdYanlis"),_=document.getElementById("tdBos");if(u!==null){const S=parseInt(u.value)||0,I=parseInt(g.value)||0,z=parseInt(_.value)||0;(S>0||I>0||z>0||pe.length>0)&&(r.student_result={dogru:S,yanlis:I,bos:z,yanlis_konular:[...pe],ts:new Date().toISOString()},o.student_result=r.student_result)}if(!o._id){x("Hata: görev ID bulunamadı");return}const{error:T}=await y.from("tasks").update(r).eq("id",o._id);if(T){x("Kaydetme hatası: "+T.message),console.error("saveTaskDetail error",T,r);return}o.student_note=s,q("taskDetailModal"),x("Kaydedildi ✓"),n==="student"?ze():X()}function on(){const e=l.students.find(o=>o.id===b.studentId);if(!e)return;const t=document.getElementById("view-sexams"),n=[...l.exams].filter(o=>o.studentId===e.id).sort((o,s)=>s.date.localeCompare(o.date));let a="";if(n.length>1){const o=[...n].sort((r,d)=>r.date.localeCompare(d.date)).slice(-8),s=Math.max(...o.map(r=>(EXAM_DEFS[r.type]||[]).reduce((c,p)=>{var m;return c+Number(((m=r.nets)==null?void 0:m[p])||0)},0)),1);a=`<div class="card cp" style="margin-bottom:16px">
    ...
    </div>`,Ie()}let yt=null;function rn(){ln();const e=b.role==="coach"||b.role==="developer"?l.msgThread:b.studentId;e&&(yt=y.channel("messages_"+e).on("postgres_changes",{event:"INSERT",schema:"public",table:"messages",filter:`student_id=eq.${e}`},t=>{const n=t.new;l.messages[e]||(l.messages[e]=[]),!l.messages[e].find(a=>a._id===n.id)&&(l.messages[e].push({_id:n.id,from:n.from_role,text:n.text||"",image_url:n.image_url||null,read:n.read,time:new Date(n.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}),b.role==="student"&&n.from_role==="coach"&&currentTab!=="smessages"&&Ct(),currentTab==="messages"&&l.msgThread===e&&(document.getElementById("msgMain").innerHTML=Se(e,"coach"),Ie()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=Se(e,"student"),Ie()))}).subscribe())}function ln(){yt&&(y.removeChannel(yt),yt=null)}async function is(){var e,t;await y.from("workspaces").upsert({coach_id:b.coachId,brand_name:((e=l.workspace)==null?void 0:e.brand_name)||"Akademi",brand_color:((t=l.workspace)==null?void 0:t.brand_color)||"#E8613A",onboarding_done:!1},{onConflict:"coach_id"}),l.workspace&&(l.workspace.onboarding_done=!1),Ta()}window.devResetOnboarding=is;async function ka(){const e=document.getElementById("view-dev-dashboard");e.innerHTML='<div class="sh"><h2>🖥️ Sistem Dashboard</h2></div><div class="empty"><p>Yükleniyor...</p></div>';const[t,n,a,i,o,s]=await Promise.all([y.from("users").select("id,role,created_at"),y.from("tasks").select("id,done,created_at"),y.from("exams").select("id,created_at"),y.from("messages").select("id,created_at"),y.from("tickets").select("id,status,created_at"),y.from("payments").select("id,amount,status,payment_date")]),r=t.data||[],d=n.data||[],c=a.data||[],p=i.data||[],m=o.data||[],u=s.data||[],g=r.filter(h=>h.role==="coach").length,_=r.filter(h=>h.role==="student").length,T=u.filter(h=>h.status==="completed").reduce((h,S)=>h+Number(S.amount),0),f=m.filter(h=>h.status==="open").length,w=Array.from({length:7},(h,S)=>{const I=new Date;return I.setDate(I.getDate()-6+S),O(I)}),k=w.map(h=>d.filter(S=>{var I;return(I=S.created_at)==null?void 0:I.startsWith(h)}).length),B=Math.max(...k,1);e.innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      <div class="card cp">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:80px">
          ${w.map((h,S)=>`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
            <div style="font-size:10px;color:var(--text-mid);font-weight:600">${k[S]}</div>
            <div style="width:100%;background:var(--accent);border-radius:3px 3px 0 0;height:${Math.max(Math.round(k[S]/B*100),4)}%;min-height:3px;opacity:.8"></div>
...
Bu işlem geri alınamaz.`)){M(!0);try{const{data:{session:n}}=await y.auth.getSession(),a=await fetch("/api/delete-user",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${(n==null?void 0:n.access_token)||""}`},body:JSON.stringify({targetUserId:e})}),i=await a.json();if(!a.ok)throw new Error(i.error||"Sunucu hatası");x(`🗑 ${t} silindi`),Xe()}catch(n){x("Hata: "+n.message)}finally{M(!1)}}}function ls(e,t,n,a){let i=document.getElementById("planMgmtModal");i||(i=document.createElement("div"),i.id="planMgmtModal",i.className="modal-bg",i.innerHTML=`<div class="modal" style="max-width:400px">
    ...
    </div>`}function cs(){let e=document.getElementById("playlistModal");e||(e=document.createElement("div"),e.id="playlistModal",e.className="modal-bg",document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),e.innerHTML=`<div class="modal modal-lg">
...
`).map(r=>r.trim()).filter(Boolean);let o=[];a?o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",url:d[1]||"",topic:"",soru:parseInt(d[2])||0}}):o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",soru:parseInt(d[1])||0}});const s={exam_type:document.getElementById("rmExam").value,subject:t,publisher:document.getElementById("rmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:o,active:document.getElementById("rmActive").value==="true",resource_type:a?"playlist":"book"};n?(await y.from("resources").update(s).eq("id",n),x("Güncellendi ✓")):(await y.from("resources").insert(s),x("Kaynak eklendi ✓")),q("resourceModal"),pt()}async function vs(e){await ie("Bu kaynağı silmek istediğinizden emin misiniz?")&&(await y.from("resources").delete().eq("id",e),x("Silindi"),pt())}async function mt(){const e=document.getElementById("view-dev-finance"),[{data:t},{data:n}]=await Promise.all([y.from("subscriptions").select("*,users(full_name,color)").order("created_at",{ascending:!1}),y.from("payments").select("*,users(full_name)").order("payment_date",{ascending:!1}).limit(20)]),a=(n||[]).filter(o=>o.status==="completed").reduce((o,s)=>o+Number(s.amount),0),i=(t||[]).filter(o=>o.status==="active").length;e.innerHTML=`
    ...
    </div>`}async function fs(e){const{error:t}=await y.from("payments").update({verified:!0}).eq("id",e);if(t){x("Onaylanamadı: "+t.message);return}x("✓ Ödeme doğrulandı"),mt()}function ys(){let e=document.getElementById("paymentModal");e||(e=document.createElement("div"),e.id="paymentModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('paymentModal')">×</button>
      <h2>Ödeme Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pmStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),G("paymentModal")}async function xs(){const e=parseFloat(document.getElementById("pmAmount").value);if(!e)return x("Tutar girin!");await y.from("payments").insert({student_id:document.getElementById("pmStudent").value,amount:e,method:document.getElementById("pmMethod").value,payment_date:document.getElementById("pmDate").value,description:document.getElementById("pmDesc").value,status:"completed"}),x("Ödeme kaydedildi ✓"),q("paymentModal"),mt()}function bs(){let e=document.getElementById("subModal");e||(e=document.createElement("div"),e.id="subModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('subModal')">×</button>
      <h2>Abonelik Ekle</h2>
    ...
    ${(t||[]).map(a=>`
      ...
      </div>`).join("")}`}function ks(){let e=document.getElementById("announceModal");e||(e=document.createElement("div"),e.id="announceModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('announceModal')">×</button>
      <h2>Yeni Duyuru</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),G("announceModal")}async function ws(){const e=document.getElementById("anTitle").value.trim(),t=document.getElementById("anBody").value.trim();if(!e||!t)return x("Başlık ve içerik zorunlu!");await y.from("announcements").insert({title:e,body:t,type:document.getElementById("anType").value,target:document.getElementById("anTarget").value,active:!0}),x("Duyuru yayınlandı ✓"),q("announceModal"),ut()}async function $s(e,t){await y.from("announcements").update({active:t}).eq("id",e),ut()}async function Es(e){await ie("Bu duyuruyu silmek istediğinizden emin misiniz?")&&(await y.from("announcements").delete().eq("id",e),x("Silindi"),ut())}let qe=null,$t=null,me=null,Pt=null,Ue=[],ve=[],_e="welcome";async function Qe(){const e=document.getElementById("view-dev-tickets");if(!e)return;const{data:t,error:n}=await y.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").order("updated_at",{ascending:!1});Ue=t||[],!me&&Ue.length>0&&(me=Ue[0].id),e.innerHTML=`
  ...
  `,Ss(),Pt&&clearInterval(Pt),Pt=setInterval(Ts,4e3)}function _s(e){me=e,Qe()}async function Ts(){if(!me||!document.getElementById("devChatArea"))return;const{data:t,error:n}=await y.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").eq("id",me).single();if(n||!t)return;let a=[];try{a=JSON.parse(t.body),Array.isArray(a)||(a=[{sender:"user",text:t.body,time:t.created_at}])}catch{a=[{sender:"user",text:t.body,time:t.created_at}]}const i=document.getElementById("devChatMessages");if(i){const o=i.scrollTop,s=i.scrollHeight-i.clientHeight-o<40;i.innerHTML=a.map(r=>{const d=r.sender==="emin",c=d?"Kurucu / Destek":r.sender==="ai"?"Yapay Zeka":r.name||"Kullanıcı",p=d?"var(--blue)":r.sender==="ai"?"var(--surface2)":"var(--accent)",m=d?"#fff":r.sender==="ai"?"var(--text)":"var(--on-accent)",u=d?"flex-end":"flex-start",g=d?"14px 14px 4px 14px":"14px 14px 14px 4px",_=new Date(r.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join(""),s&&(i.scrollTop=i.scrollHeight)}}function Ss(){var s,r,d;const e=document.getElementById("devChatArea");if(!e)return;const t=Ue.find(c=>c.id===me);if(!t){e.innerHTML=`
  ...
  `;const o=document.getElementById("devChatMessages");o&&(o.scrollTop=o.scrollHeight)}async function Is(){const e=document.getElementById("devReplyInput"),t=e.value.trim();if(!t||!me)return;e.value="",M(!0);const{data:n}=await y.from("tickets").select("body").eq("id",me).single();let a=[];if(n&&n.body)try{a=JSON.parse(n.body)}catch{a=[{sender:"user",text:n.body,time:new Date().toISOString()}]}const i={sender:"emin",text:t,time:new Date().toISOString(),name:"Kurucu / Destek"};a.push(i);const{error:o}=await y.from("tickets").update({body:JSON.stringify(a),reply:t,status:"resolved",updated_at:new Date().toISOString()}).eq("id",me);if(M(!1),o){x("Hata: "+o.message);return}x("Yanıt gönderildi ✓"),Qe()}async function zs(e,t){await y.from("tickets").update({status:t,updated_at:new Date().toISOString()}).eq("id",e),x("Durum güncellendi ✓"),Qe()}async function Bs(e){await ie("Bu talebi silmek istediğinizden emin misiniz?")&&(await y.from("tickets").delete().eq("id",e),x("Silindi"),me=null,Qe())}function Ms(){Dt()}async function Dt(){let e=document.getElementById("supportChatModal");e||(e=document.createElement("div"),e.id="supportChatModal",e.className="modal-bg",e.style.zIndex="99999999",e.innerHTML=`
    ...
    `}).join(""),a&&(t.scrollTop=t.scrollHeight)}function Ds(){_e="ai",ve=[{sender:"ai",text:"Merhaba! Ben Rostrum Akademi Yapay Zeka Asistanıyım. 🤖 Size nasıl yardımcı olabilirim?",time:new Date().toISOString()}],ot(ve)}function As(){_e="emin_start";const e=document.getElementById("supportMessages");e&&(e.innerHTML=`
      <div style="text-align:center;padding:40px 20px">
    ...
    </div>`,i.appendChild(s)}),document.body.appendChild(i),setTimeout(()=>i.remove(),8e3)}(()=>{const e=document.createElement("style");e.textContent=".role-dev{background:rgba(192,132,252,.15);color:#c084fc;}",document.head.appendChild(e)})();function Ea(e){return`ra_ob_${b.coachId}_${e}`}function Ut(e){return localStorage.getItem(Ea(e))==="1"}function js(e){localStorage.setItem(Ea(e),"1"),_a(),["student","program","report"].every(n=>Ut(n))&&Ps()}async function Ps(){const e=document.getElementById("obWidget");e&&(e.innerHTML=`<div style="padding:20px;text-align:center">
  ...
  </div>`}let je=0;const U={};async function Hs(){const e=l.students.find(i=>i.id===b.studentId);if(!e)return;const t=e.name.split(" ")[0],n=e.color||"var(--accent)";U={};try{const{data:i}=await y.from("student_profiles").select("*").eq("id",b.studentId).maybeSingle();i&&(U.parent_email=i.parent_email||"",U.parent_phone=i.parent_phone||"",U.target_rank=i.target_rank||"",U.target_university=i.target_university||"",U.target_department=i.target_department||"",U.struggling_subjects=i.struggling_subjects||"",U.daily_capacity=i.daily_capacity||8)}catch{}U.yks_area=e.yks_area||"SAY",U.daily_capacity===void 0&&(U.daily_capacity=8);let a=document.getElementById("stuWelcomeModal");a||(a=document.createElement("div"),a.id="stuWelcomeModal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.85);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(8px)",document.body.appendChild(a)),je=0,Sa(a,t,n,e)}function Ee(e){const t=document.getElementById("sw_err");t&&(t.textContent=e,t.style.display="block",setTimeout(()=>{t&&(t.style.display="none")},5e3))}function Sa(e,t,n,a){const i="width:100%;padding:12px 14px;background:var(--surface2);border:1.5px solid var(--border);border-radius:10px;color:var(--text);font-size:14px;outline:none;font-family:inherit;box-sizing:border-box",o="font-size:11px;font-weight:700;color:var(--text-mid);display:block;margin-bottom:5px;text-transform:uppercase;letter-spacing:.05em",s="font-size:11px;color:var(--text-dim);margin-top:5px;line-height:1.5",r=[{v:"SAY",ico:"🔬",name:"Sayısal",sub:"Mat · Fen"},{v:"EA",ico:"⚖️",name:"Eşit Ağırlık",sub:"Mat · Edb"},{v:"SOZ",ico:"📖",name:"Sözel",sub:"Edb · Sosyal"},{v:"DIL",ico:"🌍",name:"Dil",sub:"Yabancı Dil"}],d=[()=>`<div style="text-align:center">
    ...
    ${d[je]()}
      ...
      <div style="display:flex;flex-direction:column;gap:10px;text-align:left">
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px 16px;font-size:13px;display:flex;align-items:center;gap:12px"><span style="font-size:20px">📈</span><span>Deneme netlerini girdikçe grafiklerin oluşacak</span></div>
    ...
    </div>`;return}if(m.length>0){const z=m.slice(-6),E=Math.max(...z.map(A=>(EXAM_DEFS[A.type]||[]).reduce((L,$)=>{var D;return L+Number(((D=A.nets)==null?void 0:D[$])||0)},0)),1);`${z.map(A=>{const L=(EXAM_DEFS[A.type]||[]).reduce((N,F)=>{var V;return N+Number(((V=A.nets)==null?void 0:V[F])||0)},0),$=Math.max(Math.round(L/E*100),4),D=z[z.indexOf(A)-1],j=D?(EXAM_DEFS[D.type]||[]).reduce((N,F)=>{var V;return N+Number(((V=D.nets)==null?void 0:V[F])||0)},0):L,P=L>j?"↑":L<j?"↓":"",Y=L>j?"var(--green)":L<j?"var(--red)":"var(--text-dim)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
              ...
              <div style="width:100%;background:${e.color};border-radius:4px 4px 0 0;height:${$}%;min-height:4px"></div>
            ...
            </div>`}).join("")}`}if(m.length>0){const z=u.type,A=(EXAM_DEFS[z]||[]).map(C=>{var j;const L=m.filter(P=>P.type===z).map(P=>{var Y;return Number(((Y=P.nets)==null?void 0:Y[C])||0)}),$=L.length?L.reduce((P,Y)=>P+Y,0)/L.length:0,D=Number(((j=u.nets)==null?void 0:j[C])||0);return{f:C,avg:$.toFixed(1),last:D,color:qt(D)}});`${z}${A.map(C=>`
    ...
    <div class="card cp" style="margin-bottom:14px">
      ...
      <div style="position:relative;height:160px;display:flex;align-items:flex-end;gap:6px;padding-bottom:28px">
        ...
        ${S.map((z,E)=>{const C=(EXAM_DEFS[z.type]||[]).reduce((F,V)=>{var Z;return F+Number(((Z=z.nets)==null?void 0:Z[V])||0)},0),L=Math.max(Math.round(C/I*132),4),$=S[E-1],D=$?(EXAM_DEFS[$.type]||[]).reduce((F,V)=>{var Z;return F+Number(((Z=$.nets)==null?void 0:Z[V])||0)},0):C,j=C>D,P=C<D,Y=j?"var(--green)":P?"var(--red)":e.color,N=v(z.name.replace(/deneme|tyt|ayt/gi,"").trim()).slice(0,10)||"#"+(E+1);return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:0;position:relative">
            ...
            <div style="position:absolute;bottom:-22px;width:100%;text-align:center;font-size:9px;color:var(--text-dim);overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${N}</div>
          </div>`}).join("")}
      </div>
    </div>`:""}
    ...
    <div class="card cp" style="margin-bottom:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${(()=>{const z=EXAM_DEFS[u.type]||[],E=m.filter(C=>C.type===u.type),A=Math.max(...z.map(C=>Math.max(...E.map(L=>{var $;return Number((($=L.nets)==null?void 0:$[C])||0)}))),1);return z.map(C=>{var Y;const L=Number(((Y=u.nets)==null?void 0:Y[C])||0),$=E.map(N=>{var F;return Number(((F=N.nets)==null?void 0:F[C])||0)}),D=$.length?$.reduce((N,F)=>N+F,0)/$.length:0,j=Math.round(L/A*100),P=L>=D*1.1?"var(--green)":L<D*.9?"var(--red)":e.color;return`<div style="display:flex;align-items:center;gap:10px">
    ...
    <div style="max-width:480px;margin:0 auto;padding:16px">
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:16px">
        ${[{icon:"🎓",label:"Koçum",value:(n==null?void 0:n.full_name)||"—"},{icon:"📅",label:"Kayıt Tarihi",value:u(a)},{icon:"⏳",label:"Kullanım Süresi",value:m!==null?m+" gün":"—"},{icon:"📆",label:"Üyelik Sona Erme",value:u(c)},{icon:"⌛",label:"Kalan Süre",value:p!==null?`<span style="color:${g};font-weight:700">${p} gün</span>`:"—"}].map(({icon:f,label:w,value:k},B,h)=>`
          <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;${B<h.length-1?"border-bottom:1px solid var(--border)":""}">
            ...
            <div style="flex:1">
              <div style="font-size:11px;color:var(--text-dim)">${w}</div>
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:18px;margin-bottom:16px">
        ...
        ${(()=>{const f=c&&a?Math.max(1,Math.ceil((c-a)/864e5)):14,w=Math.min(f,f-p),k=Math.min(100,Math.round(w/f*100)),B=p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444";return`
            <div style="display:flex;justify-content:space-between;font-size:11px;color:var(--text-dim);margin-bottom:6px">
              <span>${w} gün kullanıldı</span>
              <span>${p} gün kaldı</span>
            </div>
            <div style="background:var(--surface2);border-radius:6px;height:10px;overflow:hidden">
              <div style="width:${k}%;height:100%;background:${B};border-radius:6px;transition:width .5s ease"></div>
            </div>
    ...
    </div>`}async function za(){var f;const e=document.getElementById("view-coach-profile");if(!e)return;e.innerHTML='<div class="loading">Profil bilgileri yükleniyor...</div>';const t=b.dbUser.id;let n=null,a=null;const i=await y.from("coach_profiles").select("*").eq("id",t).maybeSingle();if(n=i.data,a=i.error,a){const w=localStorage.getItem(`coach_profile_${t}`);if(w)try{n=JSON.parse(w),a=null}catch{}if(a){e.innerHTML=`<div style="padding:20px;color:var(--red)">Profil yüklenirken hata oluştu: ${v(a.message)}</div>`;return}}else if(!n){const w=localStorage.getItem(`coach_profile_${t}`);if(w)try{n=JSON.parse(w)}catch{}}const o=(n==null?void 0:n.bio)||"",s=(n==null?void 0:n.subjects)||"",r=(n==null?void 0:n.education)||"",d=(n==null?void 0:n.experience)||"",c=(n==null?void 0:n.photo_url)||"",p=(n==null?void 0:n.instagram)||"",m=(n==null?void 0:n.linkedin)||"",u=(n==null?void 0:n.slug)||"",g=(n==null?void 0:n.headline)||"",_=((n==null?void 0:n.capacity_left)??"")===null?"":(n==null?void 0:n.capacity_left)??"";He=u;const T=u?`${window.location.origin}/koc/${u}`:window.location.origin+window.location.pathname.replace("app.html","koc_bul.html")+`?coach=${t}`;e.innerHTML=`
          ...
          <div style="background:var(--surface); border:1px solid var(--border); border-radius:12px; padding:24px; box-shadow:var(--shadow-sm);">
            ...
            <div>
              ...
              <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                ...
                <a href="${T}" id="cpSlugBrowseBtn" target="_blank" class="btn btn-accent" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center; height:37px; padding:0 14px; border-radius:9px; font-size:13px; font-weight:700;" onclick="return browseCoachLink(event)">👁 Gözat</a>
              </div>
            ...
            <div style="margin-top:18px; display:grid; grid-template-columns:1fr 130px; gap:12px;">
              <div>
                ...
                <input type="text" id="cpHeadline" value="${v(g)}" placeholder="Örn: YKS Dereceli Sayısal Mentörü & Koçu" maxlength="60"
              ...
              <div>
                ...
                <input type="number" id="cpCapacity" value="${_}" placeholder="—" min="0" max="999"
                  style="width:100%; background:var(--surface2); border:1.5px solid var(--border); border-radius:9px; padding:9px 12px; font-size:13.5px; color:var(--text); outline:none;">
              </div>
            </div>
          ...
          <div class="profile-preview-card" style="box-shadow: 0 10px 30px rgba(0,0,0,0.15); border:1px solid var(--border);">
            <div class="preview-card-header">
              ...
              <div class="preview-header-info">
                <div class="preview-name" id="prevName">${v(((f=b.dbUser)==null?void 0:f.full_name)||"Koç")}</div>
  ...
  `,cn(),Ke(),document.getElementById("cpEducation")&&(document.getElementById("cpEducation").value=r),document.getElementById("cpExperience")&&(document.getElementById("cpExperience").value=d)}const zn=["YKS","TYT","AYT","LGS","Sayısal","Eşit Ağırlık","Sözel","Dil","Matematik","Geometri","Fizik","Kimya","Biyoloji","Türkçe","Edebiyat","Tarih","Coğrafya"];function dn(){var e;return(((e=document.getElementById("cpSubjects"))==null?void 0:e.value)||"").split(",").map(t=>t.trim()).filter(Boolean)}function Os(e){e.stopPropagation();const t=document.getElementById("cpTagDropdownMenu");if(!t)return;const n=t.style.display==="block";t.style.display=n?"none":"block"}window._tagDropdownListenerAdded||(document.addEventListener("click",e=>{const t=document.getElementById("cpTagDropdownMenu"),n=document.getElementById("cpTagSelectBox");t&&t.style.display==="block"&&n&&!n.contains(e.target)&&!t.contains(e.target)&&(t.style.display="none")}),window._tagDropdownListenerAdded=!0);function cn(){const e=document.getElementById("cpSelectedTags"),t=document.getElementById("cpDropdownPresets");if(!e||!t)return;const n=dn();n.length===0?e.innerHTML='<span style="font-size:13px; color:var(--text-dim);">Etiket seçmek için tıklayın...</span>':e.innerHTML=n.map(i=>`
      ...
      `).join("");const a=n.filter(i=>!zn.includes(i));t.innerHTML=[...zn,...a].map(i=>{const o=n.includes(i);return`
    ...
    `}).join("")}function Ba(e){const t=document.getElementById("cpSubjects");if(!t)return;let n=dn();n=n.includes(e)?n.filter(a=>a!==e):[...n,e],t.value=n.join(", "),cn(),Ke()}function Ma(){const e=document.getElementById("cpTagCustom");if(!e)return;const t=(e.value||"").trim();if(!t)return;const n=dn();n.includes(t)||(document.getElementById("cpSubjects").value=[...n,t].join(", ")),e.value="",cn(),Ke()}window.toggleTagDropdown=Os;window.toggleCoachTag=Ba;window.addCustomCoachTag=Ma;async function Fs(e){if(!e)return;if(!e.type.startsWith("image/"))return x("Lütfen bir görsel dosyası seçin");if(e.size>3*1024*1024)return x("Dosya 3 MB'den büyük — daha küçük bir görsel seçin");const t=document.getElementById("cpPhotoDropText"),n=document.getElementById("cpPhotoThumb");t&&(t.textContent="Yükleniyor…");try{const a=(e.name.split(".").pop()||"jpg").toLowerCase().replace(/[^a-z0-9]/g,"")||"jpg",i=`${b.dbUser.id}/avatar_${Date.now()}.${a}`,{error:o}=await y.storage.from("coach-photos").upload(i,e,{upsert:!0,contentType:e.type});if(o)throw o;const{data:s}=y.storage.from("coach-photos").getPublicUrl(i),r=s==null?void 0:s.publicUrl;if(!r)throw new Error("URL alınamadı");document.getElementById("cpPhotoUrl").value=r,n&&(n.style.background=`url('${r}') center/cover`,n.textContent=""),t&&(t.textContent="Fotoğraf yüklendi ✓ — değiştirmek için tıkla"),Ke(),x("Fotoğraf yüklendi ✓")}catch(a){t&&(t.textContent="Yüklenemedi — tekrar dene"),x("Yükleme hatası: "+(a.message||a)+(String(a.message||"").includes("bucket")?" (migration_v26 çalıştırıldı mı?)":""))}}let He="",Bn=null,Ge=!0;function Us(){const e=document.getElementById("cpSlug"),t=document.getElementById("cpSlugStatus");let n=(e.value||"").toLowerCase().replace(/ğ/g,"g").replace(/ü/g,"u").replace(/ş/g,"s").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ç/g,"c").replace(/[^a-z0-9-]/g,"-").replace(/-+/g,"-");if(e.value=n,clearTimeout(Bn),Ge=!1,!n||n===He){t.textContent="",Ge=!0;return}if(n.length<3){t.textContent="en az 3 karakter",t.style.color="var(--text-dim)";return}t.textContent="kontrol ediliyor…",t.style.color="var(--text-dim)",Bn=setTimeout(async()=>{try{const{data:a,error:i}=await y.rpc("check_coach_slug",{p_slug:n});if(i){t.textContent="",Ge=!0;return}Ge=!!a,t.textContent=a?"✓ müsait — linki etkinleştirmek için Kaydet'e bas":"✗ bu link alınmış, başka dene",t.style.color=a?"var(--green)":"var(--red)"}catch{t.textContent="",Ge=!0}},450)}function pn(){return He?`${window.location.origin}/koc/${He}`:`${window.location.origin}/koc_bul.html?coach=${b.dbUser.id}`}function Da(){var t;const e=(((t=document.getElementById("cpSlug"))==null?void 0:t.value)||"").trim().toLowerCase();return e&&e!==(He||"")}function Gs(){if(Da())return x("Yeni linki önce Kaydet'e basarak etkinleştir");navigator.clipboard.writeText(pn()).then(()=>x("Link kopyalandı ✓")).catch(()=>x("Kopyalanamadı"))}function qs(e){if(Da())return e&&e.preventDefault(),x("Yeni linki önce Kaydet'e basarak etkinleştir"),!1;const t=document.getElementById("cpSlugBrowseBtn");return t&&(t.href=pn()),!0}function Ws(){const e=document.getElementById("cpSlugBrowseBtn");e&&(e.href=pn());const t=document.getElementById("cpSlugStatus");t&&He&&(t.textContent="✓ link aktif",t.style.color="var(--green)")}async function Vs(){var o,s,r,d;const e=document.getElementById("cpAiBioBtn"),t=((o=b.dbUser)==null?void 0:o.full_name)||"Koç",n=((s=document.getElementById("cpSubjects"))==null?void 0:s.value)||"",a=((r=document.getElementById("cpEducation"))==null?void 0:r.value)||"",i=((d=document.getElementById("cpExperience"))==null?void 0:d.value)||"";if(!n&&!a&&!i)return ge("AI'nın malzemeye ihtiyacı var — önce uzmanlık, eğitim veya deneyim alanlarından en az birini doldur.");e&&(e.disabled=!0,e.textContent="🤖 Yazıyor…");try{const c=await fetch("/api/ai-chat",{method:"POST",headers:await rt(),body:JSON.stringify({userRole:"coach",messages:[{role:"user",content:`Koç Bul sayfamdaki kamuya açık profilim için "Hakkımda" biyografisi yaz.
Bilgilerim — İsim: ${t}. Uzmanlık: ${n||"-"}. Eğitim: ${a||"-"}. Deneyim/Başarılar: ${i||"-"}.
Kurallar: 1. tekil şahıs ("...yım/...yorum"), veli ve öğrenciye güven veren sıcak-profesyonel ton, 60-90 kelime, tek paragraf, emoji ve başlık YOK, abartılı/uydurma iddia YOK (sadece verdiğim bilgileri kullan). Yalnızca biyografi metnini yaz, başka hiçbir şey ekleme.`}]})}),p=await c.json();if(!c.ok||!p.reply)throw new Error(p.error||"Yanıt alınamadı");document.getElementById("cpBio").value=p.reply.trim().replace(/^["']|["']$/g,""),Ke(),x("Biyografi taslağı hazır — dilediğin gibi düzenleyebilirsin ✓")}catch(c){ge("AI biyografi üretilemedi: "+(c.message||c))}e&&(e.disabled=!1,e.textContent="🤖 AI ile Oluştur")}function ge(e){const t=document.getElementById("cpErr");if(!t)return x(e);t.textContent=e,t.style.display="block",t.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{t.style.display="none"},6e3)}let xt="bio";function Ke(){var u,g,_,T,f,w,k,B;const e=((u=document.getElementById("cpPhotoUrl"))==null?void 0:u.value.trim())||"",t=((g=document.getElementById("cpSubjects"))==null?void 0:g.value.trim())||"",n=((_=document.getElementById("cpBio"))==null?void 0:_.value.trim())||"",a=((T=document.getElementById("cpEducation"))==null?void 0:T.value.trim())||"",i=((f=document.getElementById("cpExperience"))==null?void 0:f.value.trim())||"",o=((w=document.getElementById("cpInstagram"))==null?void 0:w.value.trim())||"",s=((k=document.getElementById("cpLinkedin"))==null?void 0:k.value.trim())||"",r=((B=b.dbUser)==null?void 0:B.full_name)||"Koç",d=document.getElementById("prevAvatar");if(d)if(e)d.style.backgroundImage=`url('${e}')`,d.style.backgroundColor="transparent",d.innerHTML="";else{d.style.backgroundImage="",d.style.backgroundColor="var(--accent-dim)";const h=r.split(" ").map(S=>S[0]).join("").slice(0,2).toUpperCase();d.innerHTML=h||"?"}const c=document.getElementById("prevSocials");if(c){let h="";if(o&&(h+=`<a href="https://instagram.com/${o}" target="_blank" class="preview-social-link" title="Instagram">📸 @${o}</a>`),s){let S="LinkedIn";s.includes("/in/")&&(S="in/"+s.split("/in/")[1].split("/")[0]),h+=`<a href="${s}" target="_blank" class="preview-social-link" title="LinkedIn">💼 ${S}</a>`}c.innerHTML=h}const p=document.getElementById("prevSubjects");if(p)if(t){const h=t.split(",").map(S=>S.trim()).filter(Boolean);p.innerHTML=h.map(S=>`<span class="preview-tag">${v(S)}</span>`).join("")}else p.innerHTML='<span class="preview-tag" style="background:none; border:1px dashed var(--border); color:var(--text-dim)">Ders / Uzmanlık Belirtilmedi</span>';const m=document.getElementById("prevTabContent");if(m){let h="";xt==="bio"?h=n||"Biyografi bilgisi henüz girilmedi.":xt==="edu"?h=a||"Eğitim bilgisi henüz girilmedi.":xt==="exp"&&(h=i||"Deneyim/başarılar henüz girilmedi."),m.innerHTML=Aa(v(h))}}function Zs(e){xt=e;const t=document.getElementById("btn-prev-bio"),n=document.getElementById("btn-prev-edu"),a=document.getElementById("btn-prev-exp");t&&t.classList.toggle("active",e==="bio"),n&&n.classList.toggle("active",e==="edu"),a&&a.classList.toggle("active",e==="exp"),Ke()}function Aa(e){return e.replace(/\n/g,"<br>")}async function Js(){var _,T,f;const e=b.dbUser.id,t=document.getElementById("cpBio").value.trim(),n=document.getElementById("cpSubjects").value.trim(),a=document.getElementById("cpEducation").value.trim(),i=document.getElementById("cpExperience").value.trim(),o=document.getElementById("cpPhotoUrl").value.trim(),s=document.getElementById("cpInstagram").value.trim(),r=document.getElementById("cpLinkedin").value.trim(),d=(((_=document.getElementById("cpSlug"))==null?void 0:_.value)||"").trim(),c=(((T=document.getElementById("cpHeadline"))==null?void 0:T.value)||"").trim(),p=(((f=document.getElementById("cpCapacity"))==null?void 0:f.value)||"").trim(),m=p===""?null:Math.max(0,Math.min(999,parseInt(p)||0));if(!o)return ge("Profil fotoğrafı zorunlu — velilerin en çok baktığı güven sinyali.");if(!n)return ge("En az bir uzmanlık etiketi seç.");if(t.length<30)return ge('Biyografi en az 30 karakter olmalı — "AI ile Oluştur" butonunu kullanabilirsin.');if(!a)return ge("Eğitim bilgini gir (örn: Muğla Sıtkı Koçman Üniversitesi - Tıp Fakültesi).");if(!i)return ge("Deneyim/başarı bilgini gir (örn: YKS 2025 Sayısal 9.805.lik).");if(d&&d.length<3)return ge("Profil linki en az 3 karakter olmalı.");if(d&&!Ge)return ge("Bu profil linki alınmış — başka bir tane dene.");const u={id:e,bio:t,subjects:n,education:a,experience:i,photo_url:o,instagram:s,linkedin:r,slug:d||null,headline:c||null,capacity_left:m,updated_at:new Date().toISOString()};localStorage.setItem(`coach_profile_${e}`,JSON.stringify(u));let{error:g}=await y.from("coach_profiles").upsert(u);if(g&&/column/i.test(g.message||"")){const{slug:w,headline:k,capacity_left:B,...h}=u;({error:g}=await y.from("coach_profiles").upsert(h)),g||x("Profil kaydedildi — link/vitrin alanları için migration_v27 gerekli")}if(g){if(/duplicate|unique/i.test(g.message||""))return ge("Bu profil linki az önce başkası tarafından alındı — farklı bir tane dene.");console.warn("Database save failed, profile saved locally in localStorage:",g),x("Profil yerel tarayıcıya kaydedildi (Veritabanı hatası: "+g.message+")")}else He=(d||"").toLowerCase(),Ws(),x("Profil başarıyla güncellendi ✓")}async function mn(){const e=document.getElementById("view-dev-matches");if(!e)return;e.innerHTML='<div class="loading">Eşleşmeler yükleniyor...</div>';const{data:t,error:n}=await y.from("match_requests").select("*, matched_coach:matched_coach_id(full_name, username)").order("created_at",{ascending:!1});if(n){e.innerHTML=`<div style="padding:20px;color:var(--red)">Eşleşme başvuruları yüklenirken hata oluştu: ${v(n.message)}</div>`;return}const a={pending:"⏳ Bekliyor",matched:"🤝 Eşleştirildi",completed:"✅ Tamamlandı"},i={pending:"rgba(240, 165, 0, 0.15)",matched:"rgba(96, 180, 255, 0.15)",completed:"rgba(62, 207, 142, 0.15)"},o={pending:"var(--accent)",matched:"var(--accent4)",completed:"var(--green)"};e.innerHTML=`
  ...
  `}async function Xs(e,t){const{error:n}=await y.from("match_requests").update({status:t}).eq("id",e);n?x("Durum güncellenirken hata: "+n.message):(x("Durum güncellendi ✓"),mn())}async function Qs(e){const t=l.students.find(s=>s.id===e);if(!t)return;const{data:n}=await y.from("student_speeds").select("*").eq("student_id",e),a={};(n||[]).forEach(s=>{a[`${s.exam_type}_${s.subject}`]=s.secs_per_question});const i=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];let o=document.getElementById("speedModal");o||(o=document.createElement("div"),o.id="speedModal",o.className="modal-bg",document.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&o.classList.remove("open")})),o.innerHTML=`<div class="modal modal-lg">
  ...
  </div>`,G("speedModal")}async function er(e){const t=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];for(const{exam:n,sub:a}of t){const i=`${n}_${a}`,o=document.getElementById("spd_"+i);if(!o)continue;const s=parseInt(o.value)||180;await oa(e,n,a,s)}q("speedModal"),x("Hız ayarları kaydedildi ✓")}async function tr(e){const t=l.students.find(o=>o.id===e);if(!t)return;const{data:n}=await y.from("student_notes").select("notes").eq("coach_id",b.coachId).eq("student_id",e).maybeSingle(),a=(n==null?void 0:n.notes)||"";let i=document.getElementById("studentNotesModal");i||(i=document.createElement("div"),i.id="studentNotesModal",i.className="modal-bg",document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")})),i.innerHTML=`<div class="modal">
  ...
  </div>`,G("studentNotesModal")}async function nr(e){const t=document.getElementById("studentNoteText").value,{error:n}=await y.from("student_notes").upsert({coach_id:b.coachId,student_id:e,notes:t,updated_at:new Date().toISOString()},{onConflict:"coach_id,student_id"});if(n){x("Not kaydedilemedi: "+n.message);return}x("Not kaydedildi ✓"),q("studentNotesModal")}function ar(e){let t=document.getElementById("reportModal");t||(t=document.createElement("div"),t.id="reportModal",t.className="modal-bg",t.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.classList.remove("open")}),document.getElementById("rpPeriod").addEventListener("change",function(){document.getElementById("rpCustomDates").style.display=this.value==="custom"?"":"none"})),document.getElementById("rpStuId").value=e;const n=new Date,a=new Date(n.getFullYear(),n.getMonth(),1);document.getElementById("rpStart").value=O(a),document.getElementById("rpEnd").value=O(n),document.getElementById("rpNote").value="",G("reportModal")}function un(){const e=document.getElementById("rpPeriod").value,t=new Date;if(e==="weekly"){const n=ne(0,0);return{start:O(n),end:O(J(n,6))}}else return e==="monthly"?{start:O(new Date(t.getFullYear(),t.getMonth(),1)),end:O(t)}:{start:document.getElementById("rpStart").value,end:document.getElementById("rpEnd").value}}function gn(e,t=!1){var h,S,I,z;const n=l.students.find(E=>E.id===e);if(!n)return"";const{start:a,end:i}=un(),o=document.getElementById("rpNote").value.trim(),s=((h=l.workspace)==null?void 0:h.brand_name)||"Rostrum Akademi",r=((S=l.workspace)==null?void 0:S.brand_color)||"#E8613A",d=((I=b.dbUser)==null?void 0:I.full_name)||"Koç",c=[],p=new Date(a);for(;O(p)<=i;){const E=`${e}_${O(p)}`;(l.tasks[E]||[]).forEach(A=>c.push({...A,date:O(p)})),p.setDate(p.getDate()+1)}const m=c.length,u=c.filter(E=>E.done).length,g=m>0?Math.round(u/m*100):0,_=c.filter(E=>E.done).reduce((E,A)=>E+Number(A.duration||0),0),T={};c.forEach(E=>{const A=E.subject||"Diğer";T[A]||(T[A]={total:0,done:0}),T[A].total++,E.done&&T[A].done++});const f=l.exams.filter(E=>E.studentId===e&&E.date>=a&&E.date<=i).sort((E,A)=>E.date.localeCompare(A.date)),w=l.appointments.filter(E=>E.studentId===e&&E.date>=a&&E.date<=i).sort((E,A)=>E.date.localeCompare(A.date)),k=`${new Date(a+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})} – ${new Date(i+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})}`;let B="";if(f.length>1){const E=Math.max(...f.map($=>(EXAM_DEFS[$.type]||[]).reduce((D,j)=>{var P;return D+Number(((P=$.nets)==null?void 0:P[j])||0)},0)),1),A=400,C=80,L=Math.min(40,(A-20)/f.length-4);B=`<svg width="${A}" height="${C+30}" style="overflow:visible">
      ${f.map(($,D)=>{const j=(EXAM_DEFS[$.type]||[]).reduce((N,F)=>{var V;return N+Number(((V=$.nets)==null?void 0:V[F])||0)},0),P=Math.max(Math.round(j/E*(C-10)),4),Y=10+D*((A-20)/f.length);return`<rect x="${Y}" y="${C-P}" width="${L}" height="${P}" rx="3" fill="${r}" opacity="0.85"/>
          <text x="${Y+L/2}" y="${C-P-4}" text-anchor="middle" font-size="10" fill="#333">${j.toFixed(0)}</text>
          <text x="${Y+L/2}" y="${C+14}" text-anchor="middle" font-size="9" fill="#666">${v($.name.replace("Deneme","").replace("TYT","").replace("AYT","").trim()||String(D+1))}</text>`}).join("")}
...
<div class="page">
  ...
  <div class="section">
    ...
    <table>
      ...
      <tbody>
        ${f.map(E=>{const A=EXAM_DEFS[E.type]||[],C=A.reduce((L,$)=>{var D;return L+Number(((D=E.nets)==null?void 0:D[$])||0)},0).toFixed(1);return`<tr>
            <td><strong>${v(E.name)}</strong></td>
            <td>${new Date(E.date+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"short"})}</td>
            <td>${v(E.type)}</td>
            ${A.map(L=>{var D;const $=Number(((D=E.nets)==null?void 0:D[L])||0);return`<td><span class="badge ${$>=20?"badge-green":$>=12?"badge-yellow":"badge-red"}">${$}</span></td>`}).join("")}
...
</html>`}function ir(){const e=document.getElementById("rpStuId").value,t=gn(e,!0),n=window.open("","_blank","width=900,height=700");n.document.write(t),n.document.close()}function or(){const e=document.getElementById("rpStuId").value;l.students.find(a=>a.id===e);const t=gn(e,!1),n=window.open("","_blank");n.document.write(t),n.document.close(),setTimeout(()=>{n.focus(),n.print()},500),q("reportModal"),x('PDF oluşturuluyor — "PDF olarak kaydet" seçin')}async function sr(){const e=document.getElementById("rpStuId").value,t=l.students.find(s=>s.id===e);if(!t)return;const n=`${window.location.origin}/api/generate-pdf-report?studentId=${e}`,a=`Merhaba, ${t.name} isimli öğrencimizin bu dönemki performans ve gelişim raporu hazırlandı. Aşağıdaki bağlantıdan raporu detaylıca görüntüleyebilirsiniz:

🔗 ${n}`,o=`https://api.whatsapp.com/send?text=${encodeURIComponent(a)}`;window.open(o,"_blank"),q("reportModal"),x("WhatsApp yönlendirmesi açıldı ✓")}function rr(){let e=document.getElementById("weeklyPDFModal");e||(e=document.createElement("div"),e.id="weeklyPDFModal",e.className="modal-bg",e.innerHTML=`<div class="modal">
      ...
      <button class="btn btn-accent" style="width:100%;justify-content:center;padding:12px" onclick="generateWeeklyPDF()">PDF Oluştur →</button>
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pdfNote").value="",G("weeklyPDFModal")}function lr(){const e=document.getElementById("pdfNote").value.trim();q("weeklyPDFModal"),Ca(l.activeStuId,e)}function Ca(e,t){var C,L;const n=l.students.find($=>$.id===e);if(!n)return;const a=(n==null?void 0:n.weekStart)??0,i=ne(l.weekOffset,a),o=J(i,6),s=((C=l.workspace)==null?void 0:C.brand_name)||"Rostrum Akademi",r=((L=l.workspace)==null?void 0:L.brand_color)||"#E8613A",d=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"],c=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],p={deneme:"#f59e0b",soru:"#3b82f6",konu:"#10b981",diger:"#8b5cf6"},m={deneme:"Deneme",soru:"Soru Bankası",konu:"Konu Anlatımı",diger:"Diğer"};let u=0,g=0,_=0;const T=[];for(let $=0;$<7;$++){const D=J(i,$),j=O(D),P=l.tasks[`${e}_${j}`]||[];u+=P.length,g+=P.filter(Y=>Y.done).length,_+=P.reduce((Y,N)=>Y+Number(N.duration||0),0),P.length>0&&T.push({d:D,ds:j,tasks:P,dayName:d[(a+$)%7]})}const f=u>0?Math.round(g/u*100):0,w=163.36,k=(w*(1-f/100)).toFixed(1),B=($,D=5)=>{let j="";for(let P=1;P<=D;P++)j+=`<span style="display:inline-block;width:6px;height:6px;border-radius:50%;margin-right:2px;background:${P<=$?r:"#E8E6DE"}"></span>`;return j},h=$=>$?'<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;border-radius:50%;background:#22C55E;flex-shrink:0"><svg width="8" height="6" viewBox="0 0 8 6"><path d="M1 3L3 5L7 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></span>':'<span style="display:inline-block;width:15px;height:15px;border-radius:50%;border:1.5px solid #D1D0DC;flex-shrink:0"></span>';let S="";for(const{d:$,tasks:D,dayName:j}of T){const P=D.reduce((N,F)=>N+Number(F.duration||0),0),Y=D.map(N=>{const F=p[N.type]||"#94a3b8",V=m[N.type]||"Diğer",Z=N.done,te=N.student_result||null,Q=N.student_feedback||null,R=te&&(te.dogru!=null||te.yanlis!=null||te.bos!=null)?`
        ...
        </div>`:"",H=N.student_note?`<div style="font-size:9px;color:#9998AA;font-style:italic;margin-top:4px;margin-left:21px;line-height:1.4">"${v(N.student_note)}"</div>`:"",K=Q&&(Q.difficulty||Q.focus)?`
        ...
        <div style="flex:1;min-width:0">
          <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
            ${h(Z)}
            <span style="font-size:11px;font-weight:800;color:${Z?"#9998AA":"#111118"};${Z?"text-decoration:line-through":""}">${v(N.subject)}</span>
            <span style="font-size:8px;font-weight:700;color:${F};text-transform:uppercase;letter-spacing:.5px;margin-left:2px">${V}${N.exam?" · "+v(N.exam):""}</span>
          </div>
          ${N.note?`<div style="font-size:9px;color:#6B6A7A;margin-left:21px;line-height:1.4;margin-bottom:2px">${v(N.note)}</div>`:""}
          ${R}
          ${H}
        </div>
        <div style="display:flex;flex-direction:column;align-items:flex-end;flex-shrink:0">
          <span style="font-size:10px;font-weight:600;color:#9998AA;background:#F7F6F2;padding:2px 8px;border-radius:99px;white-space:nowrap">${N.duration} dk</span>
          ${K}
        </div>
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:7px">
        ...
        <span style="font-size:10px;color:#6B6A7A">${$.getDate()} ${c[$.getMonth()]}</span>
        <div style="flex:1;height:1px;background:#E8E6DE"></div>
        <span style="font-size:9px;color:#9998AA">${D.length} görev · ${P} dk</span>
      </div>
      ${Y}
    </div>`}const z=[{val:g,lbl:"Tamamlanan",col:"#22C55E"},{val:u-g,lbl:"Bekleyen",col:"#C4C3D0"},{val:Math.round(_/60)+" sa",lbl:"Toplam Süre",col:r},{val:u,lbl:"Toplam Görev",col:"#C4C3D0"}].map(($,D)=>`<div style="flex:1;${D>0?"border-left:1px solid rgba(255,255,255,.06);padding-left:16px;":""}padding-right:16px">
    <div style="font-size:18px;font-weight:800;color:${$.col};font-variant-numeric:tabular-nums">${$.val}</div>
    <div style="font-size:8px;color:#6B6A7A;text-transform:uppercase;letter-spacing:.07em">${$.lbl}</div>
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:8px;flex-shrink:0">
          <div style="position:relative;width:64px;height:64px">
            <svg width="64" height="64" viewBox="0 0 64 64" style="transform:rotate(-90deg)">
              ...
              <circle cx="32" cy="32" r="26" fill="none" stroke="${r}" stroke-width="5" stroke-linecap="round" stroke-dasharray="${w.toFixed(1)}" stroke-dashoffset="${k}"/>
            </svg>
  ...
  </body></html>`,A=window.open("","_blank","width=1000,height=850");A.document.write(E),A.document.close(),setTimeout(()=>A.focus(),300)}async function dr(){var s,r;G("inviteCodeModal");const e=document.getElementById("invCodeBox");let t=(s=l.workspace)==null?void 0:s.invite_code;if(!t){e.textContent="……";try{const{data:d,error:c}=await y.rpc("ensure_invite_code");!c&&d&&(t=d,l.workspace&&(l.workspace.invite_code=t))}catch{}}if(!t){e.textContent="—",x("Kod alınamadı — sayfayı yenileyip tekrar dene");return}e.textContent=t;const n=`https://rostrumakademi.com/app.html?davet=${t}`,i=`Merhaba! ${((r=l.workspace)==null?void 0:r.brand_name)||"koçun"} koçluk platformuna davetlisin. 🎓

Kayıt linki: ${n}
(Davet kodun: ${t})

Linke tıkla, hesabını oluştur — otomatik olarak bana bağlanacaksın.`,o=document.getElementById("invWaBtn");o&&(o.href="https://wa.me/?text="+encodeURIComponent(i))}function cr(){var t,n;const e=(n=(t=document.getElementById("invCodeBox"))==null?void 0:t.textContent)==null?void 0:n.trim();e&&e.length===6&&vn(e)}function pr(){var t,n;const e=(n=(t=document.getElementById("invCodeBox"))==null?void 0:t.textContent)==null?void 0:n.trim();e&&e.length===6&&vn(`https://rostrumakademi.com/app.html?davet=${e}`)}function vn(e){navigator.clipboard.writeText(e).then(()=>x("Link kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),x("Link kopyalandı ✓")})}const La=[{name:"Terrakota",val:"#e8613a",dim:"rgba(232,97,58,.12)"},{name:"Altın",val:"#f0a500",dim:"rgba(240,165,0,.12)"},{name:"Mavi",val:"#4da6ff",dim:"rgba(77,166,255,.12)"},{name:"Yeşil",val:"#3ecf8e",dim:"rgba(62,207,142,.12)"},{name:"Mor",val:"#c084fc",dim:"rgba(192,132,252,.12)"},{name:"Pembe",val:"#f472b6",dim:"rgba(244,114,182,.12)"},{name:"Kırmızı",val:"#ff5c5c",dim:"rgba(255,92,92,.12)"},{name:"Turkuaz",val:"#06b6d4",dim:"rgba(6,182,212,.12)"}];function ja(){try{const e=JSON.parse(localStorage.getItem("ba_theme")||"{}");e.theme==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),e.accent&&Pa(e.accent,e.accentDim,!1)}catch{}}function Pa(e,t,n=!0){if(document.documentElement.style.setProperty("--accent",e),document.documentElement.style.setProperty("--accent-dim",t||"rgba(240,165,0,.12)"),n)try{const a=JSON.parse(localStorage.getItem("ba_theme")||"{}");a.accent=e,a.accentDim=t,localStorage.setItem("ba_theme",JSON.stringify(a))}catch{}}function mr(e){e==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{const t=JSON.parse(localStorage.getItem("ba_theme")||"{}");t.theme=e,localStorage.setItem("ba_theme",JSON.stringify(t))}catch{}document.querySelectorAll(".theme-btn").forEach(t=>{const n=t.dataset.theme===e;t.style.background=n?"var(--accent-dim)":"",t.style.borderColor=n?"var(--accent)":"",t.style.color=n?"var(--accent)":""})}function ur(){let e=document.getElementById("themePanel");if(e){e.remove();return}e=document.createElement("div"),e.id="themePanel";const t=document.documentElement.getAttribute("data-theme")!=="light";e.style.cssText="position:fixed;top:60px;right:12px;background:var(--surface);border:1px solid var(--border2);border-radius:14px;padding:18px;z-index:300;box-shadow:var(--shadow-lg);min-width:230px;animation:fadeUp .2s ease",e.innerHTML=`
...
Paylaşılan şablonlar değerlendirilerek tüm koçlara önerilebilir.`)&&y.auth.getSession().then(({data:{session:r}})=>{const d=r==null?void 0:r.access_token;d&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({type:"template_share",template_name:e,task_count:i.length,tasks_json:JSON.stringify(i,null,2)})}).then(()=>x("Şablon Rostrum ekibiyle paylaşıldı ✓")).catch(()=>x("Şablon kaydedildi, paylaşım gönderilemedi."))})}async function Ar(){M(!0);const{data:e,error:t}=await y.from("program_templates").select("*").eq("coach_id",b.coachId);if(M(!1),t)return x("Şablonlar yüklenemedi.");if(!e||e.length===0)return x("Kayıtlı şablonunuz bulunmuyor. Önce haftayı şablon olarak kaydedin.");let n=document.getElementById("applyTemplateModal");n||(n=document.createElement("div"),n.id="applyTemplateModal",n.className="modal-bg",n.innerHTML=`<div class="modal">
    ...
    <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:18px 20px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px">
        ...
        ${d.phone?`<div style="background:var(--surface2);border-radius:8px;padding:10px 12px">
          ...
          <a href="https://wa.me/9${v((d.phone||"").replace(/\\D/g,""))}" target="_blank" style="font-size:12px;font-weight:700;color:#25D366;text-decoration:none">💬 Mesaj gönder</a>
        </div>`:""}
        ${d.goal||d.style?`<div style="background:var(--surface2);border-radius:8px;padding:10px 12px;grid-column:1/-1">
          ...
          <div style="font-size:12px;color:var(--text-mid)">${v(d.goal||d.style)}</div>
        </div>`:""}
      </div>
      ${d.status==="pending"?`
      <div style="display:flex;gap:8px">
    ...
    </div>`).join("");const s=t.filter(d=>d.status==="pending").length,r=document.getElementById("sbi_coach-applications");if(r){const d=r.querySelector(".sb-badge");if(d&&d.remove(),s>0){const c=document.createElement("span");c.className="sb-badge",c.textContent=s,r.appendChild(c)}}}async function Hr(e,t,n,a){var o;const{error:i}=await y.from("match_requests").update({status:t}).eq("id",e);if(i)return x("Hata: "+i.message);x(t==="accepted"?"✓ Başvuru kabul edildi":"Başvuru reddedildi"),n&&n.includes("@")&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"application_update",to:n,student_name:a||"",status:t,coach_name:((o=l.workspace)==null?void 0:o.brand_name)||"Koçunuz"})}).catch(s=>console.warn("[updateApplication] mail error:",s.message)),bn()}let Ne=null;async function qa(){var a;const e=document.getElementById("view-coach-notes");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:860px;margin:0 auto">
    ...
    </div>`).join("")}function Nr(e){const t=e!==null?Ne[e]||{}:{};let n=document.getElementById("coachNoteModal");n||(n=document.createElement("div"),n.id="coachNoteModal",n.className="modal-bg",document.body.appendChild(n)),n.innerHTML=`<div class="modal" style="max-width:520px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
  ...
  </div>`,n.style.display="flex"}async function Yr(e){const t=document.getElementById("noteEditorTitle").value.trim(),n=document.getElementById("noteEditorBody").value.trim();if(!t&&!n)return x("Not boş olamaz");const a={title:t||"Başlıksız",body:n,updated:new Date().toISOString()};e===null?Ne.unshift(a):Ne[e]=a,await Wa(),document.getElementById("coachNoteModal").style.display="none",hn(),x("Not kaydedildi ✓")}async function Kr(e){await ie("Bu notu silmek istiyor musun?")&&(Ne.splice(e,1),await Wa(),hn(),x("Not silindi"))}async function Wa(){const e=`coach_notes_${b.coachId}`;await y.from("platform_settings").upsert({key:e,value:{notes:Ne}},{onConflict:"key"})}function Ct(){if(b.role!=="student")return;const e=(l.messages[b.studentId]||[]).filter(t=>t.from==="coach"&&!t.read).length;["sbi_smessages","mntab_smessages"].forEach(t=>{const n=document.getElementById(t);if(!n)return;n.style.position="relative";const a=n.querySelector(".msg-nav-badge");if(a&&a.remove(),e>0){const i=document.createElement("span");i.className="msg-nav-badge",i.style.cssText="position:absolute;top:3px;right:3px;background:#ef4444;color:#fff;border-radius:100px;min-width:14px;height:14px;font-size:9px;font-weight:800;display:flex;align-items:center;justify-content:center;padding:0 3px;pointer-events:none;line-height:1",i.textContent=e>9?"9+":e,n.appendChild(i)}})}window.updateMsgBadge=Ct;window.toggleSidebar=ki;window.setupShell=$i;window.switchTab=se;window.renderHome=qn;window.renderCoachApplications=bn;window.updateApplication=Hr;window.renderCoachNotes=qa;window.openNoteEditor=Nr;window.toggleNewResourceMode=qi;window.addManualTest=Wi;window.removeManualTest=Vi;window.saveCoachNote=Yr;window.deleteCoachNote=Kr;window.renderStudentsSearch=ct;window.filterStudentSearch=Ei;window.openStudentDetail=Wn;window.openKonuHaritasi=Si;window.openStudentProgram=Qt;window.openStudentExams=Ii;window.openStudentAppointments=zi;window.renderProfile=Jn;window.saveProfile=Li;window.renderSettings=Xn;window.saveGeminiKey=ji;window.renderProgram=X;window.selectStu=Pi;window.chWeek=Ri;window.goToday=Hi;window.openClearWeekModal=Yi;window.toggleDaySel=Ki;window.toggleAllDays=Oi;window.confirmClearDays=Fi;window.openTaskModal=ta;window.loadResources=aa;window.updateSubjectList=Tt;window.updateBookList=Zi;window.renderBookList=St;window.filterBooks=Ji;window.selectBook=Xi;window.renderTestList=It;window.selectAllTests=Qi;window.clearAllTests=eo;window.updateTestSummary=Ve;window.selectModalSpeed=to;window.applyDuration=no;window.scheduleSmartBadge=zt;window.applySmartDuration=io;window.loadStudentSpeeds=ia;window.saveStudentSpeed=oa;window.saveTask=oo;window.toggleTask=so;window.closeTaskMenu=tn;window.showTaskMenu=ro;window.copyTask=lo;window.deleteTask=co;window.renderTodoList=da;window.renderStudents=pa;window.goProgram=ko;window.openStudentModal=wo;window.saveStudent=$o;window.showInviteInfo=ma;window.deleteStu=_o;window.renderAppointments=Ze;window.renderCalDays=Bt;window.selCalDay=So;window.chCalMonth=Io;window.renderApptList=nn;window.openApptModal=zo;window.saveAppt=Bo;window.deleteAppt=Ao;window.renderExams=Je;window.openCommentModal=Ho;window.saveComment=No;window.deleteExam=Yo;window.renderMessages=xa;window.selectThread=Ko;window.renderThreadHTML=Se;window.sendMsg=Oo;window.scrollMsgs=Ie;window.renderPortal=Mt;window.stuToggleTask=Fo;window.renderSPortal=ze;window.stuToggleTask2=Uo;window.chWeekS=qo;window.openTaskDetail=an;window.toggleTaskDetail=Zo;window.toggleDetailItem=Jo;window.selectVideoSpeed=Xo;window.saveTaskDetail=Qo;window.renderSExams=on;window.openStudentExamModal=ba;window.openExamModal=es;window.renderNetInputs=sn;window.saveExam=as;window.renderSMessages=Ft;window.initRealtime=rn;window.destroyRealtime=ln;window.renderDevDashboard=ka;window.renderDevUsers=Xe;window.openDevUserModal=ss;window.devDeleteUser=rs;window.openPlanModal=ls;window.savePlan=ds;window.renderDevResources=pt;window.openPlaylistModal=cs;window.fetchYouTubePlaylist=ps;window.savePlaylist=ms;window.openResourceModal=us;window.saveResource=gs;window.devDeleteResource=vs;window.renderDevFinance=mt;window.openPaymentModal=ys;window.verifyPayment=fs;window.setDevUserFilter=os;window.savePayment=xs;window.openSubModal=bs;window.saveSub=hs;window.renderDevAnnounce=ut;window.openAnnounceModal=ks;window.saveAnnounce=ws;window.toggleAnnounce=$s;window.devDeleteAnnounce=Es;window.renderDevTickets=Qe;window.updateTicketStatus=zs;window.devDeleteTicket=Bs;window.selectDevTicket=_s;window.sendDevReply=Is;window.openSupportTicket=Ms;window.openSupportChat=Dt;window.closeSupportChat=wa;window.startAISupportChat=Ds;window.startEminSupportChat=As;window.submitEminInitialMessage=Cs;window.sendSupportMessage=Ls;window.openSupportChatDirect=Dt;window.checkCoachSubscription=Xt;window.showTrialExpiredScreen=bt;window.loadAnnouncements=$a;window.saveStudentDev=hr;window.showOnboarding=Ta;window.showOnboardingWidget=Rs;window.showStudentWelcome=Hs;window.renderSProfil=Ia;window.saveStudentProfile=Ns;window.changePassword=Ys;window.renderCoachProfile=za;window.updateProfilePreview=Ke;window.switchPreviewTab=Zs;window.toggleCoachTag=Ba;window.addCustomCoachTag=Ma;window.uploadCoachPhoto=Fs;window.onCoachSlugInput=Us;window.copyCoachLink=Gs;window.browseCoachLink=qs;window.generateCoachBio=Vs;window.nl2br=Aa;window.saveCoachProfile=Js;window.renderDevMatches=mn;window.updateMatchRequestStatus=Xs;window.openSpeedModal=Qs;window.saveAllSpeeds=er;window.openStudentNotes=tr;window.saveStudentNote=nr;window.openReportModal=ar;window.getReportDates=un;window.buildReportHTML=gn;window.previewReport=ir;window.generatePDF=or;window.openWeeklyPDFModal=rr;window.generateWeeklyPDF=lr;window.printWeeklyProgramWithNote=Ca;window.openInviteCodeModal=dr;window.copyInviteCode=cr;window.copyInviteLink=pr;window.copyToClipboard=vn;window.loadTheme=ja;window.applyAccent=Pa;window.setTheme=mr;window.openThemePanel=ur;window.initAIChatForRole=Ra;window.toggleAIChat=gr;window.aiQuickSend=vr;window.buildAIContext=Gt;window.addAIMessage=be;window.sendAIMessage=Ha;window.autoDetectModel=Na;window.callGeminiFallback=Te;window.generateAICopilotDraft=fr;window.checkCopilotDraftEdited=xr;window.shareCopilotWhatsApp=yr;window.assignResourceAsTask=kr;window.confirmAssignResource=wr;window.sendCopilotDraft=br;window.renderParentHome=Ya;window.renderParentProgress=Ka;window.renderParentAI=Oa;window.applyResFilter=xn;window.updateCRFilter=$r;window.buildCRContent=At;window.renderCoachResources=gt;window.switchCRTab=Er;window.compileResourceStats=Ua;window.openResourceModalCoach=_r;window.fetchYtPlaylistCoach=Tr;window.saveResourceCoach=Sr;window.deleteResourceCoach=Ir;window.importResourcesFromExcel=zr;window.importStudentsFromExcel=Br;window.getTestStatus=Ga;window.openCoachTaskEdit=Mr;window.saveWeekAsTemplate=Dr;window.applyTemplateToWeek=Ar;window.downloadICS=Co;window.confirmApplyTemplate=Cr;window.copyTaskToClipboard=Lr;window.pasteTaskFromClipboard=jr;window.copyTaskToWholeWeek=Pr;window.pasteTaskToWholeWeek=Rr;window.sendWhatsAppReport=sr;window.toggleUserMenu=wi;window.closeUserMenu=Gn;window.renderAgenda=$e;window.openAgendaApptModal=ca;window.deleteAgendaAppt=ho;window.agendaPrev=go;window.agendaNext=vo;window.agendaToday=fo;window.agendaSetFilter=yo;window.exportAgendaICS=xo;window.openApptPopup=la;window.handleApptDrop=bo;window.openStudentKaynaklar=Bi;window.addStudentBook=Mi;window.editStudentBook=Di;window.sbUpdatePct=Zn;window.saveStudentBook=Ai;window.deleteStudentBook=Ci;async function Or(){const e=document.getElementById("rpStuId").value,t=l.students.find(m=>m.id===e);if(!t)return;const n=document.getElementById("rpPeriod").value,{start:a,end:i}=un(),o=document.getElementById("rpNote").value.trim();let s="Performans Raporu";n==="weekly"?s="Haftalık Performans Raporu":n==="monthly"?s="Aylık Performans Raporu":s="Özel Dönem Performans Raporu";const r=`${s} (${a} - ${i})`,d=o||"Değerlendirme notu eklenmedi.";M(!0);const c=b.coachId||t.coachId,{error:p}=await y.from("reports").insert({student_id:e,coach_id:c,type:"performance",title:r,content:d,start_date:a,end_date:i});M(!1),p?x("Rapor kaydedilirken hata oluştu: "+p.message):(x("Rapor başarıyla geçmişe kaydedildi! ✓"),q("reportModal"))}async function Va(e){const t=l.students.find(s=>s.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&se("student-detail");const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button>
  ...
  `,G("viewReportDetailModal")}function Ur(){const e=document.getElementById("viewReportDetailModal");if(!e)return;const t=e.querySelector("h3").textContent,n=e.querySelector("div div").textContent,a=e.querySelector('div[style*="pre-wrap"]').textContent,i=window.open("","_blank");i.document.write(`
    <html>
      <head>
        <title>${t}</title>
        <style>
