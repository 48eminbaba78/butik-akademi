(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const l={students:[],tasks:{},appointments:[],exams:[],messages:{},coachTodos:{},weekOffset:0,calMonth:new Date().getMonth(),calYear:new Date().getFullYear(),calSelDay:null,activeStuId:null,msgThread:null,workspace:null,studentSpeeds:[],konuHaftaSoru:[]},x={role:null,studentId:null,dbUser:null,coachId:null,childName:null};window.S=l;window.session=x;window._loginMode="email";window.STU_DEFAULT_PASS="Rostrum"+Math.floor(1e3+Math.random()*9e3);window.DAYS_TR=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"];window.MONTHS_TR=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];window.EXAM_DEFS={TYT:["Türkçe","Matematik","Fen","Sosyal"],"AYT-SAY":["Matematik","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Edebiyat","Tarih","Coğrafya"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.EXAM_SORU={TYT:{Türkçe:40,Matematik:40,Fen:20,Sosyal:20},"AYT-SAY":{Matematik:40,Fizik:14,Kimya:13,Biyoloji:13},"AYT-EA":{Matematik:40,Edebiyat:24,Tarih:10,Coğrafya:6},"AYT-SOZ":{Edebiyat:24,Tarih1:10,Tarih2:11,Coğrafya1:6,Coğrafya2:11,Felsefe:12,Din:6}};window.EXAM_KONU_MAP={TYT_Türkçe:["Dil Bilgisi"],TYT_Matematik:["TYT Matematik","Geometri"],TYT_Fen:["TYT Fizik","TYT Kimya","TYT Biyoloji"],TYT_Sosyal:[],"AYT-SAY_Matematik":["AYT Matematik","Geometri"],"AYT-SAY_Fizik":["AYT Fizik"],"AYT-SAY_Kimya":["AYT Kimya"],"AYT-SAY_Biyoloji":["AYT Biyoloji"],"AYT-EA_Matematik":["AYT Matematik","Geometri"],"AYT-EA_Edebiyat":["Dil Bilgisi"]};window.SUBJECT_MAP={TYT:["Türkçe","Matematik","Geometri","Fizik","Kimya","Biyoloji","Tarih","Coğrafya","Felsefe","Din"],"AYT-SAY":["Matematik","Geometri","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Geometri","Edebiyat","Tarih","Coğrafya","Felsefe"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.currentTab="";window._clipboardTask=null;window._editingTaskId=null;window._regRole=null;window._onbRole=null;window._oauthUser=null;const ga="https://imyhenrwmsmyikpollur.supabase.co",va="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlteWhlbnJ3bXNteWlrcG9sbHVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxNDE3ODYsImV4cCI6MjA5NTcxNzc4Nn0._ySJ5ArD1GYthyitHjdyEjLaUhextIwEqpRoF5ScI34",b=supabase.createClient(ga,va);window.db=b;function xe(){var e;try{localStorage.setItem("ba_ui_"+(((e=x.dbUser)==null?void 0:e.id)||"x"),JSON.stringify({weekOffset:l.weekOffset,activeStuId:l.activeStuId,calMonth:l.calMonth,calYear:l.calYear}))}catch{}}function Ve(){xe()}function B(e,t){let n=document.getElementById("loadingOverlay");if(document.querySelectorAll(".btn-login, .btn-accent, .btn").forEach(i=>{e?(i.setAttribute("disabled","true"),i.style.opacity="0.6",i.style.pointerEvents="none"):(i.removeAttribute("disabled"),i.style.opacity="",i.style.pointerEvents="")}),e&&!n){n=document.createElement("div"),n.id="loadingOverlay",n.style.cssText="position:fixed;inset:0;background:rgba(15,14,12,.82);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:14px;backdrop-filter:blur(6px)";const i=t||"Yükleniyor...",o=t?'<div style="font-size:36px;animation:overlayPop .3s cubic-bezier(.34,1.56,.64,1) both">🗑️</div>':'<div style="width:38px;height:38px;border:3px solid rgba(255,255,255,.12);border-top-color:var(--accent);border-radius:50%;animation:spin .7s linear infinite"></div>';if(n.innerHTML=`${o}<div style="font-size:14px;font-weight:600;color:#fff;letter-spacing:.2px">${i}</div>`,!document.getElementById("spinStyle")){const s=document.createElement("style");s.id="spinStyle",s.textContent="@keyframes spin{to{transform:rotate(360deg)}}@keyframes overlayPop{from{transform:scale(.6);opacity:0}to{transform:scale(1);opacity:1}}",document.head.appendChild(s)}document.body.appendChild(n)}else!e&&n&&n.remove()}function g(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function K(e){return e instanceof Date?e.toISOString().split("T")[0]:e}function V(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function be(){return K(new Date)}function zt(e){return e>=20?"good":e>=12?"mid":"low"}function Ze(e){return{deneme:"📊 Deneme",soru:"📚 Soru",konu:"🎯 Konu",diger:"⭐ Diğer"}[e]||e}function O(e){document.getElementById(e).classList.add("open")}function F(e){document.getElementById(e).classList.remove("open")}function h(e){const t=document.getElementById("toast");t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),2300)}document.addEventListener("click",e=>{e.target.classList.contains("modal-bg")&&e.target.id!=="trialExpiredModal"&&e.target.classList.remove("open")});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".modal-bg.open").forEach(t=>{t.id!=="trialExpiredModal"&&t.classList.remove("open")})});function ee(e,t=0){const n=new Date,a=n.getDay(),o=(a===0?6:a-1)-t,s=new Date(n);return s.setDate(n.getDate()-(o+7)%7+e*7),s.setHours(0,0,0,0),s}function fa(){const e=l.students.find(t=>t.id===l.activeStuId);return(e==null?void 0:e.weekStart)??0}async function Le(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return[...new Uint8Array(t)].map(n=>n.toString(16).padStart(2,"0")).join("")}function Ae(e){return e?e.trim().toLowerCase().replace(/ç/g,"c").replace(/ğ/g,"g").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ş/g,"s").replace(/ü/g,"u").replace(/i̇/g,"i").replace(/ı/g,"i").replace(/i/g,"i").replace(/\s+/g,"").replace(/\u0307/g,""):""}function ya(){if(!("Notification"in window)){console.log("Bu tarayıcı anlık bildirimleri desteklemiyor.");return}Notification.permission!=="granted"&&Notification.permission!=="denied"?Notification.requestPermission().then(e=>{e==="granted"&&h("Bildirim izinleri onaylandı ✓")}):Notification.permission==="granted"?h("Bildirim izinleri zaten açık ✓"):h("Bildirim izinleri tarayıcı ayarlarından engellenmiş.")}window.saveUI=xe;window.saveS=Ve;window.showLoading=B;window.esc=g;window.fmtDate=K;window.addDays=V;window.todayStr=be;window.netColor=zt;window.typeLabel=Ze;window.om=O;window.cm=F;window.showToast=h;window.getWeekStart=ee;window.getStudentWeekStart=fa;window.sha256=Le;window.normalizeUsername=Ae;window.requestNotificationPermission=ya;async function xa(e,t={}){let n=b.from(e).select("*");Object.entries(t).forEach(([o,s])=>{n=n.eq(o,s)});const{data:a,error:i}=await n;return i&&console.error(e,i),a||[]}const ba=4*60*1e3;function Bt(){return"ra_d_"+(x.coachId||x.studentId||"x")}function rn(){try{localStorage.removeItem(Bt())}catch{}}function tn(){try{localStorage.setItem(Bt(),JSON.stringify({ts:Date.now(),students:l.students,tasks:l.tasks,appointments:l.appointments,exams:l.exams,messages:l.messages,coachTodos:l.coachTodos,studentSpeeds:l.studentSpeeds,workspace:l.workspace,konuHaftaSoru:l.konuHaftaSoru}))}catch{}}function ha(){try{const e=localStorage.getItem(Bt());if(!e)return!1;const t=JSON.parse(e);return!t.ts||Date.now()-t.ts>ba?!1:(t.students&&(l.students=t.students),t.tasks&&(l.tasks=t.tasks),t.appointments&&(l.appointments=t.appointments),t.exams&&(l.exams=t.exams),t.messages&&(l.messages=t.messages),t.coachTodos&&(l.coachTodos=t.coachTodos),t.studentSpeeds&&(l.studentSpeeds=t.studentSpeeds),t.workspace&&(l.workspace=t.workspace),t.konuHaftaSoru&&(l.konuHaftaSoru=t.konuHaftaSoru),!0)}catch{return!1}}async function nn(){var j;const e=x.coachId,t=x.role,n=t==="coach"||t==="developer"?b.from("workspaces").select("*").eq("coach_id",e).single():Promise.resolve({data:null});let a=b.from("users").select("*").eq("role","student");t==="student"?a=a.eq("id",x.studentId):(t==="coach"||t==="developer")&&(a=a.eq("coach_id",e));const i=a,o=new Date;o.setDate(o.getDate()-60);const s=o.toISOString().split("T")[0],r=new Date;r.setDate(r.getDate()-30);const d=r.toISOString().split("T")[0],c=t==="student"?b.from("tasks").select("*").eq("student_id",x.studentId).gte("date",s):t==="coach"||t==="developer"?b.from("tasks").select("*").eq("coach_id",e).gte("date",s):b.from("tasks").select("*").gte("date",s),p=t==="student"?b.from("appointments").select("*").eq("student_id",x.studentId).gte("date",d):t==="coach"||t==="developer"?b.from("appointments").select("*").eq("coach_id",e).gte("date",d):b.from("appointments").select("*").gte("date",d),m=t==="student"?b.from("exams").select("*").eq("student_id",x.studentId):t==="coach"||t==="developer"?b.from("exams").select("*").eq("coach_id",e):b.from("exams").select("*"),u=t==="student"?b.from("messages").select("*").eq("student_id",x.studentId).order("created_at",{ascending:!1}).limit(200):t==="coach"||t==="developer"?b.from("messages").select("*").eq("coach_id",e).order("created_at",{ascending:!1}).limit(200):b.from("messages").select("*").order("created_at",{ascending:!1}).limit(200),f=t==="coach"||t==="developer"?b.from("coach_todos").select("*").eq("coach_id",e):Promise.resolve({data:[]}),S=t==="student"?b.from("student_speeds").select("*").eq("student_id",x.studentId):t==="coach"||t==="developer"?b.from("student_speeds").select("*").eq("coach_id",e):b.from("student_speeds").select("*"),I=t==="coach"||t==="developer"?b.from("konu_mastery").select("*").eq("coach_id",e):t==="student"?b.from("konu_mastery").select("*").eq("student_id",x.studentId):Promise.resolve({data:[]}),v=t==="coach"||t==="developer"?b.from("konu_tekrar_log").select("*").eq("coach_id",e):t==="student"?b.from("konu_tekrar_log").select("*").eq("student_id",x.studentId):Promise.resolve({data:[]}),[$,k,E,y,z,T,M,_,D,C]=await Promise.all([n,i,c,p,m,u,f,S,I,v]);(t==="coach"||t==="developer")&&(l.workspace=$.data||null),l.students=(k.data||[]).map(w=>({id:w.id,name:w.full_name||w.username||"Öğrenci",target:w.target||"",color:w.color||"#4da6ff",progress:w.progress||0,weekStart:w.week_start||0,username:w.username,coachId:w.coach_id,yksArea:w.yks_area||"SAY"})),l.tasks={},(E.data||[]).forEach(w=>{const A=`${w.student_id}_${w.date}`;l.tasks[A]||(l.tasks[A]=[]),l.tasks[A].push({_id:w.id,type:w.type,exam:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,done:w.done,student_note:w.student_note||"",student_result:w.student_result||null,student_feedback:w.student_feedback||null,task_items:w.task_items,start_time:w.start_time})}),l.appointments=(y.data||[]).map(w=>({id:w.id,studentId:w.student_id,date:w.date,time:w.time,duration:w.duration,type:w.type,note:w.note,meetLink:w.meet_link})),l.exams=(z.data||[]).map(w=>({id:w.id,studentId:w.student_id,name:w.name,date:w.date,type:w.exam_type,nets:w.nets||{},examDetails:w.exam_details||{},note:w.student_note,coachComment:w.coach_comment})),l.messages={},(T.data||[]).forEach(w=>{l.messages[w.student_id]||(l.messages[w.student_id]=[]),l.messages[w.student_id].push({_id:w.id,from:w.from_role,text:w.text||"",image_url:w.image_url||null,read:w.read,time:new Date(w.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})})}),Object.keys(l.messages).forEach(w=>l.messages[w].sort((A,L)=>A._id>L._id?1:-1)),l.coachTodos={},(M.data||[]).forEach(w=>{l.coachTodos[w.date]||(l.coachTodos[w.date]=[]),l.coachTodos[w.date].push({_id:w.id,task:w.task,note:w.note,done:w.done})}),l.studentSpeeds=_.data||[],l.konuMastery={},(D.data||[]).forEach(w=>{l.konuMastery[w.student_id]||(l.konuMastery[w.student_id]={}),l.konuMastery[w.student_id][w.subject]||(l.konuMastery[w.student_id][w.subject]={}),l.konuMastery[w.student_id][w.subject][w.konu]=w}),l.konuTekrarLog={},(C.data||[]).forEach(w=>{l.konuTekrarLog[w.student_id]||(l.konuTekrarLog[w.student_id]={}),l.konuTekrarLog[w.student_id][w.subject]||(l.konuTekrarLog[w.student_id][w.subject]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu]||(l.konuTekrarLog[w.student_id][w.subject][w.konu]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu][w.period_start]=w});try{const w=JSON.parse(localStorage.getItem("ba_ui_"+((j=x.dbUser)==null?void 0:j.id))||"{}");w.weekOffset!==void 0&&(l.weekOffset=w.weekOffset),w.activeStuId&&(l.activeStuId=w.activeStuId),w.calMonth!==void 0&&(l.calMonth=w.calMonth,l.calYear=w.calYear)}catch{}}async function ln(){if(ha()){nn().then(()=>{if(tn(),window.currentTab)try{window.switchTab(window.currentTab)}catch{}}).catch(t=>console.error("Arka plan yenileme hatası:",t));return}B(!0);try{await nn(),tn()}catch(t){console.error("loadAllData error",t)}B(!1)}window.dbQ=xa;window.loadAllData=ln;window.invalidateCache=rn;let Se=!1;function de(e){const t=document.getElementById("loginErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function at(e){const t=document.getElementById("regErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function dn(e){document.getElementById("loginPanel").style.display=e==="login"?"block":"none",document.getElementById("registerPanel").style.display=e==="register"?"block":"none",document.getElementById("lmtLogin").classList.toggle("active",e==="login"),document.getElementById("lmtRegister").classList.toggle("active",e==="register")}function ka(e){window._loginMode=e,document.querySelectorAll("#loginTabs .login-tab").forEach((t,n)=>t.classList.toggle("active",n===(e==="email"?0:1))),document.getElementById("loginEmailField").style.display=e==="email"?"block":"none",document.getElementById("loginUserField").style.display=e==="username"?"block":"none"}function wa(e){window._regRole=e,document.getElementById("rrbCoach").classList.toggle("sel",e==="coach"),document.getElementById("rrbStudent").classList.toggle("sel",e==="student")}function $a(e){window._onbRole=e,document.getElementById("onbRoleCoach").classList.toggle("sel",e==="coach"),document.getElementById("onbRoleStudent").classList.toggle("sel",e==="student")}async function Ta(){if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.protocol==="file:"){pn();return}await cn()}async function cn(){Mt(),B(!0);try{const{error:e}=await b.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin+"/app.html",queryParams:{access_type:"offline",prompt:"select_account"}}});e&&(B(!0),console.warn("Google Auth failed:",e),de("Google Girişi Başlatılamadı: "+e.message))}catch(e){B(!1),de("Google Girişi Başlatılamadı: "+e.message)}}function pn(){document.getElementById("googleSimulatorModal").style.display="flex"}function Mt(){document.getElementById("googleSimulatorModal").style.display="none"}async function Ea(e){if(Mt(),B(!0),e==="demokoc"){const{data:t,error:n}=await b.from("users").select("*").eq("username","demokoc").maybeSingle();if(n||!t){B(!1),de("Demo koç profili bulunamadı!");return}await De(t)}else if(e==="demoogrenci"){const{data:t,error:n}=await b.from("users").select("*").eq("username","demoogrenci").maybeSingle();if(n||!t){B(!1),de("Demo öğrenci profili bulunamadı!");return}await De(t)}else if(e==="new"){B(!1),document.getElementById("newUserOnboarding").style.display="flex";const t=Math.floor(1e3+Math.random()*9e3),n=`yeni.kullanici${t}@gmail.com`;document.getElementById("onbEmail").textContent=n,document.getElementById("onbName").value=`Yeni Kullanıcı ${t}`,window._oauthUser={id:`mock-google-id-${t}`,email:n,user_metadata:{full_name:`Yeni Kullanıcı ${t}`}}}}async function mn(){var t,n,a;if(window.location.hash.includes("type=recovery")){console.log("[Auth] Recovery session active, skipping checkOAuthSession");return}if(Se)return;Se=!0;let e=null;try{console.log("[Auth] 1/4 getSession...");const{data:{session:i}}=await b.auth.getSession();if(console.log("[Auth] 2/4 session:",((t=i==null?void 0:i.user)==null?void 0:t.email)||"yok"),!(i!=null&&i.user)){Se=!1;return}if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible")){Se=!1;return}B(!0),e=setTimeout(()=>{console.warn("[Auth] timeout — Supabase yanıt vermedi, spinner kapatılıyor"),Se=!1,B(!1)},1e4),console.log("[Auth] 3/4 profil yükleniyor...");const{data:o,error:s}=await b.from("users").select("*").eq("id",i.user.id).maybeSingle();console.log("[Auth] 4/4 profil:",o==null?void 0:o.role,(s==null?void 0:s.message)||""),clearTimeout(e);let r=!1;if(o){if(o.role==="coach"){const{data:d}=await b.from("workspaces").select("*").eq("coach_id",o.id).maybeSingle();(!d||!d.onboarding_done)&&(r=!0)}}else r=!0;o&&!r?await De(o):(B(!1),document.getElementById("newUserOnboarding").style.display="flex",document.getElementById("onbEmail").textContent=i.user.email,document.getElementById("onbName").value=((a=i.user.user_metadata)==null?void 0:a.full_name)||"",window._oauthUser=i.user)}catch(i){clearTimeout(e),Se=!1,B(!1),console.warn("[checkOAuthSession]",i)}}async function _a(){const e=document.getElementById("onbName").value.trim();if(!e){document.getElementById("onbErr").textContent="Ad soyad zorunlu",document.getElementById("onbErr").style.display="block";return}if(!window._onbRole){document.getElementById("onbErr").textContent="Hesap türü seçin",document.getElementById("onbErr").style.display="block";return}document.getElementById("onbErr").style.display="none",B(!0);const t=window._oauthUser,n=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""),a={id:t.id,full_name:e,email:t.email,role:window._onbRole,username:n+"_"+Math.random().toString(36).slice(2,6),password_hash:"supabase_managed",color:window._onbRole==="coach"?"#f0a500":"#4da6ff",week_start:0,progress:0,target:""},{data:i,error:o}=await b.from("users").upsert(a).select().single();if(o){B(!1),document.getElementById("onbErr").textContent="Hata: "+o.message,document.getElementById("onbErr").style.display="block";return}document.getElementById("newUserOnboarding").style.display="none",await De(i)}let Q=0;function Sa(e,t){document.getElementById("regBrandColor").value=e,t.parentElement.querySelectorAll("div").forEach(n=>n.style.outline="none"),t.style.outline="3px solid white"}function Ia(){const e=document.getElementById("regErr0");if(e&&(e.style.display="none"),Q===0){if(!window._regRole){e&&(e.textContent="Lütfen bir hesap türü seçin.",e.style.display="block");return}window._regRole==="student"?Q=3:Q=1}else if(Q===1){if(!document.getElementById("regBrandName").value.trim()){alert("Lütfen akademi / koçluk adını girin.");return}Q=2}else Q===2&&(Q=3);At(Q)}function za(){Q===3?window._regRole==="student"?Q=0:Q=2:Q===2?Q=1:Q===1&&(Q=0),At(Q)}function At(e){document.getElementById("regWizardStep0").style.display=e===0?"block":"none",document.getElementById("regWizardStepCoach1").style.display=e===1?"block":"none",document.getElementById("regWizardStepCoach2").style.display=e===2?"block":"none",document.getElementById("regWizardStepFinal").style.display=e===3?"block":"none"}async function Ba(){const e=document.getElementById("regName").value.trim(),t=document.getElementById("regEmail").value.trim().toLowerCase(),n=document.getElementById("regPass").value;if(!e||!t||!n)return at("Tüm hesap bilgileri zorunludur");if(n.length<8)return at("Şifre en az 8 karakter olmalıdır");B(!0);try{let a={full_name:e,role:window._regRole};if(window._regRole==="coach"){const s=document.getElementById("regBrandName").value.trim(),r=document.getElementById("regBrandColor").value||"#f0a500",d=document.getElementById("regPhone").value.trim(),c=[...document.querySelectorAll("#regExamTypesWrap .ob-exam-sel input")].map(u=>u.value),p=c.length>0?c.join(","):"YKS",m=document.getElementById("regStudentCountRange").value||"1-5";a.ob_brand=s,a.ob_color=r,a.ob_phone=d,a.ob_examtypes=p,a.ob_studentcount=m}const{data:i,error:o}=await b.auth.signUp({email:t,password:n,options:{data:a}});if(o)throw o;if(i!=null&&i.user){B(!1),document.getElementById("regName").value="",document.getElementById("regEmail").value="",document.getElementById("regPass").value="",document.getElementById("regBrandName")&&(document.getElementById("regBrandName").value=""),document.getElementById("regPhone")&&(document.getElementById("regPhone").value="");const s=document.getElementById("regSuccess");s.textContent="Kayıt başarılı! E-posta adresinize bir doğrulama bağlantısı gönderildi. Lütfen doğrulama yaptıktan sonra giriş yapın.",s.style.display="block",setTimeout(()=>s.style.display="none",1e4),Q=0,At(0),dn("login")}}catch(a){B(!1),at("Kayıt Hatası: "+a.message)}}async function Ma(){const e=(document.getElementById("loginEmail").value||document.getElementById("loginUser").value||"").trim(),t=document.getElementById("loginPass").value;if(!e||!t)return de("Kullanıcı adı ve şifre zorunlu");B(!0);const n=setTimeout(()=>{B(!1),de("Bağlantı zaman aşımına uğradı. Supabase yanıt vermiyor — lütfen tekrar deneyin.")},15e3);try{let a=e;a.includes("@")?a=a.toLowerCase():a=Ae(e)+"@rostrumakademi.com";const{data:i,error:o}=await b.auth.signInWithPassword({email:a,password:t});if(!o&&(i!=null&&i.user)){const{data:s,error:r}=await b.from("users").select("*").eq("id",i.user.id).maybeSingle();if(r&&console.error("Profile fetch error:",r),s){clearTimeout(n),await De(s);return}return B(!1),de("Hesabınız veritabanında aktif değil.")}try{const s=Ae(e.includes("@")?e.split("@")[0]:e),r=await Le(t),{data:d}=await b.rpc("get_user_by_credentials",{p_username:s,p_password_hash:r}),c=Array.isArray(d)?d[0]:d;if(c){clearTimeout(n),await De(c);return}}catch(s){console.warn("Fallback RPC error:",s)}return B(!1),de(o?"Giriş başarısız: "+o.message:"Kullanıcı adı veya şifre hatalı.")}catch(a){return B(!1),console.error("[doLogin]",a),de("Giriş hatası: "+a.message)}finally{clearTimeout(n)}}async function De(e){var n,a,i,o,s;B(!1);const t=e.role==="coach"||e.role==="developer"?e.id:e.role==="student"||e.role==="parent"?e.coach_id:null;x.role=e.role,x.studentId=e.role==="student"?e.id:null,x.dbUser=e,x.coachId=t,document.getElementById("loginScreen").style.display="none",document.getElementById("appShell").classList.add("visible");try{if(await ln(),(x.role==="coach"||x.role==="developer")&&!l.workspace){console.log("[Auth] Workspace not found, auto-creating from signup metadata...");const{data:{user:p}}=await b.auth.getUser();if(p){const m=((n=p.user_metadata)==null?void 0:n.ob_brand)||"Akademi",u=((a=p.user_metadata)==null?void 0:a.ob_color)||"#f0a500",f=((i=p.user_metadata)==null?void 0:i.ob_phone)||null,S=((o=p.user_metadata)==null?void 0:o.ob_examtypes)||"YKS",I=((s=p.user_metadata)==null?void 0:s.ob_studentcount)||"1-5",v={coach_id:e.id,brand_name:m,brand_color:u,phone:f,exam_types:S,student_count_range:I,onboarding_done:!1},{data:$,error:k}=await b.from("workspaces").upsert(v,{onConflict:"coach_id"}).select().maybeSingle();k?console.error("[finishLogin] Create workspace error:",k):$&&(l.workspace=$)}}if(x.role==="student"&&(l.activeStuId=e.id,x.studentId=e.id,l.students.find(p=>p.id===e.id)||l.students.push({id:e.id,name:e.full_name||e.username||"Öğrenci",target:e.target||"",color:e.color||"#4da6ff",progress:e.progress||0,weekStart:e.week_start||0,username:e.username,coachId:e.coach_id})),x.role==="parent"){const{data:p}=await b.from("users").select("*").eq("parent_id",e.id).single();p&&(l.activeStuId=p.id,x.studentId=p.id,x.childName=p.full_name||p.username)}if(window.setupShell(),document.getElementById("aiChatBubble").style.display="flex",(x.role==="coach"||x.role==="developer")&&(!l.workspace||!l.workspace.onboarding_done)){window.switchTab("home"),window.showOnboarding();return}const r=window.location.hash.substring(1),d={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[x.role]||"portal",c=r&&document.getElementById("view-"+r)?r:d;setTimeout(()=>window.switchTab(c),50)}catch(r){B(!1),console.error("[doLogin] HATA:",r),de("Hata: "+r.message),document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible")}}function Aa(){window._fcInstance&&(window._fcInstance.destroy(),window._fcInstance=null),window.destroyRealtime&&window.destroyRealtime(),b.auth.signOut().catch(()=>{}),rn(),x.role=null,x.studentId=null,x.dbUser=null,x.coachId=null,x.childName=null,l.workspace=null,document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible"),document.getElementById("aiChatBubble").style.display="none",document.getElementById("aiChatPanel").classList.remove("open"),document.getElementById("loginEmail")&&(document.getElementById("loginEmail").value=""),document.getElementById("loginUser")&&(document.getElementById("loginUser").value=""),document.getElementById("loginPass").value="",window.location.hash=""}function Da(){window.om("forgotPassModal")}async function Ca(){const e=document.getElementById("forgotEmail").value.trim();if(!e)return;const t=document.getElementById("forgotMsg");try{const n=await fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"password_reset",email:e})}),a=await n.json();if(!n.ok)throw new Error(a.error||"Sunucu hatası");t.style.display="block",t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="Sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin."}catch(n){t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Hata: "+(n.message||"Bir sorun oluştu.")}}async function La(){const e=document.getElementById("newPasswordInput").value;if(!e||e.length<8){alert("Şifre en az 8 karakter olmalıdır.");return}B(!0);try{const{error:t}=await b.auth.updateUser({password:e});if(t)throw t;const n=await Le(e),{data:{user:a}}=await b.auth.getUser();a&&await b.from("users").update({password_hash:n}).eq("id",a.id),alert("Şifreniz başarıyla güncellendi! Lütfen yeni şifrenizle giriş yapın."),window.cm("resetPasswordModal"),await b.auth.signOut(),window.location.hash="",window.location.reload()}catch(t){alert("Şifre güncellenirken hata oluştu: "+t.message)}finally{B(!1)}}window.loginErr=de;window.regErr=at;window.setAuthMode=dn;window.setLoginMode=ka;window.setRegRole=wa;window.setOnbRole=$a;window.loginWithGoogle=Ta;window.triggerRealGoogleLogin=cn;window.showGoogleSimulator=pn;window.closeGoogleSimulator=Mt;window.simOAuthLogin=Ea;window.checkOAuthSession=mn;window.completeOnboarding=_a;window.doRegister=Ba;window.doLogin=Ma;window.finishLogin=De;window.doLogout=Aa;window.showForgotPassword=Da;window.sendResetEmail=Ca;window.updateUserPassword=La;window.nextRegWizardStep=Ia;window.prevRegWizardStep=za;window.setRegBrandColor=Sa;b.auth.onAuthStateChange(async(e,t)=>{var a;if(e==="PASSWORD_RECOVERY"||window.location.hash.includes("type=recovery")){console.log("[Auth] Password recovery flow active, showing resetPasswordModal"),B(!1),window.om("resetPasswordModal");return}if(e==="SIGNED_IN"&&(t!=null&&t.user)){if((a=document.getElementById("appShell"))!=null&&a.classList.contains("visible"))return;await mn()}e==="SIGNED_OUT"&&(Se=!1,B(!1))});function an(){const e=document.getElementById("loginEmail"),t=document.getElementById("loginUser");e&&t&&(e.addEventListener("input",n=>{t.value=n.target.value}),t.addEventListener("input",n=>{e.value=n.target.value}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",an):an();if(new URLSearchParams(window.location.search).get("new_coach")==="1"){const e=sessionStorage.getItem("ra_new_coach_email"),t=sessionStorage.getItem("ra_new_coach_pass");if(e&&t){sessionStorage.removeItem("ra_new_coach_email"),sessionStorage.removeItem("ra_new_coach_pass");const n=()=>{const a=document.getElementById("loginEmail"),i=document.getElementById("loginPass");a&&i&&(a.value=e,i.value=t,setTimeout(()=>window.doLogin&&window.doLogin(),400))};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}function qe(e){if(!e||e<=0)return"0 sa";const t=Math.floor(e/60),n=e%60;return t>0&&n>0?`${t} sa ${n} dk`:t>0?`${t} sa`:`${n} dk`}window.formatMinToHours=qe;function ae(e){return new Promise(t=>{let n=document.getElementById("customConfirmModal");n||(n=document.createElement("div"),n.id="customConfirmModal",n.className="modal-bg",n.style.zIndex="999999",n.innerHTML=`
    ...
    <button class="mnav-btn" id="mntab_${p.id}" onclick="switchTab('${p.id}')">${p.lbl}<span style="font-size:9px;display:block">${p.name}</span></button>`).join(""),document.getElementById("mainContent").innerHTML=[...e,{id:"student-detail"},{id:"profile"},{id:"settings"},{id:"coach-resources"},{id:"coach-applications"},{id:"coach-notes"},{id:"coach-profile"},{id:"messages"},{id:"todolist"},{id:"program"},{id:"appointments"},{id:"exams"}].map(p=>`<div class="view" id="view-${p.id}"></div>`).join("");const t=x.dbUser,n=x.role==="student"?l.students.find(p=>p.id===x.studentId):null,a=(t==null?void 0:t.full_name)||(n==null?void 0:n.name)||"",i=a.split(" ").map(p=>p[0]).join("").slice(0,2).toUpperCase(),o={coach:"#f0a500",student:(n==null?void 0:n.color)||"#4da6ff",developer:"#c084fc",parent:"#3ecf8e"},s={coach:"KOÇ",student:"ÖĞRENCİ",developer:"DEV",parent:"VELİ"};if(document.getElementById("sbAv").textContent=i,document.getElementById("sbAv").style.background=o[x.role]||"#888",document.getElementById("sbName").textContent=a,document.getElementById("sbRole").textContent=s[x.role]||x.role,(x.role==="coach"||x.role==="developer")&&((c=l.workspace)!=null&&c.brand_name)){const p=document.querySelector(".sb-logo-text");p&&(p.textContent=l.workspace.brand_name);const m=document.querySelector(".tn-logo .sb-logo-icon");m&&(m.textContent=l.workspace.brand_name.slice(0,1).toUpperCase())}const r=document.getElementById("sb-site-admin");r&&(r.style.display=x.role==="developer"?"flex":"none");const d=document.getElementById("tnCoachProfileItem");d&&(d.style.display=x.role==="coach"||x.role==="developer"?"flex":"none"),aa(),setTimeout(Gn,600),(x.role==="coach"||x.role==="developer")&&b.from("match_requests").select("id",{count:"exact",head:!0}).eq("matched_coach_id",x.coachId).eq("status","pending").then(({count:p})=>{if(p>0){const m=document.getElementById("sbi_coach-applications");if(m&&!m.querySelector(".sb-badge")){const u=document.createElement("span");u.className="sb-badge",u.textContent=p,m.appendChild(u)}}})}function se(e,t=!0){var c,p,m;if(!e)return;currentTab=e,t&&(window.location.hash=e),document.querySelectorAll(".tn-nav-item").forEach(u=>u.classList.remove("active"));const n=document.getElementById("sbi_"+e)||document.getElementById("sb-"+e);n&&n.classList.add("active"),document.querySelectorAll(".view").forEach(u=>u.classList.remove("active"));const a=document.getElementById("view-"+e);a&&a.classList.add("active");const o=[...Et,...gn,...vn,...fn,{id:"profile",name:"Profil"},{id:"settings",name:"Ayarlar"},{id:"student-detail",name:((c=l.students.find(u=>u.id===l.activeStuId))==null?void 0:c.name)||"Öğrenci"},{id:"program",name:"Program"},{id:"appointments",name:"Randevular"},{id:"exams",name:"Denemeler"}].find(u=>u.id===e),s=document.getElementById("tbarTitle");s&&(s.textContent=(o==null?void 0:o.name)||e);const r={home:xn,students:Je,messages:Nn,"coach-applications":Xt,"coach-notes":pa,todolist:An,portal:ft,sportal:_e,sexams:Nt,smessages:_t,suyelik:Vo,sprofil:Zn,profile:wn,settings:$n,"student-detail":()=>{l.activeStuId?bn(l.activeStuId):se("students")},program:()=>{l.activeStuId?Ct(l.activeStuId):se("students")},exams:()=>{l.activeStuId?Ne():se("students")},appointments:()=>{l.activeStuId?Xe():se("students")},"dev-dashboard":Fn,"dev-users":Qe,"dev-resources":et,"dev-finance":yt,"dev-announce":tt,"dev-tickets":Ke,"parent-home":sa,"parent-progress":ra,"parent-messages":_t,"parent-ai":la,"coach-profile":Jn,"dev-matches":Gt,"coach-resources":nt};try{(p=r[e])==null||p.call(r)}catch(u){console.error("[switchTab] Render error for tab:",e,u),a&&(a.innerHTML=`<div style="padding:24px;color:var(--text)"><b>Hata Oluştu ⚠️</b><p style="color:var(--text-mid);margin-top:6px">${g(u.message)}</p><pre style="font-size:10px;color:var(--text-dim);white-space:pre-wrap;margin-top:8px">${g((u.stack||"").slice(0,400))}</pre></div>`)}e==="messages"||e==="smessages"?Ot():Ft();const d=document.getElementById("aiChatBubble");d&&(e==="dev-tickets"||e.startsWith("dev-")||e==="messages"||e==="smessages"?(d.style.display="none",(m=document.getElementById("aiChatPanel"))==null||m.classList.remove("open")):(x.role==="student"||x.role==="coach"||x.role==="parent")&&(d.style.display="flex"))}function xn(){var t,n;const e=document.getElementById("view-home");if(e)try{const a=new Date,i=["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],o=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],s=K(a);let r=0;Object.values(l.messages).forEach(T=>{r+=T.filter(M=>M.from==="student"&&!M.read).length});const d=l.appointments.filter(T=>T.date===s).sort((T,M)=>T.time.localeCompare(M.time)),c=[],p=ee(0,0);(l.students||[]).forEach(T=>{let M=0,_=0;for(let A=0;A<7;A++){const L=K(V(p,A)),P=l.tasks[`${T.id}_${L}`]||[];M+=P.length,_+=P.filter(q=>q.done).length}const D=M>0?Math.round(_/M*100):0;M>0&&D<30&&c.push({studentId:T.id,studentName:T.name,color:T.color,type:"tasks",icon:"📋",title:"Düşük Görev",desc:`Bu haftaki görev tamamlama oranı <b>%${D}</b>'de kaldı (${_}/${M} görev tamamlandı).`});const C=(l.exams||[]).filter(A=>A.studentId===T.id).sort((A,L)=>new Date(L.date).getTime()-new Date(A.date).getTime()),j={};if(C.forEach(A=>{j[A.type]||(j[A.type]=[]),j[A.type].push(A)}),Object.entries(j).forEach(([A,L])=>{if(L.length>=2){const P=L[0],q=L[1],Y=Object.values(P.nets||{}).reduce((J,X)=>J+Number(X||0),0),G=Object.values(q.nets||{}).reduce((J,X)=>J+Number(X||0),0),te=Y-G;te<-5&&c.push({studentId:T.id,studentName:T.name,color:T.color,type:"exams",icon:"📉",title:`Net Düşüşü (${A})`,desc:`Son denemede <b>${Y} net</b> yaptı. Önceki denemesine (${G} net) göre <b>${Math.abs(te).toFixed(1)} net düşüş</b>.`})}}),M===0&&c.push({studentId:T.id,studentName:T.name,color:T.color,type:"noplan",icon:"📭",title:"Program Yok",desc:"Bu hafta için henüz hiç görev eklenmemiş."}),M>0&&_===0){let A=!1;for(let L=0;L<3;L++){const P=K(V(a,-L));if((l.tasks[`${T.id}_${P}`]||[]).length>0){A=!0;break}}A&&c.push({studentId:T.id,studentName:T.name,color:T.color,type:"inactive",icon:"💤",title:"3 Gündür Pasif",desc:"Son 3 gündür hiçbir görev tamamlanmadı. İletişime geç!"})}M>0&&_===M&&c.push({studentId:T.id,studentName:T.name,color:T.color,type:"perfect",icon:"🏆",title:"Harika Hafta!",desc:`Bu haftaki tüm ${M} görevi tamamladı! Tebrik et.`}),(l.studentSpeeds||[]).filter(A=>A.student_id===T.id).forEach(A=>{let L=120;A.exam_type==="TYT"?["Türkçe","Sosyal"].includes(A.subject)?L=100:["Matematik","Fen"].includes(A.subject)&&(L=130):A.exam_type&&A.exam_type.startsWith("AYT")&&(L=180),A.secs_per_question>L&&c.push({studentId:T.id,studentName:T.name,color:T.color,type:"speed",icon:"⚡",title:`Hız Aşımı (${A.exam_type} - ${A.subject})`,desc:`Soru çözüm hızı <b>${A.secs_per_question} sn/soru</b> (Limit: ${L} sn).`})})});let m="";if(c.length===0)m=`
      <div style="text-align:center;padding:16px;color:var(--text-dim);font-size:13px">
      ...
      </div>`;else{const T={perfect:{badge:"#3ecf8e",badgeBg:"rgba(62,207,142,.12)",border:"rgba(62,207,142,.25)"},noplan:{badge:"#f0a500",badgeBg:"rgba(240,165,0,.1)",border:"rgba(240,165,0,.2)"},inactive:{badge:"#ff5c7a",badgeBg:"rgba(255,92,122,.08)",border:"rgba(255,92,122,.2)"},tasks:{badge:"#ff5c7a",badgeBg:"rgba(255,92,122,.08)",border:"rgba(255,92,122,.2)"},exams:{badge:"#ff5c7a",badgeBg:"rgba(255,92,122,.08)",border:"rgba(255,92,122,.2)"},speed:{badge:"#f0a500",badgeBg:"rgba(240,165,0,.1)",border:"rgba(240,165,0,.2)"}};m=c.map(M=>{const _=T[M.type]||T.tasks;return`<div style="cursor:pointer;padding:10px 12px;margin-bottom:8px;border-radius:8px;background:${_.badgeBg};border:1px solid ${_.border};display:flex;align-items:center;gap:10px;transition:opacity .15s" onclick="openStudentDetail('${M.studentId}')" onmouseover="this.style.opacity='.85'" onmouseout="this.style.opacity='1'">
        ...
        <div style="flex:1;min-width:0">
          <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:2px">
            ...
            <span style="font-size:10px;font-weight:700;color:${_.badge};white-space:nowrap">${M.title}</span>
          </div>
          <div style="font-size:11px;color:var(--text-mid);line-height:1.4">${M.desc}</div>
        </div>
      </div>`}).join("")}const u=a.getHours(),f=u<6?"İyi geceler":u<12?"Günaydın":u<18?"İyi günler":"İyi akşamlar",S=`${String(u).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`,I=d.find(T=>T.time>=S),v=new Date(2026,5,14),$=Math.max(0,Math.ceil((v-a)/(1e3*60*60*24))),k=ee(0,0);let E=0,y=0;l.students.forEach(T=>{for(let M=0;M<7;M++){const _=l.tasks[`${T.id}_${K(V(k,M))}`]||[];E+=_.length,y+=_.filter(D=>D.done).length}});const z=E>0?Math.round(y/E*100):0;e.innerHTML=`
    <!-- HERO -->
    <div class="home-hero">
    ...
    <div class="home-bottom-grid">
      ...
      <div class="home-section-card">
        ...
        <div class="hsc-body">
          ...
          ${d.map(T=>{const M=l.students.find(G=>G.id===T.studentId),_=T.time<S,[D,C]=T.time.split(":").map(Number),j=D*60+C,[w,A]=S.split(":").map(Number),L=w*60+A,P=j-L,q=P>=-(T.duration||60)&&P<=15,Y=q&&T.meet_link?`<a href="${g(T.meet_link)}" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;background:${P<=0?"var(--red)":"var(--accent)"};color:${P<=0?"white":"#0f0e0c"};font-size:11px;font-weight:800;text-decoration:none;animation:${P<=0?"pulse 1.5s infinite":"none"};white-space:nowrap;flex-shrink:0">${P<=0?"🔴 Ders Sürüyor":"🟡 Derse Gir"}</a>`:"";return`<div class="hsc-appt-row ${_&&!q?"hsc-appt-past":""}">
              ...
              <div style="flex:1;min-width:0">
                ...
                <div class="hsc-appt-meta">${g(T.type)} · ${T.duration} dk${!q&&T.meet_link?` · <a href="${g(T.meet_link)}" target="_blank" style="color:var(--blue);text-decoration:none">${T.meet_link.includes("zoom")?"Zoom":"Meet"} →</a>`:""}</div>
              </div>
              ${Y||(_?'<span class="hsc-appt-done">✓</span>':"")}
            </div>`}).join("")}
        </div>
      </div>
    </div>
    ...
    <div style="display:flex;gap:8px;max-width:900px;margin:0 auto 4px;justify-content:center">
      ${[{tab:"messages",icon:"💬",label:"Mesajlar",sub:r>0?r+" okunmamış":"Temiz"},{tab:"coach-notes",icon:"📝",label:"Notlarım",sub:"Kişisel notlar"},{tab:"todolist",icon:"📅",label:"Ajanda",sub:"Tüm randevular"},{tab:"coach-applications",icon:"📩",label:"Başvurular",sub:"Eşleşme talepleri"}].map(({tab:T,icon:M,label:_,sub:D})=>`
    ...
    <div id="stuSearchResults" style="display:flex;flex-direction:column;gap:8px">
      ...
      `:l.students.map(s=>{const r=n[s.id]||{total:0,done:0},d=r.total>0?Math.round(r.done/r.total*100):0,c=d>=80?"var(--green)":d>=40?"var(--accent)":"var(--red)",p=r.total>0&&r.done===r.total,m=l.exams.filter(f=>f.studentId===s.id).sort((f,S)=>S.date.localeCompare(f.date))[0],u=m?Object.values(m.nets||{}).reduce((f,S)=>f+S,0).toFixed(1):null;return`<div class="stu-row" id="sturow_${s.id}" onclick="openStudentDetail('${s.id}')" style="padding:12px 16px;align-items:center;gap:12px;border-radius:10px">
    ...
    <div class="card" style="margin-top:16px; border: 1px dashed var(--accent); padding: 18px; border-radius: 14px; background: var(--surface)">
      ...
      <div id="aiCopilotResultArea" style="display:none; margin-top:12px">
    ...
    </div>`,currentTab!=="student-detail"&&se("student-detail");const c=document.getElementById("tbarTitle");c&&(c.textContent=t.name)}const je=[{stars:0,label:"Başlanmadı",color:"#6b7280",bg:"rgba(107,114,128,.08)",border:"rgba(107,114,128,.2)"},{stars:1,label:"Anlamadım",color:"#ef4444",bg:"rgba(239,68,68,.08)",border:"rgba(239,68,68,.2)"},{stars:2,label:"Temel Zorluk",color:"#f97316",bg:"rgba(249,115,22,.08)",border:"rgba(249,115,22,.2)"},{stars:3,label:"Temel OK",color:"#eab308",bg:"rgba(234,179,8,.08)",border:"rgba(234,179,8,.2)"},{stars:4,label:"Orta Seviye",color:"#84cc16",bg:"rgba(132,204,22,.08)",border:"rgba(132,204,22,.2)"},{stars:5,label:"İleri Seviye",color:"#22c55e",bg:"rgba(34,197,94,.08)",border:"rgba(34,197,94,.2)"},{stars:6,label:"Uzman",color:"#10b981",bg:"rgba(16,185,129,.08)",border:"rgba(16,185,129,.2)"},{stars:7,label:"Tekrar Dışı (TD)",color:"#3b82f6",bg:"rgba(59,130,246,.1)",border:"rgba(59,130,246,.3)"}];function hn(e){const t=new Date(e),n=t.getDate(),a=n<=10?1:n<=20?11:21;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function Ya(e=6){const t=[],n=new Date;let a=new Date(n);for(let i=0;i<e;i++){const o=hn(a);t.find(c=>c.start===o)||t.unshift({start:o,label:Na(o)});const[s,r,d]=o.split("-").map(Number);if(d===21?a=new Date(s,r-1,11):d===11?a=new Date(s,r-1,1):a=new Date(s,r-2,21),t.length>=e)break}return t.slice(-e)}function Na(e){const[t,n,a]=e.split("-").map(Number),i=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],o=a===1?10:a===11?20:new Date(t,n,0).getDate();return`${a}-${o} ${i[n-1]}`}const on={SAY:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","TYT Fizik","AYT Fizik","TYT Kimya","AYT Kimya","TYT Biyoloji","AYT Biyoloji"],EA:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],SOZ:["Dil Bilgisi","TYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],DIL:["Dil Bilgisi","TYT Matematik","Geometri","YDT İngilizce"]};async function Ka(e){const t=l.students.find(v=>v.id===e);if(!t)return;const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${g(t.name)}</button><div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`;const a=x.role==="coach"||x.role==="developer",i=t.yksArea||"SAY",o=on[i]||on.SAY;let s=o[0],r="mastery";function d(v,$){var k,E;return((E=(k=l.konuMastery[e])==null?void 0:k[v])==null?void 0:E[$])||null}function c(v,$){var k,E;return((E=(k=l.konuTekrarLog[e])==null?void 0:k[v])==null?void 0:E[$])||{}}async function p(v,$,k,E){const y=d(v,$),z=new Date().toISOString(),T=E||(k>=7?"td":k>0?"active":"not_started"),M={student_id:e,coach_id:x.coachId,subject:v,konu:$,stars:k,status:T,updated_at:z,...T==="active"&&!(y!=null&&y.ka_date)?{ka_date:z}:{},...T==="td"&&!(y!=null&&y.td_date)?{td_date:z}:{},...T==="active"&&(y==null?void 0:y.status)==="td"?{td_date:null}:{}},{data:_,error:D}=await b.from("konu_mastery").upsert(M,{onConflict:"student_id,subject,konu"}).select().single();if(D){h("Hata: "+D.message);return}return l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][v]||(l.konuMastery[e][v]={}),l.konuMastery[e][v][$]=_,_}async function m(v,$,k,E){const y=new Date().toISOString(),z={student_id:e,coach_id:x.coachId,subject:v,konu:$,period_start:k,review_count:E,updated_at:y},{data:T,error:M}=await b.from("konu_tekrar_log").upsert(z,{onConflict:"student_id,subject,konu,period_start"}).select().single();if(M){h("Hata: "+M.message);return}return l.konuTekrarLog[e]||(l.konuTekrarLog[e]={}),l.konuTekrarLog[e][v]||(l.konuTekrarLog[e][v]={}),l.konuTekrarLog[e][v][$]||(l.konuTekrarLog[e][v][$]={}),l.konuTekrarLog[e][v][$][k]=T,T}function u(v){const $=Ge[v]||[],k=$.map((_,D)=>{const C=d(v,_),j=(C==null?void 0:C.stars)||0,w=(C==null?void 0:C.status)||"not_started",A=je[j],L=w==="td",P=D%2===0?"var(--surface)":"var(--surface2)",q=c(v,_),Y=Object.values(q).reduce((Z,R)=>Z+(R.review_count||0),0),G=C!=null&&C.last_review_date?new Date(C.last_review_date).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"}):"—",te=a?Array.from({length:7},(Z,R)=>{const H=R+1,N=H<=j,ie=v.replace(/'/g,"\\'"),ve=_.replace(/'/g,"\\'");return`<span class="km-star${N?" km-star-on":""}" data-stars="${H}" 
          onclick="window._kmSetStars('${ie}','${ve}',${H})"
          title="${je[H].label}"
        ...
        <td style="padding:8px 10px;text-align:center;font-size:11px;color:var(--text-dim);white-space:nowrap">${G}</td>
        ${a?`<td style="padding:8px 8px;text-align:center;white-space:nowrap">
          <button onclick="window._kmToggleKA('${v.replace(/'/g,"\\'")}','${_.replace(/'/g,"\\'")}')" 
          ...
          <button onclick="window._kmToggleTD('${v.replace(/'/g,"\\'")}','${_.replace(/'/g,"\\'")}')" 
      ...
      </tr>`}).join(""),E=$.map(_=>d(v,_)),y=Array(8).fill(0);E.forEach(_=>y[(_==null?void 0:_.stars)||0]++);const z=E.filter(_=>(_==null?void 0:_.status)==="td").length,T=E.filter(_=>(_==null?void 0:_.status)==="active").length;return`<div style="display:flex;gap:12px;flex-wrap:wrap;padding:12px 16px;background:var(--surface2);border-bottom:1px solid var(--border);align-items:center">
    ...
    </div>`}function f(v){const $=Ge[v]||[],k=Ya(6),E=hn(new Date),y=`<tr style="background:var(--surface2)">
      <th style="padding:8px 14px;text-align:left;font-size:10px;font-weight:800;color:var(--text-dim);border-right:1px solid var(--border);position:sticky;left:0;z-index:2;background:var(--surface2);white-space:nowrap;min-width:200px">KONU</th>
    ...
    </tr>`,z=$.map((T,M)=>{const _=d(v,T),D=(_==null?void 0:_.stars)||0,j=((_==null?void 0:_.status)||"not_started")==="td",w=je[D],A=M%2===0?"var(--surface)":"var(--surface2)",L=c(v,T);let P=0;const q=k.map(G=>{const te=L[G.start],J=(te==null?void 0:te.review_count)||0;P+=J;const X=G.start===E;if(a){const Z=Array.from({length:6},(R,H)=>{const N=H<J,ie=v.replace(/'/g,"\\'"),ve=T.replace(/'/g,"\\'");return`<span class="kt-box${N?" kt-box-on":""}"
              onclick="window._ktToggleBox('${ie}','${ve}','${G.start}',${H+1})"
    ...
    ${c}`}function Ga(e){document.getElementById("sbModalTitle").textContent="Kaynak Ekle",document.getElementById("sbId").value="",document.getElementById("sbStuId").value=e,document.getElementById("sbName").value="",document.getElementById("sbTotal").value="0",document.getElementById("sbCompleted").value="0",document.getElementById("sbPctPreview").innerHTML="",O("sbModal")}function Ua(e,t){const n=(ge[e]||[]).find(a=>a.id===t);n&&(document.getElementById("sbModalTitle").textContent="Kaynağı Düzenle",document.getElementById("sbId").value=t,document.getElementById("sbStuId").value=e,document.getElementById("sbName").value=n.name,document.getElementById("sbTotal").value=n.total_tests,document.getElementById("sbCompleted").value=n.completed_tests,kn(),O("sbModal"))}function kn(){var o,s;const e=parseInt((o=document.getElementById("sbTotal"))==null?void 0:o.value)||0,t=parseInt((s=document.getElementById("sbCompleted"))==null?void 0:s.value)||0,n=document.getElementById("sbPctPreview");if(!n||!e){n&&(n.innerHTML="");return}const a=Math.min(100,Math.round(t/e*100)),i=a>=75?"var(--green)":a>=40?"var(--accent)":"var(--red)";n.innerHTML=`<div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;height:8px;background:var(--surface3);border-radius:99px;overflow:hidden">
    ...
    <div style="max-width:500px;margin:0 auto">
      <div class="settings-block">
        ...
        <div class="setting-item">
          ...
          <div class="accent-palette">
            ${ea.map(a=>`<div class="ac-dot" onclick="applyAccent('${a.val}','${a.dim}')" style="background:${a.val}" title="${a.name}"></div>`).join("")}
          </div>
        </div>
      </div>
    ...
    </div>`}function Ja(){const e=document.getElementById("geminiApiKeyInput").value.trim();e?(localStorage.setItem("gemini_api_key",e),h("API Anahtarı kaydedildi ✓")):(localStorage.removeItem("gemini_api_key"),h("API Anahtarı kaldırıldı."))}let ze="";function W(){const e=document.getElementById("view-program"),t=l.students.find(d=>d.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=ee(l.weekOffset,n),i=V(a,6),o=be(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let d=0;d<7;d++){const c=V(a,d),p=K(c),m=p===o,u=`${l.activeStuId}_${p}`,f=l.tasks[u]||[],S=f.reduce((y,z)=>y+Number(z.duration),0),I=f.reduce((y,z)=>y+(z.done?Number(z.duration):0),0),v=DAYS_TR[(n+d)%7],$=[...f];s==="hourly"&&$.sort((y,z)=>y.start_time&&!z.start_time?-1:!y.start_time&&z.start_time?1:y.start_time&&z.start_time?y.start_time.localeCompare(z.start_time):0);const k=$.map(y=>{const z=f.indexOf(y),T=y.start_time?`<div class="tc-time-badge">🕒 ${y.start_time}</div>`:"";return`
      ...
      <div class="day-hd">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px">
          <span class="day-badge" style="font-size:8.5px">${qe(I)} / ${qe(S)}</span>
    ...
    <div class="week-grid">${r}</div>`}function Xa(e){l.activeStuId=e||null,Ve(),W()}function Qa(e){l.weekOffset+=e,Ve(),W()}function ei(){l.weekOffset=0,Ve(),W()}function ti(e){localStorage.setItem("ra_program_mode",e),x.role==="student"?_e():W()}window.setProgramMode=ti;(()=>{const e=document.createElement("style");e.textContent=`
    .tc-time-badge {
      font-size: 11px;
      font-weight: 800;
      color: var(--accent);
  ...
  `,document.head.appendChild(e)})();let re=[];function ni(){if(!l.activeStuId)return h("Önce öğrenci seçin");const e=l.students.find(i=>i.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=ee(l.weekOffset,t);re=[];let a="";for(let i=0;i<7;i++){const o=V(n,i),s=K(o);DAYS_TR[(t+i)%7];const r=(l.tasks[`${l.activeStuId}_${s}`]||[]).length>0,d=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(t+i)%7];a+=`<button class="day-sel-btn" id="dsbtn_${i}" data-ds="${s}" onclick="toggleDaySel(${i},'${s}')">
    ...
    </span>`).join(""))}function pi(e,t){if(!l.activeStuId)return h("Önce öğrenci seçin");ze=e,_editingTaskId=null,U=null,document.querySelector("#taskModal h2").innerHTML=`Görev Ekle — <span id="tmDay">${t}</span>`,document.querySelector("#taskModal .btn-accent").textContent="Programa Ekle",document.getElementById("tmSubjectFree").value="",document.getElementById("tmDuration").value="60",document.getElementById("tmStartTime").value="",document.getElementById("tmNote").value="",document.getElementById("tmExam").value="",document.getElementById("tmType").value="deneme",document.getElementById("tmSubjectSel").style.display="none",document.getElementById("tmSubjectFree").style.display="",document.getElementById("soruBankasiWrap").style.display="none",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookVal").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none";const n=document.getElementById("tmTestSummary");n&&(n.style.display="none");const a=document.getElementById("tmNewResourceToggle");a&&(a.checked=!1,Tn(!1)),document.getElementById("tmManualKaynak").value="",document.getElementById("tmManualTestInput").value="",document.getElementById("tmManualTestChips").innerHTML="",ue=[],Sn(),O("taskModal")}let oe={},He=!1;async function _n(){if(He)return;const{data:e}=await b.from("resources").select("*").eq("active",!0).order("name");e&&(e.forEach(t=>{let n=[t.subject];t.subject==="Tarih"?n.push("Tarih1","Tarih2"):t.subject==="Coğrafya"?n.push("Coğrafya1","Coğrafya2"):(t.subject==="Din Kültürü"||t.subject==="Din")&&(n=["Din","Din Kültürü"]),n.forEach(a=>{const i=`${t.exam_type}_${a}`;oe[i]||(oe[i]=[]),oe[i].push({name:t.name,yil:t.year,testler:Array.isArray(t.tests)?t.tests:[],publisher:t.publisher})})}),He=!0)}let Oe=[],U=null;function jt(){const e=document.getElementById("tmExam").value,t=document.getElementById("tmType").value,n=document.getElementById("tmSubjectSel"),a=document.getElementById("tmSubjectFree");U=null,document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").innerHTML="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none";const i=document.getElementById("tmTestSummary");i&&(i.style.display="none"),e&&SUBJECT_MAP[e]?(n.innerHTML=SUBJECT_MAP[e].map(r=>`<option value="${r}">${r}</option>`).join(""),n.style.display="",a.style.display="none"):(n.style.display="none",a.style.display="");const o=(t==="soru"||t==="konu")&&e;document.getElementById("soruBankasiWrap").style.display=o?"":"none";const s=document.getElementById("tmBookSearch");s&&(s.placeholder=t==="konu"?"Hoca veya playlist ara...":"Kitap veya yayınevi ara..."),He=!1,oe={},o&&gt("")}function mi(){U=null,document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none";const e=document.getElementById("tmType").value,t=document.getElementById("tmExam").value;He=!1,oe={},(e==="soru"||e==="konu")&&t&&gt("")}document.getElementById("tmType").addEventListener("change",jt);async function gt(e){const t=document.getElementById("tmExam").value,n=document.getElementById("tmSubjectSel").value||"",a=document.getElementById("tmType").value,i=document.getElementById("tmBookList"),o=a==="konu"?"playlist":"book";if(!He){i.style.display="block",i.innerHTML='<div style="padding:12px;font-size:12px;color:var(--text-dim);text-align:center">⏳ Yükleniyor...</div>';const{data:c}=await b.from("resources").select("*").eq("active",!0).eq("resource_type",o).order("name");oe={},c&&c.forEach(p=>{let m=[p.subject];p.subject==="Tarih"?m.push("Tarih1","Tarih2"):p.subject==="Coğrafya"?m.push("Coğrafya1","Coğrafya2"):(p.subject==="Din Kültürü"||p.subject==="Din")&&(m=["Din","Din Kültürü"]),m.forEach(u=>{const f=`${p.exam_type}_${u}`;oe[f]||(oe[f]=[]),oe[f].push({name:p.name,yil:p.year,testler:Array.isArray(p.tests)?p.tests:[],publisher:p.publisher,resource_type:p.resource_type||"book"})})}),He=!0}const s=`${t}_${n}`,r=oe[s]||[],d=e.toLowerCase();if(Oe=r.filter(c=>{var p;return!d||c.name.toLowerCase().includes(d)||((p=c.publisher)==null?void 0:p.toLowerCase().includes(d))}),!e&&!Oe.length){i.style.display="none";return}if(!Oe.length){i.style.display="block",i.innerHTML='<div style="padding:12px;font-size:12px;color:var(--text-dim);text-align:center">Kaynak bulunamadı</div>';return}i.style.display="block",i.innerHTML=Oe.map((c,p)=>`
    ...
    </div>`).join("")}function ui(){const e=document.getElementById("tmBookSearch").value;if(e.length===0){document.getElementById("tmBookList").style.display="none";return}gt(e)}function gi(e){U=Oe[e],document.getElementById("tmBookVal").value=U.name,document.getElementById("tmBookSearch").value=U.name,document.getElementById("tmBookList").style.display="none",Pt(),document.getElementById("tmTestWrap").style.display=""}function Pt(){if(!U)return;const e=document.getElementById("tmTestList"),t=U.resource_type==="playlist",n=U.name||"";e.innerHTML=U.testler.map((a,i)=>{const o=a.label||a,s=o.trim()===""||o.trim()===n.trim()?`Ders ${i+1}`:o,r=a.soru||0,d=a.url||"";a.topic;const c=ca(o),p=c==="done"?"ti-status-done":c==="pending"?"ti-status-pending":"",m=c==="done"?'<span class="ti-badge ti-badge-done">✓ Tamamlandı</span>':c==="pending"?'<span class="ti-badge ti-badge-pending">⏳ Atandı</span>':"";return t?`<label class="${p}" style="display:flex;align-items:center;gap:8px;padding:8px 10px;cursor:pointer;transition:background .1s;border-bottom:1px solid var(--border)"
        onmouseover="this.style.background='var(--surface3)'" onmouseout="this.style.background=''">
...
`)],{type:"text/calendar;charset=utf-8"}),a=URL.createObjectURL(n),i=document.createElement("a");i.href=a,i.download="rostrum-ajanda.ics",i.click(),URL.revokeObjectURL(a),h("Ajanda indirildi ✓")}function Mn(e,t){t.stopPropagation();const n=document.getElementById("apptDetailPopup");if(n){const f=n.dataset.id;if(n.remove(),f===e)return}const a=l.appointments.find(f=>f.id===e);if(!a)return;const i=l.students.find(f=>f.id===a.studentId),o=Bn(a.type),s=document.createElement("div");s.id="apptDetailPopup",s.dataset.id=e;const r=window.innerWidth,d=window.innerHeight,c=264;let p=Math.min(t.clientX+12,r-c-12),m=Math.min(t.clientY+12,d-220);s.style.cssText=`position:fixed;left:${p}px;top:${m}px;z-index:600;width:${c}px;background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:14px 16px;box-shadow:0 8px 32px rgba(0,0,0,.18);animation:viewIn .15s ease`;const u=a.meetLink||a.meet_link;s.innerHTML=`
    ...
    <div style="display:flex;gap:6px;flex-wrap:wrap">
      ...
      <a href="${_i(a)}" target="_blank" style="font-size:11px;font-weight:700;color:var(--green);background:var(--green-dim);padding:4px 10px;border-radius:99px;text-decoration:none">📅 GCal</a>
    ...
    </div>`,document.body.appendChild(s),setTimeout(()=>{document.addEventListener("click",function f(S){s.contains(S.target)||(s.remove(),document.removeEventListener("click",f))})},50)}async function Ai(e,t){e.preventDefault();const n=window._draggingApptId;if(!n)return;window._draggingApptId=null;const a=e.currentTarget,i=a.getBoundingClientRect(),o=a.closest("[data-tl-scroll]"),s=o?o.scrollTop:0,d=(e.clientY-i.top+s)/Ei*60+sn*60,c=Math.max(sn,Math.min(Ti-1,Math.floor(d/60))),p=Math.round(d%60/15)*15,m=p>=60?0:p,u=`${String(c).padStart(2,"0")}:${String(m).padStart(2,"0")}`,{error:f}=await b.from("appointments").update({date:t,time:u}).eq("id",n);if(f){h("Hata: "+f.message);return}const S=l.appointments.find(I=>I.id===n);S&&(S.date=t,S.time=u),he(),h("Randevu taşındı ✓")}function An(){he()}function he(){const e=document.getElementById("view-todolist");if(!e)return;if(!document.getElementById("fc-styles")){const r=document.createElement("style");r.id="fc-styles",r.textContent=`
      .fc {
...
Şifre: ${t}`;navigator.clipboard.writeText(a).then(()=>h("Kopyalandı ✓")).catch(()=>{const i=document.createElement("textarea");i.value=a,document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove(),h("Kopyalandı ✓")})}async function Hi(e){var a;if(!await ae("Bu öğrenciyi silmek istediğinizden emin misiniz?"))return;const t=document.getElementById(`sturow_${e}`);t&&(t.style.transition="all 0.3s ease",t.style.opacity="0",t.style.transform="translateX(30px)",t.innerHTML='<div style="color:var(--red); font-weight:700; font-size:13px; display:flex; align-items:center; gap:6px">🗑️ Siliniyor...</div>'),await new Promise(i=>setTimeout(i,300));const{error:n}=await b.from("users").delete().eq("id",e);if(n)return h("Hata: "+n.message);l.students=l.students.filter(i=>i.id!==e),l.activeStuId===e&&(l.activeStuId=((a=l.students[0])==null?void 0:a.id)||null),xe(),Cn(),h("Silindi")}function Xe(){var t;const e=document.getElementById("view-appointments");e.innerHTML=`
    ...
    <div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;padding:12px;text-align:center">
  ...
  </div>`,S=o.map(R=>{var en;const H=Number(((en=a.nets)==null?void 0:en[R])||0),N=(EXAM_SORU[a.type]||{})[R]||40,ie=Math.min(100,Math.max(0,H/N*100)),ve=H>=N*.6?"#3ecf8e":H>=N*.35?"#f0a500":"#ef4444";return`<div style="margin-bottom:11px">
      ...
      <div style="background:rgba(255,255,255,0.07);border-radius:4px;height:7px;overflow:hidden">
        <div style="width:${ie.toFixed(1)}%;height:100%;background:${ve};border-radius:4px"></div>
      </div>
    ...
    ${S}
  </div>`;const I=n.map(R=>(EXAM_DEFS[R.type]||[]).reduce((N,ie)=>{var ve;return N+Number(((ve=R.nets)==null?void 0:ve[ie])||0)},0)),v=Math.max(...I,10),$=600,k=160,E=40,y=16,z=28,T=30,M=$-E-y,_=k-z-T,D=n.length,C=R=>E+(D<=1?M/2:R/(D-1)*M),j=R=>z+_-R/v*_,w=v/4,A=w<=10?10:w<=20?20:w<=25?25:50,L=[];for(let R=0;R<=v+A;R+=A)R<=v*1.12&&L.push(R);const P=L.map(R=>{const H=j(R).toFixed(1);return`<line x1="${E}" y1="${H}" x2="${$-y}" y2="${H}" stroke="rgba(255,255,255,0.05)" stroke-width="1"/><text x="${E-5}" y="${(j(R)+3.5).toFixed(1)}" text-anchor="end" font-size="9" fill="rgba(200,215,230,0.28)" font-family="system-ui,sans-serif">${R}</text>`}).join(""),q=n.map((R,H)=>`${C(H).toFixed(1)},${j(I[H]).toFixed(1)}`).join(" "),Y=`M ${C(0).toFixed(1)},${j(I[0]).toFixed(1)} `+n.slice(1).map((R,H)=>`L ${C(H+1).toFixed(1)},${j(I[H+1]).toFixed(1)}`).join(" ")+` L ${C(D-1).toFixed(1)},${(z+_).toFixed(1)} L ${C(0).toFixed(1)},${(z+_).toFixed(1)} Z`,G="ag"+Math.random().toString(36).slice(2,7),te=n.map((R,H)=>{const N=C(H).toFixed(1),ie=j(I[H]).toFixed(1);return`<circle cx="${N}" cy="${ie}" r="5" fill="${s}" stroke="#0d0d0f" stroke-width="2.5"/><text x="${N}" y="${(j(I[H])-10).toFixed(1)}" text-anchor="middle" font-size="9.5" font-weight="700" fill="${s}" font-family="system-ui,sans-serif">${I[H].toFixed(0)}</text>`}).join(""),J=n.map((R,H)=>{let N=R.name.replace(/Deneme\s+/,"#").replace(/^(TYT|AYT-SAY|AYT-EA|AYT-SOZ)\s+/,"");return N.length>7&&(N=N.slice(0,6)+"…"),`<text x="${C(H).toFixed(1)}" y="${(k-T+14).toFixed(1)}" text-anchor="middle" font-size="9" fill="rgba(200,215,230,0.35)" font-family="system-ui,sans-serif">${g(N)}</text>`}).join(""),X=`<svg viewBox="0 0 ${$} ${k}" style="width:100%;height:auto;display:block" xmlns="http://www.w3.org/2000/svg">
  ...
  ${P}
  <path d="${Y}" fill="url(#${G})"/>
  <polyline points="${q}" fill="none" stroke="${s}" stroke-width="2.5" stroke-linejoin="round" stroke-linecap="round"/>
  ${te}${J}
    ...
    ${o}`}window._krRenderBody=Yn;function Wi(e){Hn=e;const t=l.exams.find(n=>n.studentId===e&&n.examDetails&&Object.keys(n.examDetails).length);Ie=(t==null?void 0:t.type)||"TYT",Yn(),O("konuRaporuModal")}window.openKonuRaporu=Wi;function Vi(e){const t=l.exams.find(n=>n.id===e);document.getElementById("cmExamId").value=e,document.getElementById("cmText").value=(t==null?void 0:t.coachComment)||"",O("commentModal")}async function Zi(){const e=document.getElementById("cmExamId").value,t=document.getElementById("cmText").value.trim();await b.from("exams").update({coach_comment:t}).eq("id",e);const n=l.exams.find(a=>a.id===e);n&&(n.coachComment=t),F("commentModal"),Ne(),h("Yorum kaydedildi ✓")}async function Ji(e){await ae("Bu denemeyi silmek istediğinizden emin misiniz?")&&(await b.from("exams").delete().eq("id",e),l.exams=l.exams.filter(t=>t.id!==e),Ne(),h("Silindi"))}function Nn(){const e=document.getElementById("view-messages");e.innerHTML=`<div class="sh" style="margin-bottom:14px"><h2>Mesajlar</h2></div>
  ...
  <div class="msg-input-area">
    ...
    <div class="card cp" style="border-color:rgba(239,68,68,.3)">
      ...
      ${c.slice(0,5).map(f=>{const S=je[f.stars];return f.daysSince<999&&`${f.daysSince}`,`<div style="display:flex;align-items:center;gap:10px;padding:7px 0;border-bottom:1px solid var(--border)">
          <span style="font-size:13px;color:${S.color};font-weight:800;white-space:nowrap">${"⭐".repeat(f.stars)||"○"}</span>
          <div style="flex:1;min-width:0">
        ...
        ${i.length?`
          ${i.map((f,S)=>`
            <div data-task-id="${f._id}" class="task-card task-${f.type} ${f.done?"done":""}" style="margin-bottom:6px">
              <div class="tc-check ${f.done?"on":""}" onclick="stuToggleTask('${n}',${S})"></div>
              <div class="tc-body">
    ...
    </div>`}async function eo(e,t){var s;const n=l.students.find(r=>r.id===x.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(s=l.tasks[a])==null?void 0:s[t];if(!i)return;const o=!i.done;await b.from("tasks").update({done:o}).eq("id",i._id),i.done=o,ft()}function _e(){const e=l.students.find(d=>d.id===x.studentId);if(!e)return;const t=document.getElementById("view-sportal"),n=e.weekStart??0,a=ee(l.weekOffset,n),i=V(a,6),o=be(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let d=0;d<7;d++){const c=V(a,d),p=K(c),m=p===o,u=`${e.id}_${p}`,f=l.tasks[u]||[],S=f.reduce((E,y)=>E+Number(y.duration),0),I=f.reduce((E,y)=>E+(y.done?Number(y.duration):0),0);DAYS_TR[(n+d)%7];const v=[...f];s==="hourly"&&v.sort((E,y)=>E.start_time&&!y.start_time?-1:!E.start_time&&y.start_time?1:E.start_time&&y.start_time?E.start_time.localeCompare(y.start_time):0);const $=v.map(E=>{const y=f.indexOf(E),z=E.start_time?`<div class="tc-time-badge">🕒 ${E.start_time}</div>`:"";return`
  ...
  </div>`}function io(e){const t=e.student_feedback||{};if(!(t.status||t.focus||t.difficulty||t.time_spent>0||t.blocker))return"";const a={completed:{l:"Tamamladı",c:"#3ecf8e",bg:"rgba(62,207,142,.1)"},partial:{l:"Kısmen Tamamladı",c:"#f0a500",bg:"rgba(240,165,0,.1)"},failed:{l:"Yapamadı",c:"#ef4444",bg:"rgba(239,68,68,.1)"}},i={1:"Çok Kolay",2:"Kolay",3:"Orta",4:"Zor",5:"Çok Zor"},o={time:"Zamanı yetmedi",topic:"Konuyu anlayamadı",hard:"Kaynak çok zordu",moti:"Motivasyon yok"},s=a[t.status],r=t.time_spent,d=r>0?(Math.floor(r/60)>0?Math.floor(r/60)+"sa ":"")+(r%60>0?r%60+"dk":""):null,c=t.focus?"★".repeat(t.focus)+"☆".repeat(5-t.focus):null,p={1:"#3ecf8e",2:"#86efac",3:"#f0a500",4:"#fb923c",5:"#ef4444"},m=t.difficulty?p[t.difficulty]:"var(--text-mid)";return`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:12px 16px;margin-bottom:14px">
    ...
    ${(()=>{var k;const $=si(o.exam,o.subject);return $?(ce=[...((k=o.student_result)==null?void 0:k.yanlis_konular)||[]],`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:14px 16px;margin-bottom:14px">
    ...
    ${a}${i}`}function Kn(e){var n;const t=e?l.exams.find(a=>a.id===e):null;document.getElementById("emTitle").textContent=t?"Sonucu Düzenle":"Deneme Sonucu Gir",document.getElementById("emId").value=e||"",document.getElementById("emName").value=(t==null?void 0:t.name)||"",document.getElementById("emDate").value=(t==null?void 0:t.date)||K(new Date),document.getElementById("emStudentWrap").style.display="none",document.getElementById("emStudent").innerHTML=`<option value="${x.studentId}">${g(((n=l.students.find(a=>a.id===x.studentId))==null?void 0:n.name)||"")}</option>`,document.getElementById("emExamType").value=(t==null?void 0:t.type)||"TYT",document.getElementById("emNote").value=(t==null?void 0:t.note)||"",Kt(),t!=null&&t.examDetails&&Object.entries(t.examDetails).forEach(([a,i])=>{const o=document.getElementById(`ed_${a}_d`),s=document.getElementById(`ed_${a}_y`),r=document.getElementById(`ed_${a}_b`);o&&(o.value=i.dogru||0,s.value=i.yanlis||0,r.value=i.bos||0),ne[a]={...i},On(a),(i.yanlis_konular||[]).forEach(d=>{document.querySelectorAll(`#konu_acc_${a.replace(/\s/g,"_")} span`).forEach(p=>{p.textContent.trim()===d&&(p.style.borderColor="var(--red)",p.style.background="rgba(255,92,122,.12)",p.style.color="var(--red)")})})}),O("examModal")}function co(e){document.getElementById("emStudentWrap").style.display="",document.getElementById("emStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${g(t.name)}</option>`).join(""),Kn(e),document.getElementById("emStudentWrap").style.display=""}let ne={};function po(e,t,n){ne[t]||(ne[t]={dogru:0,yanlis:0,bos:0,yanlis_konular:[]});const a=ne[t].yanlis_konular,i=a.indexOf(n);i===-1?(a.push(n),e.style.borderColor="var(--red)",e.style.background="rgba(255,92,122,.12)",e.style.color="var(--red)"):(a.splice(i,1),e.style.borderColor="var(--border)",e.style.background="var(--surface)",e.style.color="var(--text-mid)")}window.toggleExamKonuChip=po;function On(e){var c,p,m,u;const t=parseInt((c=document.getElementById(`ed_${e}_d`))==null?void 0:c.value)||0,n=parseInt((p=document.getElementById(`ed_${e}_y`))==null?void 0:p.value)||0,a=parseInt((m=document.getElementById(`ed_${e}_b`))==null?void 0:m.value)||0;ne[e]||(ne[e]={yanlis_konular:[]}),ne[e].dogru=t,ne[e].yanlis=n,ne[e].bos=a;const i=document.getElementById("emExamType").value,o=((u=EXAM_SORU[i])==null?void 0:u[e])||40,s=t+n+a,r=document.getElementById(`ed_${e}_net`),d=document.getElementById(`ed_${e}_warn`);r&&(r.textContent=Math.max(0,t-n/4).toFixed(2)),d&&(d.style.display=s>o?"":"none"),qi()}window.updateExamNet=On;function mo(e){const t=document.getElementById(`konu_acc_${e.replace(/\s/g,"_")}`);t&&(t.style.display=t.style.display==="none"?"":"none")}window.toggleKonuAccordion=mo;function Kt(){const e=document.getElementById("emExamType").value,t=EXAM_DEFS[e]||[];ne={};const n=document.getElementById("emPuanDisplay");n&&(n.innerHTML=""),document.getElementById("netInputsWrap").innerHTML=t.map(a=>{var d;const i=((d=EXAM_SORU[e])==null?void 0:d[a])||40,s=(EXAM_KONU_MAP[`${e}_${a}`]||[]).flatMap(c=>Ge[c]||[]),r=s.length?`
      ...
      ${r}
    </div>`}).join("")}async function uo(){var r,d;const e=document.getElementById("emName").value.trim();if(!e)return h("Sınav adı girin!");const t=document.getElementById("emExamType").value,n={};(EXAM_DEFS[t]||[]).forEach(c=>{const p=ne[c]||{};n[c]=Math.max(0,(p.dogru||0)-(p.yanlis||0)/4)});const a=document.getElementById("emId").value,i=document.getElementById("emStudent").value,o={name:e,date:document.getElementById("emDate").value,student_id:i,coach_id:x.coachId||((r=l.students.find(c=>c.id===i))==null?void 0:r.coachId),exam_type:t,nets:n,exam_details:ne,student_note:document.getElementById("emNote").value.trim()};async function s(c,p,m){var u,f,S;if(p){const{error:I}=await b.from("exams").update(c).eq("id",m);if((u=I==null?void 0:I.message)!=null&&u.includes("exam_details")){const{exam_details:v,...$}=c;return b.from("exams").update($).eq("id",m)}return{error:I}}else{const I=await b.from("exams").insert(c).select().single();if((S=(f=I.error)==null?void 0:f.message)!=null&&S.includes("exam_details")){const{exam_details:v,...$}=c;return b.from("exams").insert($).select().single()}return I}}if(a){const{error:c}=await s(o,!0,a);if(c)return h("Hata: "+c.message);const p=l.exams.find(m=>m.id===a);p&&Object.assign(p,{name:o.name,date:o.date,studentId:i,type:t,nets:n,examDetails:ne,note:o.student_note}),h("Güncellendi ✓")}else{const{data:c,error:p}=await s(o,!1,null);if(p)return h("Hata: "+p.message);l.exams.push({id:c.id,studentId:c.student_id,name:c.name,date:c.date,type:c.exam_type,nets:c.nets||{},examDetails:c.exam_details||{},note:c.student_note,coachComment:""}),h("Deneme eklendi ✓")}if(F("examModal"),x.role==="student"?Nt():Ne(),x.role==="coach"||x.role==="developer")try{const c=[];Object.values(ne||{}).forEach(m=>{var u;(u=m==null?void 0:m.yanlis_konular)!=null&&u.length&&c.push(...m.yanlis_konular)}),ce!=null&&ce.length&&c.push(...ce);const p=[...new Set(c)];if(p.length>0&&i){const m=((d=l.konuMastery)==null?void 0:d[i])||{},u=[];if(Object.entries(m).forEach(([f,S])=>{Object.entries(S).forEach(([I,v])=>{p.includes(I)&&(v.status==="td"?u.push({konu:I,subject:f,type:"td_broken",stars:v.stars}):v.stars>=5&&u.push({konu:I,subject:f,type:"high_star_wrong",stars:v.stars}))})}),u.length>0){const f=u.filter(v=>v.type==="td_broken"),S=u.filter(v=>v.type==="high_star_wrong");let I="⚠️ Mastery Önerileri: ";f.length>0&&(I+=`${f.map(v=>v.konu).join(", ")} TD'den düştü! `),S.length>0&&(I+=`${S.map(v=>v.konu).join(", ")} için yıldız düşürmeyi düşün.`),setTimeout(()=>{const v=document.createElement("div");v.style.cssText="position:fixed;bottom:80px;right:16px;max-width:360px;background:var(--surface);border:1.5px solid var(--accent);border-radius:12px;padding:14px 16px;box-shadow:var(--shadow-lg);z-index:99999;animation:slideIn .3s ease",v.innerHTML=`
...
`).map(r=>r.trim()).filter(Boolean);let o=[];a?o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",url:d[1]||"",topic:"",soru:parseInt(d[2])||0}}):o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",soru:parseInt(d[1])||0}});const s={exam_type:document.getElementById("rmExam").value,subject:t,publisher:document.getElementById("rmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:o,active:document.getElementById("rmActive").value==="true",resource_type:a?"playlist":"book"};n?(await b.from("resources").update(s).eq("id",n),h("Güncellendi ✓")):(await b.from("resources").insert(s),h("Kaynak eklendi ✓")),F("resourceModal"),et()}async function To(e){await ae("Bu kaynağı silmek istediğinizden emin misiniz?")&&(await b.from("resources").delete().eq("id",e),h("Silindi"),et())}async function yt(){const e=document.getElementById("view-dev-finance"),[{data:t},{data:n}]=await Promise.all([b.from("subscriptions").select("*,users(full_name,color)").order("created_at",{ascending:!1}),b.from("payments").select("*,users(full_name)").order("payment_date",{ascending:!1}).limit(20)]),a=(n||[]).filter(o=>o.status==="completed").reduce((o,s)=>o+Number(s.amount),0),i=(t||[]).filter(o=>o.status==="active").length;e.innerHTML=`
    ...
    </div>`}function Eo(){let e=document.getElementById("paymentModal");e||(e=document.createElement("div"),e.id="paymentModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('paymentModal')">×</button>
      <h2>Ödeme Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pmStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${g(t.name)}</option>`).join(""),O("paymentModal")}async function _o(){const e=parseFloat(document.getElementById("pmAmount").value);if(!e)return h("Tutar girin!");await b.from("payments").insert({student_id:document.getElementById("pmStudent").value,amount:e,method:document.getElementById("pmMethod").value,payment_date:document.getElementById("pmDate").value,description:document.getElementById("pmDesc").value,status:"completed"}),h("Ödeme kaydedildi ✓"),F("paymentModal"),yt()}function So(){let e=document.getElementById("subModal");e||(e=document.createElement("div"),e.id="subModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('subModal')">×</button>
      <h2>Abonelik Ekle</h2>
    ...
    ${(t||[]).map(a=>`
      ...
      </div>`).join("")}`}function zo(){let e=document.getElementById("announceModal");e||(e=document.createElement("div"),e.id="announceModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('announceModal')">×</button>
      <h2>Yeni Duyuru</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),O("announceModal")}async function Bo(){const e=document.getElementById("anTitle").value.trim(),t=document.getElementById("anBody").value.trim();if(!e||!t)return h("Başlık ve içerik zorunlu!");await b.from("announcements").insert({title:e,body:t,type:document.getElementById("anType").value,target:document.getElementById("anTarget").value,active:!0}),h("Duyuru yayınlandı ✓"),F("announceModal"),tt()}async function Mo(e,t){await b.from("announcements").update({active:t}).eq("id",e),tt()}async function Ao(e){await ae("Bu duyuruyu silmek istediğinizden emin misiniz?")&&(await b.from("announcements").delete().eq("id",e),h("Silindi"),tt())}let Re=null,mt=null,pe=null,kt=null,Pe=[],me=[],ke="welcome";async function Ke(){const e=document.getElementById("view-dev-tickets");if(!e)return;const{data:t,error:n}=await b.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").order("updated_at",{ascending:!1});Pe=t||[],!pe&&Pe.length>0&&(pe=Pe[0].id),e.innerHTML=`
  ...
  `,Lo(),kt&&clearInterval(kt),kt=setInterval(Co,4e3)}function Do(e){pe=e,Ke()}async function Co(){if(!pe||!document.getElementById("devChatArea"))return;const{data:t,error:n}=await b.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").eq("id",pe).single();if(n||!t)return;let a=[];try{a=JSON.parse(t.body),Array.isArray(a)||(a=[{sender:"user",text:t.body,time:t.created_at}])}catch{a=[{sender:"user",text:t.body,time:t.created_at}]}const i=document.getElementById("devChatMessages");if(i){const o=i.scrollTop,s=i.scrollHeight-i.clientHeight-o<40;i.innerHTML=a.map(r=>{const d=r.sender==="emin",c=d?"Kurucu / Destek":r.sender==="ai"?"Yapay Zeka":r.name||"Kullanıcı",p=d?"var(--blue)":r.sender==="ai"?"var(--surface2)":"var(--accent)",m=d?"#fff":r.sender==="ai"?"var(--text)":"var(--on-accent)",u=d?"flex-end":"flex-start",f=d?"14px 14px 4px 14px":"14px 14px 14px 4px",S=new Date(r.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join(""),s&&(i.scrollTop=i.scrollHeight)}}function Lo(){var s,r,d;const e=document.getElementById("devChatArea");if(!e)return;const t=Pe.find(c=>c.id===pe);if(!t){e.innerHTML=`
    ...
    <div id="devChatMessages" style="flex:1; overflow-y:auto; padding:20px; display:flex; flex-direction:column; gap:12px; background:var(--surface)">
      ${i.map(c=>{const p=c.sender==="emin",m=p?"Kurucu / Destek":c.sender==="ai"?"Yapay Zeka":c.name||"Kullanıcı",u=p?"var(--blue)":c.sender==="ai"?"var(--surface2)":"var(--accent)",f=p?"#fff":c.sender==="ai"?"var(--text)":"var(--on-accent)",S=p?"flex-end":"flex-start",I=p?"14px 14px 4px 14px":"14px 14px 14px 4px",v=new Date(c.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
  ...
  `;const o=document.getElementById("devChatMessages");o&&(o.scrollTop=o.scrollHeight)}async function jo(){const e=document.getElementById("devReplyInput"),t=e.value.trim();if(!t||!pe)return;e.value="",B(!0);const{data:n}=await b.from("tickets").select("body").eq("id",pe).single();let a=[];if(n&&n.body)try{a=JSON.parse(n.body)}catch{a=[{sender:"user",text:n.body,time:new Date().toISOString()}]}const i={sender:"emin",text:t,time:new Date().toISOString(),name:"Kurucu / Destek"};a.push(i);const{error:o}=await b.from("tickets").update({body:JSON.stringify(a),reply:t,status:"resolved",updated_at:new Date().toISOString()}).eq("id",pe);if(B(!1),o){h("Hata: "+o.message);return}h("Yanıt gönderildi ✓"),Ke()}async function Po(e,t){await b.from("tickets").update({status:t,updated_at:new Date().toISOString()}).eq("id",e),h("Durum güncellendi ✓"),Ke()}async function Ro(e){await ae("Bu talebi silmek istediğinizden emin misiniz?")&&(await b.from("tickets").delete().eq("id",e),h("Silindi"),pe=null,Ke())}function Ho(){xt()}async function xt(){let e=document.getElementById("supportChatModal");e||(e=document.createElement("div"),e.id="supportChatModal",e.className="modal-bg",e.style.zIndex="99999999",e.innerHTML=`
    ...
    `,document.body.appendChild(e),e.addEventListener("click",t=>{var a;const n=(a=document.getElementById("trialExpiredModal"))==null?void 0:a.classList.contains("open");t.target===e&&!n&&qn()})),O("supportChatModal"),await ut(),Re&&clearInterval(Re),Re=setInterval(ut,4e3)}function qn(){F("supportChatModal"),Re&&(clearInterval(Re),Re=null)}async function ut(){var o,s;const e=(o=x.dbUser)==null?void 0:o.id;if(!e)return;const t=document.getElementById("supportMessages");if(!t)return;const{data:n,error:a}=await b.from("tickets").select("*").eq("user_id",e).eq("status","open").order("created_at",{ascending:!1}).limit(1);if(a){console.error("Error fetching ticket:",a);return}const i=n&&n[0];if(i){mt=i.id,ke="emin";const r=document.getElementById("supportStatusLabel");r&&(r.textContent="● Kurucu / Destek Ekibi");let d=[];try{d=JSON.parse(i.body),Array.isArray(d)||(d=[{sender:"user",text:i.body,time:i.created_at}])}catch{d=[{sender:"user",text:i.body,time:i.created_at}]}i.reply&&((s=d[d.length-1])==null?void 0:s.text)!==i.reply&&d.push({sender:"emin",text:i.reply,time:i.updated_at}),Ue(d)}else if(ke==="welcome"){const r=document.getElementById("supportStatusLabel");r&&(r.textContent="● Çevrimiçi Asistan"),t.innerHTML=`
    ...
    `}).join(""),a&&(t.scrollTop=t.scrollHeight)}function Yo(){ke="ai",me=[{sender:"ai",text:"Merhaba! Ben Rostrum Akademi Yapay Zeka Asistanıyım. 🤖 Size nasıl yardımcı olabilirim?",time:new Date().toISOString()}],Ue(me)}function No(){ke="emin_start";const e=document.getElementById("supportMessages");e&&(e.innerHTML=`
      <div style="text-align:center;padding:40px 20px">
    ...
    </div>`,i.appendChild(s)}),document.body.appendChild(i),setTimeout(()=>i.remove(),8e3)}(()=>{const e=document.createElement("style");e.textContent=".role-dev{background:rgba(192,132,252,.15);color:#c084fc;}",document.head.appendChild(e)})();function Un(e){return`ra_ob_${x.coachId}_${e}`}function St(e){return localStorage.getItem(Un(e))==="1"}function Fo(e){localStorage.setItem(Un(e),"1"),Wn(),["student","program","report"].every(n=>St(n))&&qo()}async function qo(){const e=document.getElementById("obWidget");e&&(e.innerHTML=`<div style="padding:20px;text-align:center">
    ...
    </div>`,setTimeout(()=>e.remove(),3e3)),await b.from("workspaces").update({onboarding_done:!0}).eq("coach_id",x.coachId),l.workspace&&(l.workspace.onboarding_done=!0)}function Wn(){const e=document.getElementById("obWidget");if(!e)return;const t=[{id:"student",icon:"👤",label:"İlk öğrencinizi ekleyin",action:"window.openStudentModal?.()",btnLabel:"Ekle →"},{id:"program",icon:"📅",label:"Haftalık program oluşturun",action:"switchTab('program')",btnLabel:"Git →"},{id:"report",icon:"📄",label:"İlk raporunuzu gönderin",action:"switchTab('program')",btnLabel:"Git →"}],n=t.filter(i=>St(i.id)).length,a=Math.round((n+1)/(t.length+1)*100);e.querySelector(".ob-body").innerHTML=t.map(i=>{const o=St(i.id);return`<div style="display:flex;align-items:center;gap:10px;padding:9px 0;border-bottom:1px solid var(--border)">
    ...
    <div style="font-size:11px;color:var(--text-dim);margin-top:12px">Kredi kartı gerekmez · 14 gün sonra uzatabilirsiniz</div>
  </div>`}let wt=null;window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),wt=e;const t=document.createElement("button");t.id="pwaInstallBtn",t.className="btn btn-ghost btn-sm",t.innerHTML="📲 Yükle",t.style.cssText="font-size:11px;padding:5px 10px",t.onclick=async()=>{wt.prompt();const{outcome:n}=await wt.userChoice;n==="accepted"&&(t.remove(),h("Uygulama yüklendi ✓"))},document.querySelector(".tbar-right").insertBefore(t,document.querySelector(".user-pill"))});async function Zn(){const e=l.students.find(T=>T.id===x.studentId);if(!e)return;const t=document.getElementById("view-sprofil");if(!t)return;const{data:n,error:a}=await b.from("student_profiles").select("*").eq("id",x.studentId).maybeSingle();a&&console.error("Öğrenci profili yüklenirken hata:",a);const i=(n==null?void 0:n.bio)||"",o=(n==null?void 0:n.school)||"",s=(n==null?void 0:n.grade)||"",r=(n==null?void 0:n.target_university)||"",d=(n==null?void 0:n.target_department)||"",c=(n==null?void 0:n.struggling_subjects)||"",p=(n==null?void 0:n.daily_capacity)||"",m=l.exams.filter(T=>T.studentId===e.id).sort((T,M)=>T.date.localeCompare(M.date)),u=m[m.length-1],f=u?(EXAM_DEFS[u.type]||[]).reduce((M,_)=>{var D;return M+Number(((D=u.nets)==null?void 0:D[_])||0)},0).toFixed(1):"—",S=ee(0,e.weekStart??0);let I=0,v=0;for(let T=0;T<7;T++){const M=l.tasks[`${e.id}_${K(V(S,T))}`]||[];I+=M.length,v+=M.filter(_=>_.done).length}const $=I>0?Math.round(v/I*100):0;let k=0;Object.keys(l.tasks).filter(T=>T.startsWith(e.id+"_")).forEach(T=>{k+=l.tasks[T].filter(M=>M.done).length});let E="";if(m.length>0){const T=m.slice(-6),M=Math.max(...T.map(_=>(EXAM_DEFS[_.type]||[]).reduce((C,j)=>{var w;return C+Number(((w=_.nets)==null?void 0:w[j])||0)},0)),1);E=`
      <div class="card cp" style="margin-bottom:16px">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:90px;margin-top:12px">
          ${T.map(_=>{const C=(EXAM_DEFS[_.type]||[]).reduce((q,Y)=>{var G;return q+Number(((G=_.nets)==null?void 0:G[Y])||0)},0),j=Math.max(Math.round(C/M*100),4),w=T[T.indexOf(_)-1],A=w?(EXAM_DEFS[w.type]||[]).reduce((q,Y)=>{var G;return q+Number(((G=w.nets)==null?void 0:G[Y])||0)},0):C,L=C>A?"↑":C<A?"↓":"",P=C>A?"var(--green)":C<A?"var(--red)":"var(--text-dim)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
              ...
              <div style="font-size:9px;color:var(--text-dim);text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:100%">${g(_.name.replace("Deneme","").replace("TYT","").replace("AYT","").trim())}</div>
            </div>`}).join("")}
        </div>
      </div>`}let y="";if(m.length>0){const T=u.type,_=(EXAM_DEFS[T]||[]).map(D=>{var A;const C=m.filter(L=>L.type===T).map(L=>{var P;return Number(((P=L.nets)==null?void 0:P[D])||0)}),j=C.length?C.reduce((L,P)=>L+P,0)/C.length:0,w=Number(((A=u.nets)==null?void 0:A[D])||0);return{f:D,avg:j.toFixed(1),last:w,color:zt(w)}});y=`
      <div class="card cp" style="margin-bottom:16px">
    ...
    </div>`}async function Uo(){const e=x.dbUser.id,t=document.getElementById("spBio").value.trim(),n=document.getElementById("spSchool").value.trim(),a=document.getElementById("spGrade").value.trim(),i=document.getElementById("spTargetUni").value.trim(),o=document.getElementById("spTargetDept").value.trim(),s=document.getElementById("spStruggling").value.trim(),r=parseInt(document.getElementById("spCapacity").value)||null,d={id:e,bio:t,school:n,grade:a,target_university:i,target_department:o,struggling_subjects:s,daily_capacity:r,updated_at:new Date().toISOString()},{error:c}=await b.from("student_profiles").upsert(d);h(c?"Profil kaydedilemedi: "+c.message:"Profil başarıyla güncellendi ✓")}async function Wo(){const e=document.getElementById("newPass1").value,t=document.getElementById("newPass2").value;if(!e)return h("Şifre girin!");if(e!==t)return h("Şifreler uyuşmuyor!");if(e.length<4)return h("En az 4 karakter olmalı");const{error:n}=await b.from("users").update({password_hash:e}).eq("id",x.studentId);if(n)return h("Hata: "+n.message);h("Şifre güncellendi ✓"),document.getElementById("newPass1").value="",document.getElementById("newPass2").value=""}async function Vo(){const e=document.getElementById("view-suyelik");if(!e)return;e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;height:200px"><div style="width:32px;height:32px;border:3px solid var(--accent);border-top-color:transparent;border-radius:50%;animation:spin .7s linear infinite"></div></div>',l.students.find(v=>v.id===x.studentId);const t=x.dbUser;let n=null;if(x.coachId){const{data:v}=await b.from("users").select("full_name,plan,trial_ends_at,created_at,email").eq("id",x.coachId).maybeSingle();n=v}const a=t!=null&&t.created_at?new Date(t.created_at):null,i=new Date,o=(n==null?void 0:n.plan)||"trial",s=o==="trial"?"Deneme Dönemi":o==="pro"?"Pro Üyelik":o==="premium"?"Premium Üyelik":o.charAt(0).toUpperCase()+o.slice(1),r=o==="trial"?"#f0a500":o==="pro"?"#3ecf8e":o==="premium"?"#8b5cf6":"#3ecf8e",d=o==="trial"?"#fff8e6":o==="pro"?"#e6faf3":o==="premium"?"#f3e8ff":"#e6faf3";let c=null;n!=null&&n.trial_ends_at?c=new Date(n.trial_ends_at):n!=null&&n.created_at&&(c=new Date(new Date(n.created_at).getTime()+14*24*60*60*1e3));const p=c?Math.max(0,Math.ceil((c-i)/(1e3*60*60*24))):null,m=a?Math.floor((i-a)/(1e3*60*60*24)):null,u=v=>v?v.toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"}):"—",f=p===null?"#888":p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444",S=p===null?"❓":p>7?"✅":p>3?"⚠️":"🔴",I=p===null?"Durum bilinmiyor":p>7?"Aktif":p>3?"Yakında Sona Eriyor":p===0?"Bugün Sona Eriyor":"Kritik — "+p+" gün";e.innerHTML=`
  ...
  `}async function Xo(e,t){const{error:n}=await b.from("match_requests").update({status:t}).eq("id",e);n?h("Durum güncellenirken hata: "+n.message):(h("Durum güncellendi ✓"),Gt())}async function Qo(e){const t=l.students.find(s=>s.id===e);if(!t)return;const{data:n}=await b.from("student_speeds").select("*").eq("student_id",e),a={};(n||[]).forEach(s=>{a[`${s.exam_type}_${s.subject}`]=s.secs_per_question});const i=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];let o=document.getElementById("speedModal");o||(o=document.createElement("div"),o.id="speedModal",o.className="modal-bg",document.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&o.classList.remove("open")})),o.innerHTML=`<div class="modal modal-lg">
  ...
  </div>`,O("speedModal")}async function es(e){const t=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];for(const{exam:n,sub:a}of t){const i=`${n}_${a}`,o=document.getElementById("spd_"+i);if(!o)continue;const s=parseInt(o.value)||180;await In(e,n,a,s)}F("speedModal"),h("Hız ayarları kaydedildi ✓")}async function ts(e){const t=l.students.find(o=>o.id===e);if(!t)return;const{data:n}=await b.from("student_notes").select("notes").eq("coach_id",x.coachId).eq("student_id",e).maybeSingle(),a=(n==null?void 0:n.notes)||"";let i=document.getElementById("studentNotesModal");i||(i=document.createElement("div"),i.id="studentNotesModal",i.className="modal-bg",document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")})),i.innerHTML=`<div class="modal">
  ...
  </div>`,O("studentNotesModal")}async function ns(e){const t=document.getElementById("studentNoteText").value,{error:n}=await b.from("student_notes").upsert({coach_id:x.coachId,student_id:e,notes:t,updated_at:new Date().toISOString()},{onConflict:"coach_id,student_id"});if(n){h("Not kaydedilemedi: "+n.message);return}h("Not kaydedildi ✓"),F("studentNotesModal")}function as(e){let t=document.getElementById("reportModal");t||(t=document.createElement("div"),t.id="reportModal",t.className="modal-bg",t.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.classList.remove("open")}),document.getElementById("rpPeriod").addEventListener("change",function(){document.getElementById("rpCustomDates").style.display=this.value==="custom"?"":"none"})),document.getElementById("rpStuId").value=e;const n=new Date,a=new Date(n.getFullYear(),n.getMonth(),1);document.getElementById("rpStart").value=K(a),document.getElementById("rpEnd").value=K(n),document.getElementById("rpNote").value="",O("reportModal")}function Ut(){const e=document.getElementById("rpPeriod").value,t=new Date;if(e==="weekly"){const n=ee(0,0);return{start:K(n),end:K(V(n,6))}}else return e==="monthly"?{start:K(new Date(t.getFullYear(),t.getMonth(),1)),end:K(t)}:{start:document.getElementById("rpStart").value,end:document.getElementById("rpEnd").value}}function Wt(e,t=!1){var y,z,T,M;const n=l.students.find(_=>_.id===e);if(!n)return"";const{start:a,end:i}=Ut(),o=document.getElementById("rpNote").value.trim(),s=((y=l.workspace)==null?void 0:y.brand_name)||"Rostrum Akademi",r=((z=l.workspace)==null?void 0:z.brand_color)||"#f0a500",d=((T=x.dbUser)==null?void 0:T.full_name)||"Koç",c=[],p=new Date(a);for(;K(p)<=i;){const _=`${e}_${K(p)}`;(l.tasks[_]||[]).forEach(D=>c.push({...D,date:K(p)})),p.setDate(p.getDate()+1)}const m=c.length,u=c.filter(_=>_.done).length,f=m>0?Math.round(u/m*100):0,S=c.filter(_=>_.done).reduce((_,D)=>_+Number(D.duration||0),0),I={};c.forEach(_=>{const D=_.subject||"Diğer";I[D]||(I[D]={total:0,done:0}),I[D].total++,_.done&&I[D].done++});const v=l.exams.filter(_=>_.studentId===e&&_.date>=a&&_.date<=i).sort((_,D)=>_.date.localeCompare(D.date)),$=l.appointments.filter(_=>_.studentId===e&&_.date>=a&&_.date<=i).sort((_,D)=>_.date.localeCompare(D.date)),k=`${new Date(a+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})} – ${new Date(i+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})}`;let E="";if(v.length>1){const _=Math.max(...v.map(w=>(EXAM_DEFS[w.type]||[]).reduce((A,L)=>{var P;return A+Number(((P=w.nets)==null?void 0:P[L])||0)},0)),1),D=400,C=80,j=Math.min(40,(D-20)/v.length-4);E=`<svg width="${D}" height="${C+30}" style="overflow:visible">
      ${v.map((w,A)=>{const L=(EXAM_DEFS[w.type]||[]).reduce((Y,G)=>{var te;return Y+Number(((te=w.nets)==null?void 0:te[G])||0)},0),P=Math.max(Math.round(L/_*(C-10)),4),q=10+A*((D-20)/v.length);return`<rect x="${q}" y="${C-P}" width="${j}" height="${P}" rx="3" fill="${r}" opacity="0.85"/>
          <text x="${q+j/2}" y="${C-P-4}" text-anchor="middle" font-size="10" fill="#333">${L.toFixed(0)}</text>
          <text x="${q+j/2}" y="${C+14}" text-anchor="middle" font-size="9" fill="#666">${g(w.name.replace("Deneme","").replace("TYT","").replace("AYT","").trim()||String(A+1))}</text>`}).join("")}
...
<div class="page">
  ...
  <div class="section">
    ...
    <table>
      ...
      <tbody>
        ${Object.entries(I).sort((_,D)=>D[1].total-_[1].total).map(([_,D])=>{const C=Math.round(D.done/D.total*100),j=C>=80?"badge-green":C>=50?"badge-yellow":"badge-red";return`<tr>
            <td><strong>${g(_)}</strong></td>
            <td>${D.total}</td>
            <td>${D.done}</td>
  ...
  <div class="section">
    ...
    <table>
      <thead><tr><th>Sınav</th><th>Tarih</th><th>Tür</th>${(EXAM_DEFS[(M=v[0])==null?void 0:M.type]||[]).map(_=>`<th>${_}</th>`).join("")}<th>Toplam</th></tr></thead>
      <tbody>
        ${v.map(_=>{const D=EXAM_DEFS[_.type]||[],C=D.reduce((j,w)=>{var A;return j+Number(((A=_.nets)==null?void 0:A[w])||0)},0).toFixed(1);return`<tr>
            <td><strong>${g(_.name)}</strong></td>
            <td>${new Date(_.date+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"short"})}</td>
            <td>${g(_.type)}</td>
            ${D.map(j=>{var A;const w=Number(((A=_.nets)==null?void 0:A[j])||0);return`<td><span class="badge ${w>=20?"badge-green":w>=12?"badge-yellow":"badge-red"}">${w}</span></td>`}).join("")}
...
</html>`}function is(){const e=document.getElementById("rpStuId").value,t=Wt(e,!0),n=window.open("","_blank","width=900,height=700");n.document.write(t),n.document.close()}function os(){const e=document.getElementById("rpStuId").value;l.students.find(a=>a.id===e);const t=Wt(e,!1),n=window.open("","_blank");n.document.write(t),n.document.close(),setTimeout(()=>{n.focus(),n.print()},500),F("reportModal"),h('PDF oluşturuluyor — "PDF olarak kaydet" seçin')}async function ss(){const e=document.getElementById("rpStuId").value,t=l.students.find(s=>s.id===e);if(!t)return;const n=`${window.location.origin}/api/generate-pdf-report?studentId=${e}`,a=`Merhaba, ${t.name} isimli öğrencimizin bu dönemki performans ve gelişim raporu hazırlandı. Aşağıdaki bağlantıdan raporu detaylıca görüntüleyebilirsiniz:

🔗 ${n}`,o=`https://api.whatsapp.com/send?text=${encodeURIComponent(a)}`;window.open(o,"_blank"),F("reportModal"),h("WhatsApp yönlendirmesi açıldı ✓")}function rs(){let e=document.getElementById("weeklyPDFModal");e||(e=document.createElement("div"),e.id="weeklyPDFModal",e.className="modal-bg",e.innerHTML=`<div class="modal">
      ...
      <button class="btn btn-accent" style="width:100%;justify-content:center;padding:12px" onclick="generateWeeklyPDF()">PDF Oluştur →</button>
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pdfNote").value="",O("weeklyPDFModal")}function ls(){const e=document.getElementById("pdfNote").value.trim();F("weeklyPDFModal"),Qn(l.activeStuId,e)}function Qn(e,t){var C,j;const n=l.students.find(w=>w.id===e);if(!n)return;const a=(n==null?void 0:n.weekStart)??0,i=ee(l.weekOffset,a),o=V(i,6),s=((C=l.workspace)==null?void 0:C.brand_name)||"Rostrum Akademi",r=((j=l.workspace)==null?void 0:j.brand_color)||"#E8613A",d=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"],c=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],p={deneme:"#f59e0b",soru:"#3b82f6",konu:"#10b981",diger:"#8b5cf6"},m={deneme:"Deneme",soru:"Soru Bankası",konu:"Konu Anlatımı",diger:"Diğer"};let u=0,f=0,S=0;const I=[];for(let w=0;w<7;w++){const A=V(i,w),L=K(A),P=l.tasks[`${e}_${L}`]||[];u+=P.length,f+=P.filter(q=>q.done).length,S+=P.reduce((q,Y)=>q+Number(Y.duration||0),0),P.length>0&&I.push({d:A,ds:L,tasks:P,dayName:d[(a+w)%7]})}const v=u>0?Math.round(f/u*100):0,$=163.36,k=($*(1-v/100)).toFixed(1),E=(w,A=5)=>{let L="";for(let P=1;P<=A;P++)L+=`<span style="display:inline-block;width:6px;height:6px;border-radius:50%;margin-right:2px;background:${P<=w?r:"#E8E6DE"}"></span>`;return L},y=w=>w?'<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;border-radius:50%;background:#22C55E;flex-shrink:0"><svg width="8" height="6" viewBox="0 0 8 6"><path d="M1 3L3 5L7 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></span>':'<span style="display:inline-block;width:15px;height:15px;border-radius:50%;border:1.5px solid #D1D0DC;flex-shrink:0"></span>';let z="";for(const{d:w,tasks:A,dayName:L}of I){const P=A.reduce((Y,G)=>Y+Number(G.duration||0),0),q=A.map(Y=>{const G=p[Y.type]||"#94a3b8",te=m[Y.type]||"Diğer",J=Y.done,X=Y.student_result||null,Z=Y.student_feedback||null,R=X&&(X.dogru!=null||X.yanlis!=null||X.bos!=null)?`
        ...
        </div>`:"";return`<div style="background:#fff;border-radius:8px;border:1px solid #E8E6DE;border-left:3px solid ${G};margin-bottom:6px;padding:10px 14px;display:flex;gap:10px;align-items:flex-start">
        <div style="flex:1;min-width:0">
          <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
            ...
            <span style="font-size:8px;font-weight:700;color:${G};text-transform:uppercase;letter-spacing:.5px;margin-left:2px">${te}${Y.exam?" · "+g(Y.exam):""}</span>
          </div>
      ...
      ${q}
    </div>`}const M=[{val:f,lbl:"Tamamlanan",col:"#22C55E"},{val:u-f,lbl:"Bekleyen",col:"#C4C3D0"},{val:Math.round(S/60)+" sa",lbl:"Toplam Süre",col:r},{val:u,lbl:"Toplam Görev",col:"#C4C3D0"}].map((w,A)=>`<div style="flex:1;${A>0?"border-left:1px solid rgba(255,255,255,.06);padding-left:16px;":""}padding-right:16px">
  ...
  </div>`).join(""),_=`<!DOCTYPE html><html lang="tr"><head><meta charset="UTF-8"><title>${g(n.name)} — Haftalık Program</title>
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
  ...
  <div class="page">
  ...
  </body></html>`,D=window.open("","_blank","width=1000,height=850");D.document.write(_),D.document.close(),setTimeout(()=>D.focus(),300)}function ds(){const e="abcdefghijklmnopqrstuvwxyz",t=()=>Array.from({length:3},()=>e[Math.floor(Math.random()*e.length)]).join("");return`https://meet.google.com/${t()}-${t()}-${t()}`}function cs(){return`https://zoom.us/j/${Math.floor(Math.random()*9e9)+1e9}`}function ps(e){navigator.clipboard.writeText(e).then(()=>h("Link kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),h("Link kopyalandı ✓")})}const ea=[{name:"Altın",val:"#f0a500",dim:"rgba(240,165,0,.12)"},{name:"Turuncu",val:"#e8622a",dim:"rgba(232,98,42,.12)"},{name:"Mavi",val:"#4da6ff",dim:"rgba(77,166,255,.12)"},{name:"Yeşil",val:"#3ecf8e",dim:"rgba(62,207,142,.12)"},{name:"Mor",val:"#c084fc",dim:"rgba(192,132,252,.12)"},{name:"Pembe",val:"#f472b6",dim:"rgba(244,114,182,.12)"},{name:"Kırmızı",val:"#ff5c5c",dim:"rgba(255,92,92,.12)"},{name:"Turkuaz",val:"#06b6d4",dim:"rgba(6,182,212,.12)"}];function ta(){try{const e=JSON.parse(localStorage.getItem("ba_theme")||"{}");e.theme==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),e.accent&&na(e.accent,e.accentDim,!1)}catch{}}function na(e,t,n=!0){if(document.documentElement.style.setProperty("--accent",e),document.documentElement.style.setProperty("--accent-dim",t||"rgba(240,165,0,.12)"),n)try{const a=JSON.parse(localStorage.getItem("ba_theme")||"{}");a.accent=e,a.accentDim=t,localStorage.setItem("ba_theme",JSON.stringify(a))}catch{}}function ms(e){e==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{const t=JSON.parse(localStorage.getItem("ba_theme")||"{}");t.theme=e,localStorage.setItem("ba_theme",JSON.stringify(t))}catch{}document.querySelectorAll(".theme-btn").forEach(t=>{const n=t.dataset.theme===e;t.style.background=n?"var(--accent-dim)":"",t.style.borderColor=n?"var(--accent)":"",t.style.color=n?"var(--accent)":""})}function us(){let e=document.getElementById("themePanel");if(e){e.remove();return}e=document.createElement("div"),e.id="themePanel";const t=document.documentElement.getAttribute("data-theme")!=="light";e.style.cssText="position:fixed;top:60px;right:12px;background:var(--surface);border:1px solid var(--border2);border-radius:14px;padding:18px;z-index:300;box-shadow:var(--shadow-lg);min-width:230px;animation:fadeUp .2s ease",e.innerHTML=`
    ...
    <div style="display:flex;gap:7px;flex-wrap:wrap;margin-bottom:14px">
      ${ea.map(n=>`<div onclick="applyAccent('${n.val}','${n.dim}');document.getElementById('themePanel').remove()" title="${n.name}"
...
(Öğrenciye gönderilecek haftalık değerlendirme taslağı)`;let u="";const f={studentName:t.name,target:t.target,recentExams:c,taskCompletionRate:r,weeklyTaskCount:i};try{const k=await fetch("/api/ai-chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:[{role:"user",content:m}],context:f,userRole:"coach"})});k.ok?u=(await k.json()).reply:u=await we(m,f,"coach")}catch{u=await we(m,f,"coach")}let S="Analiz üretilemedi.",I="Taslak üretilemedi.";const v=u.indexOf("[ANALİZ]"),$=u.indexOf("[TASLAK]");v!==-1&&$!==-1?v<$?(S=u.substring(v+8,$).trim(),I=u.substring($+8).trim()):(I=u.substring($+8,v).trim(),S=u.substring(v+8).trim()):I=u,document.getElementById("aiCopilotAnalysisBox").innerHTML=`<b>📊 Yapay Zeka Durum Analizi:</b><br>${S.replace(/\n/g,"<br>")}`,document.getElementById("aiCopilotTextarea").value=I,Zt=I,document.getElementById("aiCopilotResultArea").style.display="block",document.getElementById("aiCopilotSendBtn").disabled=!0,document.getElementById("aiCopilotEditWarning").style.display="inline"}catch(a){console.error("generateAICopilotDraft error:",a),h("Taslak oluşturulurken hata: "+a.message)}finally{n.disabled=!1,n.textContent="🤖 Durum Analizi Yap ve Taslak Oluştur"}}function ys(){const e=document.getElementById("aiCopilotTextarea").value.trim(),t=document.getElementById("aiCopilotSendBtn"),n=document.getElementById("aiCopilotEditWarning");e&&e!==Zt?(t.disabled=!1,n.style.display="none"):(t.disabled=!0,n.style.display="inline")}async function xs(e){var a;const t=document.getElementById("aiCopilotTextarea").value.trim();if(!t)return;const n=document.getElementById("aiCopilotSendBtn");n.disabled=!0,n.textContent="Gönderiliyor...";try{const i=x.coachId||((a=l.students.find(r=>r.id===e))==null?void 0:a.coachId),{data:o,error:s}=await b.from("messages").insert({student_id:e,coach_id:i,from_role:"coach",text:t,read:!1}).select().single();if(s)throw s;await b.from("reports").insert({student_id:e,coach_id:i,type:"ai_copilot",title:"Yapay Zeka Copilot Değerlendirmesi",content:t,start_date:be(),end_date:be()}),l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:o.id,from:"coach",text:t,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),h("Taslak mesaj başarıyla düzenlendi, öğrenciye gönderildi ve arşive kaydedildi! ✓"),document.getElementById("aiCopilotResultArea").style.display="none",document.getElementById("aiCopilotTextarea").value="",Zt=""}catch(i){console.error("sendCopilotDraft error:",i),h("Gönderim hatası: "+i.message),n.disabled=!1}finally{n.textContent="✍️ Düzenlemeyi Kaydet ve Öğrenciye Gönder"}}function sa(){const e=l.students.find(r=>r.id===l.activeStuId),t=x.childName||(e==null?void 0:e.name)||"Öğrenci",n=document.getElementById("view-parent-home");if(!n)return;let a=[];Object.entries(l.tasks||{}).forEach(([r,d])=>{r.startsWith(l.activeStuId+"_")&&(a=a.concat(d))});const i=a.filter(r=>r.done).length,o=a.length?Math.round(i/a.length*100):0,s=(l.exams||[]).filter(r=>r.studentId===l.activeStuId).slice(-3);n.innerHTML=`
    ...
    </div>`}function ra(){const e=document.getElementById("view-parent-progress");if(!e)return;const t=l.students.find(o=>o.id===l.activeStuId),n=x.childName||(t==null?void 0:t.name)||"Öğrenci",a=(l.exams||[]).filter(o=>o.studentId===l.activeStuId);let i=[];Object.entries(l.tasks||{}).forEach(([o,s])=>{o.startsWith(l.activeStuId+"_")&&(i=i.concat(s))}),e.innerHTML=`
    <div style="padding:24px;max-width:800px;margin:0 auto">
    ...
    </div>`}function la(){const e=document.getElementById("view-parent-ai");e&&(e.innerHTML=`
    <div style="padding:24px;max-width:600px;margin:0 auto;text-align:center">
      ...
      <div style="margin-bottom:28px">
        ...
        ${Object.entries(m).map(([u,f])=>{const S=i[u]||"#6B7280",I=o[u]||"📌";return`<div>
...
`).map(d=>d.trim()).filter(Boolean),o=window._crmFetchedVideos||[];let s=[];if(a){if(o.length>0?s=o.map(d=>({label:d.title||"",url:d.url||"",topic:"",soru:parseInt(d.duration)||0})):s=i.map(d=>{const c=d.split("|").map(p=>p.trim());return{label:c[0]||"",url:c[1]||"",topic:"",soru:parseInt(c[2])||0}}),!s.length)return h("Video listesi boş! Önce playlist çekin.")}else s=i.map(d=>{const c=d.split("|").map(p=>p.trim());return{label:c[0]||"",soru:parseInt(c[1])||0}});const r={exam_type:document.getElementById("crmExam").value,subject:t,publisher:document.getElementById("crmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:s,active:!0,resource_type:a?"playlist":"book",coach_id:x.coachId};B(!0),n?(await b.from("resources").update(r).eq("id",n),h("Güncellendi ✓")):(await b.from("resources").insert(r),h("Kaynak eklendi ✓")),B(!1),F("coachResourceModal"),$e=[],nt()}async function Es(e){await ae("Bu kaynağı silmek istediğinizden emin misiniz?")&&(B(!0),await b.from("resources").delete().eq("id",e),B(!1),h("Silindi"),$e=[],nt())}function _s(e){const t=e.target.files[0];if(!t)return;B(!0);const n=new FileReader;n.onload=async a=>{try{const i=new Uint8Array(a.target.result),o=XLSX.read(i,{type:"array"}),s=o.SheetNames[0],r=o.Sheets[s],d=XLSX.utils.sheet_to_json(r);if(d.length===0)return B(!1),h("Excel dosyası boş!");const c={};d.forEach(u=>{const f=u["Kaynak Adı"]||u.Name||u["Kitap Adı"]||u["Playlist Adı"]||"",I=(u["Kaynak Türü"]||u.Type||u.Tür||"book").toLowerCase().includes("playlist")?"playlist":"book",v=u.Yayınevi||u.Publisher||u.Hoca||"",$=u.Sınav||u.Exam||"TYT",k=u.Ders||u.Subject||"",E=u["Öğe Adı"]||u.Test||u.Video||u["Test Adı"]||u["Video Adı"]||"",y=parseInt(u["Soru Sayısı"]||u.Soru||u.Süre||u["Süre (dk)"]||0),z=u.URL||u.Link||"";if(!f||!k||!E)return;const T=`${f}_${$}_${k}_${I}`;c[T]||(c[T]={exam_type:$,subject:k,publisher:v,name:f,resource_type:I,tests:[]}),c[T].tests.push({label:E,soru:y,url:z,topic:""})});const p=Object.values(c);if(p.length===0)return B(!1),h("Uyumlu veri bulunamadı! Sütun başlıklarını kontrol edin.");let m=0;for(const u of p){const{error:f}=await b.from("resources").insert({...u,year:new Date().getFullYear(),active:!0,coach_id:x.coachId});f||m++}B(!1),h(`✓ Excel'den ${m} kaynak başarıyla aktarıldı!`),$e=[],nt()}catch(i){B(!1),console.error(i),h("Excel okuma hatası: "+i.message)}},n.readAsArrayBuffer(t)}function Ss(e){const t=e.target.files[0];if(!t)return;B(!0);const n=new FileReader;n.onload=async a=>{try{const i=new Uint8Array(a.target.result),o=XLSX.read(i,{type:"array"}),s=o.Sheets[o.SheetNames[0]],r=XLSX.utils.sheet_to_json(s);if(r.length===0)return B(!1),h("Excel dosyası boş!");let d=0;for(const c of r){const p=c["Ad Soyad"]||c.Ad||c.Name||"",m=c.Hedef||c.Target||"Hedef belirtilmemiş";let u=c["Kullanıcı Adı"]||c.Username||"",f=c.Şifre||c.Password||STU_DEFAULT_PASS;if(!p)continue;u||(u=p.toLowerCase().replace(/\s+/g,"")+Math.floor(Math.random()*100),u=Ae(u));const S=await Le(f),I=u+"@rostrumakademi.com",{data:v,error:$}=await b.rpc("create_new_user",{p_email:I,p_password:f,p_full_name:p,p_username:u,p_role:"student",p_target:m,p_color:"#4da6ff",p_progress:0,p_week_start:0,p_coach_id:x.coachId,p_institution_id:null,p_exam_profile:"YKS"});!$&&v&&(l.students.push({id:v,name:p,target:m,color:"#4da6ff",progress:0,pass:S,weekStart:0,username:u}),d++)}B(!1),h(`✓ Excel'den ${d} öğrenci başarıyla eklendi!`),xe(),Je()}catch(i){B(!1),console.error(i),h("Excel okuma hatası: "+i.message)}},n.readAsArrayBuffer(t)}function ca(e){if(!l.activeStuId||!U)return null;let t=null;return Object.entries(l.tasks).forEach(([n,a])=>{n.startsWith(l.activeStuId+"_")&&a.forEach(i=>{i.subject&&i.subject.includes(U.name)&&(i.task_items&&Array.isArray(i.task_items)?i.task_items.forEach(o=>{(o.label||o)===e&&(o.done||i.done?t="done":t!=="done"&&(t="pending"))}):i.note&&i.note.includes(e)&&(i.done?t="done":t!=="done"&&(t="pending")))})}),t}async function Is(e,t){var d;const a=`${l.activeStuId}_${e}`,i=(d=l.tasks[a])==null?void 0:d[t];if(!i)return;ze=e,_editingTaskId=i._id,U=null,document.querySelector("#taskModal h2").innerHTML=`Görev Düzenle — <span id="tmDay">${e}</span>`,document.querySelector("#taskModal .btn-accent").textContent="Güncelle",document.getElementById("tmType").value=i.type,document.getElementById("tmExam").value=i.exam||"",document.getElementById("tmDuration").value=i.duration||60,document.getElementById("tmStartTime").value=i.start_time||"",document.getElementById("tmNote").value=i.note||"";const o=i.exam||"",s=i.type;{const c=document.getElementById("tmSubjectSel"),p=document.getElementById("tmSubjectFree");document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none";const m=document.getElementById("tmTestSummary");m&&(m.style.display="none"),o&&typeof SUBJECT_MAP<"u"&&SUBJECT_MAP[o]?(c.innerHTML=SUBJECT_MAP[o].map(S=>`<option value="${S}">${S}</option>`).join(""),c.style.display="",p.style.display="none"):(c.style.display="none",p.style.display="");const u=(s==="soru"||s==="konu")&&o;document.getElementById("soruBankasiWrap").style.display=u?"":"none";const f=document.getElementById("tmBookSearch");f&&(f.placeholder=s==="konu"?"Hoca veya playlist ara...":"Kitap veya yayınevi ara...")}if((s==="soru"||s==="konu")&&o){const c=document.getElementById("tmSubjectSel");let p="",m=i.subject;if(i.subject.includes(" - ")){const I=i.subject.split(" - ");p=I[0].trim(),m=I.slice(1).join(" - ").trim()}p&&SUBJECT_MAP[o]&&SUBJECT_MAP[o].includes(p)&&(c.value=p),document.getElementById("tmBookVal").value=m,document.getElementById("tmBookSearch").value=m,B(!0),await _n(),B(!1);const u=`${o}_${p}`;let S=(oe[u]||[]).find(I=>I.name===m);if(S||Object.values(oe).forEach(I=>{const v=I.find($=>$.name===m);v&&(S=v)}),S){U=S,document.getElementById("tmTestWrap").style.display="",Pt();const I=(i.task_items||[]).map($=>$.label||$);document.querySelectorAll("#tmTestList input[type=checkbox]").forEach($=>{var y;const k=parseInt($.value),E=((y=U.testler[k])==null?void 0:y.label)||U.testler[k];I.includes(E)?$.checked=!0:$.checked=!1}),Ye()}}else{const c=document.getElementById("tmSubjectSel"),p=document.getElementById("tmSubjectFree");c.style.display!=="none"?c.value=i.subject:p.value=i.subject,document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none"}O("taskModal")}async function zs(){const e=prompt("Şablon adı giriniz:");if(!e)return;const t=l.students.find(s=>s.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=ee(l.weekOffset,n),i=[];for(let s=0;s<7;s++){const r=V(a,s),d=K(r),c=`${l.activeStuId}_${d}`;(l.tasks[c]||[]).forEach(m=>{i.push({day_index:s,type:m.type,exam_type:m.exam||null,subject:m.subject,duration:m.duration,note:m.note||"",task_items:m.task_items||null})})}if(i.length===0)return h("Bu haftada kaydedilecek görev bulunmuyor!");B(!0);const{error:o}=await b.from("program_templates").insert({coach_id:x.coachId,name:e,description:`${i.length} görev içeriyor.`,tasks:i});if(B(!1),o)return h("Şablon kaydedilemedi: "+o.message);h("Hafta şablon olarak kaydedildi ✓")}async function Bs(){B(!0);const{data:e,error:t}=await b.from("program_templates").select("*").eq("coach_id",x.coachId);if(B(!1),t)return h("Şablonlar yüklenemedi.");if(!e||e.length===0)return h("Kayıtlı şablonunuz bulunmuyor. Önce haftayı şablon olarak kaydedin.");let n=document.getElementById("applyTemplateModal");n||(n=document.createElement("div"),n.id="applyTemplateModal",n.className="modal-bg",n.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.classList.remove("open")})),document.getElementById("atmSelect").innerHTML=e.map(a=>`<option value="${a.id}">${g(a.name)} (${a.tasks.length} Görev)</option>`).join(""),O("applyTemplateModal")}async function Ms(){const e=document.getElementById("atmSelect").value;if(!e)return;B(!0);const{data:t,error:n}=await b.from("program_templates").select("*").eq("id",e).single();if(n||!t)return B(!1),h("Şablon yüklenemedi.");const a=l.students.find(s=>s.id===l.activeStuId),i=(a==null?void 0:a.weekStart)??0,o=ee(l.weekOffset,i);for(const s of t.tasks){const r=K(V(o,s.day_index)),d={student_id:l.activeStuId,coach_id:x.coachId,date:r,type:s.type,exam_type:s.exam_type,subject:s.subject,duration:s.duration,note:s.note,done:!1,task_items:s.task_items},{data:c,error:p}=await b.from("tasks").insert(d).select().single();if(!p&&c){const m=`${l.activeStuId}_${r}`;l.tasks[m]||(l.tasks[m]=[]),l.tasks[m].push({_id:c.id,type:c.type,exam:c.exam_type,subject:c.subject,duration:c.duration,note:c.note,done:!1,student_note:"",task_items:c.task_items})}}B(!1),F("applyTemplateModal"),W(),h("Şablon başarıyla uygulandı ✓")}function As(e,t){var o;const a=`${l.activeStuId}_${e}`,i=(o=l.tasks[a])==null?void 0:o[t];i&&(_clipboardTask={type:i.type,exam:i.exam,subject:i.subject,duration:i.duration,note:i.note,task_items:i.task_items},h("Görev panoya kopyalandı ✓"),W())}async function Ds(e){if(!_clipboardTask)return;const t={student_id:l.activeStuId,coach_id:x.coachId,date:e,type:_clipboardTask.type,exam_type:_clipboardTask.exam||null,subject:_clipboardTask.subject,duration:_clipboardTask.duration,note:_clipboardTask.note,done:!1,task_items:_clipboardTask.task_items};B(!0);const{data:n,error:a}=await b.from("tasks").insert(t).select().single();if(B(!1),a)return h("Hata: "+a.message);const i=`${l.activeStuId}_${e}`;l.tasks[i]||(l.tasks[i]=[]),l.tasks[i].push({_id:n.id,type:n.type,exam:n.exam_type,subject:n.subject,duration:n.duration,note:n.note,done:!1,student_note:"",task_items:n.task_items}),W(),h("Görev yapıştırıldı ✓")}async function Cs(e,t){var p;const n=`${l.activeStuId}_${e}`,a=(p=l.tasks[n])==null?void 0:p[t];if(!a)return;const i=l.students.find(m=>m.id===l.activeStuId),o=(i==null?void 0:i.weekStart)??0,s=ee(l.weekOffset,o),r=[];for(let m=0;m<7;m++){const u=V(s,m),f=K(u);f!==e&&r.push({student_id:l.activeStuId,coach_id:x.coachId,date:f,type:a.type,exam_type:a.exam||null,subject:a.subject,duration:a.duration,note:a.note,done:!1,task_items:a.task_items})}if(r.length===0)return;B(!0);const{data:d,error:c}=await b.from("tasks").insert(r).select();if(B(!1),c)return h("Hata: "+c.message);(d||[]).forEach(m=>{const u=`${l.activeStuId}_${m.date}`;l.tasks[u]||(l.tasks[u]=[]),l.tasks[u].push({_id:m.id,type:m.type,exam:m.exam_type,subject:m.subject,duration:m.duration,note:m.note,done:!1,student_note:"",task_items:m.task_items})}),W(),h("Görev tüm haftaya kopyalandı ✓")}async function Ls(){if(!_clipboardTask)return;const e=l.students.find(s=>s.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=ee(l.weekOffset,t),a=[];for(let s=0;s<7;s++){const r=V(n,s),d=K(r);a.push({student_id:l.activeStuId,coach_id:x.coachId,date:d,type:_clipboardTask.type,exam_type:_clipboardTask.exam||null,subject:_clipboardTask.subject,duration:_clipboardTask.duration,note:_clipboardTask.note,done:!1,task_items:_clipboardTask.task_items})}B(!0);const{data:i,error:o}=await b.from("tasks").insert(a).select();if(B(!1),o)return h("Hata: "+o.message);(i||[]).forEach(s=>{const r=`${l.activeStuId}_${s.date}`;l.tasks[r]||(l.tasks[r]=[]),l.tasks[r].push({_id:s.id,type:s.type,exam:s.exam_type,subject:s.subject,duration:s.duration,note:s.note,done:!1,student_note:"",task_items:s.task_items})}),_clipboardTask=null,W(),h("Görev tüm haftaya yapıştırıldı ✓")}ta();Kt();window.addEventListener("hashchange",()=>{let e=window.location.hash.substring(1);if(document.getElementById("appShell").classList.contains("visible")&&e!==currentTab){if(!e){e={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[x.role]||"portal",window.location.hash=e;return}document.getElementById("view-"+e)&&se(e,!1)}});async function Xt(){const e=document.getElementById("view-coach-applications");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:800px;margin:0 auto">
    ...
    </div>`).join("");const s=t.filter(d=>d.status==="pending").length,r=document.getElementById("sbi_coach-applications");if(r){const d=r.querySelector(".sb-badge");if(d&&d.remove(),s>0){const c=document.createElement("span");c.className="sb-badge",c.textContent=s,r.appendChild(c)}}}async function js(e,t,n,a){var o;const{error:i}=await b.from("match_requests").update({status:t}).eq("id",e);if(i)return h("Hata: "+i.message);h(t==="accepted"?"✓ Başvuru kabul edildi":"Başvuru reddedildi"),n&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"application_update",to:n,student_name:a||"",status:t,coach_name:((o=l.workspace)==null?void 0:o.brand_name)||"Koçunuz"})}).catch(s=>console.warn("[updateApplication] mail error:",s.message)),Xt()}let Ce=null;async function pa(){var a;const e=document.getElementById("view-coach-notes");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:860px;margin:0 auto">
  ...
  </div>`;const t=`coach_notes_${x.coachId}`,{data:n}=await b.from("platform_settings").select("value").eq("key",t).maybeSingle();Ce=((a=n==null?void 0:n.value)==null?void 0:a.notes)||[],Qt()}function Qt(){const e=document.getElementById("coachNotesList");if(!e)return;const t=Ce;if(!t.length){e.innerHTML=`<div style="grid-column:1/-1;text-align:center;padding:48px;color:var(--text-dim)">
      <div style="font-size:36px;margin-bottom:12px">📝</div>
    ...
    </div>`).join("")}function Ps(e){const t=e!==null?Ce[e]||{}:{};let n=document.getElementById("coachNoteModal");n||(n=document.createElement("div"),n.id="coachNoteModal",n.className="modal-bg",document.body.appendChild(n)),n.innerHTML=`<div class="modal" style="max-width:520px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
  ...
  </div>`,n.style.display="flex"}async function Rs(e){const t=document.getElementById("noteEditorTitle").value.trim(),n=document.getElementById("noteEditorBody").value.trim();if(!t&&!n)return h("Not boş olamaz");const a={title:t||"Başlıksız",body:n,updated:new Date().toISOString()};e===null?Ce.unshift(a):Ce[e]=a,await ma(),document.getElementById("coachNoteModal").style.display="none",Qt(),h("Not kaydedildi ✓")}async function Hs(e){await ae("Bu notu silmek istiyor musun?")&&(Ce.splice(e,1),await ma(),Qt(),h("Not silindi"))}async function ma(){const e=`coach_notes_${x.coachId}`;await b.from("platform_settings").upsert({key:e,value:{notes:Ce}},{onConflict:"key"})}window.toggleSidebar=ja;window.setupShell=Ra;window.switchTab=se;window.renderHome=xn;window.renderCoachApplications=Xt;window.updateApplication=js;window.renderCoachNotes=pa;window.openNoteEditor=Ps;window.toggleNewResourceMode=li;window.addManualTest=di;window.removeManualTest=ci;window.saveCoachNote=Rs;window.deleteCoachNote=Hs;window.renderStudentsSearch=Je;window.filterStudentSearch=Ha;window.openStudentDetail=bn;window.openKonuHaritasi=Ka;window.openStudentProgram=Ct;window.openStudentExams=Oa;window.openStudentAppointments=Fa;window.renderProfile=wn;window.saveProfile=Za;window.renderSettings=$n;window.saveGeminiKey=Ja;window.renderProgram=W;window.selectStu=Xa;window.chWeek=Qa;window.goToday=ei;window.openClearWeekModal=ni;window.toggleDaySel=ai;window.toggleAllDays=ii;window.confirmClearDays=oi;window.openTaskModal=pi;window.loadResources=_n;window.updateSubjectList=jt;window.updateBookList=mi;window.renderBookList=gt;window.filterBooks=ui;window.selectBook=gi;window.renderTestList=Pt;window.selectAllTests=vi;window.clearAllTests=fi;window.updateTestSummary=Ye;window.selectModalSpeed=yi;window.applyDuration=xi;window.loadStudentSpeeds=Sn;window.saveStudentSpeed=In;window.saveTask=bi;window.toggleTask=hi;window.closeTaskMenu=Rt;window.showTaskMenu=ki;window.copyTask=wi;window.deleteTask=$i;window.renderTodoList=An;window.renderStudents=Cn;window.goProgram=Ci;window.openStudentModal=Li;window.saveStudent=ji;window.showInviteInfo=Ln;window.copyInvite=Ri;window.deleteStu=Hi;window.renderAppointments=Xe;window.renderCalDays=vt;window.selCalDay=Yi;window.chCalMonth=Ni;window.renderApptList=Ht;window.openApptModal=Ki;window.saveAppt=Oi;window.deleteAppt=Fi;window.renderExams=Ne;window.openCommentModal=Vi;window.saveComment=Zi;window.deleteExam=Ji;window.renderMessages=Nn;window.selectThread=Xi;window.renderThreadHTML=Te;window.sendMsg=Qi;window.scrollMsgs=Ee;window.renderPortal=ft;window.stuToggleTask=eo;window.renderSPortal=_e;window.stuToggleTask2=to;window.chWeekS=no;window.openTaskDetail=Yt;window.toggleTaskDetail=oo;window.toggleDetailItem=so;window.selectVideoSpeed=ro;window.saveTaskDetail=lo;window.renderSExams=Nt;window.openStudentExamModal=Kn;window.openExamModal=co;window.renderNetInputs=Kt;window.saveExam=uo;window.renderSMessages=_t;window.initRealtime=Ot;window.destroyRealtime=Ft;window.renderDevDashboard=Fn;window.renderDevUsers=Qe;window.openDevUserModal=vo;window.devDeleteUser=fo;window.openPlanModal=yo;window.savePlan=xo;window.renderDevResources=et;window.openPlaylistModal=bo;window.fetchYouTubePlaylist=ho;window.savePlaylist=ko;window.openResourceModal=wo;window.saveResource=$o;window.devDeleteResource=To;window.renderDevFinance=yt;window.openPaymentModal=Eo;window.savePayment=_o;window.openSubModal=So;window.saveSub=Io;window.renderDevAnnounce=tt;window.openAnnounceModal=zo;window.saveAnnounce=Bo;window.toggleAnnounce=Mo;window.devDeleteAnnounce=Ao;window.renderDevTickets=Ke;window.updateTicketStatus=Po;window.devDeleteTicket=Ro;window.selectDevTicket=Do;window.sendDevReply=jo;window.openSupportTicket=Ho;window.openSupportChat=xt;window.closeSupportChat=qn;window.startAISupportChat=Yo;window.startEminSupportChat=No;window.submitEminInitialMessage=Ko;window.sendSupportMessage=Oo;window.openSupportChatDirect=xt;window.checkCoachSubscription=Dt;window.showTrialExpiredScreen=lt;window.loadAnnouncements=Gn;window.saveStudentDev=bs;window.showOnboarding=Vn;window.showOnboardingWidget=Go;window.renderSProfil=Zn;window.saveStudentProfile=Uo;window.changePassword=Wo;window.renderCoachProfile=Jn;window.updateProfilePreview=qt;window.switchPreviewTab=Zo;window.nl2br=Xn;window.saveCoachProfile=Jo;window.renderDevMatches=Gt;window.updateMatchRequestStatus=Xo;window.openSpeedModal=Qo;window.saveAllSpeeds=es;window.openStudentNotes=ts;window.saveStudentNote=ns;window.openReportModal=as;window.getReportDates=Ut;window.buildReportHTML=Wt;window.previewReport=is;window.generatePDF=os;window.openWeeklyPDFModal=rs;window.generateWeeklyPDF=ls;window.printWeeklyProgramWithNote=Qn;window.generateMeetLink=ds;window.generateZoomLink=cs;window.copyToClipboard=ps;window.loadTheme=ta;window.applyAccent=na;window.setTheme=ms;window.openThemePanel=us;window.initAIChatForRole=aa;window.toggleAIChat=gs;window.aiQuickSend=vs;window.buildAIContext=It;window.addAIMessage=fe;window.sendAIMessage=ia;window.autoDetectModel=oa;window.callGeminiFallback=we;window.generateAICopilotDraft=fs;window.checkCopilotDraftEdited=ys;window.sendCopilotDraft=xs;window.renderParentHome=sa;window.renderParentProgress=ra;window.renderParentAI=la;window.applyResFilter=Jt;window.updateCRFilter=hs;window.buildCRContent=bt;window.renderCoachResources=nt;window.switchCRTab=ks;window.compileResourceStats=da;window.openResourceModalCoach=ws;window.fetchYtPlaylistCoach=$s;window.saveResourceCoach=Ts;window.deleteResourceCoach=Es;window.importResourcesFromExcel=_s;window.importStudentsFromExcel=Ss;window.getTestStatus=ca;window.openCoachTaskEdit=Is;window.saveWeekAsTemplate=zs;window.applyTemplateToWeek=Bs;window.confirmApplyTemplate=Ms;window.copyTaskToClipboard=As;window.pasteTaskFromClipboard=Ds;window.copyTaskToWholeWeek=Cs;window.pasteTaskToWholeWeek=Ls;window.sendWhatsAppReport=ss;window.toggleUserMenu=Pa;window.closeUserMenu=yn;window.renderAgenda=he;window.openAgendaApptModal=Dn;window.deleteAgendaAppt=Di;window.agendaPrev=Si;window.agendaNext=Ii;window.agendaToday=zi;window.agendaSetFilter=Bi;window.exportAgendaICS=Mi;window.openApptPopup=Mn;window.handleApptDrop=Ai;window.openStudentKaynaklar=qa;window.addStudentBook=Ga;window.editStudentBook=Ua;window.sbUpdatePct=kn;window.saveStudentBook=Wa;window.deleteStudentBook=Va;async function Ys(){const e=document.getElementById("rpStuId").value,t=l.students.find(m=>m.id===e);if(!t)return;const n=document.getElementById("rpPeriod").value,{start:a,end:i}=Ut(),o=document.getElementById("rpNote").value.trim();let s="Performans Raporu";n==="weekly"?s="Haftalık Performans Raporu":n==="monthly"?s="Aylık Performans Raporu":s="Özel Dönem Performans Raporu";const r=`${s} (${a} - ${i})`,d=o||"Değerlendirme notu eklenmedi.";B(!0);const c=x.coachId||t.coachId,{error:p}=await b.from("reports").insert({student_id:e,coach_id:c,type:"performance",title:r,content:d,start_date:a,end_date:i});B(!1),p?h("Rapor kaydedilirken hata oluştu: "+p.message):(h("Rapor başarıyla geçmişe kaydedildi! ✓"),F("reportModal"))}async function ua(e){const t=l.students.find(s=>s.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&se("student-detail");const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${g(t.name)}</button>
  ...
  `,O("viewReportDetailModal")}function Ks(){const e=document.getElementById("viewReportDetailModal");if(!e)return;const t=e.querySelector("h3").textContent,n=e.querySelector("div div").textContent,a=e.querySelector('div[style*="pre-wrap"]').textContent,i=window.open("","_blank");i.document.write(`
    <html>
      <head>
        <title>${t}</title>
        <style>
  ...
  `),i.document.close()}async function Os(e,t){if(!await ae("Bu raporu kalıcı olarak silmek istediğinize emin misiniz?"))return;B(!0);const{error:a}=await b.from("reports").delete().eq("id",e);B(!1),a?h("Rapor silinirken hata oluştu: "+a.message):(h("Rapor başarıyla silindi ✓"),ua(t))}window.archivePerformanceReport=Ys;window.openPastReports=ua;window.viewArchivedReport=Ns;window.printActiveReport=Ks;window.deleteArchivedReport=Os;window.loadTheme&&window.loadTheme();window.renderNetInputs&&window.renderNetInputs();window.checkOAuthSession&&window.checkOAuthSession();const Fs=new URLSearchParams(window.location.search);if(Fs.get("sandbox")==="true")window.simOAuthLogin&&setTimeout(()=>{console.log("Sandbox auto-login triggered for demokoc..."),window.simOAuthLogin("demokoc")},300);else if(window.location.search.includes("sandbox")||window.location.hash==="#sandbox"){const e=document.getElementById("demoQuickWrap");e&&(e.style.display="flex"),window.showGoogleSimulator&&setTimeout(()=>window.showGoogleSimulator(),300)}"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{console.log("Service Worker başarıyla kaydedildi ✓",e.scope)}).catch(e=>{console.warn("Service Worker kaydı başarısız oldu:",e)})});window.addEventListener("hashchange",()=>{let e=window.location.hash.substring(1);if(document.getElementById("appShell").classList.contains("visible")&&e!==window.currentTab){if(!e){e={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[window.session.role]||"portal",window.location.hash=e;return}document.getElementById("view-"+e)&&window.switchTab(e,!1)}});console.log("Rostrum Akademi App initialized successfully ✓");
