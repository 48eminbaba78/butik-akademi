(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const l={students:[],tasks:{},appointments:[],exams:[],messages:{},coachTodos:{},weekOffset:0,calMonth:new Date().getMonth(),calYear:new Date().getFullYear(),calSelDay:null,activeStuId:null,msgThread:null,workspace:null,studentSpeeds:[],konuHaftaSoru:[]},b={role:null,studentId:null,dbUser:null,coachId:null,childName:null};window.S=l;window.session=b;window._loginMode="email";window.STU_DEFAULT_PASS="Rostrum"+Math.floor(1e3+Math.random()*9e3);window.DAYS_TR=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"];window.MONTHS_TR=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];window.EXAM_DEFS={TYT:["Türkçe","Matematik","Fen","Sosyal"],"AYT-SAY":["Matematik","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Edebiyat","Tarih","Coğrafya"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.EXAM_SORU={TYT:{Türkçe:40,Matematik:40,Fen:20,Sosyal:20},"AYT-SAY":{Matematik:40,Fizik:14,Kimya:13,Biyoloji:13},"AYT-EA":{Matematik:40,Edebiyat:24,Tarih:10,Coğrafya:6},"AYT-SOZ":{Edebiyat:24,Tarih1:10,Tarih2:11,Coğrafya1:6,Coğrafya2:11,Felsefe:12,Din:6}};window.EXAM_KONU_MAP={TYT_Türkçe:["Dil Bilgisi"],TYT_Matematik:["TYT Matematik","Geometri"],TYT_Fen:["TYT Fizik","TYT Kimya","TYT Biyoloji"],TYT_Sosyal:[],"AYT-SAY_Matematik":["AYT Matematik","Geometri"],"AYT-SAY_Fizik":["AYT Fizik"],"AYT-SAY_Kimya":["AYT Kimya"],"AYT-SAY_Biyoloji":["AYT Biyoloji"],"AYT-EA_Matematik":["AYT Matematik","Geometri"],"AYT-EA_Edebiyat":["Dil Bilgisi"]};window.SUBJECT_MAP={TYT:["Türkçe","Matematik","Geometri","Fizik","Kimya","Biyoloji","Tarih","Coğrafya","Felsefe","Din"],"AYT-SAY":["Matematik","Geometri","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Geometri","Edebiyat","Tarih","Coğrafya","Felsefe"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.currentTab="";window._clipboardTask=null;window._editingTaskId=null;window._regRole=null;window._onbRole=null;window._oauthUser=null;const ia="https://imyhenrwmsmyikpollur.supabase.co",oa="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlteWhlbnJ3bXNteWlrcG9sbHVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxNDE3ODYsImV4cCI6MjA5NTcxNzc4Nn0._ySJ5ArD1GYthyitHjdyEjLaUhextIwEqpRoF5ScI34",f=supabase.createClient(ia,oa);window.db=f;function pe(){var e;try{localStorage.setItem("ba_ui_"+(((e=b.dbUser)==null?void 0:e.id)||"x"),JSON.stringify({weekOffset:l.weekOffset,activeStuId:l.activeStuId,calMonth:l.calMonth,calYear:l.calYear}))}catch{}}function Fe(){pe()}function A(e){let t=document.getElementById("loadingOverlay");if(document.querySelectorAll(".btn-login, .btn-accent, .btn").forEach(a=>{e?(a.setAttribute("disabled","true"),a.style.opacity="0.6",a.style.pointerEvents="none"):(a.removeAttribute("disabled"),a.style.opacity="",a.style.pointerEvents="")}),e&&!t){if(t=document.createElement("div"),t.id="loadingOverlay",t.style.cssText="position:fixed;inset:0;background:rgba(15,14,12,.8);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:12px;backdrop-filter:blur(4px)",t.innerHTML='<div style="width:36px;height:36px;border:3px solid var(--border2);border-top-color:var(--accent);border-radius:50%;animation:spin .8s linear infinite"></div><div style="font-size:13px;color:var(--text-mid)">Yükleniyor...</div>',!document.getElementById("spinStyle")){const a=document.createElement("style");a.id="spinStyle",a.textContent="@keyframes spin{to{transform:rotate(360deg)}}",document.head.appendChild(a)}document.body.appendChild(t)}else!e&&t&&t.remove()}function v(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function H(e){return e instanceof Date?e.toISOString().split("T")[0]:e}function G(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function _e(){return H(new Date)}function St(e){return e>=20?"good":e>=12?"mid":"low"}function Ge(e){return{deneme:"📊 Deneme",soru:"📚 Soru",konu:"🎯 Konu",diger:"⭐ Diğer"}[e]||e}function N(e){document.getElementById(e).classList.add("open")}function K(e){document.getElementById(e).classList.remove("open")}function h(e){const t=document.getElementById("toast");t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),2300)}document.addEventListener("click",e=>{e.target.classList.contains("modal-bg")&&e.target.id!=="trialExpiredModal"&&e.target.classList.remove("open")});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".modal-bg.open").forEach(t=>{t.id!=="trialExpiredModal"&&t.classList.remove("open")})});function W(e,t=0){const n=new Date,a=n.getDay(),o=(a===0?6:a-1)-t,r=new Date(n);return r.setDate(n.getDate()-(o+7)%7+e*7),r.setHours(0,0,0,0),r}function sa(){const e=l.students.find(t=>t.id===l.activeStuId);return(e==null?void 0:e.weekStart)??0}async function me(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return[...new Uint8Array(t)].map(n=>n.toString(16).padStart(2,"0")).join("")}function Ee(e){return e?e.trim().toLowerCase().replace(/ç/g,"c").replace(/ğ/g,"g").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ş/g,"s").replace(/ü/g,"u").replace(/i̇/g,"i").replace(/ı/g,"i").replace(/i/g,"i").replace(/\s+/g,"").replace(/\u0307/g,""):""}function ra(){if(!("Notification"in window)){console.log("Bu tarayıcı anlık bildirimleri desteklemiyor.");return}Notification.permission!=="granted"&&Notification.permission!=="denied"?Notification.requestPermission().then(e=>{e==="granted"&&h("Bildirim izinleri onaylandı ✓")}):Notification.permission==="granted"?h("Bildirim izinleri zaten açık ✓"):h("Bildirim izinleri tarayıcı ayarlarından engellenmiş.")}window.saveUI=pe;window.saveS=Fe;window.showLoading=A;window.esc=v;window.fmtDate=H;window.addDays=G;window.todayStr=_e;window.netColor=St;window.typeLabel=Ge;window.om=N;window.cm=K;window.showToast=h;window.getWeekStart=W;window.getStudentWeekStart=sa;window.sha256=me;window.normalizeUsername=Ee;window.requestNotificationPermission=ra;async function la(e,t={}){let n=f.from(e).select("*");Object.entries(t).forEach(([o,r])=>{n=n.eq(o,r)});const{data:a,error:i}=await n;return i&&console.error(e,i),a||[]}const da=4*60*1e3;function It(){return"ra_d_"+(b.coachId||b.studentId||"x")}function en(){try{localStorage.removeItem(It())}catch{}}function Vt(){try{localStorage.setItem(It(),JSON.stringify({ts:Date.now(),students:l.students,tasks:l.tasks,appointments:l.appointments,exams:l.exams,messages:l.messages,coachTodos:l.coachTodos,studentSpeeds:l.studentSpeeds,workspace:l.workspace,konuHaftaSoru:l.konuHaftaSoru}))}catch{}}function ca(){try{const e=localStorage.getItem(It());if(!e)return!1;const t=JSON.parse(e);return!t.ts||Date.now()-t.ts>da?!1:(t.students&&(l.students=t.students),t.tasks&&(l.tasks=t.tasks),t.appointments&&(l.appointments=t.appointments),t.exams&&(l.exams=t.exams),t.messages&&(l.messages=t.messages),t.coachTodos&&(l.coachTodos=t.coachTodos),t.studentSpeeds&&(l.studentSpeeds=t.studentSpeeds),t.workspace&&(l.workspace=t.workspace),t.konuHaftaSoru&&(l.konuHaftaSoru=t.konuHaftaSoru),!0)}catch{return!1}}async function Zt(){var j;const e=b.coachId,t=b.role,n=t==="coach"||t==="developer"?f.from("workspaces").select("*").eq("coach_id",e).single():Promise.resolve({data:null});let a=f.from("users").select("*").eq("role","student");t==="student"?a=a.eq("id",b.studentId):(t==="coach"||t==="developer")&&(a=a.eq("coach_id",e));const i=a,o=new Date;o.setDate(o.getDate()-60);const r=o.toISOString().split("T")[0],s=new Date;s.setDate(s.getDate()-30);const d=s.toISOString().split("T")[0],c=t==="student"?f.from("tasks").select("*").eq("student_id",b.studentId).gte("date",r):t==="coach"||t==="developer"?f.from("tasks").select("*").eq("coach_id",e).gte("date",r):f.from("tasks").select("*").gte("date",r),p=t==="student"?f.from("appointments").select("*").eq("student_id",b.studentId).gte("date",d):t==="coach"||t==="developer"?f.from("appointments").select("*").eq("coach_id",e).gte("date",d):f.from("appointments").select("*").gte("date",d),m=t==="student"?f.from("exams").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?f.from("exams").select("*").eq("coach_id",e):f.from("exams").select("*"),u=t==="student"?f.from("messages").select("*").eq("student_id",b.studentId).order("created_at",{ascending:!1}).limit(200):t==="coach"||t==="developer"?f.from("messages").select("*").eq("coach_id",e).order("created_at",{ascending:!1}).limit(200):f.from("messages").select("*").order("created_at",{ascending:!1}).limit(200),y=t==="coach"||t==="developer"?f.from("coach_todos").select("*").eq("coach_id",e):Promise.resolve({data:[]}),E=t==="student"?f.from("student_speeds").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?f.from("student_speeds").select("*").eq("coach_id",e):f.from("student_speeds").select("*"),I=t==="coach"||t==="developer"?f.from("konu_mastery").select("*").eq("coach_id",e):t==="student"?f.from("konu_mastery").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),g=t==="coach"||t==="developer"?f.from("konu_tekrar_log").select("*").eq("coach_id",e):t==="student"?f.from("konu_tekrar_log").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),[x,k,S,_,L,T,z,$,M,D]=await Promise.all([n,i,c,p,m,u,y,E,I,g]);(t==="coach"||t==="developer")&&(l.workspace=x.data||null),l.students=(k.data||[]).map(w=>({id:w.id,name:w.full_name||w.username||"Öğrenci",target:w.target||"",color:w.color||"#4da6ff",progress:w.progress||0,weekStart:w.week_start||0,username:w.username,coachId:w.coach_id,yksArea:w.yks_area||"SAY"})),l.tasks={},(S.data||[]).forEach(w=>{const B=`${w.student_id}_${w.date}`;l.tasks[B]||(l.tasks[B]=[]),l.tasks[B].push({_id:w.id,type:w.type,exam:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,done:w.done,student_note:w.student_note||"",student_result:w.student_result||null,task_items:w.task_items})}),l.appointments=(_.data||[]).map(w=>({id:w.id,studentId:w.student_id,date:w.date,time:w.time,duration:w.duration,type:w.type,note:w.note,meetLink:w.meet_link})),l.exams=(L.data||[]).map(w=>({id:w.id,studentId:w.student_id,name:w.name,date:w.date,type:w.exam_type,nets:w.nets||{},examDetails:w.exam_details||{},note:w.student_note,coachComment:w.coach_comment})),l.messages={},(T.data||[]).forEach(w=>{l.messages[w.student_id]||(l.messages[w.student_id]=[]),l.messages[w.student_id].push({_id:w.id,from:w.from_role,text:w.text,read:w.read,time:new Date(w.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})})}),Object.keys(l.messages).forEach(w=>l.messages[w].sort((B,C)=>B._id>C._id?1:-1)),l.coachTodos={},(z.data||[]).forEach(w=>{l.coachTodos[w.date]||(l.coachTodos[w.date]=[]),l.coachTodos[w.date].push({_id:w.id,task:w.task,note:w.note,done:w.done})}),l.studentSpeeds=$.data||[],l.konuMastery={},(M.data||[]).forEach(w=>{l.konuMastery[w.student_id]||(l.konuMastery[w.student_id]={}),l.konuMastery[w.student_id][w.subject]||(l.konuMastery[w.student_id][w.subject]={}),l.konuMastery[w.student_id][w.subject][w.konu]=w}),l.konuTekrarLog={},(D.data||[]).forEach(w=>{l.konuTekrarLog[w.student_id]||(l.konuTekrarLog[w.student_id]={}),l.konuTekrarLog[w.student_id][w.subject]||(l.konuTekrarLog[w.student_id][w.subject]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu]||(l.konuTekrarLog[w.student_id][w.subject][w.konu]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu][w.period_start]=w});try{const w=JSON.parse(localStorage.getItem("ba_ui_"+((j=b.dbUser)==null?void 0:j.id))||"{}");w.weekOffset!==void 0&&(l.weekOffset=w.weekOffset),w.activeStuId&&(l.activeStuId=w.activeStuId),w.calMonth!==void 0&&(l.calMonth=w.calMonth,l.calYear=w.calYear)}catch{}}async function tn(){if(ca()){Zt().then(()=>{if(Vt(),window.currentTab)try{window.switchTab(window.currentTab)}catch{}}).catch(t=>console.error("Arka plan yenileme hatası:",t));return}A(!0);try{await Zt(),Vt()}catch(t){console.error("loadAllData error",t)}A(!1)}window.dbQ=la;window.loadAllData=tn;window.invalidateCache=en;let ke=!1;function ne(e){const t=document.getElementById("loginErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Ye(e){const t=document.getElementById("regErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function nn(e){document.getElementById("loginPanel").style.display=e==="login"?"block":"none",document.getElementById("registerPanel").style.display=e==="register"?"block":"none",document.getElementById("lmtLogin").classList.toggle("active",e==="login"),document.getElementById("lmtRegister").classList.toggle("active",e==="register")}function pa(e){window._loginMode=e,document.querySelectorAll("#loginTabs .login-tab").forEach((t,n)=>t.classList.toggle("active",n===(e==="email"?0:1))),document.getElementById("loginEmailField").style.display=e==="email"?"block":"none",document.getElementById("loginUserField").style.display=e==="username"?"block":"none"}function ma(e){window._regRole=e,document.getElementById("rrbCoach").classList.toggle("sel",e==="coach"),document.getElementById("rrbStudent").classList.toggle("sel",e==="student")}function ua(e){window._onbRole=e,document.getElementById("onbRoleCoach").classList.toggle("sel",e==="coach"),document.getElementById("onbRoleStudent").classList.toggle("sel",e==="student")}async function ga(){if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.protocol==="file:"){on();return}await an()}async function an(){_t(),A(!0);try{const{error:e}=await f.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin+"/app.html",queryParams:{access_type:"offline",prompt:"select_account"}}});e&&(A(!0),console.warn("Google Auth failed:",e),ne("Google Girişi Başlatılamadı: "+e.message))}catch(e){A(!1),ne("Google Girişi Başlatılamadı: "+e.message)}}function on(){document.getElementById("googleSimulatorModal").style.display="flex"}function _t(){document.getElementById("googleSimulatorModal").style.display="none"}async function va(e){if(_t(),A(!0),e==="demokoc"){const{data:t,error:n}=await f.from("users").select("*").eq("username","demokoc").maybeSingle();if(n||!t){A(!1),ne("Demo koç profili bulunamadı!");return}await Se(t)}else if(e==="demoogrenci"){const{data:t,error:n}=await f.from("users").select("*").eq("username","demoogrenci").maybeSingle();if(n||!t){A(!1),ne("Demo öğrenci profili bulunamadı!");return}await Se(t)}else if(e==="new"){A(!1),document.getElementById("newUserOnboarding").style.display="flex";const t=Math.floor(1e3+Math.random()*9e3),n=`yeni.kullanici${t}@gmail.com`;document.getElementById("onbEmail").textContent=n,document.getElementById("onbName").value=`Yeni Kullanıcı ${t}`,window._oauthUser={id:`mock-google-id-${t}`,email:n,user_metadata:{full_name:`Yeni Kullanıcı ${t}`}}}}async function sn(){var t,n,a;if(ke)return;ke=!0;let e=null;try{console.log("[Auth] 1/4 getSession...");const{data:{session:i}}=await f.auth.getSession();if(console.log("[Auth] 2/4 session:",((t=i==null?void 0:i.user)==null?void 0:t.email)||"yok"),!(i!=null&&i.user)){ke=!1;return}if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible")){ke=!1;return}A(!0),e=setTimeout(()=>{console.warn("[Auth] timeout — Supabase yanıt vermedi, spinner kapatılıyor"),ke=!1,A(!1)},1e4),console.log("[Auth] 3/4 profil yükleniyor...");const{data:o,error:r}=await f.from("users").select("*").eq("id",i.user.id).maybeSingle();console.log("[Auth] 4/4 profil:",o==null?void 0:o.role,(r==null?void 0:r.message)||""),clearTimeout(e);let s=!1;if(o){if(o.role==="coach"){const{data:d}=await f.from("workspaces").select("*").eq("coach_id",o.id).maybeSingle();(!d||!d.onboarding_done)&&(s=!0)}}else s=!0;o&&!s?await Se(o):(A(!1),document.getElementById("newUserOnboarding").style.display="flex",document.getElementById("onbEmail").textContent=i.user.email,document.getElementById("onbName").value=((a=i.user.user_metadata)==null?void 0:a.full_name)||"",window._oauthUser=i.user)}catch(i){clearTimeout(e),ke=!1,A(!1),console.warn("[checkOAuthSession]",i)}}async function ya(){const e=document.getElementById("onbName").value.trim();if(!e){document.getElementById("onbErr").textContent="Ad soyad zorunlu",document.getElementById("onbErr").style.display="block";return}if(!window._onbRole){document.getElementById("onbErr").textContent="Hesap türü seçin",document.getElementById("onbErr").style.display="block";return}document.getElementById("onbErr").style.display="none",A(!0);const t=window._oauthUser,n=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""),a={id:t.id,full_name:e,email:t.email,role:window._onbRole,username:n+"_"+Math.random().toString(36).slice(2,6),password_hash:"supabase_managed",color:window._onbRole==="coach"?"#f0a500":"#4da6ff",week_start:0,progress:0,target:""},{data:i,error:o}=await f.from("users").upsert(a).select().single();if(o){A(!1),document.getElementById("onbErr").textContent="Hata: "+o.message,document.getElementById("onbErr").style.display="block";return}document.getElementById("newUserOnboarding").style.display="none",await Se(i)}async function fa(){const e=document.getElementById("regName").value.trim(),t=document.getElementById("regEmail").value.trim().toLowerCase(),n=document.getElementById("regPass").value;if(!e||!t||!n)return Ye("Tüm alanlar zorunlu");if(n.length<8)return Ye("Şifre en az 8 karakter olmalıdır");if(!window._regRole)return Ye("Hesap türü seçin");A(!0);try{const{data:a,error:i}=await f.auth.signUp({email:t,password:n,options:{data:{full_name:e,role:window._regRole}}});if(i)throw i;if(a!=null&&a.user){A(!1),document.getElementById("regName").value="",document.getElementById("regEmail").value="",document.getElementById("regPass").value="";const o=document.getElementById("regSuccess");o.textContent="Kayıt başarılı! E-posta adresinize bir doğrulama bağlantısı gönderildi. Lütfen doğrulama yaptıktan sonra giriş yapın.",o.style.display="block",setTimeout(()=>o.style.display="none",1e4),nn("login")}}catch(a){A(!1),Ye("Kayıt Hatası: "+a.message)}}async function xa(){const e=(document.getElementById("loginEmail").value||document.getElementById("loginUser").value||"").trim(),t=document.getElementById("loginPass").value;if(!e||!t)return ne("Kullanıcı adı ve şifre zorunlu");A(!0);const n=setTimeout(()=>{A(!1),ne("Bağlantı zaman aşımına uğradı. Supabase yanıt vermiyor — lütfen tekrar deneyin.")},15e3);try{let a=e;a.includes("@")?a=a.toLowerCase():a=Ee(e)+"@rostrumakademi.com";const{data:i,error:o}=await f.auth.signInWithPassword({email:a,password:t});if(!o&&(i!=null&&i.user)){const{data:r,error:s}=await f.from("users").select("*").eq("id",i.user.id).maybeSingle();if(s&&console.error("Profile fetch error:",s),r){clearTimeout(n),await Se(r);return}return A(!1),ne("Hesabınız veritabanında aktif değil.")}try{const r=Ee(e.includes("@")?e.split("@")[0]:e),s=await me(t),{data:d}=await f.rpc("get_user_by_credentials",{p_username:r,p_password_hash:s}),c=Array.isArray(d)?d[0]:d;if(c){clearTimeout(n),await Se(c);return}}catch(r){console.warn("Fallback RPC error:",r)}return A(!1),ne(o?"Giriş başarısız: "+o.message:"Kullanıcı adı veya şifre hatalı.")}catch(a){return A(!1),console.error("[doLogin]",a),ne("Giriş hatası: "+a.message)}finally{clearTimeout(n)}}async function Se(e){A(!1);const t=e.role==="coach"||e.role==="developer"?e.id:e.role==="student"||e.role==="parent"?e.coach_id:null;b.role=e.role,b.studentId=e.role==="student"?e.id:null,b.dbUser=e,b.coachId=t,document.getElementById("loginScreen").style.display="none",document.getElementById("appShell").classList.add("visible");try{if(await tn(),b.role==="student"&&(l.activeStuId=e.id,b.studentId=e.id,l.students.find(o=>o.id===e.id)||l.students.push({id:e.id,name:e.full_name||e.username||"Öğrenci",target:e.target||"",color:e.color||"#4da6ff",progress:e.progress||0,weekStart:e.week_start||0,username:e.username,coachId:e.coach_id})),b.role==="parent"){const{data:o}=await f.from("users").select("*").eq("parent_id",e.id).single();o&&(l.activeStuId=o.id,b.studentId=o.id,b.childName=o.full_name||o.username)}if(window.setupShell(),document.getElementById("aiChatBubble").style.display="flex",(b.role==="coach"||b.role==="developer")&&(!l.workspace||!l.workspace.onboarding_done)){window.switchTab("home"),window.showOnboarding();return}const n=window.location.hash.substring(1),a={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[b.role]||"portal",i=n&&document.getElementById("view-"+n)?n:a;setTimeout(()=>window.switchTab(i),50)}catch(n){A(!1),console.error("[doLogin] HATA:",n),ne("Hata: "+n.message),document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible")}}function ba(){window._fcInstance&&(window._fcInstance.destroy(),window._fcInstance=null),window.destroyRealtime&&window.destroyRealtime(),f.auth.signOut().catch(()=>{}),en(),b.role=null,b.studentId=null,b.dbUser=null,b.coachId=null,b.childName=null,l.workspace=null,document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible"),document.getElementById("aiChatBubble").style.display="none",document.getElementById("aiChatPanel").classList.remove("open"),document.getElementById("loginEmail")&&(document.getElementById("loginEmail").value=""),document.getElementById("loginUser")&&(document.getElementById("loginUser").value=""),document.getElementById("loginPass").value="",window.location.hash=""}function ha(){window.om("forgotPassModal")}async function ka(){const e=document.getElementById("forgotEmail").value.trim();if(!e)return;const t=document.getElementById("forgotMsg");try{const{error:n}=await f.auth.resetPasswordForEmail(e,{redirectTo:window.location.origin+"/app.html"});if(n)throw n;t.style.display="block",t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="Sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin."}catch(n){t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Hata: "+(n.message||"Bir sorun oluştu.")}}async function wa(){const e=document.getElementById("newPasswordInput").value;if(!e||e.length<8){alert("Şifre en az 8 karakter olmalıdır.");return}A(!0);try{const{error:t}=await f.auth.updateUser({password:e});if(t)throw t;const n=await me(e),{data:{user:a}}=await f.auth.getUser();a&&await f.from("users").update({password_hash:n}).eq("id",a.id),alert("Şifreniz başarıyla güncellendi! Lütfen yeni şifrenizle giriş yapın."),window.cm("resetPasswordModal"),await f.auth.signOut(),window.location.hash="",window.location.reload()}catch(t){alert("Şifre güncellenirken hata oluştu: "+t.message)}finally{A(!1)}}window.loginErr=ne;window.regErr=Ye;window.setAuthMode=nn;window.setLoginMode=pa;window.setRegRole=ma;window.setOnbRole=ua;window.loginWithGoogle=ga;window.triggerRealGoogleLogin=an;window.showGoogleSimulator=on;window.closeGoogleSimulator=_t;window.simOAuthLogin=va;window.checkOAuthSession=sn;window.completeOnboarding=ya;window.doRegister=fa;window.doLogin=xa;window.finishLogin=Se;window.doLogout=ba;window.showForgotPassword=ha;window.sendResetEmail=ka;window.updateUserPassword=wa;f.auth.onAuthStateChange(async(e,t)=>{var n;if(e==="PASSWORD_RECOVERY"){window.om("resetPasswordModal");return}if(e==="SIGNED_IN"&&(t!=null&&t.user)){if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible"))return;await sn()}e==="SIGNED_OUT"&&(ke=!1,A(!1))});function Xt(){const e=document.getElementById("loginEmail"),t=document.getElementById("loginUser");e&&t&&(e.addEventListener("input",n=>{t.value=n.target.value}),t.addEventListener("input",n=>{e.value=n.target.value}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xt):Xt();function Ne(e){if(!e||e<=0)return"0 sa";const t=Math.floor(e/60),n=e%60;return t>0&&n>0?`${t} sa ${n} dk`:t>0?`${t} sa`:`${n} dk`}window.formatMinToHours=Ne;function X(e){return new Promise(t=>{let n=document.getElementById("customConfirmModal");n||(n=document.createElement("div"),n.id="customConfirmModal",n.className="modal-bg",n.style.zIndex="999999",n.innerHTML=`
    ...
    <div class="home-bottom-grid">
      ...
      <div class="home-section-card">
        ...
        <div class="hsc-body">
          ...
          ${d.map(T=>{const z=l.students.find(P=>P.id===T.studentId),$=T.time<E,[M,D]=T.time.split(":").map(Number),j=M*60+D,[w,B]=E.split(":").map(Number),C=w*60+B,Y=j-C,R=Y>=-(T.duration||60)&&Y<=15,U=R&&T.meet_link?`<a href="${v(T.meet_link)}" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;background:${Y<=0?"var(--red)":"var(--accent)"};color:${Y<=0?"white":"#0f0e0c"};font-size:11px;font-weight:800;text-decoration:none;animation:${Y<=0?"pulse 1.5s infinite":"none"};white-space:nowrap;flex-shrink:0">${Y<=0?"🔴 Ders Sürüyor":"🟡 Derse Gir"}</a>`:"";return`<div class="hsc-appt-row ${$&&!R?"hsc-appt-past":""}">
              ...
              <div style="flex:1;min-width:0">
                ...
                <div class="hsc-appt-meta">${v(T.type)} · ${T.duration} dk${!R&&T.meet_link?` · <a href="${v(T.meet_link)}" target="_blank" style="color:var(--blue);text-decoration:none">${T.meet_link.includes("zoom")?"Zoom":"Meet"} →</a>`:""}</div>
              </div>
    ...
    </div>`}catch(a){console.error("[renderHome] HATA:",a),e.innerHTML=`<div style='padding:24px;color:var(--text)'><b>İyi günler 👋</b><p style='color:var(--text-mid);margin-top:6px'>Hata: ${v(a.message)}</p></div>`}}function qe(){const e=document.getElementById("view-students"),t=W(0,0),n={};l.students.forEach(r=>{let s=0,d=0,c=0,p=0;for(let m=0;m<7;m++)(l.tasks[`${r.id}_${H(G(t,m))}`]||[]).forEach(y=>{s++,c+=Number(y.duration||0),y.done&&(d++,p+=Number(y.duration||0))});n[r.id]={total:s,done:d,totalMin:c,doneMin:p}});const a=l.students.length,i=l.students.filter(r=>{const s=n[r.id];return s&&s.total>0}).length,o=l.students.filter(r=>{const s=n[r.id];return s&&s.total>0&&s.done===s.total}).length;e.innerHTML=`<div style="max-width:640px;margin:0 auto">
    <!-- Üst başlık -->
  ...
  </div>`}function Sa(){const e=document.getElementById("stuSearchInput").value.trim().toLowerCase(),t=document.getElementById("stuSearchNoResults");let n=0;l.students.forEach(a=>{const i=document.getElementById("sturow_"+a.id);if(i){const o=a.name.toLowerCase().includes(e);i.style.display=o?"flex":"none",o&&n++}}),t&&(t.style.display=e&&n===0?"block":"none")}function mn(e){if(!l.students.find(p=>p.id===e))return;l.activeStuId=e;const t=l.students.find(p=>p.id===l.activeStuId),n=W(0,t.weekStart||0);let a=0,i=0,o=0;for(let p=0;p<7;p++){const m=l.tasks[`${t.id}_${H(G(n,p))}`]||[];a+=m.length,i+=m.filter(u=>u.done).length,o+=m.reduce((u,y)=>u+Number(y.duration||0),0)}const r=a>0?Math.round(i/a*100):0,s=r>=80?"var(--green)":r>=50?"var(--accent)":"var(--red)",d=document.getElementById("view-student-detail");d.innerHTML=`
    ...
    <div class="card" style="margin-top:16px; border: 1px dashed var(--accent); padding: 18px; border-radius: 14px; background: var(--surface)">
    ...
    </div>`,currentTab!=="student-detail"&&Q("student-detail");const c=document.getElementById("tbarTitle");c&&(c.textContent=t.name)}const Be=[{stars:0,label:"Başlanmadı",color:"#6b7280",bg:"rgba(107,114,128,.08)",border:"rgba(107,114,128,.2)"},{stars:1,label:"Anlamadım",color:"#ef4444",bg:"rgba(239,68,68,.08)",border:"rgba(239,68,68,.2)"},{stars:2,label:"Temel Zorluk",color:"#f97316",bg:"rgba(249,115,22,.08)",border:"rgba(249,115,22,.2)"},{stars:3,label:"Temel OK",color:"#eab308",bg:"rgba(234,179,8,.08)",border:"rgba(234,179,8,.2)"},{stars:4,label:"Orta Seviye",color:"#84cc16",bg:"rgba(132,204,22,.08)",border:"rgba(132,204,22,.2)"},{stars:5,label:"İleri Seviye",color:"#22c55e",bg:"rgba(34,197,94,.08)",border:"rgba(34,197,94,.2)"},{stars:6,label:"Uzman",color:"#10b981",bg:"rgba(16,185,129,.08)",border:"rgba(16,185,129,.2)"},{stars:7,label:"Tekrar Dışı (TD)",color:"#3b82f6",bg:"rgba(59,130,246,.1)",border:"rgba(59,130,246,.3)"}];function un(e){const t=new Date(e),n=t.getDate(),a=n<=10?1:n<=20?11:21;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function Ia(e=6){const t=[],n=new Date;let a=new Date(n);for(let i=0;i<e;i++){const o=un(a);t.find(c=>c.start===o)||t.unshift({start:o,label:_a(o)});const[r,s,d]=o.split("-").map(Number);if(d===21?a=new Date(r,s-1,11):d===11?a=new Date(r,s-1,1):a=new Date(r,s-2,21),t.length>=e)break}return t.slice(-e)}function _a(e){const[t,n,a]=e.split("-").map(Number),i=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],o=a===1?10:a===11?20:new Date(t,n,0).getDate();return`${a}-${o} ${i[n-1]}`}const Jt={SAY:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","TYT Fizik","AYT Fizik","TYT Kimya","AYT Kimya","TYT Biyoloji","AYT Biyoloji"],EA:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],SOZ:["Dil Bilgisi","TYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],DIL:["Dil Bilgisi","TYT Matematik","Geometri","YDT İngilizce"]};async function za(e){const t=l.students.find(g=>g.id===e);if(!t)return;const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button><div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`;const a=b.role==="coach"||b.role==="developer",i=t.yksArea||"SAY",o=Jt[i]||Jt.SAY;let r=o[0],s="mastery";function d(g,x){var k,S;return((S=(k=l.konuMastery[e])==null?void 0:k[g])==null?void 0:S[x])||null}function c(g,x){var k,S;return((S=(k=l.konuTekrarLog[e])==null?void 0:k[g])==null?void 0:S[x])||{}}async function p(g,x,k,S){const _=d(g,x),L=new Date().toISOString(),T=S||(k>=7?"td":k>0?"active":"not_started"),z={student_id:e,coach_id:b.coachId,subject:g,konu:x,stars:k,status:T,updated_at:L,...T==="active"&&!(_!=null&&_.ka_date)?{ka_date:L}:{},...T==="td"&&!(_!=null&&_.td_date)?{td_date:L}:{},...T==="active"&&(_==null?void 0:_.status)==="td"?{td_date:null}:{}},{data:$,error:M}=await f.from("konu_mastery").upsert(z,{onConflict:"student_id,subject,konu"}).select().single();if(M){h("Hata: "+M.message);return}return l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][g]||(l.konuMastery[e][g]={}),l.konuMastery[e][g][x]=$,$}async function m(g,x,k,S){const _=new Date().toISOString(),L={student_id:e,coach_id:b.coachId,subject:g,konu:x,period_start:k,review_count:S,updated_at:_},{data:T,error:z}=await f.from("konu_tekrar_log").upsert(L,{onConflict:"student_id,subject,konu,period_start"}).select().single();if(z){h("Hata: "+z.message);return}return l.konuTekrarLog[e]||(l.konuTekrarLog[e]={}),l.konuTekrarLog[e][g]||(l.konuTekrarLog[e][g]={}),l.konuTekrarLog[e][g][x]||(l.konuTekrarLog[e][g][x]={}),l.konuTekrarLog[e][g][x][k]=T,T}function u(g){const x=Ke[g]||[],k=x.map(($,M)=>{const D=d(g,$),j=(D==null?void 0:D.stars)||0,w=(D==null?void 0:D.status)||"not_started",B=Be[j],C=w==="td",Y=M%2===0?"var(--surface)":"var(--surface2)",R=c(g,$),U=Object.values(R).reduce((he,ge)=>he+(ge.review_count||0),0),P=D!=null&&D.last_review_date?new Date(D.last_review_date).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"}):"—",F=a?Array.from({length:7},(he,ge)=>{const oe=ge+1,de=oe<=j,vt=g.replace(/'/g,"\\'"),yt=$.replace(/'/g,"\\'");return`<span class="km-star${de?" km-star-on":""}" data-stars="${oe}" 
      ...
      <span style="font-size:11px;color:var(--text-dim)"><b style="color:var(--text)">${x.length}</b> konu</span>
      ...
      <div style="flex:1;height:6px;background:var(--surface3);border-radius:99px;overflow:hidden;min-width:80px;max-width:200px">
        <div style="height:100%;width:${x.length>0?Math.round(L/x.length*100):0}%;background:#3b82f6;border-radius:99px"></div>
      </div>
      <span style="font-size:11px;color:#3b82f6;font-weight:700">${x.length>0?Math.round(L/x.length*100):0}% TD</span>
    ...
    </div>`}function y(g){const x=Ke[g]||[],k=Ia(6),S=un(new Date),_=`<tr style="background:var(--surface2)">
      <th style="padding:8px 14px;text-align:left;font-size:10px;font-weight:800;color:var(--text-dim);border-right:1px solid var(--border);position:sticky;left:0;z-index:2;background:var(--surface2);white-space:nowrap;min-width:200px">KONU</th>
    ...
    </tr>`,L=x.map((T,z)=>{const $=d(g,T),M=($==null?void 0:$.stars)||0,j=(($==null?void 0:$.status)||"not_started")==="td",w=Be[M],B=z%2===0?"var(--surface)":"var(--surface2)",C=c(g,T);let Y=0;const R=k.map(P=>{const F=C[P.start],Z=(F==null?void 0:F.review_count)||0;Y+=Z;const le=P.start===S;if(a){const he=Array.from({length:6},(ge,oe)=>{const de=oe<Z,vt=g.replace(/'/g,"\\'"),yt=T.replace(/'/g,"\\'");return`<span class="kt-box${de?" kt-box-on":""}"
      ...
      </tr>`}).join("");return`<div style="overflow-x:auto"><table style="border-collapse:collapse;width:max-content;min-width:100%"><thead>${_}</thead><tbody>${L}</tbody></table></div>`}window._kmSetStars=async function(g,x,k){const S=d(g,x),_=(S==null?void 0:S.status)==="td"&&k<7?"active":null;await p(g,x,k,_);const L="km_"+btoa(encodeURIComponent(g+"|"+x)).replace(/[^a-zA-Z0-9]/g,"");if(document.getElementById(L)){const z=u(g);document.getElementById("khTable").innerHTML=z}h(`${x}: ${Be[k].label} ✓`)},window._kmToggleKA=async function(g,x){const k=d(g,x),S=new Date().toISOString(),_=!!(k!=null&&k.ka_date),L={student_id:e,coach_id:b.coachId,subject:g,konu:x,stars:(k==null?void 0:k.stars)||1,status:(k==null?void 0:k.status)||"active",ka_date:_?null:S,updated_at:S},{data:T,error:z}=await f.from("konu_mastery").upsert(L,{onConflict:"student_id,subject,konu"}).select().single();if(z){h("Hata: "+z.message);return}l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][g]||(l.konuMastery[e][g]={}),l.konuMastery[e][g][x]=T,document.getElementById("khTable").innerHTML=u(g),h(_?"KA tarihi kaldırıldı":"KA ✓ tamamlandı olarak işaretlendi")},window._kmToggleTD=async function(g,x){const k=d(g,x),S=(k==null?void 0:k.status)==="td",_=S?(k==null?void 0:k.stars)>=7?5:k==null?void 0:k.stars:7;await p(g,x,_,S?"active":"td"),document.getElementById("khTable").innerHTML=s==="mastery"?u(g):y(g),h(S?`${x} tekrar listesine geri döndü`:`${x} → TD ✓`)},window._ktToggleBox=async function(g,x,k,S){const L=c(g,x)[k],z=((L==null?void 0:L.review_count)||0)>=S?S-1:S;if(await m(g,x,k,z),z>0){const $=d(g,x),M=new Date().toISOString(),D={student_id:e,coach_id:b.coachId,subject:g,konu:x,stars:($==null?void 0:$.stars)||0,status:($==null?void 0:$.status)||"active",last_review_date:M,review_count:(($==null?void 0:$.review_count)||0)+1,updated_at:M},{data:j}=await f.from("konu_mastery").upsert(D,{onConflict:"student_id,subject,konu"}).select().single();j&&(l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][g]||(l.konuMastery[e][g]={}),l.konuMastery[e][g][x]=j)}document.getElementById("khTable").innerHTML=y(g)};function E(){const g=window._khActiveSub||r;document.getElementById("khTable").innerHTML=s==="mastery"?u(g):y(g)}const I=o.map(g=>`<button class="kh-tab" onclick="window._khActiveSub='${g}';document.querySelectorAll('.kh-tab').forEach(b=>{b.style.color='var(--text-mid)';b.style.borderBottom='2px solid transparent';b.style.fontWeight='600'});this.style.color='var(--accent)';this.style.borderBottom='2px solid var(--accent)';this.style.fontWeight='700';window._khRefresh()"
    ...
    </div>`,window._kmSwitchView=function(g){s=g;const x=document.getElementById("kmViewMastery"),k=document.getElementById("kmViewTekrar");g==="mastery"?(x.style.background="var(--accent)",x.style.color="#fff",x.style.fontWeight="700",k.style.background="var(--surface)",k.style.color="var(--text-mid)",k.style.fontWeight="600"):(k.style.background="var(--accent)",k.style.color="#fff",k.style.fontWeight="700",x.style.background="var(--surface)",x.style.color="var(--text-mid)",x.style.fontWeight="600"),window._khRefresh()}}function Bt(e){var i,o;l.activeStuId=e;const t=document.getElementById("view-program"),n=((i=l.students.find(r=>r.id===l.activeStuId))==null?void 0:i.name)||"";t.innerHTML=`<button class="back-link" onclick="switchTab('student-detail')">← ${n}</button>`,t.innerHTML+=document.createElement("div").innerHTML,currentTab!=="program"&&Q("program");const a=document.getElementById("tbarTitle");a&&(a.textContent=(((o=l.students.find(r=>r.id===l.activeStuId))==null?void 0:o.name)||"")+" · Program"),q()}function Ba(e){var n;l.activeStuId=e,currentTab!=="exams"&&Q("exams");const t=document.getElementById("tbarTitle");t&&(t.textContent=(((n=l.students.find(a=>a.id===l.activeStuId))==null?void 0:n.name)||"")+" · Denemeler"),je()}function Ma(e){var n;l.activeStuId=e,currentTab!=="appointments"&&Q("appointments");const t=document.getElementById("tbarTitle");t&&(t.textContent=(((n=l.students.find(a=>a.id===l.activeStuId))==null?void 0:n.name)||"")+" · Randevular"),Ue()}let re={};async function Aa(e){const t=l.students.find(a=>a.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&Q("student-detail");const n=document.getElementById("view-student-detail");if(n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button>
    ...
    ${c}`}function Da(e){document.getElementById("sbModalTitle").textContent="Kaynak Ekle",document.getElementById("sbId").value="",document.getElementById("sbStuId").value=e,document.getElementById("sbName").value="",document.getElementById("sbTotal").value="0",document.getElementById("sbCompleted").value="0",document.getElementById("sbPctPreview").innerHTML="",N("sbModal")}function La(e,t){const n=(re[e]||[]).find(a=>a.id===t);n&&(document.getElementById("sbModalTitle").textContent="Kaynağı Düzenle",document.getElementById("sbId").value=t,document.getElementById("sbStuId").value=e,document.getElementById("sbName").value=n.name,document.getElementById("sbTotal").value=n.total_tests,document.getElementById("sbCompleted").value=n.completed_tests,gn(),N("sbModal"))}function gn(){var o,r;const e=parseInt((o=document.getElementById("sbTotal"))==null?void 0:o.value)||0,t=parseInt((r=document.getElementById("sbCompleted"))==null?void 0:r.value)||0,n=document.getElementById("sbPctPreview");if(!n||!e){n&&(n.innerHTML="");return}const a=Math.min(100,Math.round(t/e*100)),i=a>=75?"var(--green)":a>=40?"var(--accent)":"var(--red)";n.innerHTML=`<div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;height:8px;background:var(--surface3);border-radius:99px;overflow:hidden">
  ...
  </div>`}async function Ca(){const e=document.getElementById("sbName").value.trim();if(!e)return h("Kaynak adı girin!");const t=Math.max(0,parseInt(document.getElementById("sbTotal").value)||0),n=Math.min(t,Math.max(0,parseInt(document.getElementById("sbCompleted").value)||0)),a=document.getElementById("sbStuId").value,i=document.getElementById("sbId").value,o={name:e,total_tests:t,completed_tests:n};if(i){const{error:r}=await f.from("student_books").update(o).eq("id",i);if(r)return h("Hata: "+r.message);const s=(re[a]||[]).find(d=>d.id===i);s&&Object.assign(s,o),h("Güncellendi ✓")}else{const{data:r,error:s}=await f.from("student_books").insert({...o,student_id:a,coach_id:b.coachId}).select().single();if(s)return h("Hata: "+s.message);re[a]||(re[a]=[]),re[a].push(r),h("Kaynak eklendi ✓")}K("sbModal"),Mt(a)}async function ja(e,t){if(!await X("Bu kaynağı silmek istiyor musunuz?"))return;const{error:n}=await f.from("student_books").delete().eq("id",t);if(n)return h("Hata: "+n.message);re[e]=(re[e]||[]).filter(a=>a.id!==t),Mt(e),h("Silindi ✓")}function vn(){var i,o;const e=document.getElementById("view-profile"),t=b.dbUser,n=((t==null?void 0:t.full_name)||"?").split(" ").map(r=>r[0]).join("").slice(0,2).toUpperCase(),a=b.role==="coach"?"Koç":b.role==="developer"?"Developer":"Öğrenci";e.innerHTML=`
    ...
    </div>`}async function Pa(){var i,o;const e=document.getElementById("pf_name").value.trim(),t=document.getElementById("pf_pass").value,n=(o=(i=document.getElementById("pf_brand"))==null?void 0:i.value)==null?void 0:o.trim();if(!e)return h("Ad boş olamaz!");const a={full_name:e};t&&(a.password_hash=await me(t)),await f.from("users").update(a).eq("id",b.dbUser.id),n&&(b.role==="coach"||b.role==="developer")&&(await f.from("workspaces").update({brand_name:n}).eq("coach_id",b.coachId),l.workspace={...l.workspace||{},brand_name:n},document.querySelector(".sb-logo-text").textContent=n),b.dbUser={...b.dbUser,full_name:e},document.getElementById("sbName").textContent=e,h("Profil kaydedildi ✓")}function yn(){var n;const e=document.getElementById("view-settings"),t=document.documentElement.getAttribute("data-theme")==="dark";e.innerHTML=`
    <div style="max-width:500px;margin:0 auto">
      <div class="settings-block">
        ...
        <div class="setting-item">
          ...
          <div class="accent-palette">
            ${Gn.map(a=>`<div class="ac-dot" onclick="applyAccent('${a.val}','${a.dim}')" style="background:${a.val}" title="${a.name}"></div>`).join("")}
          </div>
        </div>
      </div>
    ...
    </div>`}function Ya(){const e=document.getElementById("geminiApiKeyInput").value.trim();e?(localStorage.setItem("gemini_api_key",e),h("API Anahtarı kaydedildi ✓")):(localStorage.removeItem("gemini_api_key"),h("API Anahtarı kaldırıldı."))}let Te="";function q(){const e=document.getElementById("view-program"),t=l.students.find(s=>s.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=W(l.weekOffset,n),i=G(a,6),o=_e();l.students.map(s=>`<option value="${s.id}" ${s.id===l.activeStuId?"selected":""}>${v(s.name)}</option>`).join("");let r="";for(let s=0;s<7;s++){const d=G(a,s),c=H(d),p=c===o,m=`${l.activeStuId}_${c}`,u=l.tasks[m]||[],y=u.reduce((k,S)=>k+Number(S.duration),0),E=u.reduce((k,S)=>k+(S.done?Number(S.duration):0),0),I=DAYS_TR[(n+s)%7],g=u.map((k,S)=>`
      ...
      </div>`).join(""),x=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(n+s)%7];r+=`<div class="day-col ${p?"today":""}">
      <div class="day-hd">
        <div>
          <div class="day-name-lbl">${x}</div>
    ...
    <div class="week-grid">${r}</div>`}function Ha(e){l.activeStuId=e||null,Fe(),q()}function Ra(e){l.weekOffset+=e,Fe(),q()}function Na(){l.weekOffset=0,Fe(),q()}let ee=[];function Ka(){if(!l.activeStuId)return h("Önce öğrenci seçin");const e=l.students.find(i=>i.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=W(l.weekOffset,t);ee=[];let a="";for(let i=0;i<7;i++){const o=G(n,i),r=H(o);DAYS_TR[(t+i)%7];const s=(l.tasks[`${l.activeStuId}_${r}`]||[]).length>0,d=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(t+i)%7];a+=`<button class="day-sel-btn" id="dsbtn_${i}" data-ds="${r}" onclick="toggleDaySel(${i},'${r}')">
      <div>${d}</div>
    ...
    <div onclick="selectBook(${p})" style="padding:10px 14px;cursor:pointer;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;transition:background .15s"
    ...
    </div>`).join("")}function Qa(){const e=document.getElementById("tmBookSearch").value;if(e.length===0){document.getElementById("tmBookList").style.display="none";return}lt(e)}function ei(e){O=He[e],document.getElementById("tmBookVal").value=O.name,document.getElementById("tmBookSearch").value=O.name,document.getElementById("tmBookList").style.display="none",Dt(),document.getElementById("tmTestWrap").style.display=""}function Dt(){if(!O)return;const e=document.getElementById("tmTestList"),t=O.resource_type==="playlist",n=O.name||"";e.innerHTML=O.testler.map((a,i)=>{const o=a.label||a,r=o.trim()===""||o.trim()===n.trim()?`Ders ${i+1}`:o,s=a.soru||0,d=a.url||"";a.topic;const c=ta(o),p=c==="done"?"ti-status-done":c==="pending"?"ti-status-pending":"",m=c==="done"?'<span class="ti-badge ti-badge-done">✓ Tamamlandı</span>':c==="pending"?'<span class="ti-badge ti-badge-pending">⏳ Atandı</span>':"";return t?`<label class="${p}" style="display:flex;align-items:center;gap:8px;padding:8px 10px;cursor:pointer;transition:background .1s;border-bottom:1px solid var(--border)"
        onmouseover="this.style.background='var(--surface3)'" onmouseout="this.style.background=''">
      ...
      </label>`}).join(""),Ce()}function ti(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!0),Ce()}function ni(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!1),Ce()}function Ce(){if(!O)return;const e=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")],t=document.getElementById("tmTestSummary"),n=document.getElementById("tmTestSummaryText"),a=document.getElementById("tmSuggestedDuration"),i=document.getElementById("tmSpeedRow"),o=O.resource_type==="playlist";if(e.length===0){t.style.display="none";return}let r=0,s=0;e.forEach(m=>{const u=parseInt(m.value),y=O.testler[u];o?s+=(y==null?void 0:y.soru)||0:r+=(y==null?void 0:y.soru)||0});const d=document.querySelector("[data-mspeed].speed-active"),c=d?parseFloat(d.dataset.mspeed):1;let p=0;if(o)p=s>0?Math.ceil(s/c):0,n.textContent=`${e.length} video · ${s} dk`,i&&(i.style.display="");else{const m=document.getElementById("tmExam").value,u=document.getElementById("tmSubjectSel").value||"",y=`${l.activeStuId}_${m}_${u}`,E=at[y]||180;p=r>0?Math.ceil(r*E/60):0,n.textContent=`${e.length} test · ${r} soru${p>0?" · Önerilen: "+p+" dk":""}`,i&&(i.style.display="none")}a.style.display=p>0?"":"none",Je=p,a.setAttribute("data-dur",p),t.style.display="",p>0&&(document.getElementById("tmDuration").value=p)}function ai(e){document.querySelectorAll("[data-mspeed]").forEach(t=>{const n=t.dataset.mspeed===e;t.classList.toggle("speed-active",n),t.style.borderColor=n?"var(--accent)":"var(--border)",t.style.background=n?"var(--accent-dim)":"var(--surface2)",t.style.color=n?"var(--accent)":"var(--text-mid)"}),Ce()}let Je=0;function ii(){Je>0&&(document.getElementById("tmDuration").value=Je,h("Süre uygulandı: "+Je+" dk"))}let at={};async function hn(){if(!l.activeStuId)return;const{data:e}=await f.from("student_speeds").select("*").eq("student_id",l.activeStuId);at={},(e||[]).forEach(t=>{const n=`${t.student_id}_${t.exam_type}_${t.subject}`;at[n]=t.secs_per_question})}async function kn(e,t,n,a){const{data:i}=await f.from("student_speeds").select("id").eq("student_id",e).eq("exam_type",t).eq("subject",n).single();i?await f.from("student_speeds").update({secs_per_question:a,updated_at:new Date().toISOString()}).eq("id",i.id):await f.from("student_speeds").insert({student_id:e,coach_id:b.coachId,exam_type:t,subject:n,secs_per_question:a}),at[`${e}_${t}_${n}`]=a,h("Hız kaydedildi ✓")}document.getElementById("tmType").addEventListener("change",At);let ft=!1;async function oi(){var n;if(ft)return;ft=!0;const e=document.querySelector('#taskModal button[onclick*="saveTask"]'),t=e?e.textContent:"Programa Ekle";e&&(e.disabled=!0,e.textContent="Kaydediliyor...");try{const a=document.getElementById("tmType").value,i=document.getElementById("tmSubjectSel"),o=document.getElementById("tmSubjectFree"),r=document.getElementById("tmExam").value,s=parseInt(document.getElementById("tmDuration").value)||60,d=document.getElementById("tmNote").value.trim();if((n=document.getElementById("tmNewResourceToggle"))==null?void 0:n.checked){const x=document.getElementById("tmManualKaynak").value.trim();if(!x)return h("Kaynak adı girin!");const k=i.style.display!=="none"?i.value:o.value.trim(),S=k?`${k} - ${x}`:x,_=se.map(M=>({label:M,url:"",soru:0}));let L=d;se.length>0&&(L=`${se.length} test: ${se.slice(0,3).join(", ")}${se.length>3?` +${se.length-3} daha`:""}`);const T={student_id:l.activeStuId,coach_id:b.coachId,date:Te,type:a,exam_type:r,subject:S,duration:s,note:L,done:!1,task_items:_.length>0?_:null};A(!0);const{error:z}=await f.from("tasks").insert(T);if(A(!1),z)return h("Hata: "+z.message);const $=`${l.activeStuId}_${Te}`;l.tasks[$]||(l.tasks[$]=[]),l.tasks[$].push({type:a,exam:r,subject:S,duration:s,note:L,done:!1,task_items:T.task_items}),K("taskModal"),q(),h("Görev eklendi ✓");return}const p=document.getElementById("tmBookVal").value,m=(O==null?void 0:O.resource_type)==="playlist";let u="";if((a==="soru"||a==="konu")&&p){const x=i.style.display!=="none"?i.value:"";u=x?`${x} - ${p}`:`${p}`}else u=(i.style.display!=="none"?i.value:o.value).trim();if(!u)return h("Ders adı girin!");const y=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")];let E=d,I=[];if(y.length>0&&O){const x=y.map(k=>{const S=O.testler[parseInt(k.value)];return(S==null?void 0:S.label)||S||""});if(I=y.map(k=>{const S=O.testler[parseInt(k.value)];return{label:(S==null?void 0:S.label)||S||"",url:(S==null?void 0:S.url)||"",soru:(S==null?void 0:S.soru)||0}}),m){const k=S=>S.length>14?S.slice(0,13)+"…":S;E=`${x.length} video: ${x.slice(0,5).map(k).join(", ")}${x.length>5?` +${x.length-5}`:""}`}else{const k=S=>S.length>14?S.slice(0,13)+"…":S;E=`${x.length} test: ${x.slice(0,5).map(k).join(", ")}${x.length>5?` +${x.length-5}`:""}`}}const g={student_id:l.activeStuId,coach_id:b.coachId,date:Te,type:a,exam_type:r,subject:u,duration:s,note:E,done:!1,task_items:I.length>0?I:null};if(_editingTaskId){A(!0);const{error:x}=await f.from("tasks").update({type:g.type,exam_type:g.exam_type,subject:g.subject,duration:g.duration,note:g.note,task_items:g.task_items}).eq("id",_editingTaskId);if(A(!1),x)return h("Hata: "+x.message);const k=`${l.activeStuId}_${Te}`;if(l.tasks[k]){const S=l.tasks[k].findIndex(_=>_._id===_editingTaskId);S!==-1&&(l.tasks[k][S]={_id:_editingTaskId,type:g.type,exam:g.exam_type,subject:g.subject,duration:g.duration,note:g.note,done:l.tasks[k][S].done,student_note:l.tasks[k][S].student_note||"",task_items:g.task_items})}K("taskModal"),q(),h("Görev güncellendi ✓"),_editingTaskId=null}else{const{data:x,error:k}=await f.from("tasks").insert(g).select().single();if(k)return h("Hata: "+k.message);const S=`${l.activeStuId}_${Te}`;l.tasks[S]||(l.tasks[S]=[]),l.tasks[S].push({_id:x.id,type:x.type,exam:x.exam_type,subject:x.subject,duration:x.duration,note:x.note,done:!1,student_note:"",task_items:x.task_items||null}),K("taskModal"),q(),h("Görev eklendi ✓")}}finally{ft=!1,e&&(e.disabled=!1,e.textContent=t)}}async function si(e,t){var o;const n=`${l.activeStuId}_${e}`,a=(o=l.tasks[n])==null?void 0:o[t];if(!a)return;const i=!a.done;await f.from("tasks").update({done:i}).eq("id",a._id),a.done=i,q()}let Qe=null;function Lt(){Qe&&(Qe.remove(),Qe=null)}document.addEventListener("click",Lt);function ri(e,t,n){Lt();const a=n.getBoundingClientRect(),i=document.createElement("div");i.className="tc-dropdown",i.innerHTML=`
...
Giriş yaptıktan sonra programını görebileceksin!`);a.innerHTML=`<div class="modal" style="max-width:480px">
  ...
  </div>`,N("inviteModal")}function $i(e,t,n){const a=`Giriş adresi: ${n}
Kullanıcı adı: ${e}
Şifre: ${t}`;navigator.clipboard.writeText(a).then(()=>h("Kopyalandı ✓")).catch(()=>{const i=document.createElement("textarea");i.value=a,document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove(),h("Kopyalandı ✓")})}async function Ti(e){var n;if(!await X("Bu öğrenciyi silmek istediğinizden emin misiniz?"))return;const{error:t}=await f.from("users").delete().eq("id",e);if(t)return h("Hata: "+t.message);l.students=l.students.filter(a=>a.id!==e),l.activeStuId===e&&(l.activeStuId=((n=l.students[0])==null?void 0:n.id)||null),pe(),In(),h("Silindi")}function Ue(){var t;const e=document.getElementById("view-appointments");e.innerHTML=`
    ...
    ${i}`}let An=null,we="TYT";const Mi=["TYT","AYT-SAY","AYT-EA","AYT-SOZ"];function Dn(){const t=l.exams.filter(r=>r.studentId===An).filter(r=>r.type===we&&r.examDetails&&Object.keys(r.examDetails).length),n={};t.forEach(r=>{Object.entries(r.examDetails).forEach(([s,d])=>{(d.yanlis_konular||[]).forEach(c=>{const p=s+"§"+c;n[p]=(n[p]||0)+1})})});const a=Object.entries(n).sort((r,s)=>s[1]-r[1]).map(([r,s])=>{const[d,c]=r.split("§"),p=Math.round(s/Math.max(t.length,1)*100),m=s>=3?"var(--red)":s===2?"var(--accent)":"var(--text-mid)";return`<tr style="border-bottom:1px solid var(--border)">
      ...
      </tr>`}),i=Mi.map(r=>`<button onclick="window._krType='${r}';_krRenderBody()" style="padding:6px 14px;border-radius:20px;border:1px solid ${r===we?"var(--accent)":"var(--border)"};background:${r===we?"var(--accent-dim)":"transparent"};color:${r===we?"var(--accent)":"var(--text-dim)"};font-size:12px;cursor:pointer;font-weight:${r===we?700:400}">${r}</button>`).join(""),o=a.length?`<div style="font-size:11px;color:var(--text-dim);margin-bottom:12px">${t.length} denemeden derlendi · <b>${a.length}</b> farklı yanlış konu · 🔴 ≥3 tekrar kritik</div>
    ...
    ${o}`}window._krRenderBody=Dn;function Ai(e){An=e;const t=l.exams.find(n=>n.studentId===e&&n.examDetails&&Object.keys(n.examDetails).length);we=(t==null?void 0:t.type)||"TYT",Dn(),N("konuRaporuModal")}window.openKonuRaporu=Ai;function Di(e){const t=l.exams.find(n=>n.id===e);document.getElementById("cmExamId").value=e,document.getElementById("cmText").value=(t==null?void 0:t.coachComment)||"",N("commentModal")}async function Li(){const e=document.getElementById("cmExamId").value,t=document.getElementById("cmText").value.trim();await f.from("exams").update({coach_comment:t}).eq("id",e);const n=l.exams.find(a=>a.id===e);n&&(n.coachComment=t),K("commentModal"),je(),h("Yorum kaydedildi ✓")}async function Ci(e){await X("Bu denemeyi silmek istediğinizden emin misiniz?")&&(await f.from("exams").delete().eq("id",e),l.exams=l.exams.filter(t=>t.id!==e),je(),h("Silindi"))}function Ln(){const e=document.getElementById("view-messages");e.innerHTML=`<div class="sh" style="margin-bottom:14px"><h2>Mesajlar</h2></div>
  ...
  <div class="msg-input-area">
  ...
  </div>`}async function Pi(e,t){var s,d;const n=document.getElementById("msgInput"),a=n.value.trim();if(!a)return;const i=b.coachId||((s=l.students.find(c=>c.id===e))==null?void 0:s.coachId)||((d=l.students.find(c=>c.id===b.studentId))==null?void 0:d.coachId),{data:o,error:r}=await f.from("messages").insert({student_id:e,coach_id:i,from_role:t,text:a,read:!1}).select().single();if(r){console.error("sendMsg error:",r),h("Hata: "+r.message);return}l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:o.id,from:t,text:a,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),n.value="",currentTab==="messages"&&(document.getElementById("msgMain").innerHTML=xe(e,"coach"),be()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=xe(e,"student"),be())}function be(){setTimeout(()=>{const e=document.getElementById("msgBody");e&&(e.scrollTop=e.scrollHeight)},60)}function ct(){var u;const e=document.getElementById("view-portal");if(!e)return;let t=l.students.find(y=>y.id===b.studentId);if(!t&&l.students.length>0&&(t=l.students[0]),!t){e.innerHTML=`<div style="text-align:center;padding:60px 20px;color:var(--text-mid)">
      <div style="font-size:36px;margin-bottom:12px">⏳</div>
      <p style="font-size:14px">Profil yükleniyor...</p>
    </div>`,setTimeout(()=>{l.students.length&&ct()},800);return}b.studentId||(b.studentId=t.id),l.activeStuId=t.id;const n=_e(),a=`${t.id}_${n}`,i=l.tasks[a]||[],o=i.filter(y=>y.done).length,r=l.appointments.filter(y=>y.studentId===t.id&&y.date>=n).sort((y,E)=>y.date.localeCompare(E.date))[0],s=(l.messages[t.id]||[]).filter(y=>y.from==="coach"&&!y.read).length,d=((u=l.konuMastery)==null?void 0:u[t.id])||{},c=[],p=new Date;p.setDate(p.getDate()-30),Object.entries(d).forEach(([y,E])=>{Object.entries(E).forEach(([I,g])=>{if(g.status==="td"||g.status==="not_started")return;const x=g.last_review_date?new Date(g.last_review_date):null,k=x?Math.floor((Date.now()-x.getTime())/864e5):999,S=g.stars<=2,_=k>20;(S||_)&&c.push({konu:I,subject:y,stars:g.stars,daysSince:k})})}),c.sort((y,E)=>y.stars-E.stars||E.daysSince-y.daysSince);const m=c.length>0?`
    ...
    </div>`}async function Yi(e,t){var r;const n=l.students.find(s=>s.id===b.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(r=l.tasks[a])==null?void 0:r[t];if(!i)return;const o=!i.done;await f.from("tasks").update({done:o}).eq("id",i._id),i.done=o,ct()}function ze(){const e=l.students.find(s=>s.id===b.studentId);if(!e)return;const t=document.getElementById("view-sportal"),n=e.weekStart??0,a=W(l.weekOffset,n),i=G(a,6),o=_e();let r="";for(let s=0;s<7;s++){const d=G(a,s),c=H(d),p=c===o,m=`${e.id}_${c}`,u=l.tasks[m]||[],y=u.reduce((x,k)=>x+Number(k.duration),0),E=u.reduce((x,k)=>x+(k.done?Number(k.duration):0),0);DAYS_TR[(n+s)%7];const I=u.map((x,k)=>`
      <div class="task-card task-${x.type} ${x.done?"done":""}" onclick="openTaskDetail('${c}',${k},'student')" style="cursor:pointer">
        <div class="tc-check ${x.done?"on":""}" onclick="event.stopPropagation();stuToggleTask2('${c}',${k})"></div>
        <div class="tc-body">
    ...
    <div class="week-grid">${r}</div>`}async function Hi(e,t){var r;const n=l.students.find(s=>s.id===b.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(r=l.tasks[a])==null?void 0:r[t];if(!i)return;const o=!i.done;await f.from("tasks").update({done:o}).eq("id",i._id),i.done=o,ze()}function Ri(e){l.weekOffset+=e,pe(),ze()}function jt(e,t,n){var y,E,I,g;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(y=l.tasks[i])==null?void 0:y[t];if(!o)return;let r=document.getElementById("taskDetailModal");r||(r=document.createElement("div"),r.id="taskDetailModal",r.className="modal-bg",document.body.appendChild(r),r.addEventListener("click",x=>{x.target===r&&r.classList.remove("open")}));const s={soru:"var(--blue)",konu:"#c084fc",deneme:"var(--accent)",diger:"var(--text-mid)"},d={soru:"Soru Bankası",konu:"Konu Anlatımı",deneme:"Deneme",diger:"Diğer"},c=s[o.type]||"var(--accent)",p=o.type==="konu",m=o.task_items||[];let u="";m.length>0?u=`<div style="margin-bottom:14px">
      ...
      <div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;overflow:hidden;max-height:200px;overflow-y:auto">
        ${m.map((x,k)=>`
          <label style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid var(--border);${k===m.length-1?"border-bottom:none":""};cursor:${n==="coach"?"default":"pointer"};transition:background .1s"
            ...
            <input type="checkbox" ${x.done?"checked":""} ${n==="coach"?"disabled":""} onchange="toggleDetailItem('${e}',${t},${k},'${n}')"
            ...
            <div style="flex:1;min-width:0">
              <div style="font-size:13px;font-weight:600;line-height:1.4;${x.done?"text-decoration:line-through;color:var(--text-dim);":""}">${v(x.label||`Ders ${k+1}`)}</div>
              <div style="font-size:11px;color:var(--text-mid);margin-top:2px">⏱ ${x.soru>0?p?x.soru+" dk":x.soru+" soru":"?"}</div>
            </div>
            ${x.url?`<a href="${v(x.url)}" target="_blank" onclick="event.stopPropagation()"
    ...
    ${(()=>{var k;const x=qa(o.exam,o.subject);return x?(ae=[...((k=o.student_result)==null?void 0:k.yanlis_konular)||[]],`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:14px 16px;margin-bottom:14px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:0">${x.map(S=>{const _=ae.includes(S);return`<span ${n==="coach"?"":`onclick="toggleKonuChip(this,'${S.replace(/'/g,"\\'")}')"`}
  ...
  </div>`,N("taskDetailModal")}async function Ni(e,t,n){var r;if(n==="coach")return;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(r=l.tasks[i])==null?void 0:r[t];o&&(o.done=!o.done,o.task_items&&Array.isArray(o.task_items)&&o.task_items.forEach(s=>{s.done=o.done}),await f.from("tasks").update({done:o.done,task_items:o.task_items||null}).eq("id",o._id),jt(e,t,n),n==="student"?ze():q())}async function Ki(e,t,n,a){var d;if(a==="coach")return;const o=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,r=(d=l.tasks[o])==null?void 0:d[t];if(!r||!r.task_items)return;r.task_items[n].done=!r.task_items[n].done;const s=r.task_items.every(c=>c.done);r.done=s,A(!0),await f.from("tasks").update({task_items:r.task_items,done:r.done}).eq("id",r._id),A(!1),jt(e,t,a),a==="student"?ze():q(),h("İlerleme kaydedildi ✓")}function Oi(e,t){var i,o,r;e.closest("div").querySelectorAll("button[data-speed]").forEach(s=>{const d=s.dataset.speed===t;s.style.borderColor=d?"var(--accent)":"var(--border)",s.style.background=d?"var(--accent-dim)":"var(--surface2)",s.style.color=d?"var(--accent)":"var(--text-mid)"}),document.getElementById("tdSpeed").value=t;const n=parseFloat(t),a=document.getElementById("speedCalc");if(a){const s=parseInt(((r=(o=(i=a.closest("[id=speedInfo]"))==null?void 0:i.textContent)==null?void 0:o.match(/Toplam (\d+) dk/))==null?void 0:r[1])||0);a.textContent=Math.ceil(s/n)+" dk",document.getElementById("tdDuration").value=Math.ceil(s/n)}}async function Fi(e,t,n){var m,u;if(n==="coach")return;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(m=l.tasks[i])==null?void 0:m[t];if(!o)return;const r=((u=document.getElementById("tdNote"))==null?void 0:u.value.trim())||"",s={student_note:r},d=document.getElementById("tdDogru"),c=document.getElementById("tdYanlis"),p=document.getElementById("tdBos");if(d!==null){const y=parseInt(d.value)||0,E=parseInt(c.value)||0,I=parseInt(p.value)||0;(y>0||E>0||I>0||ae.length>0)&&(s.student_result={dogru:y,yanlis:E,bos:I,yanlis_konular:[...ae],ts:new Date().toISOString()},o.student_result=s.student_result)}await f.from("tasks").update(s).eq("id",o._id),o.student_note=r,K("taskDetailModal"),h("Kaydedildi ✓"),n==="student"?ze():q()}function Pt(){const e=l.students.find(o=>o.id===b.studentId);if(!e)return;const t=document.getElementById("view-sexams"),n=[...l.exams].filter(o=>o.studentId===e.id).sort((o,r)=>r.date.localeCompare(o.date));let a="";if(n.length>1){const o=[...n].sort((s,d)=>s.date.localeCompare(d.date)).slice(-8),r=Math.max(...o.map(s=>(EXAM_DEFS[s.type]||[]).reduce((c,p)=>{var m;return c+Number(((m=s.nets)==null?void 0:m[p])||0)},0)),1);a=`<div class="card cp" style="margin-bottom:16px">
    ...
    </div>`,be()}let et=null;function Ht(){Rt();const e=b.role==="coach"||b.role==="developer"?l.msgThread:b.studentId;e&&(et=f.channel("messages_"+e).on("postgres_changes",{event:"INSERT",schema:"public",table:"messages",filter:`student_id=eq.${e}`},t=>{const n=t.new;l.messages[e]||(l.messages[e]=[]),!l.messages[e].find(a=>a._id===n.id)&&(l.messages[e].push({_id:n.id,from:n.from_role,text:n.text,read:n.read,time:new Date(n.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}),currentTab==="messages"&&l.msgThread===e&&(document.getElementById("msgMain").innerHTML=xe(e,"coach"),be()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=xe(e,"student"),be()))}).subscribe())}function Rt(){et&&(f.removeChannel(et),et=null)}async function Pn(){const e=document.getElementById("view-dev-dashboard");e.innerHTML='<div class="sh"><h2>🖥️ Sistem Dashboard</h2></div><div class="empty"><p>Yükleniyor...</p></div>';const[t,n,a,i,o,r]=await Promise.all([f.from("users").select("id,role,created_at"),f.from("tasks").select("id,done,created_at"),f.from("exams").select("id,created_at"),f.from("messages").select("id,created_at"),f.from("tickets").select("id,status,created_at"),f.from("payments").select("id,amount,status,payment_date")]),s=t.data||[],d=n.data||[],c=a.data||[],p=i.data||[],m=o.data||[],u=r.data||[],y=s.filter(_=>_.role==="coach").length,E=s.filter(_=>_.role==="student").length,I=u.filter(_=>_.status==="completed").reduce((_,L)=>_+Number(L.amount),0),g=m.filter(_=>_.status==="open").length,x=Array.from({length:7},(_,L)=>{const T=new Date;return T.setDate(T.getDate()-6+L),H(T)}),k=x.map(_=>d.filter(L=>{var T;return(T=L.created_at)==null?void 0:T.startsWith(_)}).length),S=Math.max(...k,1);e.innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      <div class="card cp">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:80px">
          ${x.map((_,L)=>`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
    ...
    </div>`,document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")}),document.getElementById("planStatus").addEventListener("change",function(){document.getElementById("trialEndField").style.display=this.value==="trial"?"":"none"})),document.getElementById("planModalTitle").textContent=`Plan Yönet — ${t}`,document.getElementById("planUserId").value=e,document.getElementById("planStatus").value=n||"trial",document.getElementById("trialEndField").style.display=n==="trial"||!n?"":"none",a?document.getElementById("planTrialEnd").value=a.split("T")[0]:document.getElementById("planTrialEnd").value="",N("planMgmtModal")}async function Ji(){const e=document.getElementById("planUserId").value,t=document.getElementById("planStatus").value,n=document.getElementById("planTrialEnd").value,a={plan:t};t==="trial"&&n?a.trial_ends_at=n:t!=="trial"&&(a.trial_ends_at=null),A(!0);const{error:i}=await f.from("users").update(a).eq("id",e);if(A(!1),i)return h("Hata: "+i.message);h(`Plan güncellendi: ${{trial:"Deneme",active:"Aktif",paused:"Duraklatıldı",cancelled:"İptal"}[t]||t} ✓`),K("planMgmtModal"),We()}let Re=[];async function Ve(){const e=document.getElementById("view-dev-resources"),{data:t}=await f.from("resources").select("*").order("resource_type,exam_type,subject,name");Re=t||[];const n=Re.filter(i=>i.resource_type!=="playlist"),a=Re.filter(i=>i.resource_type==="playlist");e.innerHTML=`
    ...
    <div class="stats-row" style="margin-bottom:20px">
      ...
      <div class="stat-card"><div class="stat-label">Toplam Kaynak</div><div class="stat-val">${Re.length}</div></div>
    </div>
    ...
    </div>`}function Qi(){let e=document.getElementById("playlistModal");e||(e=document.createElement("div"),e.id="playlistModal",e.className="modal-bg",document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),e.innerHTML=`<div class="modal modal-lg">
...
`).map(s=>s.trim()).filter(Boolean);let o=[];a?o=i.map(s=>{const d=s.split("|").map(c=>c.trim());return{label:d[0]||"",url:d[1]||"",topic:"",soru:parseInt(d[2])||0}}):o=i.map(s=>{const d=s.split("|").map(c=>c.trim());return{label:d[0]||"",soru:parseInt(d[1])||0}});const r={exam_type:document.getElementById("rmExam").value,subject:t,publisher:document.getElementById("rmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:o,active:document.getElementById("rmActive").value==="true",resource_type:a?"playlist":"book"};n?(await f.from("resources").update(r).eq("id",n),h("Güncellendi ✓")):(await f.from("resources").insert(r),h("Kaynak eklendi ✓")),K("resourceModal"),Ve()}async function io(e){await X("Bu kaynağı silmek istediğinizden emin misiniz?")&&(await f.from("resources").delete().eq("id",e),h("Silindi"),Ve())}async function pt(){const e=document.getElementById("view-dev-finance"),[{data:t},{data:n}]=await Promise.all([f.from("subscriptions").select("*,users(full_name,color)").order("created_at",{ascending:!1}),f.from("payments").select("*,users(full_name)").order("payment_date",{ascending:!1}).limit(20)]),a=(n||[]).filter(o=>o.status==="completed").reduce((o,r)=>o+Number(r.amount),0),i=(t||[]).filter(o=>o.status==="active").length;e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pmStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),N("paymentModal")}async function so(){const e=parseFloat(document.getElementById("pmAmount").value);if(!e)return h("Tutar girin!");await f.from("payments").insert({student_id:document.getElementById("pmStudent").value,amount:e,method:document.getElementById("pmMethod").value,payment_date:document.getElementById("pmDate").value,description:document.getElementById("pmDesc").value,status:"completed"}),h("Ödeme kaydedildi ✓"),K("paymentModal"),pt()}function ro(){let e=document.getElementById("subModal");e||(e=document.createElement("div"),e.id="subModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('subModal')">×</button>
      <h2>Abonelik Ekle</h2>
    ...
    ${(t||[]).map(a=>`
      ...
      </div>`).join("")}`}function co(){let e=document.getElementById("announceModal");e||(e=document.createElement("div"),e.id="announceModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('announceModal')">×</button>
      <h2>Yeni Duyuru</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),N("announceModal")}async function po(){const e=document.getElementById("anTitle").value.trim(),t=document.getElementById("anBody").value.trim();if(!e||!t)return h("Başlık ve içerik zorunlu!");await f.from("announcements").insert({title:e,body:t,type:document.getElementById("anType").value,target:document.getElementById("anTarget").value,active:!0}),h("Duyuru yayınlandı ✓"),K("announceModal"),Ze()}async function mo(e,t){await f.from("announcements").update({active:t}).eq("id",e),Ze()}async function uo(e){await X("Bu duyuruyu silmek istediğinizden emin misiniz?")&&(await f.from("announcements").delete().eq("id",e),h("Silindi"),Ze())}let Ae=null,st=null,ie=null,xt=null,Me=[],ve=[],ye="welcome";async function Pe(){const e=document.getElementById("view-dev-tickets");if(!e)return;const{data:t,error:n}=await f.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").order("updated_at",{ascending:!1});Me=t||[],!ie&&Me.length>0&&(ie=Me[0].id),e.innerHTML=`
  ...
  `,yo(),xt&&clearInterval(xt),xt=setInterval(vo,4e3)}function go(e){ie=e,Pe()}async function vo(){if(!ie||!document.getElementById("devChatArea"))return;const{data:t,error:n}=await f.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").eq("id",ie).single();if(n||!t)return;let a=[];try{a=JSON.parse(t.body),Array.isArray(a)||(a=[{sender:"user",text:t.body,time:t.created_at}])}catch{a=[{sender:"user",text:t.body,time:t.created_at}]}const i=document.getElementById("devChatMessages");if(i){const o=i.scrollTop,r=i.scrollHeight-i.clientHeight-o<40;i.innerHTML=a.map(s=>{const d=s.sender==="emin",c=d?"Kurucu / Destek":s.sender==="ai"?"Yapay Zeka":s.name||"Kullanıcı",p=d?"var(--blue)":s.sender==="ai"?"var(--surface2)":"var(--accent)",m=d?"#fff":s.sender==="ai"?"var(--text)":"var(--on-accent)",u=d?"flex-end":"flex-start",y=d?"14px 14px 4px 14px":"14px 14px 14px 4px",E=new Date(s.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join(""),r&&(i.scrollTop=i.scrollHeight)}}function yo(){var r,s,d;const e=document.getElementById("devChatArea");if(!e)return;const t=Me.find(c=>c.id===ie);if(!t){e.innerHTML=`
  ...
  `;const o=document.getElementById("devChatMessages");o&&(o.scrollTop=o.scrollHeight)}async function fo(){const e=document.getElementById("devReplyInput"),t=e.value.trim();if(!t||!ie)return;e.value="",A(!0);const{data:n}=await f.from("tickets").select("body").eq("id",ie).single();let a=[];if(n&&n.body)try{a=JSON.parse(n.body)}catch{a=[{sender:"user",text:n.body,time:new Date().toISOString()}]}const i={sender:"emin",text:t,time:new Date().toISOString(),name:"Kurucu / Destek"};a.push(i);const{error:o}=await f.from("tickets").update({body:JSON.stringify(a),reply:t,status:"resolved",updated_at:new Date().toISOString()}).eq("id",ie);if(A(!1),o){h("Hata: "+o.message);return}h("Yanıt gönderildi ✓"),Pe()}async function xo(e,t){await f.from("tickets").update({status:t,updated_at:new Date().toISOString()}).eq("id",e),h("Durum güncellendi ✓"),Pe()}async function bo(e){await X("Bu talebi silmek istediğinizden emin misiniz?")&&(await f.from("tickets").delete().eq("id",e),h("Silindi"),ie=null,Pe())}function ho(){mt()}async function mt(){let e=document.getElementById("supportChatModal");e||(e=document.createElement("div"),e.id="supportChatModal",e.className="modal-bg",e.style.zIndex="99999999",e.innerHTML=`
    ...
    `}).join(""),a&&(t.scrollTop=t.scrollHeight)}function ko(){ye="ai",ve=[{sender:"ai",text:"Merhaba! Ben Rostrum Akademi Yapay Zeka Asistanıyım. 🤖 Size nasıl yardımcı olabilirim?",time:new Date().toISOString()}],Oe(ve)}function wo(){ye="emin_start";const e=document.getElementById("supportMessages");e&&(e.innerHTML=`
      <div style="text-align:center;padding:40px 20px">
    ...
    `)}async function $o(){var c,p;const e=document.getElementById("eminSubject"),t=document.getElementById("eminInitialMessage"),n=e?e.value.trim():"Müşteri Destek Sohbeti",a=t?t.value.trim():"";if(!a)return h("Mesaj boş olamaz!");const i=(c=b.dbUser)==null?void 0:c.id,o=((p=b.dbUser)==null?void 0:p.full_name)||"Kullanıcı",r={sender:"user",text:a,time:new Date().toISOString(),name:o};A(!0);const{data:s,error:d}=await f.from("tickets").insert({user_id:i,subject:n,body:JSON.stringify([r]),category:"emin",status:"open"}).select().single();if(A(!1),d){h("Hata: "+d.message);return}st=s.id,ye="emin",h("Talebiniz destek ekibine iletildi ✓"),await rt()}async function To(){var n;const e=document.getElementById("supportInput"),t=e.value.trim();if(t){if(e.value="",ye==="ai"){const a={sender:"user",text:t,time:new Date().toISOString()};ve.push(a),Oe(ve);const i=document.getElementById("supportTyping");i&&(i.style.display="flex");try{const o=await Le(t,{},b.role||"coach");ve.push({sender:"ai",text:o,time:new Date().toISOString()})}catch{ve.push({sender:"ai",text:"Üzgünüm, şu anda yanıt veremiyorum. Lütfen daha sonra deneyin.",time:new Date().toISOString()})}finally{i&&(i.style.display="none"),Oe(ve)}}else if(ye==="emin"){const a=((n=b.dbUser)==null?void 0:n.full_name)||"Kullanıcı",i={sender:"user",text:t,time:new Date().toISOString(),name:a};A(!0);const{data:o}=await f.from("tickets").select("body").eq("id",st).single();let r=[];if(o&&o.body)try{r=JSON.parse(o.body)}catch{r=[{sender:"user",text:o.body,time:new Date().toISOString(),name:a}]}r.push(i);const{error:s}=await f.from("tickets").update({body:JSON.stringify(r),status:"open",updated_at:new Date().toISOString()}).eq("id",st);if(A(!1),s){h("Gönderim hatası: "+s.message);return}await rt()}}}async function Hn(){const{data:e}=await f.from("announcements").select("*").eq("active",!0),t=b.role,n=(e||[]).filter(o=>o.target==="all"||o.target==="students"&&t==="student"||o.target==="coaches"&&t==="coach");if(!n.length)return;const a={info:"var(--blue)",warning:"var(--accent)",success:"var(--green)",urgent:"var(--red)"},i=document.createElement("div");i.style.cssText="position:fixed;top:64px;right:16px;z-index:400;display:flex;flex-direction:column;gap:8px;max-width:340px",i.id="announceBanner",n.slice(0,3).forEach(o=>{const r=document.createElement("div");r.style.cssText=`background:var(--surface);border:1px solid var(--border);border-left:3px solid ${a[o.type]||"var(--accent)"};border-radius:10px;padding:12px 14px;box-shadow:var(--shadow);animation:fadeUp .3s ease`,r.innerHTML=`<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px">
    ...
    <div style="display:flex;gap:6px;justify-content:center;margin-top:20px">${i}</div>
  </div>`}async function So(e,t){var i,o,r,s,d,c,p,m,u,y,E,I,g,x,k,S,_,L,T;const n=document.getElementById("onboardingModal");if(!t){if(e===1){const z=(o=(i=document.getElementById("ob_brand"))==null?void 0:i.value)==null?void 0:o.trim(),$=((r=document.getElementById("ob_color"))==null?void 0:r.value)||"#f0a500";if(!z){h("Akademi adı zorunlu!");return}await f.from("workspaces").upsert({coach_id:b.coachId,brand_name:z,brand_color:$},{onConflict:"coach_id"}),l.workspace={...l.workspace||{},coach_id:b.coachId,brand_name:z,brand_color:$};const M=document.querySelector(".sb-logo-text");M&&(M.textContent=z)}if(e===2){const z=(d=(s=document.getElementById("ob_phone"))==null?void 0:s.value)==null?void 0:d.trim(),$=[...document.querySelectorAll("#ob_examtypes_wrap .ob-exam-sel input")].map(w=>w.value),M=$.length>0?$.join(","):"YKS",D=((c=document.getElementById("ob_studentcount"))==null?void 0:c.value)||"1-5",j={coach_id:b.coachId,brand_name:((p=l.workspace)==null?void 0:p.brand_name)||"Akademi",brand_color:((m=l.workspace)==null?void 0:m.brand_color)||"#f0a500",exam_types:M,student_count_range:D};z&&(j.phone=z),await f.from("workspaces").upsert(j,{onConflict:"coach_id"}),l.workspace={...l.workspace||{},...j}}if(e===3){const z=(u=document.getElementById("ob_pass1"))==null?void 0:u.value,$=(y=document.getElementById("ob_pass2"))==null?void 0:y.value;if(z){if(z.length<8){h("En az 8 karakter!");return}if(z!==$){h("Şifreler uyuşmuyor!");return}const{error:M}=await f.auth.updateUser({password:z});if(M){h("Şifre güncellenemedi: "+M.message);return}const D=await me(z);await f.from("users").update({password_hash:D}).eq("id",b.coachId)}}if(e===4){const z=(I=(E=document.getElementById("ob_stuname"))==null?void 0:E.value)==null?void 0:I.trim(),$=((x=(g=document.getElementById("ob_stuuser"))==null?void 0:g.value)==null?void 0:x.trim())||((k=z==null?void 0:z.split(" ")[0])==null?void 0:k.toLowerCase()),M=((S=document.getElementById("ob_stupass"))==null?void 0:S.value)||"ogrenci123",D=await me(M);if(z){const j=$+"@rostrumakademi.com",{data:{session:w}}=await f.auth.getSession(),B=await fetch("/api/create-student",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${(w==null?void 0:w.access_token)||""}`},body:JSON.stringify({email:j,password:M,full_name:z,username:$,color:"#4da6ff",target:"",progress:0,week_start:0,coach_id:b.coachId,exam_profile:"YKS"})}),C=await B.json();B.ok&&C.userId?l.students.push({id:C.userId,name:z,target:"",color:"#4da6ff",progress:0,pass:D,weekStart:0,username:$,coachId:b.coachId}):h("Öğrenci eklenemedi: "+(C.error||"Bilinmeyen hata"))}}}if((_=Tt[e])!=null&&_.isCompletion){await f.from("workspaces").upsert({coach_id:b.coachId,brand_name:((L=l.workspace)==null?void 0:L.brand_name)||"Akademi",brand_color:((T=l.workspace)==null?void 0:T.brand_color)||"#f0a500",onboarding_done:!0},{onConflict:"coach_id"}),l.workspace&&(l.workspace.onboarding_done=!0),n.remove(),Q("home"),h("🎉 Hoş geldiniz! Platformunuz hazır.");return}const a=e+1;Nt(a,n)}let bt=null;window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),bt=e;const t=document.createElement("button");t.id="pwaInstallBtn",t.className="btn btn-ghost btn-sm",t.innerHTML="📲 Yükle",t.style.cssText="font-size:11px;padding:5px 10px",t.onclick=async()=>{bt.prompt();const{outcome:n}=await bt.userChoice;n==="accepted"&&(t.remove(),h("Uygulama yüklendi ✓"))},document.querySelector(".tbar-right").insertBefore(t,document.querySelector(".user-pill"))});async function Rn(){const e=l.students.find(T=>T.id===b.studentId);if(!e)return;const t=document.getElementById("view-sprofil");if(!t)return;const{data:n,error:a}=await f.from("student_profiles").select("*").eq("id",b.studentId).maybeSingle();a&&console.error("Öğrenci profili yüklenirken hata:",a);const i=(n==null?void 0:n.bio)||"",o=(n==null?void 0:n.school)||"",r=(n==null?void 0:n.grade)||"",s=(n==null?void 0:n.target_university)||"",d=(n==null?void 0:n.target_department)||"",c=(n==null?void 0:n.struggling_subjects)||"",p=(n==null?void 0:n.daily_capacity)||"",m=l.exams.filter(T=>T.studentId===e.id).sort((T,z)=>T.date.localeCompare(z.date)),u=m[m.length-1],y=u?(EXAM_DEFS[u.type]||[]).reduce((z,$)=>{var M;return z+Number(((M=u.nets)==null?void 0:M[$])||0)},0).toFixed(1):"—",E=W(0,e.weekStart??0);let I=0,g=0;for(let T=0;T<7;T++){const z=l.tasks[`${e.id}_${H(G(E,T))}`]||[];I+=z.length,g+=z.filter($=>$.done).length}const x=I>0?Math.round(g/I*100):0;let k=0;Object.keys(l.tasks).filter(T=>T.startsWith(e.id+"_")).forEach(T=>{k+=l.tasks[T].filter(z=>z.done).length});let S="";if(m.length>0){const T=m.slice(-6),z=Math.max(...T.map($=>(EXAM_DEFS[$.type]||[]).reduce((D,j)=>{var w;return D+Number(((w=$.nets)==null?void 0:w[j])||0)},0)),1);S=`
      <div class="card cp" style="margin-bottom:16px">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:90px;margin-top:12px">
          ${T.map($=>{const D=(EXAM_DEFS[$.type]||[]).reduce((R,U)=>{var P;return R+Number(((P=$.nets)==null?void 0:P[U])||0)},0),j=Math.max(Math.round(D/z*100),4),w=T[T.indexOf($)-1],B=w?(EXAM_DEFS[w.type]||[]).reduce((R,U)=>{var P;return R+Number(((P=w.nets)==null?void 0:P[U])||0)},0):D,C=D>B?"↑":D<B?"↓":"",Y=D>B?"var(--green)":D<B?"var(--red)":"var(--text-dim)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
    ...
    <div class="stats-row" style="margin-bottom:16px">
      ...
      <div class="stat-card">
        ...
        <div style="font-size:11px;color:var(--text-mid);margin-top:4px">%${x} tamamlandı</div>
      </div>
      <div class="stat-card">
    ...
    </div>`}async function Io(){const e=b.dbUser.id,t=document.getElementById("spBio").value.trim(),n=document.getElementById("spSchool").value.trim(),a=document.getElementById("spGrade").value.trim(),i=document.getElementById("spTargetUni").value.trim(),o=document.getElementById("spTargetDept").value.trim(),r=document.getElementById("spStruggling").value.trim(),s=parseInt(document.getElementById("spCapacity").value)||null,d={id:e,bio:t,school:n,grade:a,target_university:i,target_department:o,struggling_subjects:r,daily_capacity:s,updated_at:new Date().toISOString()},{error:c}=await f.from("student_profiles").upsert(d);h(c?"Profil kaydedilemedi: "+c.message:"Profil başarıyla güncellendi ✓")}async function _o(){const e=document.getElementById("newPass1").value,t=document.getElementById("newPass2").value;if(!e)return h("Şifre girin!");if(e!==t)return h("Şifreler uyuşmuyor!");if(e.length<4)return h("En az 4 karakter olmalı");const{error:n}=await f.from("users").update({password_hash:e}).eq("id",b.studentId);if(n)return h("Hata: "+n.message);h("Şifre güncellendi ✓"),document.getElementById("newPass1").value="",document.getElementById("newPass2").value=""}async function Nn(){var y;const e=document.getElementById("view-coach-profile");if(!e)return;e.innerHTML='<div class="loading">Profil bilgileri yükleniyor...</div>';const t=b.dbUser.id;let n=null,a=null;const i=await f.from("coach_profiles").select("*").eq("id",t).maybeSingle();if(n=i.data,a=i.error,a){const E=localStorage.getItem(`coach_profile_${t}`);if(E)try{n=JSON.parse(E),a=null}catch{}if(a){e.innerHTML=`<div style="padding:20px;color:var(--red)">Profil yüklenirken hata oluştu: ${v(a.message)}</div>`;return}}else if(!n){const E=localStorage.getItem(`coach_profile_${t}`);if(E)try{n=JSON.parse(E)}catch{}}const o=(n==null?void 0:n.bio)||"",r=(n==null?void 0:n.subjects)||"",s=(n==null?void 0:n.education)||"",d=(n==null?void 0:n.experience)||"",c=(n==null?void 0:n.photo_url)||"",p=(n==null?void 0:n.instagram)||"",m=(n==null?void 0:n.linkedin)||"",u=window.location.origin+window.location.pathname.replace("app.html","koc_bul.html")+`?coach=${t}`;e.innerHTML=`
            ...
            <div class="profile-preview-card">
              <div class="preview-card-header">
                ...
                <div class="preview-header-info">
                  <div class="preview-name" id="prevName">${v(((y=b.dbUser)==null?void 0:y.full_name)||"Koç")}</div>
  ...
  `}async function Mo(e,t){const{error:n}=await f.from("match_requests").update({status:t}).eq("id",e);n?h("Durum güncellenirken hata: "+n.message):(h("Durum güncellendi ✓"),Ot())}async function Ao(e){const t=l.students.find(r=>r.id===e);if(!t)return;const{data:n}=await f.from("student_speeds").select("*").eq("student_id",e),a={};(n||[]).forEach(r=>{a[`${r.exam_type}_${r.subject}`]=r.secs_per_question});const i=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];let o=document.getElementById("speedModal");o||(o=document.createElement("div"),o.id="speedModal",o.className="modal-bg",document.body.appendChild(o),o.addEventListener("click",r=>{r.target===o&&o.classList.remove("open")})),o.innerHTML=`<div class="modal modal-lg">
  ...
  </div>`,N("speedModal")}async function Do(e){const t=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];for(const{exam:n,sub:a}of t){const i=`${n}_${a}`,o=document.getElementById("spd_"+i);if(!o)continue;const r=parseInt(o.value)||180;await kn(e,n,a,r)}K("speedModal"),h("Hız ayarları kaydedildi ✓")}async function Lo(e){const t=l.students.find(o=>o.id===e);if(!t)return;const{data:n}=await f.from("student_notes").select("notes").eq("coach_id",b.coachId).eq("student_id",e).maybeSingle(),a=(n==null?void 0:n.notes)||"";let i=document.getElementById("studentNotesModal");i||(i=document.createElement("div"),i.id="studentNotesModal",i.className="modal-bg",document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")})),i.innerHTML=`<div class="modal">
  ...
  </div>`,N("studentNotesModal")}async function Co(e){const t=document.getElementById("studentNoteText").value,{error:n}=await f.from("student_notes").upsert({coach_id:b.coachId,student_id:e,notes:t,updated_at:new Date().toISOString()},{onConflict:"coach_id,student_id"});if(n){h("Not kaydedilemedi: "+n.message);return}h("Not kaydedildi ✓"),K("studentNotesModal")}function jo(e){let t=document.getElementById("reportModal");t||(t=document.createElement("div"),t.id="reportModal",t.className="modal-bg",t.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.classList.remove("open")}),document.getElementById("rpPeriod").addEventListener("change",function(){document.getElementById("rpCustomDates").style.display=this.value==="custom"?"":"none"})),document.getElementById("rpStuId").value=e;const n=new Date,a=new Date(n.getFullYear(),n.getMonth(),1);document.getElementById("rpStart").value=H(a),document.getElementById("rpEnd").value=H(n),document.getElementById("rpNote").value="",N("reportModal")}function On(){const e=document.getElementById("rpPeriod").value,t=new Date;if(e==="weekly"){const n=W(0,0);return{start:H(n),end:H(G(n,6))}}else return e==="monthly"?{start:H(new Date(t.getFullYear(),t.getMonth(),1)),end:H(t)}:{start:document.getElementById("rpStart").value,end:document.getElementById("rpEnd").value}}function Ft(e,t=!1){var _,L,T,z;const n=l.students.find($=>$.id===e);if(!n)return"";const{start:a,end:i}=On(),o=document.getElementById("rpNote").value.trim(),r=((_=l.workspace)==null?void 0:_.brand_name)||"Rostrum Akademi",s=((L=l.workspace)==null?void 0:L.brand_color)||"#f0a500",d=((T=b.dbUser)==null?void 0:T.full_name)||"Koç",c=[],p=new Date(a);for(;H(p)<=i;){const $=`${e}_${H(p)}`;(l.tasks[$]||[]).forEach(M=>c.push({...M,date:H(p)})),p.setDate(p.getDate()+1)}const m=c.length,u=c.filter($=>$.done).length,y=m>0?Math.round(u/m*100):0,E=c.filter($=>$.done).reduce(($,M)=>$+Number(M.duration||0),0),I={};c.forEach($=>{const M=$.subject||"Diğer";I[M]||(I[M]={total:0,done:0}),I[M].total++,$.done&&I[M].done++});const g=l.exams.filter($=>$.studentId===e&&$.date>=a&&$.date<=i).sort(($,M)=>$.date.localeCompare(M.date)),x=l.appointments.filter($=>$.studentId===e&&$.date>=a&&$.date<=i).sort(($,M)=>$.date.localeCompare(M.date)),k=`${new Date(a+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})} – ${new Date(i+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})}`;let S="";if(g.length>1){const $=Math.max(...g.map(w=>(EXAM_DEFS[w.type]||[]).reduce((B,C)=>{var Y;return B+Number(((Y=w.nets)==null?void 0:Y[C])||0)},0)),1),M=400,D=80,j=Math.min(40,(M-20)/g.length-4);S=`<svg width="${M}" height="${D+30}" style="overflow:visible">
      ${g.map((w,B)=>{const C=(EXAM_DEFS[w.type]||[]).reduce((U,P)=>{var F;return U+Number(((F=w.nets)==null?void 0:F[P])||0)},0),Y=Math.max(Math.round(C/$*(D-10)),4),R=10+B*((M-20)/g.length);return`<rect x="${R}" y="${D-Y}" width="${j}" height="${Y}" rx="3" fill="${s}" opacity="0.85"/>
          <text x="${R+j/2}" y="${D-Y-4}" text-anchor="middle" font-size="10" fill="#333">${C.toFixed(0)}</text>
          <text x="${R+j/2}" y="${D+14}" text-anchor="middle" font-size="9" fill="#666">${v(w.name.replace("Deneme","").replace("TYT","").replace("AYT","").trim()||String(B+1))}</text>`}).join("")}
...
</html>`}function Po(){const e=document.getElementById("rpStuId").value,t=Ft(e,!0),n=window.open("","_blank","width=900,height=700");n.document.write(t),n.document.close()}function Yo(){const e=document.getElementById("rpStuId").value;l.students.find(a=>a.id===e);const t=Ft(e,!1),n=window.open("","_blank");n.document.write(t),n.document.close(),setTimeout(()=>{n.focus(),n.print()},500),K("reportModal"),h('PDF oluşturuluyor — "PDF olarak kaydet" seçin')}async function Ho(){const e=document.getElementById("rpStuId").value,t=l.students.find(r=>r.id===e);if(!t)return;const n=`${window.location.origin}/api/generate-pdf-report?studentId=${e}`,a=`Merhaba, ${t.name} isimli öğrencimizin bu dönemki performans ve gelişim raporu hazırlandı. Aşağıdaki bağlantıdan raporu detaylıca görüntüleyebilirsiniz:

🔗 ${n}`,o=`https://api.whatsapp.com/send?text=${encodeURIComponent(a)}`;window.open(o,"_blank"),K("reportModal"),h("WhatsApp yönlendirmesi açıldı ✓")}function Ro(){let e=document.getElementById("weeklyPDFModal");e||(e=document.createElement("div"),e.id="weeklyPDFModal",e.className="modal-bg",e.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pdfNote").value="",N("weeklyPDFModal")}function No(){const e=document.getElementById("pdfNote").value.trim();K("weeklyPDFModal"),Fn(l.activeStuId,e)}function Fn(e,t){var $,M;const n=l.students.find(D=>D.id===e);if(!n)return;const a=(n==null?void 0:n.weekStart)??0,i=W(l.weekOffset,a),o=G(i,6),r=(($=l.workspace)==null?void 0:$.brand_name)||"Rostrum Akademi",s=((M=l.workspace)==null?void 0:M.brand_color)||"#f0a500",d=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"],c=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],p={deneme:"#f59e0b",soru:"#3b82f6",konu:"#10b981",diger:"#8b5cf6"},m={deneme:"#fffbeb",soru:"#eff6ff",konu:"#f0fdf4",diger:"#faf5ff"},u={deneme:"Deneme",soru:"Soru Bankası",konu:"Konu Anlatımı",diger:"Diğer"},y=H(new Date);let E=0,I=0,g=0,x="";for(let D=0;D<7;D++){const j=G(i,D),w=H(j),B=l.tasks[`${e}_${w}`]||[];E+=B.length,I+=B.filter(P=>P.done).length,g+=B.reduce((P,F)=>P+Number(F.duration||0),0);const C=w===y,Y=d[(a+D)%7].slice(0,3).toUpperCase(),R=B.reduce((P,F)=>P+Number(F.duration||0),0),U=B.map(P=>{const F=p[P.type]||"#94a3b8",Z=m[P.type]||"#f8fafc",le=u[P.type]||"Diğer";return`<div style="margin-bottom:5px;border-radius:7px;background:${Z};border:1px solid ${F}28;border-left:3px solid ${F}">
      ...
      </div>`}).join("");x+=`<div style="padding:0 5px;border-right:${D<6?"1px solid #ede9e3":"none"}">
      <div style="padding-bottom:7px;margin-bottom:7px;border-bottom:2px solid ${C?s:"#ede9e3"}">
        ...
        ${R>0?`<div style="font-size:7px;color:#ccc;margin-top:2px">${R}dk · ${B.length}g</div>`:""}
      </div>
      ${B.length===0?'<div style="font-size:13px;color:#e8e4dc;text-align:center;padding:14px 0">—</div>':U}
    </div>`}const k=E>0?Math.round(I/E*100):0,S=k>=80?"#22c55e":k>=50?s:"#f59e0b",_=n.name.split(" ").map(D=>D[0]).join("").slice(0,2).toUpperCase();let L="";for(let D=0;D<7;D++){const j=G(i,D),w=H(j),B=l.tasks[`${e}_${w}`]||[];if(B.length===0)continue;const C=d[(a+D)%7],Y=B.map((R,U)=>{const P=p[R.type]||"#94a3b8",F=u[R.type]||"Diğer";return`<div style="margin-bottom:12px;padding-bottom:12px;border-bottom:1px solid #eee">
        <div style="display:flex;align-items:baseline;gap:8px">
          <span style="font-size:12px;font-weight:800;color:${P}">${U+1}. ${F}${R.exam?` (${R.exam})`:""}</span>
          <span style="font-size:12px;font-weight:700;color:#111">${v(R.subject)}</span>
          <span style="font-size:11px;color:#666;margin-left:auto">${R.duration} dk</span>
        </div>
        ${R.note?`<div style="font-size:10px;color:#555;margin-top:4px;padding-left:14px;border-left:2px solid ${P}40;line-height:1.5">${v(R.note).replace(/\n/g,"<br>")}</div>`:""}
  ...
  <!-- WEEK GRID -->
  <div style="display:grid;grid-template-columns:repeat(7,1fr);padding:10px 8px 6px">${x}</div>
  ...
  <div class="page-break" style="padding:40px 30px;max-width:1000px;margin:0 auto">
  ...
  </body></html>`,z=window.open("","_blank","width=1200,height=850");z.document.write(T),z.document.close(),setTimeout(()=>z.focus(),300)}function Ko(){const e="abcdefghijklmnopqrstuvwxyz",t=()=>Array.from({length:3},()=>e[Math.floor(Math.random()*e.length)]).join("");return`https://meet.google.com/${t()}-${t()}-${t()}`}function Oo(){return`https://zoom.us/j/${Math.floor(Math.random()*9e9)+1e9}`}function Fo(e){navigator.clipboard.writeText(e).then(()=>h("Link kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),h("Link kopyalandı ✓")})}const Gn=[{name:"Altın",val:"#f0a500",dim:"rgba(240,165,0,.12)"},{name:"Turuncu",val:"#e8622a",dim:"rgba(232,98,42,.12)"},{name:"Mavi",val:"#4da6ff",dim:"rgba(77,166,255,.12)"},{name:"Yeşil",val:"#3ecf8e",dim:"rgba(62,207,142,.12)"},{name:"Mor",val:"#c084fc",dim:"rgba(192,132,252,.12)"},{name:"Pembe",val:"#f472b6",dim:"rgba(244,114,182,.12)"},{name:"Kırmızı",val:"#ff5c5c",dim:"rgba(255,92,92,.12)"},{name:"Turkuaz",val:"#06b6d4",dim:"rgba(6,182,212,.12)"}];function qn(){try{const e=JSON.parse(localStorage.getItem("ba_theme")||"{}");e.theme==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),e.accent&&Un(e.accent,e.accentDim,!1)}catch{}}function Un(e,t,n=!0){if(document.documentElement.style.setProperty("--accent",e),document.documentElement.style.setProperty("--accent-dim",t||"rgba(240,165,0,.12)"),n)try{const a=JSON.parse(localStorage.getItem("ba_theme")||"{}");a.accent=e,a.accentDim=t,localStorage.setItem("ba_theme",JSON.stringify(a))}catch{}}function Go(e){e==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{const t=JSON.parse(localStorage.getItem("ba_theme")||"{}");t.theme=e,localStorage.setItem("ba_theme",JSON.stringify(t))}catch{}document.querySelectorAll(".theme-btn").forEach(t=>{const n=t.dataset.theme===e;t.style.background=n?"var(--accent-dim)":"",t.style.borderColor=n?"var(--accent)":"",t.style.color=n?"var(--accent)":""})}function qo(){let e=document.getElementById("themePanel");if(e){e.remove();return}e=document.createElement("div"),e.id="themePanel";const t=document.documentElement.getAttribute("data-theme")!=="light";e.style.cssText="position:fixed;top:60px;right:12px;background:var(--surface);border:1px solid var(--border2);border-radius:14px;padding:18px;z-index:300;box-shadow:var(--shadow-lg);min-width:230px;animation:fadeUp .2s ease",e.innerHTML=`
    ...
    <div style="display:flex;gap:7px;flex-wrap:wrap;margin-bottom:14px">
      ${Gn.map(n=>`<div onclick="applyAccent('${n.val}','${n.dim}');document.getElementById('themePanel').remove()" title="${n.name}"
    ...
    `):b.role==="parent"?(e.title="Yapay Zeka Veli Bilgilendirme Asistanı",t.textContent="Yapay Zeka Veli Asistanı",i.textContent="Merhaba! Ben Veli Asistanıyım",o.textContent="Çocuğunuzun ders çalışma durumu, deneme netleri ve evde ona nasıl destek olabileceğiniz konularında bilgi alabilirsiniz.",r.innerHTML=`
    ...
    `)}function Uo(){const e=document.getElementById("aiChatPanel"),t=document.getElementById("aiChatBubble");if(e.classList.contains("open"))e.classList.remove("open"),t.style.display="flex";else{e.classList.add("open"),t.style.display="none";const n=document.getElementById("aiMessages");n.scrollTop=n.scrollHeight,document.getElementById("aiInput").focus()}}function Wo(e){document.getElementById("aiInput").value=e,Vn()}function Et(){var t;const e={};try{const n=l.students.find(r=>r.id===l.activeStuId);n&&(e.studentName=n.name,e.target=n.target||""),b.role==="parent"&&b.childName&&(e.studentName=b.childName);const a=(l.exams||[]).filter(r=>r.studentId===l.activeStuId).slice(-5);a.length&&(e.recentExams=a.map(r=>({name:r.type+" "+(r.name||""),date:r.date||"",nets:r.nets||{}})));let i=[];if(Object.entries(l.tasks||{}).forEach(([r,s])=>{r.startsWith(l.activeStuId+"_")&&(i=i.concat(s))}),i.length){const r=i.filter(s=>s.done).length;e.taskCompletionRate=Math.round(r/i.length*100),e.weeklyTaskCount=i.length}const o=Object.keys(EXAM_DEFS);a.length&&(e.examProfile=((t=a[0])==null?void 0:t.type)||o[0])}catch(n){console.warn("AI context error:",n)}return e}function $e(e,t){ut.push({role:e,content:t});const n=document.getElementById("aiMessages"),a=n.querySelector(".ai-welcome");a&&a.remove();const i=new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),o=document.createElement("div");o.className=`ai-msg ${e}`,o.innerHTML=`${v(t).replace(/\n/g,"<br>")}<div class="ai-msg-time">${i}</div>`,n.appendChild(o),n.scrollTop=n.scrollHeight}async function Vn(){if(ht)return;const e=document.getElementById("aiInput"),t=e.value.trim();if(t){e.value="",$e("user",t),ht=!0,document.getElementById("aiTyping").classList.add("show"),document.getElementById("aiSendBtn").disabled=!0;try{const n=Et(),a=b.role||"student",i=(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1","/api/ai-chat"),o=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:ut.slice(-10),context:n,userRole:a})});if(o.ok){const r=await o.json();$e("assistant",r.reply||"Yanıt alınamadı.")}else{const r=await Le(t,n,a);$e("assistant",r)}}catch(n){console.error("AI error:",n);try{const a=Et(),i=await Le(t,a,b.role||"student");$e("assistant",i)}catch{const i=localStorage.getItem("gemini_api_key");$e("assistant","🔒 Bu özellik ileride aktif olacaktır. Yakında kullanıma açılacak.")}}finally{ht=!1,document.getElementById("aiTyping").classList.remove("show"),document.getElementById("aiSendBtn").disabled=!1}}}let kt=null;async function Zn(e){try{const t=await fetch(`https://generativelanguage.googleapis.com/v1beta/models?key=${e}`);if(!t.ok)return null;const a=(await t.json()).models||[];let i=a.find(o=>o.name.toLowerCase().includes("flash")&&o.supportedGenerationMethods.includes("generateContent"));if(i||(i=a.find(o=>o.supportedGenerationMethods.includes("generateContent"))),i)return i.name.replace("models/","")}catch(t){console.warn("Auto-detect model failed:",t)}return null}async function Le(e,t,n){var p,m,u,y,E,I;let a=localStorage.getItem("gemini_api_key");if(!a)try{const{data:g}=await f.from("platform_settings").select("value").eq("key","ai_settings").maybeSingle();g&&g.value&&g.value.gemini_api_key&&(a=g.value.gemini_api_key)}catch(g){console.warn("DB Gemini API key load error:",g)}const i=a;if(!i)throw new Error("API anahtarı eksik.");let o="gemini-1.5-flash";if(i)if(kt)o=kt;else{const g=await Zn(i);g&&(kt=g,o=g,console.log("[Gemini API] Otomatik model tespiti başarılı:",o))}let r=`Sen "Rostrum Akademi Yapay Zeka Asistanı"sın. Türkiye eğitim sistemine (YKS, LGS) hakim, rolüne göre öğrencilere, velilere veya koçlara destek veren bir yapay zekasın.
...
[TASLAK]
(Öğrenciye gönderilecek haftalık değerlendirme taslağı)`;let u="";const y={studentName:t.name,target:t.target,recentExams:c,taskCompletionRate:s,weeklyTaskCount:i};try{const k=await fetch("/api/ai-chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({messages:[{role:"user",content:m}],context:y,userRole:"coach"})});k.ok?u=(await k.json()).reply:u=await Le(m,y,"coach")}catch{u=await Le(m,y,"coach")}let E="Analiz üretilemedi.",I="Taslak üretilemedi.";const g=u.indexOf("[ANALİZ]"),x=u.indexOf("[TASLAK]");g!==-1&&x!==-1?g<x?(E=u.substring(g+8,x).trim(),I=u.substring(x+8).trim()):(I=u.substring(x+8,g).trim(),E=u.substring(g+8).trim()):I=u,document.getElementById("aiCopilotAnalysisBox").innerHTML=`<b>📊 Yapay Zeka Durum Analizi:</b><br>${E.replace(/\n/g,"<br>")}`,document.getElementById("aiCopilotTextarea").value=I,Gt=I,document.getElementById("aiCopilotResultArea").style.display="block",document.getElementById("aiCopilotSendBtn").disabled=!0,document.getElementById("aiCopilotEditWarning").style.display="inline"}catch(a){console.error("generateAICopilotDraft error:",a),h("Taslak oluşturulurken hata: "+a.message)}finally{n.disabled=!1,n.textContent="🤖 Durum Analizi Yap ve Taslak Oluştur"}}function Zo(){const e=document.getElementById("aiCopilotTextarea").value.trim(),t=document.getElementById("aiCopilotSendBtn"),n=document.getElementById("aiCopilotEditWarning");e&&e!==Gt?(t.disabled=!1,n.style.display="none"):(t.disabled=!0,n.style.display="inline")}async function Xo(e){var a;const t=document.getElementById("aiCopilotTextarea").value.trim();if(!t)return;const n=document.getElementById("aiCopilotSendBtn");n.disabled=!0,n.textContent="Gönderiliyor...";try{const i=b.coachId||((a=l.students.find(s=>s.id===e))==null?void 0:a.coachId),{data:o,error:r}=await f.from("messages").insert({student_id:e,coach_id:i,from_role:"coach",text:t,read:!1}).select().single();if(r)throw r;l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:o.id,from:"coach",text:t,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),h("Taslak mesaj başarıyla düzenlendi ve öğrenciye gönderildi!"),document.getElementById("aiCopilotResultArea").style.display="none",document.getElementById("aiCopilotTextarea").value="",Gt=""}catch(i){console.error("sendCopilotDraft error:",i),h("Gönderim hatası: "+i.message),n.disabled=!1}finally{n.textContent="✍️ Düzenlemeyi Kaydet ve Öğrenciye Gönder"}}function Xn(){const e=l.students.find(s=>s.id===l.activeStuId),t=b.childName||(e==null?void 0:e.name)||"Öğrenci",n=document.getElementById("view-parent-home");if(!n)return;let a=[];Object.entries(l.tasks||{}).forEach(([s,d])=>{s.startsWith(l.activeStuId+"_")&&(a=a.concat(d))});const i=a.filter(s=>s.done).length,o=a.length?Math.round(i/a.length*100):0,r=(l.exams||[]).filter(s=>s.studentId===l.activeStuId).slice(-3);n.innerHTML=`
    ...
    </div>`}function Jn(){const e=document.getElementById("view-parent-progress");if(!e)return;const t=l.students.find(o=>o.id===l.activeStuId),n=b.childName||(t==null?void 0:t.name)||"Öğrenci",a=(l.exams||[]).filter(o=>o.studentId===l.activeStuId);let i=[];Object.entries(l.tasks||{}).forEach(([o,r])=>{o.startsWith(l.activeStuId+"_")&&(i=i.concat(r))}),e.innerHTML=`
    <div style="padding:24px;max-width:800px;margin:0 auto">
    ...
    <div style="padding:24px;max-width:600px;margin:0 auto;text-align:center">
      ...
      <div class="analytics-grid">
        ${ea(t).map(d=>{const c=d.totalCount>0?Math.round(d.doneCount/d.totalCount*100):0,p=c>=80?"var(--green)":c>=50?"var(--accent)":"var(--text-dim)";return`<div class="analytics-card">
      ...
      </div>`}async function Xe(){const e=document.getElementById("view-coach-resources");if(!e)return;if(!fe.length){e.innerHTML='<div style="max-width:720px;margin:0 auto;padding:40px;text-align:center;color:var(--text-dim);font-size:13px">Kaynaklar yükleniyor…</div>';const{data:a,error:i}=await f.from("resources").select("*").or(`coach_id.eq.${b.coachId},coach_id.is.null`).order("resource_type,exam_type,subject,name");i&&console.error(i),fe=a||[]}ce={search:"",exam:"",subject:""};let t="books";const n=document.querySelector(".cr-tab.active");n&&(n.id==="crt-playlists"?t="playlists":n.id==="crt-analytics"&&(t="analytics")),e.innerHTML=`<div style="max-width:720px;margin:0 auto">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
      <div>
...
`).map(d=>d.trim()).filter(Boolean),o=window._crmFetchedVideos||[];let r=[];if(a){if(o.length>0?r=o.map(d=>({label:d.title||"",url:d.url||"",topic:"",soru:parseInt(d.duration)||0})):r=i.map(d=>{const c=d.split("|").map(p=>p.trim());return{label:c[0]||"",url:c[1]||"",topic:"",soru:parseInt(c[2])||0}}),!r.length)return h("Video listesi boş! Önce playlist çekin.")}else r=i.map(d=>{const c=d.split("|").map(p=>p.trim());return{label:c[0]||"",soru:parseInt(c[1])||0}});const s={exam_type:document.getElementById("crmExam").value,subject:t,publisher:document.getElementById("crmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:r,active:!0,resource_type:a?"playlist":"book",coach_id:b.coachId};A(!0),n?(await f.from("resources").update(s).eq("id",n),h("Güncellendi ✓")):(await f.from("resources").insert(s),h("Kaynak eklendi ✓")),A(!1),K("coachResourceModal"),fe=[],Xe()}async function is(e){await X("Bu kaynağı silmek istediğinizden emin misiniz?")&&(A(!0),await f.from("resources").delete().eq("id",e),A(!1),h("Silindi"),fe=[],Xe())}function os(e){const t=e.target.files[0];if(!t)return;A(!0);const n=new FileReader;n.onload=async a=>{try{const i=new Uint8Array(a.target.result),o=XLSX.read(i,{type:"array"}),r=o.SheetNames[0],s=o.Sheets[r],d=XLSX.utils.sheet_to_json(s);if(d.length===0)return A(!1),h("Excel dosyası boş!");const c={};d.forEach(u=>{const y=u["Kaynak Adı"]||u.Name||u["Kitap Adı"]||u["Playlist Adı"]||"",I=(u["Kaynak Türü"]||u.Type||u.Tür||"book").toLowerCase().includes("playlist")?"playlist":"book",g=u.Yayınevi||u.Publisher||u.Hoca||"",x=u.Sınav||u.Exam||"TYT",k=u.Ders||u.Subject||"",S=u["Öğe Adı"]||u.Test||u.Video||u["Test Adı"]||u["Video Adı"]||"",_=parseInt(u["Soru Sayısı"]||u.Soru||u.Süre||u["Süre (dk)"]||0),L=u.URL||u.Link||"";if(!y||!k||!S)return;const T=`${y}_${x}_${k}_${I}`;c[T]||(c[T]={exam_type:x,subject:k,publisher:g,name:y,resource_type:I,tests:[]}),c[T].tests.push({label:S,soru:_,url:L,topic:""})});const p=Object.values(c);if(p.length===0)return A(!1),h("Uyumlu veri bulunamadı! Sütun başlıklarını kontrol edin.");let m=0;for(const u of p){const{error:y}=await f.from("resources").insert({...u,year:new Date().getFullYear(),active:!0,coach_id:b.coachId});y||m++}A(!1),h(`✓ Excel'den ${m} kaynak başarıyla aktarıldı!`),fe=[],Xe()}catch(i){A(!1),console.error(i),h("Excel okuma hatası: "+i.message)}},n.readAsArrayBuffer(t)}function ss(e){const t=e.target.files[0];if(!t)return;A(!0);const n=new FileReader;n.onload=async a=>{try{const i=new Uint8Array(a.target.result),o=XLSX.read(i,{type:"array"}),r=o.Sheets[o.SheetNames[0]],s=XLSX.utils.sheet_to_json(r);if(s.length===0)return A(!1),h("Excel dosyası boş!");let d=0;for(const c of s){const p=c["Ad Soyad"]||c.Ad||c.Name||"",m=c.Hedef||c.Target||"Hedef belirtilmemiş";let u=c["Kullanıcı Adı"]||c.Username||"",y=c.Şifre||c.Password||STU_DEFAULT_PASS;if(!p)continue;u||(u=p.toLowerCase().replace(/\s+/g,"")+Math.floor(Math.random()*100),u=Ee(u));const E=await me(y),I=u+"@rostrumakademi.com",{data:g,error:x}=await f.rpc("create_new_user",{p_email:I,p_password:y,p_full_name:p,p_username:u,p_role:"student",p_target:m,p_color:"#4da6ff",p_progress:0,p_week_start:0,p_coach_id:b.coachId,p_institution_id:null,p_exam_profile:"YKS"});!x&&g&&(l.students.push({id:g,name:p,target:m,color:"#4da6ff",progress:0,pass:E,weekStart:0,username:u}),d++)}A(!1),h(`✓ Excel'den ${d} öğrenci başarıyla eklendi!`),pe(),qe()}catch(i){A(!1),console.error(i),h("Excel okuma hatası: "+i.message)}},n.readAsArrayBuffer(t)}function ta(e){if(!l.activeStuId||!O)return null;let t=null;return Object.entries(l.tasks).forEach(([n,a])=>{n.startsWith(l.activeStuId+"_")&&a.forEach(i=>{i.subject&&i.subject.includes(O.name)&&(i.task_items&&Array.isArray(i.task_items)?i.task_items.forEach(o=>{(o.label||o)===e&&(o.done||i.done?t="done":t!=="done"&&(t="pending"))}):i.note&&i.note.includes(e)&&(i.done?t="done":t!=="done"&&(t="pending")))})}),t}async function rs(e,t){var d;const a=`${l.activeStuId}_${e}`,i=(d=l.tasks[a])==null?void 0:d[t];if(!i)return;Te=e,_editingTaskId=i._id,O=null,document.querySelector("#taskModal h2").innerHTML=`Görev Düzenle — <span id="tmDay">${e}</span>`,document.querySelector("#taskModal .btn-accent").textContent="Güncelle",document.getElementById("tmType").value=i.type,document.getElementById("tmExam").value=i.exam||"",document.getElementById("tmDuration").value=i.duration||60,document.getElementById("tmNote").value=i.note||"";const o=i.exam||"",r=i.type;{const c=document.getElementById("tmSubjectSel"),p=document.getElementById("tmSubjectFree");document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none";const m=document.getElementById("tmTestSummary");m&&(m.style.display="none"),o&&typeof SUBJECT_MAP<"u"&&SUBJECT_MAP[o]?(c.innerHTML=SUBJECT_MAP[o].map(E=>`<option value="${E}">${E}</option>`).join(""),c.style.display="",p.style.display="none"):(c.style.display="none",p.style.display="");const u=(r==="soru"||r==="konu")&&o;document.getElementById("soruBankasiWrap").style.display=u?"":"none";const y=document.getElementById("tmBookSearch");y&&(y.placeholder=r==="konu"?"Hoca veya playlist ara...":"Kitap veya yayınevi ara...")}if((r==="soru"||r==="konu")&&o){const c=document.getElementById("tmSubjectSel");let p="",m=i.subject;if(i.subject.includes(" - ")){const I=i.subject.split(" - ");p=I[0].trim(),m=I.slice(1).join(" - ").trim()}p&&SUBJECT_MAP[o]&&SUBJECT_MAP[o].includes(p)&&(c.value=p),document.getElementById("tmBookVal").value=m,document.getElementById("tmBookSearch").value=m,A(!0),await bn(),A(!1);const u=`${o}_${p}`;let E=(J[u]||[]).find(I=>I.name===m);if(E||Object.values(J).forEach(I=>{const g=I.find(x=>x.name===m);g&&(E=g)}),E){O=E,document.getElementById("tmTestWrap").style.display="",Dt();const I=(i.task_items||[]).map(x=>x.label||x);document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(x=>{var _;const k=parseInt(x.value),S=((_=O.testler[k])==null?void 0:_.label)||O.testler[k];I.includes(S)?x.checked=!0:x.checked=!1}),Ce()}}else{const c=document.getElementById("tmSubjectSel"),p=document.getElementById("tmSubjectFree");c.style.display!=="none"?c.value=i.subject:p.value=i.subject,document.getElementById("tmBookVal").value="",document.getElementById("tmBookSearch").value="",document.getElementById("tmBookList").style.display="none",document.getElementById("tmTestWrap").style.display="none"}N("taskModal")}async function ls(){const e=prompt("Şablon adı giriniz:");if(!e)return;const t=l.students.find(r=>r.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=W(l.weekOffset,n),i=[];for(let r=0;r<7;r++){const s=G(a,r),d=H(s),c=`${l.activeStuId}_${d}`;(l.tasks[c]||[]).forEach(m=>{i.push({day_index:r,type:m.type,exam_type:m.exam||null,subject:m.subject,duration:m.duration,note:m.note||"",task_items:m.task_items||null})})}if(i.length===0)return h("Bu haftada kaydedilecek görev bulunmuyor!");A(!0);const{error:o}=await f.from("program_templates").insert({coach_id:b.coachId,name:e,description:`${i.length} görev içeriyor.`,tasks:i});if(A(!1),o)return h("Şablon kaydedilemedi: "+o.message);h("Hafta şablon olarak kaydedildi ✓")}async function ds(){A(!0);const{data:e,error:t}=await f.from("program_templates").select("*").eq("coach_id",b.coachId);if(A(!1),t)return h("Şablonlar yüklenemedi.");if(!e||e.length===0)return h("Kayıtlı şablonunuz bulunmuyor. Önce haftayı şablon olarak kaydedin.");let n=document.getElementById("applyTemplateModal");n||(n=document.createElement("div"),n.id="applyTemplateModal",n.className="modal-bg",n.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.classList.remove("open")})),document.getElementById("atmSelect").innerHTML=e.map(a=>`<option value="${a.id}">${v(a.name)} (${a.tasks.length} Görev)</option>`).join(""),N("applyTemplateModal")}async function cs(){const e=document.getElementById("atmSelect").value;if(!e)return;A(!0);const{data:t,error:n}=await f.from("program_templates").select("*").eq("id",e).single();if(n||!t)return A(!1),h("Şablon yüklenemedi.");const a=l.students.find(r=>r.id===l.activeStuId),i=(a==null?void 0:a.weekStart)??0,o=W(l.weekOffset,i);for(const r of t.tasks){const s=H(G(o,r.day_index)),d={student_id:l.activeStuId,coach_id:b.coachId,date:s,type:r.type,exam_type:r.exam_type,subject:r.subject,duration:r.duration,note:r.note,done:!1,task_items:r.task_items},{data:c,error:p}=await f.from("tasks").insert(d).select().single();if(!p&&c){const m=`${l.activeStuId}_${s}`;l.tasks[m]||(l.tasks[m]=[]),l.tasks[m].push({_id:c.id,type:c.type,exam:c.exam_type,subject:c.subject,duration:c.duration,note:c.note,done:!1,student_note:"",task_items:c.task_items})}}A(!1),K("applyTemplateModal"),q(),h("Şablon başarıyla uygulandı ✓")}function ps(e,t){var o;const a=`${l.activeStuId}_${e}`,i=(o=l.tasks[a])==null?void 0:o[t];i&&(_clipboardTask={type:i.type,exam:i.exam,subject:i.subject,duration:i.duration,note:i.note,task_items:i.task_items},h("Görev panoya kopyalandı ✓"),q())}async function ms(e){if(!_clipboardTask)return;const t={student_id:l.activeStuId,coach_id:b.coachId,date:e,type:_clipboardTask.type,exam_type:_clipboardTask.exam||null,subject:_clipboardTask.subject,duration:_clipboardTask.duration,note:_clipboardTask.note,done:!1,task_items:_clipboardTask.task_items};A(!0);const{data:n,error:a}=await f.from("tasks").insert(t).select().single();if(A(!1),a)return h("Hata: "+a.message);const i=`${l.activeStuId}_${e}`;l.tasks[i]||(l.tasks[i]=[]),l.tasks[i].push({_id:n.id,type:n.type,exam:n.exam_type,subject:n.subject,duration:n.duration,note:n.note,done:!1,student_note:"",task_items:n.task_items}),q(),h("Görev yapıştırıldı ✓")}async function us(e,t){var p;const n=`${l.activeStuId}_${e}`,a=(p=l.tasks[n])==null?void 0:p[t];if(!a)return;const i=l.students.find(m=>m.id===l.activeStuId),o=(i==null?void 0:i.weekStart)??0,r=W(l.weekOffset,o),s=[];for(let m=0;m<7;m++){const u=G(r,m),y=H(u);y!==e&&s.push({student_id:l.activeStuId,coach_id:b.coachId,date:y,type:a.type,exam_type:a.exam||null,subject:a.subject,duration:a.duration,note:a.note,done:!1,task_items:a.task_items})}if(s.length===0)return;A(!0);const{data:d,error:c}=await f.from("tasks").insert(s).select();if(A(!1),c)return h("Hata: "+c.message);(d||[]).forEach(m=>{const u=`${l.activeStuId}_${m.date}`;l.tasks[u]||(l.tasks[u]=[]),l.tasks[u].push({_id:m.id,type:m.type,exam:m.exam_type,subject:m.subject,duration:m.duration,note:m.note,done:!1,student_note:"",task_items:m.task_items})}),q(),h("Görev tüm haftaya kopyalandı ✓")}async function gs(){if(!_clipboardTask)return;const e=l.students.find(r=>r.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=W(l.weekOffset,t),a=[];for(let r=0;r<7;r++){const s=G(n,r),d=H(s);a.push({student_id:l.activeStuId,coach_id:b.coachId,date:d,type:_clipboardTask.type,exam_type:_clipboardTask.exam||null,subject:_clipboardTask.subject,duration:_clipboardTask.duration,note:_clipboardTask.note,done:!1,task_items:_clipboardTask.task_items})}A(!0);const{data:i,error:o}=await f.from("tasks").insert(a).select();if(A(!1),o)return h("Hata: "+o.message);(i||[]).forEach(r=>{const s=`${l.activeStuId}_${r.date}`;l.tasks[s]||(l.tasks[s]=[]),l.tasks[s].push({_id:r.id,type:r.type,exam:r.exam_type,subject:r.subject,duration:r.duration,note:r.note,done:!1,student_note:"",task_items:r.task_items})}),_clipboardTask=null,q(),h("Görev tüm haftaya yapıştırıldı ✓")}qn();Yt();window.addEventListener("hashchange",()=>{let e=window.location.hash.substring(1);if(document.getElementById("appShell").classList.contains("visible")&&e!==currentTab){if(!e){e={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[b.role]||"portal",window.location.hash=e;return}document.getElementById("view-"+e)&&Q(e,!1)}});async function Ut(){const e=document.getElementById("view-coach-applications");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:800px;margin:0 auto">
    ...
    </div>`).join("")}function ys(e){const t=e!==null?Ie[e]||{}:{};let n=document.getElementById("coachNoteModal");n||(n=document.createElement("div"),n.id="coachNoteModal",n.className="modal-bg",document.body.appendChild(n)),n.innerHTML=`<div class="modal" style="max-width:520px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
  ...
  </div>`,n.style.display="flex"}async function fs(e){const t=document.getElementById("noteEditorTitle").value.trim(),n=document.getElementById("noteEditorBody").value.trim();if(!t&&!n)return h("Not boş olamaz");const a={title:t||"Başlıksız",body:n,updated:new Date().toISOString()};e===null?Ie.unshift(a):Ie[e]=a,await aa(),document.getElementById("coachNoteModal").style.display="none",Wt(),h("Not kaydedildi ✓")}async function xs(e){await X("Bu notu silmek istiyor musun?")&&(Ie.splice(e,1),await aa(),Wt(),h("Not silindi"))}async function aa(){const e=`coach_notes_${b.coachId}`;await f.from("platform_settings").upsert({key:e,value:{notes:Ie}},{onConflict:"key"})}window.toggleSidebar=$a;window.setupShell=Ea;window.switchTab=Q;window.renderHome=pn;window.renderCoachApplications=Ut;window.updateApplication=vs;window.renderCoachNotes=na;window.openNoteEditor=ys;window.toggleNewResourceMode=Wa;window.addManualTest=Va;window.removeManualTest=Za;window.saveCoachNote=fs;window.deleteCoachNote=xs;window.renderStudentsSearch=qe;window.filterStudentSearch=Sa;window.openStudentDetail=mn;window.openKonuHaritasi=za;window.openStudentProgram=Bt;window.openStudentExams=Ba;window.openStudentAppointments=Ma;window.renderProfile=vn;window.saveProfile=Pa;window.renderSettings=yn;window.saveGeminiKey=Ya;window.renderProgram=q;window.selectStu=Ha;window.chWeek=Ra;window.goToday=Na;window.openClearWeekModal=Ka;window.toggleDaySel=Oa;window.toggleAllDays=Fa;window.confirmClearDays=Ga;window.openTaskModal=Xa;window.loadResources=bn;window.updateSubjectList=At;window.updateBookList=Ja;window.renderBookList=lt;window.filterBooks=Qa;window.selectBook=ei;window.renderTestList=Dt;window.selectAllTests=ti;window.clearAllTests=ni;window.updateTestSummary=Ce;window.selectModalSpeed=ai;window.applyDuration=ii;window.loadStudentSpeeds=hn;window.saveStudentSpeed=kn;window.saveTask=oi;window.toggleTask=si;window.closeTaskMenu=Lt;window.showTaskMenu=ri;window.copyTask=li;window.deleteTask=di;window.renderTodoList=En;window.renderStudents=In;window.goProgram=hi;window.openStudentModal=ki;window.saveStudent=wi;window.showInviteInfo=_n;window.copyInvite=$i;window.deleteStu=Ti;window.renderAppointments=Ue;window.renderCalDays=dt;window.selCalDay=Ei;window.chCalMonth=Si;window.renderApptList=Ct;window.openApptModal=Ii;window.saveAppt=_i;window.deleteAppt=zi;window.renderExams=je;window.openCommentModal=Di;window.saveComment=Li;window.deleteExam=Ci;window.renderMessages=Ln;window.selectThread=ji;window.renderThreadHTML=xe;window.sendMsg=Pi;window.scrollMsgs=be;window.renderPortal=ct;window.stuToggleTask=Yi;window.renderSPortal=ze;window.stuToggleTask2=Hi;window.chWeekS=Ri;window.openTaskDetail=jt;window.toggleTaskDetail=Ni;window.toggleDetailItem=Ki;window.selectVideoSpeed=Oi;window.saveTaskDetail=Fi;window.renderSExams=Pt;window.openStudentExamModal=Cn;window.openExamModal=Gi;window.renderNetInputs=Yt;window.saveExam=Wi;window.renderSMessages=$t;window.initRealtime=Ht;window.destroyRealtime=Rt;window.renderDevDashboard=Pn;window.renderDevUsers=We;window.openDevUserModal=Vi;window.devDeleteUser=Zi;window.openPlanModal=Xi;window.savePlan=Ji;window.renderDevResources=Ve;window.openPlaylistModal=Qi;window.fetchYouTubePlaylist=eo;window.savePlaylist=to;window.openResourceModal=no;window.saveResource=ao;window.devDeleteResource=io;window.renderDevFinance=pt;window.openPaymentModal=oo;window.savePayment=so;window.openSubModal=ro;window.saveSub=lo;window.renderDevAnnounce=Ze;window.openAnnounceModal=co;window.saveAnnounce=po;window.toggleAnnounce=mo;window.devDeleteAnnounce=uo;window.renderDevTickets=Pe;window.updateTicketStatus=xo;window.devDeleteTicket=bo;window.selectDevTicket=go;window.sendDevReply=fo;window.openSupportTicket=ho;window.openSupportChat=mt;window.closeSupportChat=Yn;window.startAISupportChat=ko;window.startEminSupportChat=wo;window.submitEminInitialMessage=$o;window.sendSupportMessage=To;window.openSupportChatDirect=mt;window.checkCoachSubscription=zt;window.showTrialExpiredScreen=nt;window.loadAnnouncements=Hn;window.saveStudentDev=Jo;window.showOnboarding=Eo;window.renderOnboardingStep=Nt;window.advanceOnboarding=So;window.renderSProfil=Rn;window.saveStudentProfile=Io;window.changePassword=_o;window.renderCoachProfile=Nn;window.updateProfilePreview=Kt;window.switchPreviewTab=zo;window.nl2br=Kn;window.saveCoachProfile=Bo;window.renderDevMatches=Ot;window.updateMatchRequestStatus=Mo;window.openSpeedModal=Ao;window.saveAllSpeeds=Do;window.openStudentNotes=Lo;window.saveStudentNote=Co;window.openReportModal=jo;window.getReportDates=On;window.buildReportHTML=Ft;window.previewReport=Po;window.generatePDF=Yo;window.openWeeklyPDFModal=Ro;window.generateWeeklyPDF=No;window.printWeeklyProgramWithNote=Fn;window.generateMeetLink=Ko;window.generateZoomLink=Oo;window.copyToClipboard=Fo;window.loadTheme=qn;window.applyAccent=Un;window.setTheme=Go;window.openThemePanel=qo;window.initAIChatForRole=Wn;window.toggleAIChat=Uo;window.aiQuickSend=Wo;window.buildAIContext=Et;window.addAIMessage=$e;window.sendAIMessage=Vn;window.autoDetectModel=Zn;window.callGeminiFallback=Le;window.generateAICopilotDraft=Vo;window.checkCopilotDraftEdited=Zo;window.sendCopilotDraft=Xo;window.renderParentHome=Xn;window.renderParentProgress=Jn;window.renderParentAI=Qn;window.applyResFilter=qt;window.updateCRFilter=Qo;window.buildCRContent=gt;window.renderCoachResources=Xe;window.switchCRTab=es;window.compileResourceStats=ea;window.openResourceModalCoach=ts;window.fetchYtPlaylistCoach=ns;window.saveResourceCoach=as;window.deleteResourceCoach=is;window.importResourcesFromExcel=os;window.importStudentsFromExcel=ss;window.getTestStatus=ta;window.openCoachTaskEdit=rs;window.saveWeekAsTemplate=ls;window.applyTemplateToWeek=ds;window.confirmApplyTemplate=cs;window.copyTaskToClipboard=ps;window.pasteTaskFromClipboard=ms;window.copyTaskToWholeWeek=us;window.pasteTaskToWholeWeek=gs;window.sendWhatsAppReport=Ho;window.toggleUserMenu=Ta;window.closeUserMenu=cn;window.renderAgenda=ue;window.openAgendaApptModal=Sn;window.deleteAgendaAppt=bi;window.agendaPrev=ui;window.agendaNext=gi;window.agendaToday=vi;window.agendaSetFilter=yi;window.exportAgendaICS=fi;window.openApptPopup=Tn;window.handleApptDrop=xi;window.openStudentKaynaklar=Aa;window.addStudentBook=Da;window.editStudentBook=La;window.sbUpdatePct=gn;window.saveStudentBook=Ca;window.deleteStudentBook=ja;window.loadTheme&&window.loadTheme();window.renderNetInputs&&window.renderNetInputs();window.checkOAuthSession&&window.checkOAuthSession();const bs=new URLSearchParams(window.location.search);if(bs.get("sandbox")==="true")window.simOAuthLogin&&setTimeout(()=>{console.log("Sandbox auto-login triggered for demokoc..."),window.simOAuthLogin("demokoc")},300);else if(window.location.search.includes("sandbox")||window.location.hash==="#sandbox"){const e=document.getElementById("demoQuickWrap");e&&(e.style.display="flex"),window.showGoogleSimulator&&setTimeout(()=>window.showGoogleSimulator(),300)}"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{console.log("Service Worker başarıyla kaydedildi ✓",e.scope)}).catch(e=>{console.warn("Service Worker kaydı başarısız oldu:",e)})});window.addEventListener("hashchange",()=>{let e=window.location.hash.substring(1);if(document.getElementById("appShell").classList.contains("visible")&&e!==window.currentTab){if(!e){e={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[window.session.role]||"portal",window.location.hash=e;return}document.getElementById("view-"+e)&&window.switchTab(e,!1)}});console.log("Rostrum Akademi App initialized successfully ✓");
