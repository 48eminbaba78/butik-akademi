(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const l={students:[],tasks:{},appointments:[],exams:[],messages:{},coachTodos:{},weekOffset:0,calMonth:new Date().getMonth(),calYear:new Date().getFullYear(),calSelDay:null,activeStuId:null,msgThread:null,workspace:null,studentSpeeds:[],konuHaftaSoru:[]},b={role:null,studentId:null,dbUser:null,coachId:null,childName:null};window.S=l;window.session=b;window._loginMode="email";window.STU_DEFAULT_PASS="Rostrum"+Math.floor(1e3+Math.random()*9e3);window.DAYS_TR=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"];window.MONTHS_TR=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];window.EXAM_DEFS={TYT:["Türkçe","Matematik","Fen","Sosyal"],"AYT-SAY":["Matematik","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Edebiyat","Tarih","Coğrafya"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.EXAM_SORU={TYT:{Türkçe:40,Matematik:40,Fen:20,Sosyal:20},"AYT-SAY":{Matematik:40,Fizik:14,Kimya:13,Biyoloji:13},"AYT-EA":{Matematik:40,Edebiyat:24,Tarih:10,Coğrafya:6},"AYT-SOZ":{Edebiyat:24,Tarih1:10,Tarih2:11,Coğrafya1:6,Coğrafya2:11,Felsefe:12,Din:6}};window.EXAM_KONU_MAP={TYT_Türkçe:["Dil Bilgisi"],TYT_Matematik:["TYT Matematik","Geometri"],TYT_Fen:["TYT Fizik","TYT Kimya","TYT Biyoloji"],TYT_Sosyal:[],"AYT-SAY_Matematik":["AYT Matematik","Geometri"],"AYT-SAY_Fizik":["AYT Fizik"],"AYT-SAY_Kimya":["AYT Kimya"],"AYT-SAY_Biyoloji":["AYT Biyoloji"],"AYT-EA_Matematik":["AYT Matematik","Geometri"],"AYT-EA_Edebiyat":["Dil Bilgisi"]};window.SUBJECT_MAP={TYT:["Türkçe","Matematik","Geometri","Fizik","Kimya","Biyoloji","Tarih","Coğrafya","Felsefe","Din"],"AYT-SAY":["Matematik","Geometri","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Geometri","Edebiyat","Tarih","Coğrafya","Felsefe"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.currentTab="";window._clipboardTask=null;window._editingTaskId=null;window._regRole=null;window._onbRole=null;window._oauthUser=null;const Ja="https://imyhenrwmsmyikpollur.supabase.co",Xa="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlteWhlbnJ3bXNteWlrcG9sbHVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxNDE3ODYsImV4cCI6MjA5NTcxNzc4Nn0._ySJ5ArD1GYthyitHjdyEjLaUhextIwEqpRoF5ScI34",y=supabase.createClient(Ja,Xa);window.db=y;function we(){var e;try{localStorage.setItem("ba_ui_"+(((e=b.dbUser)==null?void 0:e.id)||"x"),JSON.stringify({weekOffset:l.weekOffset,activeStuId:l.activeStuId,calMonth:l.calMonth,calYear:l.calYear}))}catch{}}function lt(){we()}function M(e,t){let n=document.getElementById("loadingOverlay");if(document.querySelectorAll(".btn-login, .btn-accent, .btn").forEach(i=>{e?(i.setAttribute("disabled","true"),i.style.opacity="0.6",i.style.pointerEvents="none"):(i.removeAttribute("disabled"),i.style.opacity="",i.style.pointerEvents="")}),e&&!n){n=document.createElement("div"),n.id="loadingOverlay",n.style.cssText="position:fixed;inset:0;background:rgba(15,14,12,.82);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:14px;backdrop-filter:blur(6px)";const i=t||"Yükleniyor...",o=t?'<div style="font-size:36px;animation:overlayPop .3s cubic-bezier(.34,1.56,.64,1) both">🗑️</div>':'<div style="width:38px;height:38px;border:3px solid rgba(255,255,255,.12);border-top-color:var(--accent);border-radius:50%;animation:spin .7s linear infinite"></div>';if(n.innerHTML=`${o}<div style="font-size:14px;font-weight:600;color:#fff;letter-spacing:.2px">${i}</div>`,!document.getElementById("spinStyle")){const s=document.createElement("style");s.id="spinStyle",s.textContent="@keyframes spin{to{transform:rotate(360deg)}}@keyframes overlayPop{from{transform:scale(.6);opacity:0}to{transform:scale(1);opacity:1}}",document.head.appendChild(s)}document.body.appendChild(n)}else!e&&n&&n.remove()}function v(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function O(e){return e instanceof Date?e.toISOString().split("T")[0]:e}function J(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function ue(){return O(new Date)}function qt(e){return e>=20?"good":e>=12?"mid":"low"}function dt(e){return{deneme:"📊 Deneme",soru:"📚 Soru",konu:"🎯 Konu",diger:"⭐ Diğer"}[e]||e}function G(e){document.getElementById(e).classList.add("open")}function q(e){document.getElementById(e).classList.remove("open")}function x(e){const t=document.getElementById("toast");t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),2300)}document.addEventListener("click",e=>{e.target.classList.contains("modal-bg")&&e.target.id!=="trialExpiredModal"&&e.target.classList.remove("open")});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".modal-bg.open").forEach(t=>{t.id!=="trialExpiredModal"&&t.classList.remove("open")})});function Qa(e){let t=e.value.replace(/\D/g,"");t.startsWith("0")&&(t=t.slice(1)),t=t.slice(0,10);let n="";t.length>0&&(n="0 ("+t.slice(0,3)),t.length>=3&&(n+=") "+t.slice(3,6)),t.length>=6&&(n+=" "+t.slice(6,8)),t.length>=8&&(n+=" "+t.slice(8,10)),e.value=n}function Wt(){const e=new Date;let t=e.getFullYear(),n=new Date(t,5,14);return e>n&&(t+=1,n=new Date(t,5,14)),{year:t,days:Math.max(1,Math.ceil((n-e)/864e5))}}function ne(e,t=0){const n=new Date,a=n.getDay(),o=(a===0?6:a-1)-t,s=new Date(n);return s.setDate(n.getDate()-(o+7)%7+e*7),s.setHours(0,0,0,0),s}function ei(){const e=l.students.find(t=>t.id===l.activeStuId);return(e==null?void 0:e.weekStart)??0}async function Ye(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return[...new Uint8Array(t)].map(n=>n.toString(16).padStart(2,"0")).join("")}function je(e){return e?e.trim().toLowerCase().replace(/ç/g,"c").replace(/ğ/g,"g").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ş/g,"s").replace(/ü/g,"u").replace(/i̇/g,"i").replace(/ı/g,"i").replace(/i/g,"i").replace(/\s+/g,"").replace(/\u0307/g,""):""}function ti(){if(!("Notification"in window)){console.log("Bu tarayıcı anlık bildirimleri desteklemiyor.");return}Notification.permission!=="granted"&&Notification.permission!=="denied"?Notification.requestPermission().then(e=>{e==="granted"&&x("Bildirim izinleri onaylandı ✓")}):Notification.permission==="granted"?x("Bildirim izinleri zaten açık ✓"):x("Bildirim izinleri tarayıcı ayarlarından engellenmiş.")}window.saveUI=we;window.saveS=lt;window.showLoading=M;window.esc=v;window.fmtDate=O;window.addDays=J;window.todayStr=ue;window.netColor=qt;window.typeLabel=dt;window.om=G;window.cm=q;window.showToast=x;window.getWeekStart=ne;window.getNextYks=Wt;window.maskPhoneTR=Qa;window.getStudentWeekStart=ei;window.sha256=Ye;window.normalizeUsername=je;window.requestNotificationPermission=ti;async function ni(e,t={}){let n=y.from(e).select("*");Object.entries(t).forEach(([o,s])=>{n=n.eq(o,s)});const{data:a,error:i}=await n;return i&&console.error(e,i),a||[]}const ai=4*60*1e3;function Vt(){return"ra_d_"+(b.coachId||b.studentId||"x")}function Ln(){try{localStorage.removeItem(Vt())}catch{}}function wn(){try{localStorage.setItem(Vt(),JSON.stringify({ts:Date.now(),students:l.students,tasks:l.tasks,appointments:l.appointments,exams:l.exams,messages:l.messages,coachTodos:l.coachTodos,studentSpeeds:l.studentSpeeds,workspace:l.workspace,konuHaftaSoru:l.konuHaftaSoru}))}catch{}}function ii(){try{const e=localStorage.getItem(Vt());if(!e)return!1;const t=JSON.parse(e);return!t.ts||Date.now()-t.ts>ai?!1:(t.students&&(l.students=t.students),t.tasks&&(l.tasks=t.tasks),t.appointments&&(l.appointments=t.appointments),t.exams&&(l.exams=t.exams),t.messages&&(l.messages=t.messages),t.coachTodos&&(l.coachTodos=t.coachTodos),t.studentSpeeds&&(l.studentSpeeds=t.studentSpeeds),t.workspace&&(l.workspace=t.workspace),t.konuHaftaSoru&&(l.konuHaftaSoru=t.konuHaftaSoru),!0)}catch{return!1}}async function $n(){var L;const e=b.coachId,t=b.role,n=t==="coach"||t==="developer"?y.from("workspaces").select("*").eq("coach_id",e).single():Promise.resolve({data:null});let a=y.from("users").select("*").eq("role","student");t==="student"?a=a.eq("id",b.studentId):(t==="coach"||t==="developer")&&(a=a.eq("coach_id",e));const i=a,o=new Date;o.setDate(o.getDate()-60);const s=o.toISOString().split("T")[0],r=new Date;r.setDate(r.getDate()-30);const d=r.toISOString().split("T")[0],c=t==="student"?y.from("tasks").select("*").eq("student_id",b.studentId).gte("date",s):t==="coach"||t==="developer"?y.from("tasks").select("*").eq("coach_id",e).gte("date",s):y.from("tasks").select("*").gte("date",s),p=t==="student"?y.from("appointments").select("*").eq("student_id",b.studentId).gte("date",d):t==="coach"||t==="developer"?y.from("appointments").select("*").eq("coach_id",e).gte("date",d):y.from("appointments").select("*").gte("date",d),m=t==="student"?y.from("exams").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?y.from("exams").select("*").eq("coach_id",e):y.from("exams").select("*"),u=t==="student"?y.from("messages").select("*").eq("student_id",b.studentId).order("created_at",{ascending:!1}).limit(200):t==="coach"||t==="developer"?y.from("messages").select("*").eq("coach_id",e).order("created_at",{ascending:!1}).limit(200):y.from("messages").select("*").order("created_at",{ascending:!1}).limit(200),g=t==="coach"||t==="developer"?y.from("coach_todos").select("*").eq("coach_id",e):Promise.resolve({data:[]}),_=t==="student"?y.from("student_speeds").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?y.from("student_speeds").select("*").eq("coach_id",e):y.from("student_speeds").select("*"),T=t==="coach"||t==="developer"?y.from("konu_mastery").select("*").eq("coach_id",e):t==="student"?y.from("konu_mastery").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),f=t==="coach"||t==="developer"?y.from("konu_tekrar_log").select("*").eq("coach_id",e):t==="student"?y.from("konu_tekrar_log").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),[$,k,z,h,S,I,B,E,A,C]=await Promise.all([n,i,c,p,m,u,g,_,T,f]);(t==="coach"||t==="developer")&&(l.workspace=$.data||null),l.students=(k.data||[]).map(w=>({id:w.id,name:w.full_name||w.username||"Öğrenci",target:w.target||"",color:w.color||"#4da6ff",progress:w.progress||0,weekStart:w.week_start||0,username:w.username,coachId:w.coach_id,yksArea:w.yks_area||"SAY"})),l.tasks={},(z.data||[]).forEach(w=>{const D=`${w.student_id}_${w.date}`;l.tasks[D]||(l.tasks[D]=[]),l.tasks[D].push({_id:w.id,type:w.type,exam:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,done:w.done,student_note:w.student_note||"",student_result:w.student_result||null,student_feedback:w.student_feedback||null,task_items:w.task_items,start_time:w.start_time})}),l.appointments=(h.data||[]).map(w=>({id:w.id,studentId:w.student_id,date:w.date,time:w.time,duration:w.duration,type:w.type,note:w.note,meetLink:w.meet_link,google_event_id:w.google_event_id||null})),l.exams=(S.data||[]).map(w=>({id:w.id,studentId:w.student_id,name:w.name,date:w.date,type:w.exam_type,nets:w.nets||{},examDetails:w.exam_details||{},note:w.student_note,coachComment:w.coach_comment})),l.messages={},(I.data||[]).forEach(w=>{l.messages[w.student_id]||(l.messages[w.student_id]=[]),l.messages[w.student_id].push({_id:w.id,from:w.from_role,text:w.text||"",image_url:w.image_url||null,read:w.read,time:new Date(w.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})})}),Object.keys(l.messages).forEach(w=>l.messages[w].sort((D,P)=>D._id>P._id?1:-1)),l.coachTodos={},(B.data||[]).forEach(w=>{l.coachTodos[w.date]||(l.coachTodos[w.date]=[]),l.coachTodos[w.date].push({_id:w.id,task:w.task,note:w.note,done:w.done})}),l.studentSpeeds=E.data||[],l.konuMastery={},(A.data||[]).forEach(w=>{l.konuMastery[w.student_id]||(l.konuMastery[w.student_id]={}),l.konuMastery[w.student_id][w.subject]||(l.konuMastery[w.student_id][w.subject]={}),l.konuMastery[w.student_id][w.subject][w.konu]=w}),l.konuTekrarLog={},(C.data||[]).forEach(w=>{l.konuTekrarLog[w.student_id]||(l.konuTekrarLog[w.student_id]={}),l.konuTekrarLog[w.student_id][w.subject]||(l.konuTekrarLog[w.student_id][w.subject]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu]||(l.konuTekrarLog[w.student_id][w.subject][w.konu]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu][w.period_start]=w});try{const w=JSON.parse(localStorage.getItem("ba_ui_"+((L=b.dbUser)==null?void 0:L.id))||"{}");w.weekOffset!==void 0&&(l.weekOffset=w.weekOffset),w.activeStuId&&(l.activeStuId=w.activeStuId),w.calMonth!==void 0&&(l.calMonth=w.calMonth,l.calYear=w.calYear)}catch{}}async function Pn(){if(ii()){$n().then(()=>{if(wn(),window.currentTab)try{window.switchTab(window.currentTab)}catch{}}).catch(t=>console.error("Arka plan yenileme hatası:",t));return}M(!0);try{await $n(),wn()}catch(t){console.error("loadAllData error",t)}M(!1)}window.dbQ=ni;window.loadAllData=Pn;window.invalidateCache=Ln;let ze=!1;window.location.hash.includes("type=recovery")&&(window.isPasswordRecoveryActive=!0);function oe(e){const t=document.getElementById("loginErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Me(e){const t=document.getElementById("regErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Zt(e){document.getElementById("loginPanel").style.display=e==="login"?"block":"none",document.getElementById("registerPanel").style.display=e==="register"?"block":"none",document.getElementById("lmtLogin").classList.toggle("active",e==="login"),document.getElementById("lmtRegister").classList.toggle("active",e==="register")}function oi(e){window._loginMode=e,document.querySelectorAll("#loginTabs .login-tab").forEach((t,n)=>t.classList.toggle("active",n===(e==="email"?0:1))),document.getElementById("loginEmailField").style.display=e==="email"?"block":"none",document.getElementById("loginUserField").style.display=e==="username"?"block":"none"}function jn(e){window._regRole=e,[["rrbCoach","coach"],["rrbStudent","student"]].forEach(([t,n])=>{const a=document.getElementById(t);if(!a)return;const i=e===n;a.classList.toggle("sel",i),a.style.borderColor=i?"var(--accent)":"var(--border)",a.style.background=i?"var(--accent-dim)":"var(--surface2)",a.style.boxShadow=i?"0 0 0 1px var(--accent)":"none"})}function si(e){window._onbRole=e,document.getElementById("onbRoleCoach").classList.toggle("sel",e==="coach"),document.getElementById("onbRoleStudent").classList.toggle("sel",e==="student")}async function ri(){if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.protocol==="file:"){Nn();return}await Rn()}async function Rn(){Jt(),M(!0);try{const{error:e}=await y.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin+"/app.html",queryParams:{access_type:"offline",prompt:"select_account"}}});e&&(M(!0),console.warn("Google Auth failed:",e),oe("Google Girişi Başlatılamadı: "+e.message))}catch(e){M(!1),oe("Google Girişi Başlatılamadı: "+e.message)}}function Nn(){document.getElementById("googleSimulatorModal").style.display="flex"}function Jt(){document.getElementById("googleSimulatorModal").style.display="none"}async function li(e){if(Jt(),M(!0),e==="demokoc"){const{data:t,error:n}=await y.from("users").select("*").eq("username","demokoc").maybeSingle();if(n||!t){M(!1),oe("Demo koç profili bulunamadı!");return}await Re(t)}else if(e==="demoogrenci"){const{data:t,error:n}=await y.from("users").select("*").eq("username","demoogrenci").maybeSingle();if(n||!t){M(!1),oe("Demo öğrenci profili bulunamadı!");return}await Re(t)}else if(e==="new"){M(!1),document.getElementById("newUserOnboarding").style.display="flex";const t=Math.floor(1e3+Math.random()*9e3),n=`yeni.kullanici${t}@gmail.com`;document.getElementById("onbEmail").textContent=n,document.getElementById("onbName").value=`Yeni Kullanıcı ${t}`,window._oauthUser={id:`mock-google-id-${t}`,email:n,user_metadata:{full_name:`Yeni Kullanıcı ${t}`}}}}async function Hn(){var t,n,a;if(window.location.hash.includes("type=recovery")||window.isPasswordRecoveryActive){console.log("[Auth] Recovery session active, skipping checkOAuthSession");return}if(ze)return;ze=!0;let e=null;try{console.log("[Auth] 1/4 getSession...");const{data:{session:i}}=await y.auth.getSession();if(console.log("[Auth] 2/4 session:",((t=i==null?void 0:i.user)==null?void 0:t.email)||"yok"),!(i!=null&&i.user)){ze=!1;return}if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible")){ze=!1;return}M(!0),e=setTimeout(()=>{console.warn("[Auth] timeout — Supabase yanıt vermedi, spinner kapatılıyor"),ze=!1,M(!1)},1e4),console.log("[Auth] 3/4 profil yükleniyor...");const{data:o,error:s}=await y.from("users").select("*").eq("id",i.user.id).maybeSingle();console.log("[Auth] 4/4 profil:",o==null?void 0:o.role,(s==null?void 0:s.message)||""),clearTimeout(e);let r=!1;if(o){if(o.role==="coach"){const{data:d}=await y.from("workspaces").select("*").eq("coach_id",o.id).maybeSingle();(!d||!d.onboarding_done)&&(r=!0)}}else r=!0;if(o&&!r){if(o.active===!1){M(!1),y.auth.signOut(),alert("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");return}await Re(o)}else M(!1),document.getElementById("newUserOnboarding").style.display="flex",document.getElementById("onbEmail").textContent=i.user.email,document.getElementById("onbName").value=((a=i.user.user_metadata)==null?void 0:a.full_name)||"",window._oauthUser=i.user}catch(i){clearTimeout(e),ze=!1,M(!1),console.warn("[checkOAuthSession]",i)}}async function di(){const e=document.getElementById("onbName").value.trim();if(!e){document.getElementById("onbErr").textContent="Ad soyad zorunlu",document.getElementById("onbErr").style.display="block";return}if(!window._onbRole){document.getElementById("onbErr").textContent="Hesap türü seçin",document.getElementById("onbErr").style.display="block";return}document.getElementById("onbErr").style.display="none",M(!0);const t=window._oauthUser,n=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""),a={id:t.id,full_name:e,email:t.email,role:window._onbRole,username:n+"_"+Math.random().toString(36).slice(2,6),password_hash:"supabase_managed",color:window._onbRole==="coach"?"#f0a500":"#4da6ff",week_start:0,progress:0,target:""},{data:i,error:o}=await y.from("users").upsert(a).select().single();if(o){M(!1),document.getElementById("onbErr").textContent="Hata: "+o.message,document.getElementById("onbErr").style.display="block";return}document.getElementById("newUserOnboarding").style.display="none",await Re(i)}let ee=0;function ci(e,t){document.getElementById("regBrandColor").value=e,t.parentElement.querySelectorAll("div").forEach(n=>n.style.outline="none"),t.style.outline="3px solid white"}function pi(){const e=document.getElementById("regErr0");if(e&&(e.style.display="none"),ee===0){if(!window._regRole){e&&(e.textContent="Lütfen bir hesap türü seçin.",e.style.display="block");return}window._regRole==="student"?ee=3:ee=1}else if(ee===1){if(!document.getElementById("regBrandName").value.trim()){alert("Lütfen akademi / koçluk adını girin.");return}ee=2}else ee===2&&(ee=3);_t(ee)}function mi(){ee===3?window._regRole==="student"?ee=0:ee=2:ee===2?ee=1:ee===1&&(ee=0),_t(ee)}function _t(e){document.getElementById("regWizardStep0").style.display=e===0?"block":"none",document.getElementById("regWizardStepCoach1").style.display=e===1?"block":"none",document.getElementById("regWizardStepCoach2").style.display=e===2?"block":"none",document.getElementById("regWizardStepFinal").style.display=e===3?"block":"none";const t=document.getElementById("regInviteWrap");t&&(t.style.display=e===3&&window._regRole==="student"?"block":"none")}function ui(e){if(e=(e||"").toUpperCase().replace(/[^0-9A-Z]/g,"").slice(0,6),e.length!==6)return;Zt("register"),jn("student"),ee=3,_t(3);const t=document.getElementById("regInviteCode");t&&(t.value=e,t.readOnly=!0,t.style.opacity=".75",Yn(),t.readOnly=!0)}let En=null,Yt=!1;function Yn(){const e=document.getElementById("regInviteCode"),t=document.getElementById("regInviteStatus"),n=(e.value||"").toUpperCase().replace(/[^0-9A-Z]/g,"");if(e.value=n,Yt=!1,clearTimeout(En),n.length<6){t.style.display="none";return}t.style.display="block",t.style.background="var(--surface2)",t.style.color="var(--text-mid)",t.textContent="Kod kontrol ediliyor…",En=setTimeout(async()=>{try{const{data:a,error:i}=await y.rpc("check_invite_code",{p_code:n}),o=!i&&a&&a.length?a[0].brand_name:null;o?(Yt=!0,t.style.background="rgba(5,150,105,.1)",t.style.color="var(--green)",t.textContent="✓ "+o+" akademisine katılacaksın"):(t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="✗ Kod bulunamadı — koçundan doğru kodu iste")}catch{t.style.display="none"}},450)}async function gi(){var i;const e=document.getElementById("regName").value.trim(),t=document.getElementById("regEmail").value.trim().toLowerCase(),n=document.getElementById("regPass").value;if(!e||!t||!n)return Me("Tüm hesap bilgileri zorunludur");if(n.length<8)return Me("Şifre en az 8 karakter olmalıdır");let a="";if(window._regRole==="student"){if(a=(((i=document.getElementById("regInviteCode"))==null?void 0:i.value)||"").toUpperCase().trim(),a.length!==6)return Me("Koç davet kodu gerekli — 6 haneli kodu koçundan iste.");if(!Yt)try{const{data:o}=await y.rpc("check_invite_code",{p_code:a});if(!o||!o.length)return Me("Davet kodu geçersiz — koçundan doğru kodu iste.")}catch{return Me("Kod doğrulanamadı, tekrar dene.")}}M(!0);try{let o={full_name:e,role:window._regRole};if(a&&(o.invite_code=a),window._regRole==="coach"){const d=document.getElementById("regBrandName").value.trim(),c=document.getElementById("regBrandColor").value||"#f0a500",p=document.getElementById("regPhone").value.trim(),m=[...document.querySelectorAll("#regExamTypesWrap .ob-exam-sel input")].map(_=>_.value),u=m.length>0?m.join(","):"YKS",g=document.getElementById("regStudentCountRange").value||"1-5";o.ob_brand=d,o.ob_color=c,o.ob_phone=p,o.ob_examtypes=u,o.ob_studentcount=g}const{data:s,error:r}=await y.auth.signUp({email:t,password:n,options:{data:o}});if(r)throw r;if(s!=null&&s.user){M(!1),document.getElementById("regName").value="",document.getElementById("regEmail").value="",document.getElementById("regPass").value="",document.getElementById("regBrandName")&&(document.getElementById("regBrandName").value=""),document.getElementById("regPhone")&&(document.getElementById("regPhone").value="");const d=document.getElementById("regSuccess");d.textContent="Kayıt başarılı! E-posta adresinize bir doğrulama bağlantısı gönderildi. Lütfen doğrulama yaptıktan sonra giriş yapın.",d.style.display="block",setTimeout(()=>d.style.display="none",1e4),ee=0,_t(0),Zt("login")}}catch(o){M(!1),Me("Kayıt Hatası: "+o.message)}}async function vi(){const e=(document.getElementById("loginEmail").value||document.getElementById("loginUser").value||"").trim(),t=document.getElementById("loginPass").value;if(!e||!t)return oe("Kullanıcı adı ve şifre zorunlu");M(!0);const n=setTimeout(()=>{M(!1),oe("Bağlantı zaman aşımına uğradı. Supabase yanıt vermiyor — lütfen tekrar deneyin.")},15e3);try{let a=e;a.includes("@")?a=a.toLowerCase():a=je(e)+"@rostrumakademi.com";const{data:i,error:o}=await y.auth.signInWithPassword({email:a,password:t});if(!o&&(i!=null&&i.user)){const{data:s,error:r}=await y.from("users").select("*").eq("id",i.user.id).maybeSingle();if(r&&console.error("Profile fetch error:",r),s){if(s.active===!1)return M(!1),y.auth.signOut(),oe("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");clearTimeout(n),await Re(s);return}return M(!1),oe("Hesabınız veritabanında aktif değil.")}try{const s=je(e.includes("@")?e.split("@")[0]:e),r=await Ye(t),{data:d}=await y.rpc("get_user_by_credentials",{p_username:s,p_password_hash:r}),c=Array.isArray(d)?d[0]:d;if(c){if(c.active===!1)return M(!1),oe("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");clearTimeout(n),await Re(c);return}}catch(s){console.warn("Fallback RPC error:",s)}return M(!1),oe(o?"Giriş başarısız: "+o.message:"Kullanıcı adı veya şifre hatalı.")}catch(a){return M(!1),console.error("[doLogin]",a),oe("Giriş hatası: "+a.message)}finally{clearTimeout(n)}}async function Re(e){var n,a,i,o,s;M(!1);const t=e.role==="coach"||e.role==="developer"?e.id:e.role==="student"||e.role==="parent"?e.coach_id:null;b.role=e.role,b.studentId=e.role==="student"?e.id:null,b.dbUser=e,b.coachId=t,document.getElementById("loginScreen").style.display="none",document.getElementById("appShell").classList.add("visible");try{if(await Pn(),(b.role==="coach"||b.role==="developer")&&!l.workspace){console.log("[Auth] Workspace not found, auto-creating from signup metadata...");const{data:{user:m}}=await y.auth.getUser();if(m){const u=((n=m.user_metadata)==null?void 0:n.ob_brand)||"Akademi",g=((a=m.user_metadata)==null?void 0:a.ob_color)||"#f0a500",_=((i=m.user_metadata)==null?void 0:i.ob_phone)||null,T=((o=m.user_metadata)==null?void 0:o.ob_examtypes)||"YKS",f=((s=m.user_metadata)==null?void 0:s.ob_studentcount)||"1-5",$={coach_id:e.id,brand_name:u,brand_color:g,phone:_,exam_types:T,student_count_range:f,onboarding_done:!1},{data:k,error:z}=await y.from("workspaces").upsert($,{onConflict:"coach_id"}).select().maybeSingle();z?console.error("[finishLogin] Create workspace error:",z):k&&(l.workspace=k)}}if(b.role==="student"&&(l.activeStuId=e.id,b.studentId=e.id,l.students.find(m=>m.id===e.id)||l.students.push({id:e.id,name:e.full_name||e.username||"Öğrenci",target:e.target||"",color:e.color||"#4da6ff",progress:e.progress||0,weekStart:e.week_start||0,username:e.username,coachId:e.coach_id})),b.role==="parent"){const{data:m}=await y.from("users").select("*").eq("parent_id",e.id).single();m&&(l.activeStuId=m.id,b.studentId=m.id,b.childName=m.full_name||m.username)}window.setupShell();const r=new URLSearchParams(window.location.search);if(r.get("state")==="google_calendar"&&r.get("code")&&(b.role==="coach"||b.role==="developer")){const m=r.get("code");window.history.replaceState({},"",window.location.pathname+window.location.hash),document.getElementById("aiChatBubble").style.display="flex",setTimeout(()=>window.switchTab("appointments"),50),y.auth.getSession().then(({data:{session:u}})=>{u!=null&&u.access_token&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${u.access_token}`},body:JSON.stringify({type:"google_oauth_exchange",code:m})}).then(g=>g.json()).then(g=>{g.success?(l.workspace&&(l.workspace.google_calendar_connected=!0),x("Google Takvim bağlandı ✓"),window.renderAppointments&&window.renderAppointments()):x("Google bağlanamadı: "+(g.error||"Bilinmeyen hata"))}).catch(()=>x("Google Takvim bağlanamadı"))});return}if(document.getElementById("aiChatBubble").style.display="flex",(b.role==="coach"||b.role==="developer")&&(!l.workspace||!l.workspace.onboarding_done)){window.switchTab("home"),window.showOnboarding();return}if(b.role==="student"){const{data:m}=await y.from("student_profiles").select("onboarding_done").eq("id",b.studentId||e.id).maybeSingle();if(!m||!m.onboarding_done){const u=window.location.hash.substring(1),g=u&&document.getElementById("view-"+u)?u:"portal";setTimeout(()=>{window.switchTab(g),window.showStudentWelcome&&window.showStudentWelcome()},100);return}}const d=window.location.hash.substring(1),c={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[b.role]||"portal",p=d&&document.getElementById("view-"+d)?d:c;setTimeout(()=>window.switchTab(p),50)}catch(r){M(!1),console.error("[doLogin] HATA:",r),oe("Hata: "+r.message),document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible")}}function fi(){window._fcInstance&&(window._fcInstance.destroy(),window._fcInstance=null),window.destroyRealtime&&window.destroyRealtime(),y.auth.signOut().catch(()=>{}),Ln(),b.role=null,b.studentId=null,b.dbUser=null,b.coachId=null,b.childName=null,l.workspace=null,document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible"),document.getElementById("aiChatBubble").style.display="none",document.getElementById("aiChatPanel").classList.remove("open"),document.getElementById("loginEmail")&&(document.getElementById("loginEmail").value=""),document.getElementById("loginUser")&&(document.getElementById("loginUser").value=""),document.getElementById("loginPass").value="",window.location.hash=""}function yi(){var t,n;const e=(((t=document.getElementById("loginEmail"))==null?void 0:t.value)||((n=document.getElementById("loginUser"))==null?void 0:n.value)||"").trim();e&&document.getElementById("forgotEmail")&&(document.getElementById("forgotEmail").value=e),window.om("forgotPassModal")}async function xi(){const e=document.getElementById("forgotEmail").value.trim();if(!e)return;const t=document.getElementById("forgotMsg"),n=document.getElementById("btnSendReset");n&&(n.disabled=!0,n.textContent="Gönderiliyor..."),t.style.display="none";try{const a=await fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"password_reset",email:e})}),i=await a.json();if(!a.ok)throw new Error(i.error||"Sunucu hatası");t.style.display="block",t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="Sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin."}catch(a){t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Hata: "+(a.message||"Bir sorun oluştu.")}finally{n&&(n.disabled=!1,n.textContent="Sıfırlama Linki Gönder →")}}async function bi(){const e=document.getElementById("newPasswordInput").value;if(!e||e.length<8){alert("Şifre en az 8 karakter olmalıdır.");return}M(!0);try{const{error:t}=await y.auth.updateUser({password:e});if(t)throw t;const n=await Ye(e),{data:{user:a}}=await y.auth.getUser();a&&await y.from("users").update({password_hash:n}).eq("id",a.id),alert("Şifreniz başarıyla güncellendi! Lütfen yeni şifrenizle giriş yapın."),window.cm("resetPasswordModal"),await y.auth.signOut(),window.location.hash="",window.location.reload()}catch(t){alert("Şifre güncellenirken hata oluştu: "+t.message)}finally{M(!1)}}window.loginErr=oe;window.regErr=Me;window.setAuthMode=Zt;window.setLoginMode=oi;window.setRegRole=jn;window.setOnbRole=si;window.loginWithGoogle=ri;window.triggerRealGoogleLogin=Rn;window.showGoogleSimulator=Nn;window.closeGoogleSimulator=Jt;window.simOAuthLogin=li;window.checkOAuthSession=Hn;window.completeOnboarding=di;window.doRegister=gi;window.doLogin=vi;window.finishLogin=Re;window.doLogout=fi;window.showForgotPassword=yi;window.sendResetEmail=xi;window.updateUserPassword=bi;window.nextRegWizardStep=pi;window.prevRegWizardStep=mi;window.setRegBrandColor=ci;window.onInviteCodeInput=Yn;window.applyInviteFromUrl=ui;y.auth.onAuthStateChange(async(e,t)=>{var a;if(e==="PASSWORD_RECOVERY"||window.location.hash.includes("type=recovery")||window.isPasswordRecoveryActive){window.isPasswordRecoveryActive=!0,console.log("[Auth] Password recovery flow active, showing resetPasswordModal"),M(!1),window.om("resetPasswordModal");return}if(e==="SIGNED_IN"&&(t!=null&&t.user)){if((a=document.getElementById("appShell"))!=null&&a.classList.contains("visible"))return;await Hn()}e==="SIGNED_OUT"&&(ze=!1,M(!1))});function _n(){const e=document.getElementById("loginEmail"),t=document.getElementById("loginUser");e&&t&&(e.addEventListener("input",n=>{t.value=n.target.value}),t.addEventListener("input",n=>{e.value=n.target.value}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_n):_n();if(new URLSearchParams(window.location.search).get("new_coach")==="1"){const e=sessionStorage.getItem("ra_new_coach_email"),t=sessionStorage.getItem("ra_new_coach_pass");if(e&&t){sessionStorage.removeItem("ra_new_coach_email"),sessionStorage.removeItem("ra_new_coach_pass");const n=()=>{const a=document.getElementById("loginEmail"),i=document.getElementById("loginPass");a&&i&&(a.value=e,i.value=t,setTimeout(()=>window.doLogin&&window.doLogin(),400))};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}function at(e){if(!e||e<=0)return"0 sa";const t=Math.floor(e/60),n=e%60;return t>0&&n>0?`${t} sa ${n} dk`:t>0?`${t} sa`:`${n} dk`}window.formatMinToHours=at;function ie(e){return new Promise(t=>{let n=document.getElementById("customConfirmModal");n||(n=document.createElement("div"),n.id="customConfirmModal",n.className="modal-bg",n.style.zIndex="999999",n.innerHTML=`
      ...
      `,document.body.appendChild(n),n.addEventListener("click",r=>{r.target===n&&(n.classList.remove("open"),t(!1))})),n.querySelector("#confirmMessage").textContent=e;const a=n.querySelector("#confirmOkBtn"),i=n.querySelector("#confirmCancelBtn"),o=a.cloneNode(!0),s=i.cloneNode(!0);a.parentNode.replaceChild(o,a),i.parentNode.replaceChild(s,i),n.classList.add("open"),o.focus(),o.onclick=()=>{n.classList.remove("open"),t(!0)},s.onclick=()=>{n.classList.remove("open"),t(!1)}})}window.customConfirm=ie;async function Xt(){const e=b.dbUser;if(e&&!(e.email==="ceylanemin1928@gmail.com"||e.email==="simkoc1@rostrumakademi.com"||window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.__testMode)){if(b.role==="coach"||b.role==="developer"){if((e.plan||"trial")==="trial"){const n=e.trial_ends_at?new Date(e.trial_ends_at):new Date(new Date(e.created_at).getTime()+12096e5),a=new Date;if(a>n)bt();else{const i=Math.ceil((n-a)/864e5);i<=7&&Kn(i)}}}else if((b.role==="student"||b.role==="parent")&&b.coachId)try{const{data:t}=await y.from("users").select("plan,trial_ends_at,created_at,email").eq("id",b.coachId).maybeSingle();if(t){if(t.email==="ceylanemin1928@gmail.com"||t.email==="simkoc1@rostrumakademi.com")return;if((t.plan||"trial")==="trial"){const a=t.trial_ends_at?new Date(t.trial_ends_at):new Date(new Date(t.created_at).getTime()+12096e5);new Date>a&&bt()}}}catch(t){console.error("Error checking coach subscription:",t)}}}function bt(){let e=document.getElementById("trialExpiredModal");e?e.classList.add("open"):(e=document.createElement("div"),e.id="trialExpiredModal",e.className="modal-bg open",e.style.zIndex="9999999",e.innerHTML=`
    ...
    <button onclick="document.getElementById('trialCountdownBanner').remove()" style="background:none;border:none;cursor:pointer;color:rgba(0,0,0,.4);font-size:18px;padding:0 4px;line-height:1">×</button>`,document.body.prepend(t);const n=document.getElementById("appShell");n&&(n.style.marginTop=t.offsetHeight+"px")}window.openSupportChatDirect=Dt;window.checkCoachSubscription=Xt;window.showTrialExpiredScreen=bt;window.showTrialCountdownBanner=Kn;const Kt=[{id:"home",lbl:"🏠",name:"Ana Sayfa"},{id:"students",lbl:"👤",name:"Öğrencilerim"},{id:"todolist",lbl:"📅",name:"Takvim"},{id:"coach-resources",lbl:"📚",name:"Kaynaklarım"},{id:"coach-applications",lbl:"📩",name:"Başvurular"}],On=[{id:"portal",lbl:"🏠",name:"Ana Sayfa"},{id:"sportal",lbl:"📋",name:"Programım"},{id:"sexams",lbl:"📊",name:"Denemeler"},{id:"smessages",lbl:"💬",name:"Koçuma Yaz"},{id:"sprofil",lbl:"🌟",name:"Yolculuğum"}],Fn=[{id:"dev-dashboard",lbl:"🖥️",name:"Dev Panel"},{id:"dev-tickets",lbl:"🎫",name:"Destek"}],Un=[{id:"parent-home",lbl:"🏠",name:"Ana Sayfa"},{id:"parent-progress",lbl:"📊",name:"İlerleme"},{id:"parent-messages",lbl:"💬",name:"Koça Yaz"},{id:"parent-ai",lbl:"🤖",name:"AI Asistan"}];function hi(){var e;(e=document.getElementById("mainSidebar"))==null||e.classList.toggle("open")}function ki(){var e;(e=document.getElementById("tnUserMenu"))==null||e.classList.toggle("open")}function Gn(){var e;(e=document.getElementById("tnUserMenu"))==null||e.classList.remove("open")}document.addEventListener("click",e=>{const t=document.getElementById("tnUserWrap");t&&!t.contains(e.target)&&Gn()});function wi(){var p;Xt();const e=b.role==="coach"?Kt:b.role==="developer"?[...Kt,...Fn]:b.role==="parent"?Un:On;document.getElementById("sidebarNav").innerHTML=e.map(m=>`
    ...
    <button class="mnav-btn" id="mntab_${m.id}" onclick="switchTab('${m.id}')">${m.lbl}<span style="font-size:9px;display:block">${m.name}</span></button>`).join(""),document.getElementById("mainContent").innerHTML=[...e,{id:"student-detail"},{id:"profile"},{id:"settings"},{id:"coach-resources"},{id:"coach-applications"},{id:"coach-notes"},{id:"coach-profile"},{id:"messages"},{id:"todolist"},{id:"suyelik"},{id:"program"},{id:"appointments"},{id:"exams"}].map(m=>`<div class="view" id="view-${m.id}"></div>`).join("");const t=b.dbUser,n=b.role==="student"?l.students.find(m=>m.id===b.studentId):null,a=(t==null?void 0:t.full_name)||(n==null?void 0:n.name)||"",i=a.split(" ").map(m=>m[0]).join("").slice(0,2).toUpperCase(),o={coach:"#E8613A",student:(n==null?void 0:n.color)||"#4da6ff",developer:"#c084fc",parent:"#3ecf8e"},s={coach:"KOÇ",student:"ÖĞRENCİ",developer:"DEV",parent:"VELİ"};if(document.getElementById("sbAv").textContent=i,document.getElementById("sbAv").style.background=o[b.role]||"#888",document.getElementById("sbName").textContent=a,document.getElementById("sbRole").textContent=s[b.role]||b.role,(b.role==="coach"||b.role==="developer")&&((p=l.workspace)!=null&&p.brand_name)){const m=document.querySelector(".sb-logo-text");m&&(m.textContent=l.workspace.brand_name);const u=document.querySelector(".tn-logo .sb-logo-icon");u&&u.tagName!=="IMG"&&(u.textContent=l.workspace.brand_name.slice(0,1).toUpperCase())}const r=document.getElementById("sb-site-admin");r&&(r.style.display=b.role==="developer"?"flex":"none");const d=document.getElementById("tnCoachProfileItem");d&&(d.style.display=b.role==="coach"||b.role==="developer"?"flex":"none");const c=document.getElementById("tnUyelikItem");c&&(c.style.display=b.role==="coach"||b.role==="developer"?"flex":"none"),setTimeout(Ct,200),Ra(),setTimeout($a,600),(b.role==="coach"||b.role==="developer")&&y.from("match_requests").select("id",{count:"exact",head:!0}).eq("matched_coach_id",b.coachId).eq("status","pending").then(({count:m})=>{if(m>0){const u=document.getElementById("sbi_coach-applications");if(u&&!u.querySelector(".sb-badge")){const g=document.createElement("span");g.className="sb-badge",g.textContent=m,u.appendChild(g)}}})}function se(e,t=!0){var p,m,u;if(!e)return;currentTab=e,t&&(window.location.hash=e),document.querySelectorAll(".tn-nav-item").forEach(g=>g.classList.remove("active"));const n=document.getElementById("sbi_"+e)||document.getElementById("sb-"+e);n&&n.classList.add("active"),document.querySelectorAll(".mnav-btn").forEach(g=>g.classList.remove("active"));const a=document.getElementById("mntab_"+e);a&&a.classList.add("active"),document.querySelectorAll(".view").forEach(g=>g.classList.remove("active"));const i=document.getElementById("view-"+e);i&&i.classList.add("active");const s=[...Kt,...On,...Fn,...Un,{id:"profile",name:"Profil"},{id:"settings",name:"Ayarlar"},{id:"student-detail",name:((p=l.students.find(g=>g.id===l.activeStuId))==null?void 0:p.name)||"Öğrenci"},{id:"program",name:"Program"},{id:"appointments",name:"Randevular"},{id:"exams",name:"Denemeler"}].find(g=>g.id===e),r=document.getElementById("tbarTitle");r&&(r.textContent=(s==null?void 0:s.name)||e);const d={home:qn,students:ct,messages:xa,"coach-applications":bn,"coach-notes":qa,todolist:da,portal:Mt,sportal:Be,sexams:on,smessages:Ft,suyelik:Ys,sprofil:Ia,profile:Jn,settings:Xn,"student-detail":()=>{l.activeStuId?Wn(l.activeStuId):se("students")},program:()=>{l.activeStuId?Qt(l.activeStuId):se("students")},exams:()=>{l.activeStuId?Je():se("students")},appointments:()=>{l.activeStuId?Ze():se("students")},"dev-dashboard":ka,"dev-users":Xe,"dev-resources":pt,"dev-finance":mt,"dev-announce":ut,"dev-tickets":Qe,"parent-home":Ya,"parent-progress":Ka,"parent-messages":Ft,"parent-ai":Oa,"coach-profile":Ba,"dev-matches":mn,"coach-resources":gt};try{(m=d[e])==null||m.call(d)}catch(g){console.error("[switchTab] Render error for tab:",e,g),i&&(i.innerHTML=`<div style="padding:24px;color:var(--text)"><b>Hata Oluştu ⚠️</b><p style="color:var(--text-mid);margin-top:6px">${v(g.message)}</p><pre style="font-size:10px;color:var(--text-dim);white-space:pre-wrap;margin-top:8px">${v((g.stack||"").slice(0,400))}</pre></div>`)}e==="messages"||e==="smessages"?rn():ln();const c=document.getElementById("aiChatBubble");c&&(e==="dev-tickets"||e.startsWith("dev-")||e==="messages"||e==="smessages"?(c.style.display="none",(u=document.getElementById("aiChatPanel"))==null||u.classList.remove("open")):(b.role==="student"||b.role==="coach"||b.role==="parent")&&(c.style.display="flex"))}function qn(){var t,n;const e=document.getElementById("view-home");if(e)try{const a=new Date,i=["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],o=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],s=O(a);let r=0;Object.values(l.messages).forEach(I=>{r+=I.filter(B=>B.from==="student"&&!B.read).length});const d=l.appointments.filter(I=>I.date===s).sort((I,B)=>I.time.localeCompare(B.time)),c=[],p=ne(0,0);(l.students||[]).forEach(I=>{let B=0,E=0;for(let D=0;D<7;D++){const P=O(J(p,D)),j=l.tasks[`${I.id}_${P}`]||[];B+=j.length,E+=j.filter(Y=>Y.done).length}const A=B>0?Math.round(E/B*100):0;B>0&&A<30&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"tasks",icon:"📋",title:"Düşük Görev",desc:`Bu haftaki görev tamamlama oranı <b>%${A}</b>'de kaldı (${E}/${B} görev tamamlandı).`});const C=(l.exams||[]).filter(D=>D.studentId===I.id).sort((D,P)=>new Date(P.date).getTime()-new Date(D.date).getTime()),L={};if(C.forEach(D=>{L[D.type]||(L[D.type]=[]),L[D.type].push(D)}),Object.entries(L).forEach(([D,P])=>{if(P.length>=2){const j=P[0],Y=P[1],H=Object.values(j.nets||{}).reduce((Z,te)=>Z+Number(te||0),0),F=Object.values(Y.nets||{}).reduce((Z,te)=>Z+Number(te||0),0),V=H-F;V<-5&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"exams",icon:"📉",title:`Net Düşüşü (${D})`,desc:`Son denemede <b>${H} net</b> yaptı. Önceki denemesine (${F} net) göre <b>${Math.abs(V).toFixed(1)} net düşüş</b>.`})}}),B===0&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"noplan",icon:"📭",title:"Program Yok",desc:"Bu hafta için henüz hiç görev eklenmemiş."}),B>0&&E===0){let D=!1;for(let P=0;P<3;P++){const j=O(J(a,-P));if((l.tasks[`${I.id}_${j}`]||[]).length>0){D=!0;break}}D&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"inactive",icon:"💤",title:"3 Gündür Pasif",desc:"Son 3 gündür hiçbir görev tamamlanmadı. İletişime geç!"})}B>0&&E===B&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"perfect",icon:"🏆",title:"Harika Hafta!",desc:`Bu haftaki tüm ${B} görevi tamamladı! Tebrik et.`}),(l.studentSpeeds||[]).filter(D=>D.student_id===I.id).forEach(D=>{let P=120;D.exam_type==="TYT"?["Türkçe","Sosyal"].includes(D.subject)?P=100:["Matematik","Fen"].includes(D.subject)&&(P=130):D.exam_type&&D.exam_type.startsWith("AYT")&&(P=180),D.secs_per_question>P&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"speed",icon:"⚡",title:`Hız Aşımı (${D.exam_type} - ${D.subject})`,desc:`Soru çözüm hızı <b>${D.secs_per_question} sn/soru</b> (Limit: ${P} sn).`})})});let m="";if(c.length===0)l.students.length===0?m=`
        ...
        ${L}
      </div>`}).join("")}const u=a.getHours(),g=u<6?"İyi geceler":u<12?"Günaydın":u<18?"İyi günler":"İyi akşamlar",_=`${String(u).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`,T=d.find(I=>I.time>=_),f=Wt(),$=f.days,k=ne(0,0);let z=0,h=0;l.students.forEach(I=>{for(let B=0;B<7;B++){const E=l.tasks[`${I.id}_${O(J(k,B))}`]||[];z+=E.length,h+=E.filter(A=>A.done).length}});const S=z>0?Math.round(h/z*100):0;e.innerHTML=`
    <!-- HERO -->
    <div class="home-hero">
    ...
    <div class="home-stats-v2">
      ...
      <div class="hsv2-card" title="Haftalık görev durumu">
        ...
        <div class="hsv2-val" style="color:${S>=70?"var(--green)":S>=40?"var(--accent)":"var(--red)"}">${h}<span style="font-size:18px;font-weight:500;color:var(--text-dim)">/${z}</span></div>
    ...
    <div class="home-bottom-grid">
      ...
      <div class="home-section-card">
        ...
        <div class="hsc-body">
          ...
          ${d.map(I=>{const B=l.students.find(F=>F.id===I.studentId),E=I.time<_,[A,C]=I.time.split(":").map(Number),L=A*60+C,[w,D]=_.split(":").map(Number),P=w*60+D,j=L-P,Y=j>=-(I.duration||60)&&j<=15,H=Y&&I.meet_link?`<a href="${v(I.meet_link)}" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;background:${j<=0?"var(--red)":"var(--accent)"};color:#fff;font-size:11px;font-weight:800;text-decoration:none;animation:${j<=0?"pulse 1.5s infinite":"none"};white-space:nowrap;flex-shrink:0">${j<=0?"🔴 Ders Sürüyor":"🟡 Derse Gir"}</a>`:"";return`<div class="hsc-appt-row ${E&&!Y?"hsc-appt-past":""}">
              <div class="hsc-appt-time">${I.time}</div>
              <div class="hsc-appt-bar" style="background:${(B==null?void 0:B.color)||"var(--accent)"}"></div>
              <div style="flex:1;min-width:0">
                <div class="hsc-appt-name">${v((B==null?void 0:B.name)||"?")}</div>
    ...
    <div style="display:flex;gap:8px;max-width:900px;margin:0 auto 4px;justify-content:center">
      ${[{tab:"messages",icon:"💬",label:"Mesajlar",sub:r>0?r+" okunmamış":"Temiz"},{tab:"coach-notes",icon:"📝",label:"Notlarım",sub:"Kişisel notlar"},{tab:"todolist",icon:"📅",label:"Ajanda",sub:"Tüm randevular"},{tab:"coach-applications",icon:"📩",label:"Başvurular",sub:"Eşleşme talepleri"}].map(({tab:I,icon:B,label:E,sub:A})=>`
    ...
    </div>`}catch(a){console.error("[renderHome] HATA:",a),e.innerHTML=`<div style='padding:24px;color:var(--text)'><b>İyi günler 👋</b><p style='color:var(--text-mid);margin-top:6px'>Hata: ${v(a.message)}</p></div>`}}function ct(){const e=document.getElementById("view-students"),t=ne(0,0),n={};l.students.forEach(s=>{let r=0,d=0,c=0,p=0;for(let m=0;m<7;m++)(l.tasks[`${s.id}_${O(J(t,m))}`]||[]).forEach(g=>{r++,c+=Number(g.duration||0),g.done&&(d++,p+=Number(g.duration||0))});n[s.id]={total:r,done:d,totalMin:c,doneMin:p}});const a=l.students.length,i=l.students.filter(s=>{const r=n[s.id];return r&&r.total>0}).length,o=l.students.filter(s=>{const r=n[s.id];return r&&r.total>0&&r.done===r.total}).length;e.innerHTML=`<div style="max-width:640px;margin:0 auto">
    <!-- Üst başlık -->
  ...
  </div>`}function $i(){const e=document.getElementById("stuSearchInput").value.trim().toLowerCase(),t=document.getElementById("stuSearchNoResults");let n=0;l.students.forEach(a=>{const i=document.getElementById("sturow_"+a.id);if(i){const o=a.name.toLowerCase().includes(e);i.style.display=o?"flex":"none",o&&n++}}),t&&(t.style.display=e&&n===0?"block":"none")}function Wn(e){if(!l.students.find(p=>p.id===e))return;l.activeStuId=e;const t=l.students.find(p=>p.id===l.activeStuId),n=ne(0,t.weekStart||0);let a=0,i=0,o=0;for(let p=0;p<7;p++){const m=l.tasks[`${t.id}_${O(J(n,p))}`]||[];a+=m.length,i+=m.filter(u=>u.done).length,o+=m.reduce((u,g)=>u+Number(g.duration||0),0)}const s=a>0?Math.round(i/a*100):0,r=s>=80?"var(--green)":s>=50?"var(--accent)":"var(--red)",d=document.getElementById("view-student-detail");d.innerHTML=`
    ...
    <div class="card" style="margin-top:16px; border: 1px dashed var(--accent); padding: 18px; border-radius: 14px; background: var(--surface)">
      ...
      <div id="aiCopilotResultArea" style="display:none; margin-top:12px">
    ...
    </div>`,currentTab!=="student-detail"&&se("student-detail");const c=document.getElementById("tbarTitle");c&&(c.textContent=t.name)}const Oe=[{stars:0,label:"Başlanmadı",color:"#6b7280",bg:"rgba(107,114,128,.08)",border:"rgba(107,114,128,.2)"},{stars:1,label:"Anlamadım",color:"#ef4444",bg:"rgba(239,68,68,.08)",border:"rgba(239,68,68,.2)"},{stars:2,label:"Temel Zorluk",color:"#f97316",bg:"rgba(249,115,22,.08)",border:"rgba(249,115,22,.2)"},{stars:3,label:"Temel OK",color:"#eab308",bg:"rgba(234,179,8,.08)",border:"rgba(234,179,8,.2)"},{stars:4,label:"Orta Seviye",color:"#84cc16",bg:"rgba(132,204,22,.08)",border:"rgba(132,204,22,.2)"},{stars:5,label:"İleri Seviye",color:"#22c55e",bg:"rgba(34,197,94,.08)",border:"rgba(34,197,94,.2)"},{stars:6,label:"Uzman",color:"#10b981",bg:"rgba(16,185,129,.08)",border:"rgba(16,185,129,.2)"},{stars:7,label:"Tekrar Dışı (TD)",color:"#3b82f6",bg:"rgba(59,130,246,.1)",border:"rgba(59,130,246,.3)"}];function Vn(e){const t=new Date(e),n=t.getDate(),a=n<=10?1:n<=20?11:21;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function Ei(e=6){const t=[],n=new Date;let a=new Date(n);for(let i=0;i<e;i++){const o=Vn(a);t.find(c=>c.start===o)||t.unshift({start:o,label:_i(o)});const[s,r,d]=o.split("-").map(Number);if(d===21?a=new Date(s,r-1,11):d===11?a=new Date(s,r-1,1):a=new Date(s,r-2,21),t.length>=e)break}return t.slice(-e)}function _i(e){const[t,n,a]=e.split("-").map(Number),i=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],o=a===1?10:a===11?20:new Date(t,n,0).getDate();return`${a}-${o} ${i[n-1]}`}const Tn={SAY:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","TYT Fizik","AYT Fizik","TYT Kimya","AYT Kimya","TYT Biyoloji","AYT Biyoloji"],EA:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],SOZ:["Dil Bilgisi","TYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],DIL:["Dil Bilgisi","TYT Matematik","Geometri","YDT İngilizce"]};async function Ti(e){const t=l.students.find(f=>f.id===e);if(!t)return;const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button><div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`;const a=b.role==="coach"||b.role==="developer",i=t.yksArea||"SAY",o=Tn[i]||Tn.SAY;let s=o[0],r="mastery";function d(f,$){var k,z;return((z=(k=l.konuMastery[e])==null?void 0:k[f])==null?void 0:z[$])||null}function c(f,$){var k,z;return((z=(k=l.konuTekrarLog[e])==null?void 0:k[f])==null?void 0:z[$])||{}}async function p(f,$,k,z){const h=d(f,$),S=new Date().toISOString(),I=z||(k>=7?"td":k>0?"active":"not_started"),B={student_id:e,coach_id:b.coachId,subject:f,konu:$,stars:k,status:I,updated_at:S,...I==="active"&&!(h!=null&&h.ka_date)?{ka_date:S}:{},...I==="td"&&!(h!=null&&h.td_date)?{td_date:S}:{},...I==="active"&&(h==null?void 0:h.status)==="td"?{td_date:null}:{}},{data:E,error:A}=await y.from("konu_mastery").upsert(B,{onConflict:"student_id,subject,konu"}).select().single();if(A){x("Hata: "+A.message);return}return l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][$]=E,E}async function m(f,$,k,z){const h=new Date().toISOString(),S={student_id:e,coach_id:b.coachId,subject:f,konu:$,period_start:k,review_count:z,updated_at:h},{data:I,error:B}=await y.from("konu_tekrar_log").upsert(S,{onConflict:"student_id,subject,konu,period_start"}).select().single();if(B){x("Hata: "+B.message);return}return l.konuTekrarLog[e]||(l.konuTekrarLog[e]={}),l.konuTekrarLog[e][f]||(l.konuTekrarLog[e][f]={}),l.konuTekrarLog[e][f][$]||(l.konuTekrarLog[e][f][$]={}),l.konuTekrarLog[e][f][$][k]=I,I}function u(f){const $=it[f]||[],k=$.map((E,A)=>{const C=d(f,E),L=(C==null?void 0:C.stars)||0,w=(C==null?void 0:C.status)||"not_started",D=Oe[L],P=w==="td",j=A%2===0?"var(--surface)":"var(--surface2)",Y=c(f,E),H=Object.values(Y).reduce((Q,R)=>Q+(R.review_count||0),0),F=C!=null&&C.last_review_date?new Date(C.last_review_date).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"}):"—",V=a?Array.from({length:7},(Q,R)=>{const N=R+1,K=N<=L,re=f.replace(/'/g,"\\'"),xe=E.replace(/'/g,"\\'");return`<span class="km-star${K?" km-star-on":""}" data-stars="${N}" 
        ...
        >${K?"⭐":"☆"}</span>`}).join(""):Array.from({length:7},(Q,R)=>`<span style="font-size:14px;opacity:${R<L?1:.25}">${R<L?"⭐":"☆"}</span>`).join("");let Z="";return P?Z='<span style="font-size:9px;font-weight:800;color:#3b82f6;background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.3);border-radius:4px;padding:1px 5px;margin-left:4px">TD</span>':C!=null&&C.ka_date&&(Z='<span style="font-size:9px;font-weight:700;color:#10b981;background:rgba(16,185,129,.1);border:1px solid rgba(16,185,129,.2);border-radius:4px;padding:1px 5px;margin-left:4px">KA✓</span>'),`<tr id="${"km_"+btoa(encodeURIComponent(f+"|"+E)).replace(/[^a-zA-Z0-9]/g,"")}" style="background:${D.bg};border-bottom:1px solid ${D.border};transition:background .3s">
        <td style="padding:10px 14px;font-size:12px;font-weight:600;color:var(--text);min-width:200px;position:sticky;left:0;z-index:1;background:${j};border-right:1px solid var(--border)">
          ${v(E)}${Z}
        </td>
        ...
        ${a?`<td style="padding:8px 8px;text-align:center;white-space:nowrap">
          ...
          <button onclick="window._kmToggleTD('${f.replace(/'/g,"\\'")}','${E.replace(/'/g,"\\'")}')" 
            style="font-size:10px;padding:3px 7px;border-radius:5px;border:1px solid ${P?"#3b82f6":"var(--border)"};background:${P?"rgba(59,130,246,.15)":"var(--surface2)"};color:${P?"#3b82f6":"var(--text-mid)"};cursor:pointer;font-weight:${P?"800":"400"}" 
            title="Tekrar Dışı">TD</button>
        </td>`:""}
      </tr>`}).join(""),z=$.map(E=>d(f,E)),h=Array(8).fill(0);z.forEach(E=>h[(E==null?void 0:E.stars)||0]++);const S=z.filter(E=>(E==null?void 0:E.status)==="td").length,I=z.filter(E=>(E==null?void 0:E.status)==="active").length;return`<div style="display:flex;gap:12px;flex-wrap:wrap;padding:12px 16px;background:var(--surface2);border-bottom:1px solid var(--border);align-items:center">
    ...
    </div>`}function g(f){const $=it[f]||[],k=Ei(6),z=Vn(new Date),h=`<tr style="background:var(--surface2)">
      <th style="padding:8px 14px;text-align:left;font-size:10px;font-weight:800;color:var(--text-dim);border-right:1px solid var(--border);position:sticky;left:0;z-index:2;background:var(--surface2);white-space:nowrap;min-width:200px">KONU</th>
      ...
      ${k.map(I=>`<th style="padding:8px 10px;text-align:center;font-size:10px;font-weight:800;color:${I.start===z?"var(--accent)":"var(--text-dim)"};background:${I.start===z?"var(--accent-dim)":"var(--surface2)"};white-space:nowrap;min-width:100px;border-left:1px solid var(--border)">${I.label}</th>`).join("")}
      <th style="padding:8px 10px;text-align:center;font-size:10px;font-weight:800;color:var(--text-dim);white-space:nowrap;border-left:2px solid var(--border)">TOPLAM</th>
        ...
        ${Y}
        <td style="padding:8px 10px;text-align:center;font-size:12px;font-weight:800;color:${j>0?w.color:"var(--text-dim)"};border-left:2px solid var(--border)">${j||0}</td>
      </tr>`}).join("");return`<div style="overflow-x:auto"><table style="border-collapse:collapse;width:max-content;min-width:100%"><thead>${h}</thead><tbody>${S}</tbody></table></div>`}window._kmSetStars=async function(f,$,k){const z=d(f,$),h=(z==null?void 0:z.status)==="td"&&k<7?"active":null;await p(f,$,k,h);const S="km_"+btoa(encodeURIComponent(f+"|"+$)).replace(/[^a-zA-Z0-9]/g,"");if(document.getElementById(S)){const B=u(f);document.getElementById("khTable").innerHTML=B}x(`${$}: ${Oe[k].label} ✓`)},window._kmToggleKA=async function(f,$){const k=d(f,$),z=new Date().toISOString(),h=!!(k!=null&&k.ka_date),S={student_id:e,coach_id:b.coachId,subject:f,konu:$,stars:(k==null?void 0:k.stars)||1,status:(k==null?void 0:k.status)||"active",ka_date:h?null:z,updated_at:z},{data:I,error:B}=await y.from("konu_mastery").upsert(S,{onConflict:"student_id,subject,konu"}).select().single();if(B){x("Hata: "+B.message);return}l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][$]=I,document.getElementById("khTable").innerHTML=u(f),x(h?"KA tarihi kaldırıldı":"KA ✓ tamamlandı olarak işaretlendi")},window._kmToggleTD=async function(f,$){const k=d(f,$),z=(k==null?void 0:k.status)==="td",h=z?(k==null?void 0:k.stars)>=7?5:k==null?void 0:k.stars:7;await p(f,$,h,z?"active":"td"),document.getElementById("khTable").innerHTML=r==="mastery"?u(f):g(f),x(z?`${$} tekrar listesine geri döndü`:`${$} → TD ✓`)},window._ktToggleBox=async function(f,$,k,z){const S=c(f,$)[k],B=((S==null?void 0:S.review_count)||0)>=z?z-1:z;if(await m(f,$,k,B),B>0){const E=d(f,$),A=new Date().toISOString(),C={student_id:e,coach_id:b.coachId,subject:f,konu:$,stars:(E==null?void 0:E.stars)||0,status:(E==null?void 0:E.status)||"active",last_review_date:A,review_count:((E==null?void 0:E.review_count)||0)+1,updated_at:A},{data:L}=await y.from("konu_mastery").upsert(C,{onConflict:"student_id,subject,konu"}).select().single();L&&(l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][$]=L)}document.getElementById("khTable").innerHTML=g(f)};function _(){const f=window._khActiveSub||s;document.getElementById("khTable").innerHTML=r==="mastery"?u(f):g(f)}const T=o.map(f=>`<button class="kh-tab" onclick="window._khActiveSub='${f}';document.querySelectorAll('.kh-tab').forEach(b=>{b.style.color='var(--text-mid)';b.style.borderBottom='2px solid transparent';b.style.fontWeight='600'});this.style.color='var(--accent)';this.style.borderBottom='2px solid var(--accent)';this.style.fontWeight='700';window._khRefresh()"
    ...
    </div>`,window._kmSwitchView=function(f){r=f;const $=document.getElementById("kmViewMastery"),k=document.getElementById("kmViewTekrar");f==="mastery"?($.style.background="var(--accent)",$.style.color="#fff",$.style.fontWeight="700",k.style.background="var(--surface)",k.style.color="var(--text-mid)",k.style.fontWeight="600"):(k.style.background="var(--accent)",k.style.color="#fff",k.style.fontWeight="700",$.style.background="var(--surface)",$.style.color="var(--text-mid)",$.style.fontWeight="600"),window._khRefresh()}}function Qt(e){var i,o;l.activeStuId=e;const t=document.getElementById("view-program"),n=((i=l.students.find(s=>s.id===l.activeStuId))==null?void 0:i.name)||"";t.innerHTML=`<button class="back-link" onclick="switchTab('student-detail')">← ${n}</button>`,t.innerHTML+=document.createElement("div").innerHTML,currentTab!=="program"&&se("program");const a=document.getElementById("tbarTitle");a&&(a.textContent=(((o=l.students.find(s=>s.id===l.activeStuId))==null?void 0:o.name)||"")+" · Program"),X()}function Si(e){var n;l.activeStuId=e,currentTab!=="exams"&&se("exams");const t=document.getElementById("tbarTitle");t&&(t.textContent=(((n=l.students.find(a=>a.id===l.activeStuId))==null?void 0:n.name)||"")+" · Denemeler"),Je()}function Ii(e){var n;l.activeStuId=e,currentTab!=="appointments"&&se("appointments");const t=document.getElementById("tbarTitle");t&&(t.textContent=(((n=l.students.find(a=>a.id===l.activeStuId))==null?void 0:n.name)||"")+" · Randevular"),Ze()}let ye={};async function Bi(e){const t=l.students.find(a=>a.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&se("student-detail");const n=document.getElementById("view-student-detail");if(n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button>
    <div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`,!ye[e]){const{data:a}=await y.from("student_books").select("*").eq("student_id",e).order("created_at",{ascending:!0});ye[e]=a||[]}en(e)}function en(e){const t=l.students.find(p=>p.id===e),n=ye[e]||[],a=document.getElementById("view-student-detail"),i=b.role==="coach"||b.role==="developer",o=n.reduce((p,m)=>p+m.total_tests,0),s=n.reduce((p,m)=>p+m.completed_tests,0),r=o>0?Math.round(s/o*100):0,d=r>=75?"var(--green)":r>=40?"var(--accent)":"var(--red)",c=n.length?n.map(p=>{const m=p.total_tests>0?Math.min(100,Math.round(p.completed_tests/p.total_tests*100)):0,u=m>=75?"var(--green)":m>=40?"var(--accent)":"var(--red)";return`<div style="background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px 16px;margin-bottom:10px">
    ...
    ${c}`}function zi(e){document.getElementById("sbModalTitle").textContent="Kaynak Ekle",document.getElementById("sbId").value="",document.getElementById("sbStuId").value=e,document.getElementById("sbName").value="",document.getElementById("sbTotal").value="0",document.getElementById("sbCompleted").value="0",document.getElementById("sbPctPreview").innerHTML="",G("sbModal")}function Mi(e,t){const n=(ye[e]||[]).find(a=>a.id===t);n&&(document.getElementById("sbModalTitle").textContent="Kaynağı Düzenle",document.getElementById("sbId").value=t,document.getElementById("sbStuId").value=e,document.getElementById("sbName").value=n.name,document.getElementById("sbTotal").value=n.total_tests,document.getElementById("sbCompleted").value=n.completed_tests,Zn(),G("sbModal"))}function Zn(){var o,s;const e=parseInt((o=document.getElementById("sbTotal"))==null?void 0:o.value)||0,t=parseInt((s=document.getElementById("sbCompleted"))==null?void 0:s.value)||0,n=document.getElementById("sbPctPreview");if(!n||!e){n&&(n.innerHTML="");return}const a=Math.min(100,Math.round(t/e*100)),i=a>=75?"var(--green)":a>=40?"var(--accent)":"var(--red)";n.innerHTML=`<div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;height:8px;background:var(--surface3);border-radius:99px;overflow:hidden">
    ...
    </div>`}async function Ci(){var i,o;const e=document.getElementById("pf_name").value.trim(),t=document.getElementById("pf_pass").value,n=(o=(i=document.getElementById("pf_brand"))==null?void 0:i.value)==null?void 0:o.trim();if(!e)return x("Ad boş olamaz!");const a={full_name:e};t&&(a.password_hash=await Ye(t)),await y.from("users").update(a).eq("id",b.dbUser.id),n&&(b.role==="coach"||b.role==="developer")&&(await y.from("workspaces").update({brand_name:n}).eq("coach_id",b.coachId),l.workspace={...l.workspace||{},brand_name:n},document.querySelector(".sb-logo-text").textContent=n),b.dbUser={...b.dbUser,full_name:e},document.getElementById("sbName").textContent=e,x("Profil kaydedildi ✓")}function Xn(){var n;const e=document.getElementById("view-settings"),t=document.documentElement.getAttribute("data-theme")==="dark";e.innerHTML=`
    <div style="max-width:500px;margin:0 auto">
      <div class="settings-block">
        ...
        <div class="setting-item">
          ...
          <div class="accent-palette">
            ${La.map(a=>`<div class="ac-dot" onclick="applyAccent('${a.val}','${a.dim}')" style="background:${a.val}" title="${a.name}"></div>`).join("")}
          </div>
        </div>
      </div>
      ...
      <div class="settings-block" style="margin-top:20px">
    ...
    </div>`}function Li(){const e=document.getElementById("geminiApiKeyInput").value.trim();e?(localStorage.setItem("gemini_api_key",e),x("API Anahtarı kaydedildi ✓")):(localStorage.removeItem("gemini_api_key"),x("API Anahtarı kaldırıldı."))}let Ae="";function X(){const e=document.getElementById("view-program"),t=l.students.find(d=>d.id===l.activeStuId),n=(t==null?void 0:t.weekStart)??0,a=ne(l.weekOffset,n),i=J(a,6),o=ue(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let d=0;d<7;d++){const c=J(a,d),p=O(c),m=p===o,u=`${l.activeStuId}_${p}`,g=l.tasks[u]||[],_=g.reduce((h,S)=>h+Number(S.duration),0),T=g.reduce((h,S)=>h+(S.done?Number(S.duration):0),0),f=DAYS_TR[(n+d)%7],$=[...g];s==="hourly"&&$.sort((h,S)=>h.start_time&&!S.start_time?-1:!h.start_time&&S.start_time?1:h.start_time&&S.start_time?h.start_time.localeCompare(S.start_time):0);const k=$.map(h=>{const S=g.indexOf(h),I=h.start_time?`<div class="tc-time-badge">🕒 ${h.start_time}</div>`:"";return`
        <div data-task-id="${h._id}" class="task-card task-${h.type} ${h.done?"done":""} ${h.start_time?"hourly-card":""}" onclick="openTaskDetail('${p}',${S},'coach')" style="cursor:pointer">
          ...
          <div class="tc-body">
            ${I}
            <div class="tc-type">${dt(h.type)}${h.exam?" · "+h.exam:""}</div>
        ...
        </div>`}).join(""),z=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(n+d)%7];r+=`<div class="day-col ${m?"today":""}">
      <div class="day-hd">
        <div>
          <div class="day-name-lbl">${z}</div>
          <div class="day-num">${c.getDate()}</div>
        </div>
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px">
          <span class="day-badge" style="font-size:8.5px">${at(T)} / ${at(_)}</span>
    ...
    <div class="week-grid">${r}</div>`}function Pi(e){l.activeStuId=e||null,lt(),X()}function ji(e){l.weekOffset+=e,lt(),X()}function Ri(){l.weekOffset=0,lt(),X()}function Ni(e){localStorage.setItem("ra_program_mode",e),b.role==="student"?Be():X()}window.setProgramMode=Ni;(()=>{const e=document.createElement("style");e.textContent=`
    .tc-time-badge {
      font-size: 11px;
      font-weight: 800;
      color: var(--accent);
  ...
  `,document.head.appendChild(e)})();let de=[];function Hi(){if(!l.activeStuId)return x("Önce öğrenci seçin");const e=l.students.find(i=>i.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=ne(l.weekOffset,t);de=[];let a="";for(let i=0;i<7;i++){const o=J(n,i),s=O(o);DAYS_TR[(t+i)%7];const r=(l.tasks[`${l.activeStuId}_${s}`]||[]).length>0,d=["Pzt","Sal","Çar","Per","Cum","Cmt","Paz"][(t+i)%7];a+=`<button class="day-sel-btn" id="dsbtn_${i}" data-ds="${s}" onclick="toggleDaySel(${i},'${s}')">
    ...
    <div onclick="selectBook(${p})" style="padding:10px 14px;cursor:pointer;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;transition:background .15s"
    ...
    </div>`).join("")}function Zi(){const e=document.getElementById("tmBookSearch").value;if(e.length===0){document.getElementById("tmBookList").style.display="none";return}St(e)}function Ji(e){W=et[e],document.getElementById("tmBookVal").value=W.name,document.getElementById("tmBookSearch").value=W.name,document.getElementById("tmBookList").style.display="none",It(),document.getElementById("tmTestWrap").style.display=""}function It(){if(!W)return;const e=document.getElementById("tmTestList"),t=W.resource_type==="playlist",n=W.name||"";e.innerHTML=W.testler.map((a,i)=>{const o=a.label||a,s=o.trim()===""||o.trim()===n.trim()?`Ders ${i+1}`:o,r=a.soru||0,d=a.url||"";a.topic;const c=Ga(o),p=c==="done"?"ti-status-done":c==="pending"?"ti-status-pending":"",m=c==="done"?'<span class="ti-badge ti-badge-done">✓ Tamamlandı</span>':c==="pending"?'<span class="ti-badge ti-badge-pending">⏳ Atandı</span>':"";return t?`<label class="${p}" style="display:flex;align-items:center;gap:8px;padding:8px 10px;cursor:pointer;transition:background .1s;border-bottom:1px solid var(--border)"
        onmouseover="this.style.background='var(--surface3)'" onmouseout="this.style.background=''">
      ...
      </label>`}).join(""),Ve()}function Xi(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!0),Ve()}function Qi(){document.querySelectorAll("#tmTestList input[type=checkbox]").forEach(e=>e.checked=!1),Ve()}function Ve(){if(!W)return;const e=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")],t=document.getElementById("tmTestSummary"),n=document.getElementById("tmTestSummaryText"),a=document.getElementById("tmSuggestedDuration"),i=document.getElementById("tmSpeedRow"),o=W.resource_type==="playlist";if(e.length===0){t.style.display="none";return}let s=0,r=0;e.forEach(m=>{const u=parseInt(m.value),g=W.testler[u];o?r+=(g==null?void 0:g.soru)||0:s+=(g==null?void 0:g.soru)||0});const d=document.querySelector("[data-mspeed].speed-active"),c=d?parseFloat(d.dataset.mspeed):1;let p=0;if(o)p=r>0?Math.ceil(r/c):0,n.textContent=`${e.length} video · ${r} dk`,i&&(i.style.display="");else{const m=document.getElementById("tmExam").value,u=document.getElementById("tmSubjectSel").value||"",g=`${l.activeStuId}_${m}_${u}`,_=ht[g]||180;p=s>0?Math.ceil(s*_/60):0,n.textContent=`${e.length} test · ${s} soru${p>0?" · Önerilen: "+p+" dk":""}`,i&&(i.style.display="none")}a.style.display=p>0?"":"none",vt=p,a.setAttribute("data-dur",p),t.style.display="",p>0&&(document.getElementById("tmDuration").value=p)}function eo(e){document.querySelectorAll("[data-mspeed]").forEach(t=>{const n=t.dataset.mspeed===e;t.classList.toggle("speed-active",n),t.style.borderColor=n?"var(--accent)":"var(--border)",t.style.background=n?"var(--accent-dim)":"var(--surface2)",t.style.color=n?"var(--accent)":"var(--text-mid)"}),Ve()}let vt=0;function to(){vt>0&&(document.getElementById("tmDuration").value=vt,x("Süre uygulandı: "+vt+" dk"))}let ht={};async function ia(){if(!l.activeStuId)return;const{data:e}=await y.from("student_speeds").select("*").eq("student_id",l.activeStuId);ht={},(e||[]).forEach(t=>{const n=`${t.student_id}_${t.exam_type}_${t.subject}`;ht[n]=t.secs_per_question})}async function oa(e,t,n,a){const{data:i}=await y.from("student_speeds").select("id").eq("student_id",e).eq("exam_type",t).eq("subject",n).single();i?await y.from("student_speeds").update({secs_per_question:a,updated_at:new Date().toISOString()}).eq("id",i.id):await y.from("student_speeds").insert({student_id:e,coach_id:b.coachId,exam_type:t,subject:n,secs_per_question:a}),ht[`${e}_${t}_${n}`]=a,x("Hız kaydedildi ✓")}let Sn=null,nt=null;function Bt(){clearTimeout(Sn),Sn=setTimeout(no,400)}async function no(){var i,o,s,r,d;const e=document.getElementById("tmSmartBadge");if(!e)return;const t=parseInt((i=document.getElementById("tmQCount"))==null?void 0:i.value)||0,n=(((o=document.getElementById("tmSubjectSel"))==null?void 0:o.style.display)!=="none"?(s=document.getElementById("tmSubjectSel"))==null?void 0:s.value:(r=document.getElementById("tmSubjectFree"))==null?void 0:r.value)||"",a=((d=document.getElementById("tmExam"))==null?void 0:d.value)||"TYT";if(!t||!n||!l.activeStuId){e.style.display="none",nt=null;return}try{const{data:c,error:p}=await y.rpc("calculate_smart_duration",{p_student_id:l.activeStuId,p_exam_type:a,p_subject:n,p_question_count:t,p_video_minutes:0,p_speed_multiplier:1});if(p||!c){e.style.display="none";return}nt=c.estimated_minutes;const m=c.speed_source==="student";e.style.display="block",e.style.background=m?"var(--green-dim)":"var(--blue-dim)",e.style.borderColor=m?"rgba(5,150,105,.3)":"rgba(37,99,235,.3)",e.style.color=m?"var(--green)":"var(--blue)",e.innerHTML=`⚡ Akıllı Süre: <b>${c.estimated_minutes} dk</b> — ${m?`öğrencinin gerçek hızına göre (${c.secs_per_question} sn/soru)`:`sistem varsayılanına göre (${c.secs_per_question} sn/soru)`} · <u>süreye uygula</u>`}catch{e.style.display="none"}}function ao(){nt&&(document.getElementById("tmDuration").value=nt,x("⚡ Akıllı süre uygulandı: "+nt+" dk"))}document.getElementById("tmType").addEventListener("change",Tt);var Dn;(Dn=document.getElementById("tmExam"))==null||Dn.addEventListener("change",Bt);var An;(An=document.getElementById("tmSubjectSel"))==null||An.addEventListener("change",Bt);var Cn;(Cn=document.getElementById("tmSubjectFree"))==null||Cn.addEventListener("input",Bt);let Lt=!1;async function io(){var n;if(Lt)return;Lt=!0;const e=document.querySelector('#taskModal button[onclick*="saveTask"]'),t=e?e.textContent:"Programa Ekle";e&&(e.disabled=!0,e.textContent="Kaydediliyor...");try{const a=document.getElementById("tmType").value,i=document.getElementById("tmSubjectSel"),o=document.getElementById("tmSubjectFree"),s=document.getElementById("tmExam").value,r=parseInt(document.getElementById("tmDuration").value)||60,d=document.getElementById("tmStartTime").value||null,c=document.getElementById("tmNote").value.trim();if((n=document.getElementById("tmNewResourceToggle"))==null?void 0:n.checked){const k=document.getElementById("tmManualKaynak").value.trim();if(!k)return x("Kaynak adı girin!");const z=i.style.display!=="none"?i.value:o.value.trim(),h=z?`${z} - ${k}`:k,S=fe.map(C=>({label:C,url:"",soru:0}));let I=c;fe.length>0&&(I=`${fe.length} test: ${fe.slice(0,3).join(", ")}${fe.length>3?` +${fe.length-3} daha`:""}`);const B={student_id:l.activeStuId,coach_id:b.coachId,date:Ae,type:a,exam_type:s,subject:h,duration:r,note:I,done:!1,task_items:S.length>0?S:null,start_time:d};M(!0);const{error:E}=await y.from("tasks").insert(B);if(M(!1),E)return x("Hata: "+E.message);const A=`${l.activeStuId}_${Ae}`;l.tasks[A]||(l.tasks[A]=[]),l.tasks[A].push({type:a,exam:s,subject:h,duration:r,note:I,done:!1,task_items:B.task_items,start_time:d}),q("taskModal"),X(),x("Görev eklendi ✓");return}const m=document.getElementById("tmBookVal").value,u=(W==null?void 0:W.resource_type)==="playlist";let g="";if((a==="soru"||a==="konu")&&m){const k=i.style.display!=="none"?i.value:"";g=k?`${k} - ${m}`:`${m}`}else g=(i.style.display!=="none"?i.value:o.value).trim();if(!g)return x("Ders adı girin!");const _=[...document.querySelectorAll("#tmTestList input[type=checkbox]:checked")];let T=c,f=[];if(_.length>0&&W){const k=_.map(z=>{const h=W.testler[parseInt(z.value)];return(h==null?void 0:h.label)||h||""});if(f=_.map(z=>{const h=W.testler[parseInt(z.value)];return{label:(h==null?void 0:h.label)||h||"",url:(h==null?void 0:h.url)||"",soru:(h==null?void 0:h.soru)||0}}),u){const z=h=>h.length>14?h.slice(0,13)+"…":h;T=`${k.length} video: ${k.slice(0,5).map(z).join(", ")}${k.length>5?` +${k.length-5}`:""}`}else{const z=h=>h.length>14?h.slice(0,13)+"…":h;T=`${k.length} test: ${k.slice(0,5).map(z).join(", ")}${k.length>5?` +${k.length-5}`:""}`}}const $={student_id:l.activeStuId,coach_id:b.coachId,date:Ae,type:a,exam_type:s,subject:g,duration:r,note:T,done:!1,task_items:f.length>0?f:null,start_time:d};if(_editingTaskId){M(!0);const{error:k}=await y.from("tasks").update({type:$.type,exam_type:$.exam_type,subject:$.subject,duration:$.duration,note:$.note,task_items:$.task_items,start_time:$.start_time}).eq("id",_editingTaskId);if(M(!1),k)return x("Hata: "+k.message);const z=`${l.activeStuId}_${Ae}`;if(l.tasks[z]){const h=l.tasks[z].findIndex(S=>S._id===_editingTaskId);h!==-1&&(l.tasks[z][h]={_id:_editingTaskId,type:$.type,exam:$.exam_type,subject:$.subject,duration:$.duration,note:$.note,done:l.tasks[z][h].done,student_note:l.tasks[z][h].student_note||"",task_items:$.task_items,start_time:$.start_time})}q("taskModal"),X(),x("Görev güncellendi ✓"),_editingTaskId=null}else{const{data:k,error:z}=await y.from("tasks").insert($).select().single();if(z)return x("Hata: "+z.message);const h=`${l.activeStuId}_${Ae}`;l.tasks[h]||(l.tasks[h]=[]),l.tasks[h].push({_id:k.id,type:k.type,exam:k.exam_type,subject:k.subject,duration:k.duration,note:k.note,done:!1,student_note:"",task_items:k.task_items||null,start_time:k.start_time}),q("taskModal"),X(),x("Görev eklendi ✓")}}finally{Lt=!1,e&&(e.disabled=!1,e.textContent=t)}}async function oo(e,t){var o;const n=`${l.activeStuId}_${e}`,a=(o=l.tasks[n])==null?void 0:o[t];if(!a)return;const i=!a.done;await y.from("tasks").update({done:i}).eq("id",a._id),a.done=i,X()}let ft=null;function tn(){ft&&(ft.remove(),ft=null)}document.addEventListener("click",tn);function so(e,t,n){tn();const a=n.getBoundingClientRect(),i=document.createElement("div");i.className="tc-dropdown",i.innerHTML=`
...
`)],{type:"text/calendar;charset=utf-8"}),a=URL.createObjectURL(n),i=document.createElement("a");i.href=a,i.download="rostrum-ajanda.ics",i.click(),URL.revokeObjectURL(a),x("Ajanda indirildi ✓")}function la(e,t){t.stopPropagation();const n=document.getElementById("apptDetailPopup");if(n){const g=n.dataset.id;if(n.remove(),g===e)return}const a=l.appointments.find(g=>g.id===e);if(!a)return;const i=l.students.find(g=>g.id===a.studentId),o=ra(a.type),s=document.createElement("div");s.id="apptDetailPopup",s.dataset.id=e;const r=window.innerWidth,d=window.innerHeight,c=264;let p=Math.min(t.clientX+12,r-c-12),m=Math.min(t.clientY+12,d-220);s.style.cssText=`position:fixed;left:${p}px;top:${m}px;z-index:600;width:${c}px;background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:14px 16px;box-shadow:0 8px 32px rgba(0,0,0,.18);animation:viewIn .15s ease`;const u=a.meetLink||a.meet_link;s.innerHTML=`
    ...
    <div style="display:flex;gap:6px;flex-wrap:wrap">
      ...
      <a href="${mo(a)}" target="_blank" style="font-size:11px;font-weight:700;color:var(--green);background:var(--green-dim);padding:4px 10px;border-radius:99px;text-decoration:none">📅 GCal</a>
    ...
    </div>`,document.body.appendChild(s),setTimeout(()=>{document.addEventListener("click",function g(_){s.contains(_.target)||(s.remove(),document.removeEventListener("click",g))})},50)}async function xo(e,t){e.preventDefault();const n=window._draggingApptId;if(!n)return;window._draggingApptId=null;const a=e.currentTarget,i=a.getBoundingClientRect(),o=a.closest("[data-tl-scroll]"),s=o?o.scrollTop:0,d=(e.clientY-i.top+s)/po*60+In*60,c=Math.max(In,Math.min(co-1,Math.floor(d/60))),p=Math.round(d%60/15)*15,m=p>=60?0:p,u=`${String(c).padStart(2,"0")}:${String(m).padStart(2,"0")}`,{error:g}=await y.from("appointments").update({date:t,time:u}).eq("id",n);if(g){x("Hata: "+g.message);return}const _=l.appointments.find(T=>T.id===n);_&&(_.date=t,_.time=u),$e(),x("Randevu taşındı ✓")}function da(){$e()}function $e(){const e=document.getElementById("view-todolist");if(!e)return;if(!document.getElementById("fc-styles")){const r=document.createElement("style");r.id="fc-styles",r.textContent=`
      .fc {
    ...
    `,s=document.getElementById("fc-calendar");else{const r=e.querySelectorAll("select");r[0]&&(r[0].innerHTML=t),r[1]&&(r[1].innerHTML=n)}typeof FullCalendar<"u"?window._fcInstance?(window._fcInstance.removeAllEvents(),window._fcInstance.addEventSource(i),window._fcInstance.updateSize()):(window._fcInstance=new FullCalendar.Calendar(s,{initialView:window.innerWidth<700?"listWeek":"timeGridWeek",headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay,listWeek"},buttonText:{today:"Bugün",month:"Ay",week:"Hafta",day:"Gün",list:"Ajanda"},locale:"tr",firstDay:1,slotMinTime:"08:00",slotMaxTime:"23:00",allDaySlot:!1,editable:!0,droppable:!0,selectable:!0,eventClick:function(r){la(r.event.id,r.jsEvent)},select:function(r){const d=r.startStr.slice(0,10),c=r.startStr.slice(11,16)||"14:00";ca(null,d),setTimeout(()=>{const p=document.getElementById("amTime");p&&(p.value=c)},50)},eventDrop:async function(r){const d=r.event.start,c=r.event.end||new Date(d.getTime()+45*6e4),p=d.getFullYear()+"-"+String(d.getMonth()+1).padStart(2,"0")+"-"+String(d.getDate()).padStart(2,"0"),m=String(d.getHours()).padStart(2,"0")+":"+String(d.getMinutes()).padStart(2,"0"),u=Math.round((c.getTime()-d.getTime())/6e4),g=r.event.id,{error:_}=await y.from("appointments").update({date:p,time:m,duration:u}).eq("id",g);if(_){x("Hata: "+_.message),r.revert();return}const T=l.appointments.find(f=>f.id===g);T&&(T.date=p,T.time=m,T.duration=u),x("Randevu taşıma başarılı ✓")},eventResize:async function(r){const d=r.event.start,c=r.event.end;if(!c)return;const p=Math.round((c.getTime()-d.getTime())/6e4),m=r.event.id,{error:u}=await y.from("appointments").update({duration:p}).eq("id",m);if(u){x("Hata: "+u.message),r.revert();return}const g=l.appointments.find(_=>_.id===m);g&&(g.duration=p),x("Randevu süresi güncellendi ✓")},events:i}),window._fcInstance.render()):console.warn("FullCalendar library not loaded yet")}function ca(e,t){const n=e?l.appointments.find(a=>a.id===e):null;document.getElementById("amTitle").textContent=n?"Randevuyu Düzenle":"Yeni Randevu",document.getElementById("amId").value=e||"",document.getElementById("amStudent").innerHTML=l.students.map(a=>`<option value="${a.id}" ${(n==null?void 0:n.studentId)===a.id?"selected":""}>${v(a.name)}</option>`).join(""),document.getElementById("amDate").value=n?n.date:t||O(new Date),document.getElementById("amTime").value=n?n.time:"14:00",document.getElementById("amDuration").value=n?n.duration:"45",document.getElementById("amType").value=n?n.type:"Haftalık Değerlendirme",document.getElementById("amNote").value=n&&n.note||"",document.getElementById("amMeetLink").value=n&&(n.meetLink||n.meet_link)||"",G("apptModal")}async function bo(e){await ie("Randevu silinsin mi?")&&(await y.from("appointments").delete().eq("id",e),l.appointments=l.appointments.filter(t=>t.id!==e),$e(),x("Randevu silindi"))}function pa(){ct()}function ho(e){l.activeStuId=e,l.weekOffset=0,we(),Qt(e)}function ko(e){const t=e?l.students.find(u=>u.id===e):null,n=!!t;document.getElementById("smTitle").textContent=n?"Öğrenciyi Düzenle":"Öğrenci Davet Et",document.getElementById("smId").value=e||"",document.getElementById("smName").value=(t==null?void 0:t.name)||"",document.getElementById("smTarget").value=(t==null?void 0:t.target)||"",document.getElementById("smUsername").value=(t==null?void 0:t.username)||"",document.getElementById("smPass").value=(t==null?void 0:t.pass)||STU_DEFAULT_PASS,document.getElementById("smWeekStart").value=(t==null?void 0:t.weekStart)??0,document.getElementById("smYksArea").value=(t==null?void 0:t.yksArea)||"SAY",document.getElementById("smProg").value=(t==null?void 0:t.progress)||0,document.getElementById("smProgVal").textContent=((t==null?void 0:t.progress)||0)+"%",document.querySelectorAll(".color-opt").forEach(u=>u.classList.toggle("sel",u.dataset.c===((t==null?void 0:t.color)||"#e8622a")));const a=document.getElementById("smEmailField"),i=document.getElementById("smTargetField"),o=document.getElementById("smInviteRow"),s=document.getElementById("smYksRow"),r=document.getElementById("smColorField"),d=document.getElementById("smProgField"),c=document.querySelector("#studentModal .btn-accent");a&&(a.style.display=n?"none":"block"),i&&(i.style.display=n?"block":"none"),o&&(o.style.display=n?"flex":"none"),s&&(s.style.display=n?"flex":"none"),r&&(r.style.display=n?"block":"none"),d&&(d.style.display=n?"block":"none");const p=document.getElementById("smContactSection");p&&(p.style.display=n?"block":"none",["smLevel","smStudentPhone","smParentEmail","smParentPhone"].forEach(u=>{const g=document.getElementById(u);g&&(g.value="")}),n&&y.from("student_profiles").select("level, student_phone, parent_email, parent_phone").eq("id",e).maybeSingle().then(({data:u})=>{if(!u)return;const g=(_,T)=>{const f=document.getElementById(_);f&&T&&(f.value=T)};g("smLevel",u.level),g("smStudentPhone",u.student_phone),g("smParentEmail",u.parent_email),g("smParentPhone",u.parent_phone)}).catch(()=>{})),c&&(c.textContent=n?"Kaydet":"Davet Gönder",c.setAttribute("onclick","saveStudent()"));const m=document.getElementById("smRoleField");m&&(m.style.display="none"),G("studentModal")}document.getElementById("smProg").addEventListener("input",function(){document.getElementById("smProgVal").textContent=this.value+"%"});document.getElementById("smColorPick").addEventListener("click",function(e){const t=e.target.closest(".color-opt");t&&(document.querySelectorAll(".color-opt").forEach(n=>n.classList.remove("sel")),t.classList.add("sel"))});async function wo(){var d,c,p,m,u,g,_,T;const e=document.getElementById("smName").value.trim();if(!e)return x("İsim girin!");const t=((d=document.querySelector(".color-opt.sel"))==null?void 0:d.dataset.c)||"#e8622a",n=document.getElementById("smId").value,a=je(document.getElementById("smUsername").value.trim())||je(e.split(" ")[0])+Math.floor(Math.random()*100),i=document.getElementById("smPass").value||STU_DEFAULT_PASS,o=await Ye(i),s=document.getElementById("smYksArea").value,r={full_name:e,target:document.getElementById("smTarget").value.trim()||"Hedef belirtilmemiş",color:t,progress:Number(document.getElementById("smProg").value),password_hash:o,week_start:Number(document.getElementById("smWeekStart").value),username:a,role:"student",coach_id:b.coachId,yks_area:s};if(n){const{error:f}=await y.rpc("update_student_profile",{p_student_id:n,p_full_name:e,p_target:r.target,p_color:t,p_progress:r.progress,p_week_start:r.week_start,p_username:a,p_plain_password:i,p_password_hash:o,p_yks_area:r.yks_area});if(f)return x("Hata: "+f.message);const $=l.students.find(I=>I.id===n);$&&Object.assign($,{name:r.full_name,target:r.target,color:t,progress:r.progress,pass:r.password_hash,weekStart:r.week_start,username:a,yksArea:r.yks_area});const k=((c=document.getElementById("smLevel"))==null?void 0:c.value)||"",z=((p=document.getElementById("smStudentPhone"))==null?void 0:p.value.trim())||"",h=((m=document.getElementById("smParentEmail"))==null?void 0:m.value.trim())||"",S=((u=document.getElementById("smParentPhone"))==null?void 0:u.value.trim())||"";if(k||z||h||S){const I={id:n};k&&(I.level=k),z&&(I.student_phone=z),h&&(I.parent_email=h),S&&(I.parent_phone=S);const{error:B}=await y.from("student_profiles").upsert(I);B&&!/column/i.test(B.message||"")&&console.warn("student_profiles upsert:",B.message)}x("Güncellendi ✓"),we(),q("studentModal"),ct()}else{const f=(g=document.getElementById("smEmail"))==null?void 0:g.value.trim();if(!f||!f.includes("@"))return x("Geçerli bir e-posta adresi girin!");const{data:{session:$}}=await y.auth.getSession();x("Davet gönderiliyor...");try{const k=await fetch("/api/invitation?action=create",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${($==null?void 0:$.access_token)||""}`,"X-Coach-Id":((_=b.dbUser)==null?void 0:_.id)||"","X-Coach-Hash":((T=b.dbUser)==null?void 0:T.password_hash)||""},body:JSON.stringify({email:f,student_name:r.full_name,username:a})}),z=await k.json();if(!k.ok)return x("Hata: "+z.error);x("Davet gönderildi ✓"),we(),q("studentModal");const S=`${window.location.origin+window.location.pathname.replace("app.html","")}davet.html?token=${z.token}`;ma(r.full_name,f,S)}catch(k){console.error(k),x("İletişim hatası oluştu.")}}}function ma(e,t,n){let a=document.getElementById("inviteModal");a||(a=document.createElement("div"),a.id="inviteModal",a.className="modal-bg",document.body.appendChild(a),a.addEventListener("click",o=>{o.target===a&&a.classList.remove("open")}));const i=encodeURIComponent(`Merhaba ${e}! 🎓
...
🔗 Davet Linki: ${n}`);a.innerHTML=`<div class="modal" style="max-width:480px">
  ...
  </div>`,window._pendingInvite={name:e,email:t,inviteUrl:n},G("inviteModal")}function $o(e){navigator.clipboard.writeText(e).then(()=>x("Bağlantı kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),x("Bağlantı kopyalandı ✓")})}async function Eo(e){var a;if(!await ie("Bu öğrenciyi silmek istediğinizden emin misiniz?"))return;const t=document.getElementById(`sturow_${e}`);t&&(t.style.transition="all 0.3s ease",t.style.opacity="0",t.style.transform="translateX(30px)",t.innerHTML='<div style="color:var(--red); font-weight:700; font-size:13px; display:flex; align-items:center; gap:6px">🗑️ Siliniyor...</div>'),await new Promise(i=>setTimeout(i,300));const{error:n}=await y.from("users").delete().eq("id",e);if(n)return x("Hata: "+n.message);l.students=l.students.filter(i=>i.id!==e),l.activeStuId===e&&(l.activeStuId=((a=l.students[0])==null?void 0:a.id)||null),we(),pa(),x("Silindi")}function _o(){const e="217851738834-1cp3fk66hfhm0mr2aklsk3jphqmub2s3.apps.googleusercontent.com",t=encodeURIComponent("https://www.rostrumakademi.com/app.html"),n=encodeURIComponent("https://www.googleapis.com/auth/calendar.events"),a=`https://accounts.google.com/o/oauth2/v2/auth?client_id=${e}&redirect_uri=${t}&response_type=code&scope=${n}&access_type=offline&prompt=consent&state=google_calendar`;window.location.href=a}window.connectGoogleCalendar=_o;function Ze(){var a,i;const e=document.getElementById("view-appointments"),n=((a=l.workspace)==null?void 0:a.google_calendar_connected)?'<span style="font-size:12px;color:var(--green);font-weight:600;display:flex;align-items:center;gap:4px">✓ Google Takvim</span>':'<button class="btn btn-ghost btn-sm" onclick="connectGoogleCalendar()">🔗 Google Takvim Bağla</button>';e.innerHTML=`
...
`)],{type:"text/calendar;charset=utf-8"}),o=URL.createObjectURL(i),s=document.createElement("a");s.href=o,s.download="rostrum-randevular.ics",s.click(),setTimeout(()=>URL.revokeObjectURL(o),1e3),x(`${t.length} randevu takvim dosyasına aktarıldı ✓`)}function kt(e){return 100+(Number(e.Türkçe||0)+Number(e.Matematik||0)+Number(e.Fen||0)+Number(e.Sosyal||0))*(400/120)}function ua(e,t){const n=a=>Number(t[a]||0);return e==="AYT-SAY"?100+(n("Matematik")+n("Fizik")+n("Kimya")+n("Biyoloji"))*5:e==="AYT-EA"?100+(n("Matematik")+n("Edebiyat")+n("Tarih")+n("Coğrafya"))*5:e==="AYT-SOZ"?100+(n("Edebiyat")+n("Tarih1")+n("Tarih2")+n("Coğrafya1")+n("Coğrafya2")+n("Felsefe")+n("Din"))*5:null}const ga={"AYT-SAY":"SAY","AYT-EA":"EA","AYT-SOZ":"SÖZ"},wt={TYT:"#3B82F6",SAY:"#8B5CF6",EA:"#10B981",SÖZ:"#F59E0B"};function va(e,t){const{type:n,nets:a}=e;if(n==="TYT"){const d=kt(a),c=wt.TYT;return`<div style="margin-top:10px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
    ...
    </div>`}const i=ga[n];if(!i)return"";const o=wt[i]||"#64748B",s=ua(n,a),r=t.filter(d=>d.type==="TYT"&&d.date<=e.date).sort((d,c)=>c.date.localeCompare(d.date))[0];if(r){const d=kt(r.nets),c=d*.4+s*.6;return`<div style="margin-top:10px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">
    ...
    </div>`;return}const a=ga[t],i=wt[a]||"#64748B",o=ua(t,n);if(o===null){e.innerHTML="";return}const s=(c=document.getElementById("emStudent"))==null?void 0:c.value,r=s?[...l.exams].filter(p=>p.studentId===s&&p.type==="TYT").sort((p,m)=>m.date.localeCompare(p.date))[0]:null;if(r){const p=kt(r.nets),m=p*.4+o*.6;e.innerHTML=`<div style="background:${i}12;border:1px solid ${i}35;border-radius:10px;padding:10px 14px">
  ...
  </div>`,_=o.map(R=>{var kn;const N=Number(((kn=a.nets)==null?void 0:kn[R])||0),K=(EXAM_SORU[a.type]||{})[R]||40,re=Math.min(100,Math.max(0,N/K*100)),xe=N>=K*.6?"#3ecf8e":N>=K*.35?"#f0a500":"#ef4444";return`<div style="margin-bottom:11px">
    ...
    ${_}
  </div>`;const T=n.map(R=>(EXAM_DEFS[R.type]||[]).reduce((K,re)=>{var xe;return K+Number(((xe=R.nets)==null?void 0:xe[re])||0)},0)),f=Math.max(...T,10),$=600,k=160,z=40,h=16,S=28,I=30,B=$-z-h,E=k-S-I,A=n.length,C=R=>z+(A<=1?B/2:R/(A-1)*B),L=R=>S+E-R/f*E,w=f/4,D=w<=10?10:w<=20?20:w<=25?25:50,P=[];for(let R=0;R<=f+D;R+=D)R<=f*1.12&&P.push(R);const j=P.map(R=>{const N=L(R).toFixed(1);return`<line x1="${z}" y1="${N}" x2="${$-h}" y2="${N}" stroke="rgba(255,255,255,0.05)" stroke-width="1"/><text x="${z-5}" y="${(L(R)+3.5).toFixed(1)}" text-anchor="end" font-size="9" fill="rgba(200,215,230,0.28)" font-family="system-ui,sans-serif">${R}</text>`}).join(""),Y=n.map((R,N)=>`${C(N).toFixed(1)},${L(T[N]).toFixed(1)}`).join(" "),H=`M ${C(0).toFixed(1)},${L(T[0]).toFixed(1)} `+n.slice(1).map((R,N)=>`L ${C(N+1).toFixed(1)},${L(T[N+1]).toFixed(1)}`).join(" ")+` L ${C(A-1).toFixed(1)},${(S+E).toFixed(1)} L ${C(0).toFixed(1)},${(S+E).toFixed(1)} Z`,F="ag"+Math.random().toString(36).slice(2,7),V=n.map((R,N)=>{const K=C(N).toFixed(1),re=L(T[N]).toFixed(1);return`<circle cx="${K}" cy="${re}" r="5" fill="${s}" stroke="#0d0d0f" stroke-width="2.5"/><text x="${K}" y="${(L(T[N])-10).toFixed(1)}" text-anchor="middle" font-size="9.5" font-weight="700" fill="${s}" font-family="system-ui,sans-serif">${T[N].toFixed(0)}</text>`}).join(""),Z=n.map((R,N)=>{let K=R.name.replace(/Deneme\s+/,"#").replace(/^(TYT|AYT-SAY|AYT-EA|AYT-SOZ)\s+/,"");return K.length>7&&(K=K.slice(0,6)+"…"),`<text x="${C(N).toFixed(1)}" y="${(k-I+14).toFixed(1)}" text-anchor="middle" font-size="9" fill="rgba(200,215,230,0.35)" font-family="system-ui,sans-serif">${v(K)}</text>`}).join(""),te=`<svg viewBox="0 0 ${$} ${k}" style="width:100%;height:auto;display:block" xmlns="http://www.w3.org/2000/svg">
  ...
  ${V}${Z}
    ...
    ${_}
  </div>`}function Je(){const e=document.getElementById("view-exams"),t=l.students.find(o=>o.id===l.activeStuId),n=[...l.exams].filter(o=>o.studentId===l.activeStuId).sort((o,s)=>s.date.localeCompare(o.date)),a=Lo(n,t),i=n.length?n.map(o=>{const s=EXAM_DEFS[o.type]||[],r=s.reduce((d,c)=>{var p;return d+Number(((p=o.nets)==null?void 0:p[c])||0)},0).toFixed(1);return`<div style="background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:16px;margin-bottom:10px;">
    ...
    ${o}`}window._krRenderBody=ya;function jo(e){fa=e;const t=l.exams.find(n=>n.studentId===e&&n.examDetails&&Object.keys(n.examDetails).length);De=(t==null?void 0:t.type)||"TYT",ya(),G("konuRaporuModal")}window.openKonuRaporu=jo;function Ro(e){const t=l.exams.find(n=>n.id===e);document.getElementById("cmExamId").value=e,document.getElementById("cmText").value=(t==null?void 0:t.coachComment)||"",G("commentModal")}async function No(){const e=document.getElementById("cmExamId").value,t=document.getElementById("cmText").value.trim();await y.from("exams").update({coach_comment:t}).eq("id",e);const n=l.exams.find(a=>a.id===e);n&&(n.coachComment=t),q("commentModal"),Je(),x("Yorum kaydedildi ✓")}async function Ho(e){await ie("Bu denemeyi silmek istediğinizden emin misiniz?")&&(await y.from("exams").delete().eq("id",e),l.exams=l.exams.filter(t=>t.id!==e),Je(),x("Silindi"))}function xa(){const e=document.getElementById("view-messages");e.innerHTML=`<div class="sh" style="margin-bottom:14px"><h2>Mesajlar</h2></div>
  ...
  <div class="msg-input-area">
  ...
  </div>`}window._pickMsgImg=function(e,t,n){const a=e.files[0];if(!a)return;if(a.size>5*1024*1024){x("Dosya max 5 MB olabilir"),e.value="";return}Ce={file:a};const i=document.getElementById("msgImgPreview"),o=document.getElementById("msgImgThumb"),s=document.getElementById("msgImgName");if(a.type.startsWith("image/")){const r=new FileReader;r.onload=d=>{o.src=d.target.result,o.style.display="block"},r.readAsDataURL(a)}else o.style.display="none";s.textContent=a.name,i.style.display="flex",e.value=""};window._cancelMsgImg=function(){Ce=null,document.getElementById("msgImgPreview").style.display="none"};window._handleMsgPaste=function(e,t,n){var i;const a=(i=e.clipboardData)==null?void 0:i.items;if(a){for(const o of a)if(o.type.startsWith("image/")){e.preventDefault();const s=o.getAsFile();if(!s)return;if(s.size>5*1024*1024){x("Dosya max 5 MB olabilir");return}Ce={file:s};const r=new FileReader;r.onload=d=>{const c=document.getElementById("msgImgPreview"),p=document.getElementById("msgImgThumb"),m=document.getElementById("msgImgName");p.src=d.target.result,p.style.display="block",m.textContent="Yapıştırılan görsel",c&&(c.style.display="flex")},r.readAsDataURL(s);return}}};async function Ko(e,t){var d,c,p;const n=document.getElementById("msgInput"),a=n.value.trim();if(!a&&!Ce)return;const i=b.coachId||((d=l.students.find(m=>m.id===e))==null?void 0:d.coachId)||((c=l.students.find(m=>m.id===b.studentId))==null?void 0:c.coachId);let o=null;if(Ce){const m=Ce.file,g=((p=m.name)!=null&&p.includes(".")?m.name.split(".").pop():"")||(m.type==="image/png"?"png":m.type==="image/webp"?"webp":"jpg"),_=`${e}/${Date.now()}.${g}`,{error:T}=await y.storage.from("chat_images").upload(_,m,{upsert:!0});if(T){x("Görsel yüklenemedi: "+T.message);return}const{data:f}=y.storage.from("chat_images").getPublicUrl(_);o=f.publicUrl,Ce=null,document.getElementById("msgImgPreview").style.display="none"}const{data:s,error:r}=await y.from("messages").insert({student_id:e,coach_id:i,from_role:t,text:a||null,image_url:o,read:!1}).select().single();if(r){x("Hata: "+r.message);return}l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:s.id,from:t,text:a||"",image_url:o,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),n.value="",n.style.height="auto",currentTab==="messages"&&(document.getElementById("msgMain").innerHTML=Se(e,"coach"),Ie()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=Se(e,"student"),Ie()),t==="student"&&i&&y.auth.getSession().then(({data:{session:m}})=>{var g;const u=m==null?void 0:m.access_token;u&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${u}`},body:JSON.stringify({type:"new_message",coach_id:i,student_name:((g=b.dbUser)==null?void 0:g.full_name)||"Öğrenciniz",message_preview:a?a.slice(0,200):"📷 Görsel gönderdi"})}).catch(()=>{})})}function Ie(){setTimeout(()=>{const e=document.getElementById("msgBody");e&&(e.scrollTop=e.scrollHeight)},60)}function Mt(){var u;const e=document.getElementById("view-portal");if(!e)return;let t=l.students.find(g=>g.id===b.studentId);if(!t&&l.students.length>0&&(t=l.students[0]),!t){e.innerHTML=`<div style="text-align:center;padding:60px 20px;color:var(--text-mid)">
      <div style="font-size:36px;margin-bottom:12px">⏳</div>
      <p style="font-size:14px">Profil yükleniyor...</p>
    </div>`,setTimeout(()=>{l.students.length&&Mt()},800);return}b.studentId||(b.studentId=t.id),l.activeStuId=t.id;const n=ue(),a=`${t.id}_${n}`,i=l.tasks[a]||[],o=i.filter(g=>g.done).length,s=l.appointments.filter(g=>g.studentId===t.id&&g.date>=n).sort((g,_)=>g.date.localeCompare(_.date))[0],r=(l.messages[t.id]||[]).filter(g=>g.from==="coach"&&!g.read).length,d=((u=l.konuMastery)==null?void 0:u[t.id])||{},c=[],p=new Date;p.setDate(p.getDate()-30),Object.entries(d).forEach(([g,_])=>{Object.entries(_).forEach(([T,f])=>{if(f.status==="td"||f.status==="not_started")return;const $=f.last_review_date?new Date(f.last_review_date):null,k=$?Math.floor((Date.now()-$.getTime())/864e5):999,z=f.stars<=2,h=k>20;(z||h)&&c.push({konu:T,subject:g,stars:f.stars,daysSince:k})})}),c.sort((g,_)=>g.stars-_.stars||_.daysSince-g.daysSince);const m=c.length>0?`
    <div class="card cp" style="border-color:rgba(239,68,68,.3)">
      ...
      ${c.slice(0,5).map(g=>{const _=Oe[g.stars];return g.daysSince<999&&`${g.daysSince}`,`<div style="display:flex;align-items:center;gap:10px;padding:7px 0;border-bottom:1px solid var(--border)">
    ...
    <div class="portal-grid">
        ...
        ${i.length?`
          ${i.map((g,_)=>`
            <div data-task-id="${g._id}" class="task-card task-${g.type} ${g.done?"done":""}" style="margin-bottom:6px">
              ...
              <div class="tc-body">
                <div class="tc-type">${dt(g.type)}${g.exam?" · "+g.exam:""}</div>
      ...
      <div style="display:flex;flex-direction:column;gap:12px">
    ...
    </div>`}async function Oo(e,t){var s;const n=l.students.find(r=>r.id===b.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(s=l.tasks[a])==null?void 0:s[t];if(!i)return;const o=!i.done;await y.from("tasks").update({done:o}).eq("id",i._id),i.done=o,Mt()}function Be(){const e=l.students.find(p=>p.id===b.studentId);if(!e)return;const t=document.getElementById("view-sportal"),n=e.weekStart??0,a=ne(l.weekOffset,n),i=J(a,6),o=ue(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let p=0;p<7;p++){const m=J(a,p),u=O(m),g=u===o,_=`${e.id}_${u}`,T=l.tasks[_]||[],f=T.reduce((S,I)=>S+Number(I.duration),0),$=T.reduce((S,I)=>S+(I.done?Number(I.duration):0),0);DAYS_TR[(n+p)%7];const k=[...T];s==="hourly"&&k.sort((S,I)=>S.start_time&&!I.start_time?-1:!S.start_time&&I.start_time?1:S.start_time&&I.start_time?S.start_time.localeCompare(I.start_time):0);const z=k.map(S=>{const I=T.indexOf(S),B=S.start_time?`<div class="tc-time-badge">🕒 ${S.start_time}</div>`:"";return`
        <div data-task-id="${S._id}" class="task-card task-${S.type} ${S.done?"done":""} ${S.start_time?"hourly-card":""}" onclick="openTaskDetail('${u}',${I},'student')" style="cursor:pointer">
          ...
          <div class="tc-body">
            ${B}
            <div class="tc-type">${dt(S.type)}${S.exam?" · "+S.exam:""}</div>
      ...
      <div class="day-hd">
        ...
        <span class="day-badge" style="font-size:8.5px">${at($)} / ${at(f)}</span>
      </div>
      <div class="day-tasks-list">${z||'<div class="empty" style="padding:8px 0"><p style="font-size:11px">Görev yok</p></div>'}</div>
    </div>`}const d=Wt(),c=d.days;t.innerHTML=`
  ...
  </div>`}function Wo(e){const t=e.student_feedback||{};if(!(t.status||t.focus||t.difficulty||t.time_spent>0||t.blocker))return"";const a={completed:{l:"Tamamladı",c:"#3ecf8e",bg:"rgba(62,207,142,.1)"},partial:{l:"Kısmen Tamamladı",c:"#f0a500",bg:"rgba(240,165,0,.1)"},failed:{l:"Yapamadı",c:"#ef4444",bg:"rgba(239,68,68,.1)"}},i={1:"Çok Kolay",2:"Kolay",3:"Orta",4:"Zor",5:"Çok Zor"},o={time:"Zamanı yetmedi",topic:"Konuyu anlayamadı",hard:"Kaynak çok zordu",moti:"Motivasyon yok"},s=a[t.status],r=t.time_spent,d=r>0?(Math.floor(r/60)>0?Math.floor(r/60)+"sa ":"")+(r%60>0?r%60+"dk":""):null,c=t.focus?"★".repeat(t.focus)+"☆".repeat(5-t.focus):null,p={1:"#3ecf8e",2:"#86efac",3:"#f0a500",4:"#fb923c",5:"#ef4444"},m=t.difficulty?p[t.difficulty]:"var(--text-mid)";return`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:12px 16px;margin-bottom:14px">
      ...
      <div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;overflow:hidden;max-height:200px;overflow-y:auto">
        ${m.map(($,k)=>`
          <label style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid var(--border);${k===m.length-1?"border-bottom:none":""};cursor:${n==="coach"?"default":"pointer"};transition:background .1s"
            ...
            <div style="flex:1;min-width:0">
              <div style="font-size:13px;font-weight:600;line-height:1.4;${$.done?"text-decoration:line-through;color:var(--text-dim);":""}">${v($.label||`Ders ${k+1}`)}</div>
    ...
    ${(()=>{var k;const $=Fi(o.exam,o.subject);return $?(pe=[...((k=o.student_result)==null?void 0:k.yanlis_konular)||[]],`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:14px 16px;margin-bottom:14px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:0">${$.map(z=>{const h=pe.includes(z);return`<span ${n==="coach"?"":`onclick="toggleKonuChip(this,'${z.replace(/'/g,"\\'")}')"`}
  ...
  </div>`,G("taskDetailModal")}async function Vo(e,t,n){var s;if(n==="coach")return;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(s=l.tasks[i])==null?void 0:s[t];o&&(o.done=!o.done,o.task_items&&Array.isArray(o.task_items)&&o.task_items.forEach(r=>{r.done=o.done}),await y.from("tasks").update({done:o.done,task_items:o.task_items||null}).eq("id",o._id),an(e,t,n),n==="student"?Be():X())}async function Zo(e,t,n,a){var d;if(a==="coach")return;const o=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,s=(d=l.tasks[o])==null?void 0:d[t];if(!s||!s.task_items)return;s.task_items[n].done=!s.task_items[n].done;const r=s.task_items.every(c=>c.done);s.done=r,M(!0),await y.from("tasks").update({task_items:s.task_items,done:s.done}).eq("id",s._id),M(!1),an(e,t,a),a==="student"?Be():X(),x("İlerleme kaydedildi ✓")}function Jo(e,t){var i,o,s;e.closest("div").querySelectorAll("button[data-speed]").forEach(r=>{const d=r.dataset.speed===t;r.style.borderColor=d?"var(--accent)":"var(--border)",r.style.background=d?"var(--accent-dim)":"var(--surface2)",r.style.color=d?"var(--accent)":"var(--text-mid)"}),document.getElementById("tdSpeed").value=t;const n=parseFloat(t),a=document.getElementById("speedCalc");if(a){const r=parseInt(((s=(o=(i=a.closest("[id=speedInfo]"))==null?void 0:i.textContent)==null?void 0:o.match(/Toplam (\d+) dk/))==null?void 0:s[1])||0);a.textContent=Math.ceil(r/n)+" dk",document.getElementById("tdDuration").value=Math.ceil(r/n)}}async function Xo(e,t,n){var f,$,k,z,h;if(n==="coach")return;const i=`${b.role==="student"?b.studentId:l.activeStuId}_${e}`,o=(f=l.tasks[i])==null?void 0:f[t];if(!o)return;const s=(($=document.getElementById("tdNote"))==null?void 0:$.value.trim())||"",r={student_note:s},d=parseInt((k=document.getElementById("fbHour"))==null?void 0:k.value)||0,c=parseInt((z=document.getElementById("fbMin"))==null?void 0:z.value)||0,p=d*60+c,m={status:Le.status||null,time_spent:p>0?p:((h=o.student_feedback)==null?void 0:h.time_spent)||null,focus:Le.focus||null,difficulty:Le.difficulty||null,blocker:Le.blocker||null};(m.status||m.focus||m.difficulty||p>0)&&(r.student_feedback=m,o.student_feedback=m,m.status&&(r.done=m.status!=="failed",o.done=r.done));const u=document.getElementById("tdDogru"),g=document.getElementById("tdYanlis"),_=document.getElementById("tdBos");if(u!==null){const S=parseInt(u.value)||0,I=parseInt(g.value)||0,B=parseInt(_.value)||0;(S>0||I>0||B>0||pe.length>0)&&(r.student_result={dogru:S,yanlis:I,bos:B,yanlis_konular:[...pe],ts:new Date().toISOString()},o.student_result=r.student_result)}if(!o._id){x("Hata: görev ID bulunamadı");return}const{error:T}=await y.from("tasks").update(r).eq("id",o._id);if(T){x("Kaydetme hatası: "+T.message),console.error("saveTaskDetail error",T,r);return}o.student_note=s,q("taskDetailModal"),x("Kaydedildi ✓"),n==="student"?Be():X()}function on(){const e=l.students.find(o=>o.id===b.studentId);if(!e)return;const t=document.getElementById("view-sexams"),n=[...l.exams].filter(o=>o.studentId===e.id).sort((o,s)=>s.date.localeCompare(o.date));let a="";if(n.length>1){const o=[...n].sort((r,d)=>r.date.localeCompare(d.date)).slice(-8),s=Math.max(...o.map(r=>(EXAM_DEFS[r.type]||[]).reduce((c,p)=>{var m;return c+Number(((m=r.nets)==null?void 0:m[p])||0)},0)),1);a=`<div class="card cp" style="margin-bottom:16px">
    ...
    ${a}${i}`}function ba(e){var n;const t=e?l.exams.find(a=>a.id===e):null;document.getElementById("emTitle").textContent=t?"Sonucu Düzenle":"Deneme Sonucu Gir",document.getElementById("emId").value=e||"",document.getElementById("emName").value=(t==null?void 0:t.name)||"",document.getElementById("emDate").value=(t==null?void 0:t.date)||O(new Date),document.getElementById("emStudentWrap").style.display="none",document.getElementById("emStudent").innerHTML=`<option value="${b.studentId}">${v(((n=l.students.find(a=>a.id===b.studentId))==null?void 0:n.name)||"")}</option>`,document.getElementById("emExamType").value=(t==null?void 0:t.type)||"TYT",document.getElementById("emNote").value=(t==null?void 0:t.note)||"",sn(),t!=null&&t.examDetails&&Object.entries(t.examDetails).forEach(([a,i])=>{const o=document.getElementById(`ed_${a}_d`),s=document.getElementById(`ed_${a}_y`),r=document.getElementById(`ed_${a}_b`);o&&(o.value=i.dogru||0,s.value=i.yanlis||0,r.value=i.bos||0),ae[a]={...i},ha(a),(i.yanlis_konular||[]).forEach(d=>{document.querySelectorAll(`#konu_acc_${a.replace(/\s/g,"_")} span`).forEach(p=>{p.textContent.trim()===d&&(p.style.borderColor="var(--red)",p.style.background="rgba(255,92,122,.12)",p.style.color="var(--red)")})})}),G("examModal")}function Qo(e){document.getElementById("emStudentWrap").style.display="",document.getElementById("emStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),ba(e),document.getElementById("emStudentWrap").style.display=""}let ae={};function es(e,t,n){ae[t]||(ae[t]={dogru:0,yanlis:0,bos:0,yanlis_konular:[]});const a=ae[t].yanlis_konular,i=a.indexOf(n);i===-1?(a.push(n),e.style.borderColor="var(--red)",e.style.background="rgba(255,92,122,.12)",e.style.color="var(--red)"):(a.splice(i,1),e.style.borderColor="var(--border)",e.style.background="var(--surface)",e.style.color="var(--text-mid)")}window.toggleExamKonuChip=es;function ha(e){var c,p,m,u;const t=parseInt((c=document.getElementById(`ed_${e}_d`))==null?void 0:c.value)||0,n=parseInt((p=document.getElementById(`ed_${e}_y`))==null?void 0:p.value)||0,a=parseInt((m=document.getElementById(`ed_${e}_b`))==null?void 0:m.value)||0;ae[e]||(ae[e]={yanlis_konular:[]}),ae[e].dogru=t,ae[e].yanlis=n,ae[e].bos=a;const i=document.getElementById("emExamType").value,o=((u=EXAM_SORU[i])==null?void 0:u[e])||40,s=t+n+a,r=document.getElementById(`ed_${e}_net`),d=document.getElementById(`ed_${e}_warn`);r&&(r.textContent=Math.max(0,t-n/4).toFixed(2)),d&&(d.style.display=s>o?"":"none"),Co()}window.updateExamNet=ha;function ts(e){const t=document.getElementById(`konu_acc_${e.replace(/\s/g,"_")}`);t&&(t.style.display=t.style.display==="none"?"":"none")}window.toggleKonuAccordion=ts;function sn(){const e=document.getElementById("emExamType").value,t=EXAM_DEFS[e]||[];ae={};const n=document.getElementById("emPuanDisplay");n&&(n.innerHTML=""),document.getElementById("netInputsWrap").innerHTML=t.map(a=>{var d;const i=((d=EXAM_SORU[e])==null?void 0:d[a])||40,s=(EXAM_KONU_MAP[`${e}_${a}`]||[]).flatMap(c=>it[c]||[]),r=s.length?`
      ...
      ${r}
              ...
              </div>`,document.body.appendChild(f),setTimeout(()=>f.remove(),12e3)},600)}}}catch(c){console.error("[mastery suggestion]",c)}}async function Ft(){const e=l.students.find(a=>a.id===b.studentId);if(!e)return;const t=(l.messages[e.id]||[]).filter(a=>a.from==="coach"&&!a.read&&a._id).map(a=>a._id);t.length&&await y.from("messages").update({read:!0}).in("id",t),(l.messages[e.id]||[]).forEach(a=>{a.from==="coach"&&(a.read=!0)}),Ct();const n=document.getElementById("view-smessages");n.innerHTML=`<div class="sh" style="margin-bottom:12px"><h2>💬 Koçuma Yaz</h2></div>
    <div class="smsg-wrap">
      <div class="msg-main" id="msgMain">${Se(e.id,"student")}</div>
    </div>`,Ie()}let yt=null;function rn(){ln();const e=b.role==="coach"||b.role==="developer"?l.msgThread:b.studentId;e&&(yt=y.channel("messages_"+e).on("postgres_changes",{event:"INSERT",schema:"public",table:"messages",filter:`student_id=eq.${e}`},t=>{const n=t.new;l.messages[e]||(l.messages[e]=[]),!l.messages[e].find(a=>a._id===n.id)&&(l.messages[e].push({_id:n.id,from:n.from_role,text:n.text||"",image_url:n.image_url||null,read:n.read,time:new Date(n.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}),b.role==="student"&&n.from_role==="coach"&&currentTab!=="smessages"&&Ct(),currentTab==="messages"&&l.msgThread===e&&(document.getElementById("msgMain").innerHTML=Se(e,"coach"),Ie()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=Se(e,"student"),Ie()))}).subscribe())}function ln(){yt&&(y.removeChannel(yt),yt=null)}async function as(){var e,t;await y.from("workspaces").upsert({coach_id:b.coachId,brand_name:((e=l.workspace)==null?void 0:e.brand_name)||"Akademi",brand_color:((t=l.workspace)==null?void 0:t.brand_color)||"#E8613A",onboarding_done:!1},{onConflict:"coach_id"}),l.workspace&&(l.workspace.onboarding_done=!1),Ta()}window.devResetOnboarding=as;async function ka(){const e=document.getElementById("view-dev-dashboard");e.innerHTML='<div class="sh"><h2>🖥️ Sistem Dashboard</h2></div><div class="empty"><p>Yükleniyor...</p></div>';const[t,n,a,i,o,s]=await Promise.all([y.from("users").select("id,role,created_at"),y.from("tasks").select("id,done,created_at"),y.from("exams").select("id,created_at"),y.from("messages").select("id,created_at"),y.from("tickets").select("id,status,created_at"),y.from("payments").select("id,amount,status,payment_date")]),r=t.data||[],d=n.data||[],c=a.data||[],p=i.data||[],m=o.data||[],u=s.data||[],g=r.filter(h=>h.role==="coach").length,_=r.filter(h=>h.role==="student").length,T=u.filter(h=>h.status==="completed").reduce((h,S)=>h+Number(S.amount),0),f=m.filter(h=>h.status==="open").length,$=Array.from({length:7},(h,S)=>{const I=new Date;return I.setDate(I.getDate()-6+S),O(I)}),k=$.map(h=>d.filter(S=>{var I;return(I=S.created_at)==null?void 0:I.startsWith(h)}).length),z=Math.max(...k,1);e.innerHTML=`
      ...
      <div class="card cp">
        ...
        <div style="display:flex;align-items:flex-end;gap:6px;height:80px">
          ${$.map((h,S)=>`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
            <div style="font-size:10px;color:var(--text-mid);font-weight:600">${k[S]}</div>
            <div style="width:100%;background:var(--accent);border-radius:3px 3px 0 0;height:${Math.max(Math.round(k[S]/z*100),4)}%;min-height:3px;opacity:.8"></div>
...
Bu işlem geri alınamaz.`)){M(!0);try{const{data:{session:n}}=await y.auth.getSession(),a=await fetch("/api/delete-user",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${(n==null?void 0:n.access_token)||""}`},body:JSON.stringify({targetUserId:e})}),i=await a.json();if(!a.ok)throw new Error(i.error||"Sunucu hatası");x(`🗑 ${t} silindi`),Xe()}catch(n){x("Hata: "+n.message)}finally{M(!1)}}}function rs(e,t,n,a){let i=document.getElementById("planMgmtModal");i||(i=document.createElement("div"),i.id="planMgmtModal",i.className="modal-bg",i.innerHTML=`<div class="modal" style="max-width:400px">
    ...
    </div>`,document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")}),document.getElementById("planStatus").addEventListener("change",function(){document.getElementById("trialEndField").style.display=this.value==="trial"?"":"none"})),document.getElementById("planModalTitle").textContent=`Plan Yönet — ${t}`,document.getElementById("planUserId").value=e,document.getElementById("planStatus").value=n||"trial",document.getElementById("trialEndField").style.display=n==="trial"||!n?"":"none",a?document.getElementById("planTrialEnd").value=a.split("T")[0]:document.getElementById("planTrialEnd").value="",G("planMgmtModal")}async function ls(){const e=document.getElementById("planUserId").value,t=document.getElementById("planStatus").value,n=document.getElementById("planTrialEnd").value,a={plan:t};t==="trial"&&n?a.trial_ends_at=n:t!=="trial"&&(a.trial_ends_at=null),M(!0);const{error:i}=await y.from("users").update(a).eq("id",e);if(M(!1),i)return x("Hata: "+i.message);x(`Plan güncellendi: ${{trial:"Deneme",active:"Aktif",paused:"Duraklatıldı",cancelled:"İptal"}[t]||t} ✓`),q("planMgmtModal"),Xe()}let tt=[];async function pt(){const e=document.getElementById("view-dev-resources"),{data:t}=await y.from("resources").select("*").order("resource_type,exam_type,subject,name");tt=t||[];const n=tt.filter(i=>i.resource_type!=="playlist"),a=tt.filter(i=>i.resource_type==="playlist");e.innerHTML=`
    ...
    <div class="stats-row" style="margin-bottom:20px">
      ...
      <div class="stat-card"><div class="stat-label">Toplam Kaynak</div><div class="stat-val">${tt.length}</div></div>
    </div>
    ...
    </div>`}function ds(){let e=document.getElementById("playlistModal");e||(e=document.createElement("div"),e.id="playlistModal",e.className="modal-bg",document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),e.innerHTML=`<div class="modal modal-lg">
...
`).map(r=>r.trim()).filter(Boolean);let o=[];a?o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",url:d[1]||"",topic:"",soru:parseInt(d[2])||0}}):o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",soru:parseInt(d[1])||0}});const s={exam_type:document.getElementById("rmExam").value,subject:t,publisher:document.getElementById("rmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:o,active:document.getElementById("rmActive").value==="true",resource_type:a?"playlist":"book"};n?(await y.from("resources").update(s).eq("id",n),x("Güncellendi ✓")):(await y.from("resources").insert(s),x("Kaynak eklendi ✓")),q("resourceModal"),pt()}async function gs(e){await ie("Bu kaynağı silmek istediğinizden emin misiniz?")&&(await y.from("resources").delete().eq("id",e),x("Silindi"),pt())}async function mt(){const e=document.getElementById("view-dev-finance"),[{data:t},{data:n}]=await Promise.all([y.from("subscriptions").select("*,users(full_name,color)").order("created_at",{ascending:!1}),y.from("payments").select("*,users(full_name)").order("payment_date",{ascending:!1}).limit(20)]),a=(n||[]).filter(o=>o.status==="completed").reduce((o,s)=>o+Number(s.amount),0),i=(t||[]).filter(o=>o.status==="active").length;e.innerHTML=`
    ...
    </div>`}async function vs(e){const{error:t}=await y.from("payments").update({verified:!0}).eq("id",e);if(t){x("Onaylanamadı: "+t.message);return}x("✓ Ödeme doğrulandı"),mt()}function fs(){let e=document.getElementById("paymentModal");e||(e=document.createElement("div"),e.id="paymentModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('paymentModal')">×</button>
      <h2>Ödeme Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pmStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),G("paymentModal")}async function ys(){const e=parseFloat(document.getElementById("pmAmount").value);if(!e)return x("Tutar girin!");await y.from("payments").insert({student_id:document.getElementById("pmStudent").value,amount:e,method:document.getElementById("pmMethod").value,payment_date:document.getElementById("pmDate").value,description:document.getElementById("pmDesc").value,status:"completed"}),x("Ödeme kaydedildi ✓"),q("paymentModal"),mt()}function xs(){let e=document.getElementById("subModal");e||(e=document.createElement("div"),e.id="subModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('subModal')">×</button>
      <h2>Abonelik Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("sbStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),G("subModal")}async function bs(){const e=parseFloat(document.getElementById("sbAmount").value);if(!e)return x("Tutar girin!");await y.from("subscriptions").insert({student_id:document.getElementById("sbStudent").value,plan:document.getElementById("sbPlan").value,amount:e,start_date:document.getElementById("sbStart").value,end_date:document.getElementById("sbEnd").value||null,status:document.getElementById("sbStatus").value,notes:document.getElementById("sbNotes").value}),x("Abonelik eklendi ✓"),q("subModal"),mt()}async function ut(){const e=document.getElementById("view-dev-announce"),{data:t}=await y.from("announcements").select("*").order("created_at",{ascending:!1}),n={info:"var(--blue)",warning:"var(--accent)",success:"var(--green)",urgent:"var(--red)"};e.innerHTML=`
    ...
    ${(t||[]).map(a=>`
      ...
      </div>`).join("")}`}function hs(){let e=document.getElementById("announceModal");e||(e=document.createElement("div"),e.id="announceModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('announceModal')">×</button>
      <h2>Yeni Duyuru</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),G("announceModal")}async function ks(){const e=document.getElementById("anTitle").value.trim(),t=document.getElementById("anBody").value.trim();if(!e||!t)return x("Başlık ve içerik zorunlu!");await y.from("announcements").insert({title:e,body:t,type:document.getElementById("anType").value,target:document.getElementById("anTarget").value,active:!0}),x("Duyuru yayınlandı ✓"),q("announceModal"),ut()}async function ws(e,t){await y.from("announcements").update({active:t}).eq("id",e),ut()}async function $s(e){await ie("Bu duyuruyu silmek istediğinizden emin misiniz?")&&(await y.from("announcements").delete().eq("id",e),x("Silindi"),ut())}let qe=null,$t=null,me=null,jt=null,Ue=[],ve=[],_e="welcome";async function Qe(){const e=document.getElementById("view-dev-tickets");if(!e)return;const{data:t,error:n}=await y.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").order("updated_at",{ascending:!1});Ue=t||[],!me&&Ue.length>0&&(me=Ue[0].id),e.innerHTML=`
  ...
  `,Ts(),jt&&clearInterval(jt),jt=setInterval(_s,4e3)}function Es(e){me=e,Qe()}async function _s(){if(!me||!document.getElementById("devChatArea"))return;const{data:t,error:n}=await y.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").eq("id",me).single();if(n||!t)return;let a=[];try{a=JSON.parse(t.body),Array.isArray(a)||(a=[{sender:"user",text:t.body,time:t.created_at}])}catch{a=[{sender:"user",text:t.body,time:t.created_at}]}const i=document.getElementById("devChatMessages");if(i){const o=i.scrollTop,s=i.scrollHeight-i.clientHeight-o<40;i.innerHTML=a.map(r=>{const d=r.sender==="emin",c=d?"Kurucu / Destek":r.sender==="ai"?"Yapay Zeka":r.name||"Kullanıcı",p=d?"var(--blue)":r.sender==="ai"?"var(--surface2)":"var(--accent)",m=d?"#fff":r.sender==="ai"?"var(--text)":"var(--on-accent)",u=d?"flex-end":"flex-start",g=d?"14px 14px 4px 14px":"14px 14px 14px 4px",_=new Date(r.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join(""),s&&(i.scrollTop=i.scrollHeight)}}function Ts(){var s,r,d;const e=document.getElementById("devChatArea");if(!e)return;const t=Ue.find(c=>c.id===me);if(!t){e.innerHTML=`
  ...
  `;const o=document.getElementById("devChatMessages");o&&(o.scrollTop=o.scrollHeight)}async function Ss(){const e=document.getElementById("devReplyInput"),t=e.value.trim();if(!t||!me)return;e.value="",M(!0);const{data:n}=await y.from("tickets").select("body").eq("id",me).single();let a=[];if(n&&n.body)try{a=JSON.parse(n.body)}catch{a=[{sender:"user",text:n.body,time:new Date().toISOString()}]}const i={sender:"emin",text:t,time:new Date().toISOString(),name:"Kurucu / Destek"};a.push(i);const{error:o}=await y.from("tickets").update({body:JSON.stringify(a),reply:t,status:"resolved",updated_at:new Date().toISOString()}).eq("id",me);if(M(!1),o){x("Hata: "+o.message);return}x("Yanıt gönderildi ✓"),Qe()}async function Is(e,t){await y.from("tickets").update({status:t,updated_at:new Date().toISOString()}).eq("id",e),x("Durum güncellendi ✓"),Qe()}async function Bs(e){await ie("Bu talebi silmek istediğinizden emin misiniz?")&&(await y.from("tickets").delete().eq("id",e),x("Silindi"),me=null,Qe())}function zs(){Dt()}async function Dt(){let e=document.getElementById("supportChatModal");e||(e=document.createElement("div"),e.id="supportChatModal",e.className="modal-bg",e.style.zIndex="99999999",e.innerHTML=`
    ...
    `,document.body.appendChild(e),e.addEventListener("click",t=>{var a;const n=(a=document.getElementById("trialExpiredModal"))==null?void 0:a.classList.contains("open");t.target===e&&!n&&wa()})),G("supportChatModal"),await Et(),qe&&clearInterval(qe),qe=setInterval(Et,4e3)}function wa(){q("supportChatModal"),qe&&(clearInterval(qe),qe=null)}async function Et(){var o,s;const e=(o=b.dbUser)==null?void 0:o.id;if(!e)return;const t=document.getElementById("supportMessages");if(!t)return;const{data:n,error:a}=await y.from("tickets").select("*").eq("user_id",e).eq("status","open").order("created_at",{ascending:!1}).limit(1);if(a){console.error("Error fetching ticket:",a);return}const i=n&&n[0];if(i){$t=i.id,_e="emin";const r=document.getElementById("supportStatusLabel");r&&(r.textContent="● Kurucu / Destek Ekibi");let d=[];try{d=JSON.parse(i.body),Array.isArray(d)||(d=[{sender:"user",text:i.body,time:i.created_at}])}catch{d=[{sender:"user",text:i.body,time:i.created_at}]}i.reply&&((s=d[d.length-1])==null?void 0:s.text)!==i.reply&&d.push({sender:"emin",text:i.reply,time:i.updated_at}),ot(d)}else if(_e==="welcome"){const r=document.getElementById("supportStatusLabel");r&&(r.textContent="● Çevrimiçi Asistan"),t.innerHTML=`
    ...
    `}).join(""),a&&(t.scrollTop=t.scrollHeight)}function Ms(){_e="ai",ve=[{sender:"ai",text:"Merhaba! Ben Rostrum Akademi Yapay Zeka Asistanıyım. 🤖 Size nasıl yardımcı olabilirim?",time:new Date().toISOString()}],ot(ve)}function Ds(){_e="emin_start";const e=document.getElementById("supportMessages");e&&(e.innerHTML=`
      <div style="text-align:center;padding:40px 20px">
    ...
    </div>`,i.appendChild(s)}),document.body.appendChild(i),setTimeout(()=>i.remove(),8e3)}(()=>{const e=document.createElement("style");e.textContent=".role-dev{background:rgba(192,132,252,.15);color:#c084fc;}",document.head.appendChild(e)})();function Ea(e){return`ra_ob_${b.coachId}_${e}`}function Ut(e){return localStorage.getItem(Ea(e))==="1"}function Ls(e){localStorage.setItem(Ea(e),"1"),_a(),["student","program","report"].every(n=>Ut(n))&&Ps()}async function Ps(){const e=document.getElementById("obWidget");e&&(e.innerHTML=`<div style="padding:20px;text-align:center">
    ...
    </div>`,setTimeout(()=>e.remove(),3e3)),await y.from("workspaces").update({onboarding_done:!0}).eq("coach_id",b.coachId),l.workspace&&(l.workspace.onboarding_done=!0)}function _a(){const e=document.getElementById("obWidget");if(!e)return;const t=[{id:"student",icon:"👤",label:"İlk öğrencinizi ekleyin",action:"window.openStudentModal?.()",btnLabel:"Ekle →"},{id:"program",icon:"📅",label:"Haftalık program oluşturun",action:"switchTab('program')",btnLabel:"Git →"},{id:"report",icon:"📄",label:"İlk raporunuzu gönderin",action:"switchTab('program')",btnLabel:"Git →"}],n=t.filter(i=>Ut(i.id)).length,a=Math.round((n+1)/(t.length+1)*100);e.querySelector(".ob-body").innerHTML=t.map(i=>{const o=Ut(i.id);return`<div style="display:flex;align-items:center;gap:10px;padding:9px 0;border-bottom:1px solid var(--border)">
  ...
  </div>`}let Pe=0;const U={};async function Rs(){const e=l.students.find(i=>i.id===b.studentId);if(!e)return;const t=e.name.split(" ")[0],n=e.color||"var(--accent)";U={};try{const{data:i}=await y.from("student_profiles").select("*").eq("id",b.studentId).maybeSingle();i&&(U.parent_email=i.parent_email||"",U.parent_phone=i.parent_phone||"",U.target_rank=i.target_rank||"",U.target_university=i.target_university||"",U.target_department=i.target_department||"",U.struggling_subjects=i.struggling_subjects||"",U.daily_capacity=i.daily_capacity||8)}catch{}U.yks_area=e.yks_area||"SAY",U.daily_capacity===void 0&&(U.daily_capacity=8);let a=document.getElementById("stuWelcomeModal");a||(a=document.createElement("div"),a.id="stuWelcomeModal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.85);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(8px)",document.body.appendChild(a)),Pe=0,Sa(a,t,n,e)}function Ee(e){const t=document.getElementById("sw_err");t&&(t.textContent=e,t.style.display="block",setTimeout(()=>{t&&(t.style.display="none")},5e3))}function Sa(e,t,n,a){const i="width:100%;padding:12px 14px;background:var(--surface2);border:1.5px solid var(--border);border-radius:10px;color:var(--text);font-size:14px;outline:none;font-family:inherit;box-sizing:border-box",o="font-size:11px;font-weight:700;color:var(--text-mid);display:block;margin-bottom:5px;text-transform:uppercase;letter-spacing:.05em",s="font-size:11px;color:var(--text-dim);margin-top:5px;line-height:1.5",r=[{v:"SAY",ico:"🔬",name:"Sayısal",sub:"Mat · Fen"},{v:"EA",ico:"⚖️",name:"Eşit Ağırlık",sub:"Mat · Edb"},{v:"SOZ",ico:"📖",name:"Sözel",sub:"Edb · Sosyal"},{v:"DIL",ico:"🌍",name:"Dil",sub:"Yabancı Dil"}],d=[()=>`<div style="text-align:center">
    ...
    </div>`],c=Pe>0?`<div style="height:3px;background:var(--border);border-radius:99px;margin-bottom:24px;overflow:hidden"><div style="height:100%;width:${Math.round(Pe/3*100)}%;background:${n};transition:width .4s"></div></div>`:"";e.innerHTML=`<div style="background:var(--surface);border:1px solid var(--border2);border-radius:24px;width:100%;max-width:460px;padding:32px;animation:fadeUp .3s ease;max-height:90vh;overflow-y:auto;box-shadow:var(--shadow-lg)">
    ${c}
    ${d[Pe]()}
  </div>`;const p=()=>e.querySelectorAll(".sw-area").forEach(u=>{const g=u.classList.contains("sel");u.style.borderColor=g?n:"var(--border)",u.style.background=g?`color-mix(in srgb, ${n} 10%, var(--surface2))`:"var(--surface2)"});e.querySelectorAll(".sw-area").forEach(u=>u.addEventListener("click",p)),p();const m=u=>{const g=u.classList.contains("sel");u.style.background=g?n:"var(--surface2)",u.style.borderColor=g?n:"var(--border)",u.style.color=g?"#fff":"var(--text)"};e.querySelectorAll(".sw-chip").forEach(u=>{m(u),u.addEventListener("click",function(){m(this)})})}window.maskPhoneTR=function(e){let t=e.value.replace(/\D/g,"");t.length>0&&!t.startsWith("0")&&(t="0"+t);let n="";t.length>0&&(n="0"),t.length>1&&(n+=" ("+t.substring(1,4)),t.length>=4&&(n+=")"),t.length>4&&(n+=" "+t.substring(4,7)),t.length>7&&(n+=" "+t.substring(7,9)),t.length>9&&(n+=" "+t.substring(9,11)),e.value=n};window._swNext=function(){var n,a,i,o,s,r,d,c,p,m,u;const e=document.getElementById("stuWelcomeModal");if(!e)return;if(Pe===1){const g=(a=(n=e.querySelector(".sw-area.sel"))==null?void 0:n.dataset)==null?void 0:a.v;if(!g){Ee("Lütfen hazırlık alanınızı seçin.");return}U.yks_area=g}if(Pe===2){const g=(o=(i=document.getElementById("sw_rank"))==null?void 0:i.value)==null?void 0:o.trim();if(!g){Ee("Lütfen hedef sıralamanızı girin.");return}const _=parseInt(g);if(isNaN(_)||_<=0||_>=5e6){Ee("Lütfen geçerli bir hedef sıralaması girin.");return}U.target_rank=_;const f=(((r=(s=document.getElementById("sw_uni"))==null?void 0:s.value)==null?void 0:r.trim())||"").split("-");U.target_university=((d=f[0])==null?void 0:d.trim())||"",U.target_department=((c=f[1])==null?void 0:c.trim())||"",U.struggling_subjects=((m=(p=document.getElementById("sw_struggle"))==null?void 0:p.value)==null?void 0:m.trim())||""}Pe++;const t=l.students.find(g=>g.id===b.studentId);Sa(e,((u=t==null?void 0:t.name)==null?void 0:u.split(" ")[0])||"",(t==null?void 0:t.color)||"var(--accent)",t)};window._swSkip=function(){var e;(e=document.getElementById("stuWelcomeModal"))==null||e.remove(),y.from("student_profiles").upsert({id:b.studentId}).then(()=>{})};window._swSave=async function(){var a,i,o,s,r,d;const e=((i=(a=document.getElementById("sw_pmail"))==null?void 0:a.value)==null?void 0:i.trim())||"",t=((s=(o=document.getElementById("sw_pphone"))==null?void 0:o.value)==null?void 0:s.trim())||"",n=parseInt((r=document.getElementById("sw_hours"))==null?void 0:r.value)||8;if(!e){Ee("Lütfen velinizin e-posta adresini girin.");return}if(!e.includes("@")){Ee("Geçerli bir veli e-posta adresi girin.");return}if(!t||t.replace(/\D/g,"").length<10){Ee("Lütfen geçerli bir veli telefon numarası girin.");return}M(!0,"Kaydediliyor...");try{await y.from("users").update({yks_area:U.yks_area}).eq("id",b.studentId);const c=l.students.find(u=>u.id===b.studentId);c&&(c.yksArea=U.yks_area);const p={id:b.studentId,target_rank:U.target_rank,target_university:U.target_university||"",target_department:U.target_department||"",struggling_subjects:U.struggling_subjects||"",parent_email:e,parent_phone:t,daily_capacity:n,onboarding_done:!0};let{error:m}=await y.from("student_profiles").upsert(p);if(m&&/column/i.test(m.message||"")&&({error:m}=await y.from("student_profiles").upsert({id:p.id,target_university:p.target_university,target_department:p.target_department,struggling_subjects:p.struggling_subjects,daily_capacity:p.daily_capacity,bio:`Hedef sıralama: ${p.target_rank} · Veli: ${e} / ${t}`})),m)return M(!1),Ee("Kaydedilemedi: "+m.message)}catch(c){return M(!1),Ee("Kaydedilemedi: "+(c.message||c))}M(!1),(d=document.getElementById("stuWelcomeModal"))==null||d.remove(),x("Profilin başarıyla kaydedildi! 🎉"),se("sportal")};let Rt=null;window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),Rt=e;const t=document.createElement("button");t.id="pwaInstallBtn",t.className="btn btn-ghost btn-sm",t.innerHTML="📲 Yükle",t.style.cssText="font-size:11px;padding:5px 10px",t.onclick=async()=>{Rt.prompt();const{outcome:a}=await Rt.userChoice;a==="accepted"&&(t.remove(),x("Uygulama yüklendi ✓"))};const n=document.querySelector(".tbar-right");n&&n.insertBefore(t,document.querySelector(".user-pill"))});async function Ia(){const e=l.students.find(B=>B.id===b.studentId);if(!e)return;const t=document.getElementById("view-sprofil");if(!t)return;const{data:n,error:a}=await y.from("student_profiles").select("*").eq("id",b.studentId).maybeSingle();a&&console.error("Öğrenci profili yüklenirken hata:",a);const i=(n==null?void 0:n.bio)||"",o=(n==null?void 0:n.school)||"",s=(n==null?void 0:n.grade)||"",r=(n==null?void 0:n.target_university)||"",d=(n==null?void 0:n.target_department)||"",c=(n==null?void 0:n.struggling_subjects)||"",p=(n==null?void 0:n.daily_capacity)||"",m=l.exams.filter(B=>B.studentId===e.id).sort((B,E)=>B.date.localeCompare(E.date)),u=m[m.length-1],g=u?(EXAM_DEFS[u.type]||[]).reduce((E,A)=>{var C;return E+Number(((C=u.nets)==null?void 0:C[A])||0)},0).toFixed(1):"—",_=ne(0,e.weekStart??0);let T=0,f=0;for(let B=0;B<7;B++){const E=l.tasks[`${e.id}_${O(J(_,B))}`]||[];T+=E.length,f+=E.filter(A=>A.done).length}const $=T>0?Math.round(f/T*100):0;let k=0;if(Object.keys(l.tasks).filter(B=>B.startsWith(e.id+"_")).forEach(B=>{k+=l.tasks[B].filter(E=>E.done).length}),m.length===0&&k===0){t.innerHTML=`<div style="text-align:center;padding:60px 24px;max-width:360px;margin:0 auto">
      ...
      <div style="display:flex;flex-direction:column;gap:10px;text-align:left">
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px 16px;font-size:13px;display:flex;align-items:center;gap:12px"><span style="font-size:20px">📈</span><span>Deneme netlerini girdikçe grafiklerin oluşacak</span></div>
    ...
    </div>`;return}if(m.length>0){const B=m.slice(-6),E=Math.max(...B.map(A=>(EXAM_DEFS[A.type]||[]).reduce((L,w)=>{var D;return L+Number(((D=A.nets)==null?void 0:D[w])||0)},0)),1);`${B.map(A=>{const L=(EXAM_DEFS[A.type]||[]).reduce((H,F)=>{var V;return H+Number(((V=A.nets)==null?void 0:V[F])||0)},0),w=Math.max(Math.round(L/E*100),4),D=B[B.indexOf(A)-1],P=D?(EXAM_DEFS[D.type]||[]).reduce((H,F)=>{var V;return H+Number(((V=D.nets)==null?void 0:V[F])||0)},0):L,j=L>P?"↑":L<P?"↓":"",Y=L>P?"var(--green)":L<P?"var(--red)":"var(--text-dim)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
              <div style="font-size:10px;font-weight:700;color:var(--text-mid)">${L.toFixed(0)}</div>
              <div style="font-size:9px;color:${Y};font-weight:800">${j}</div>
              <div style="width:100%;background:${e.color};border-radius:4px 4px 0 0;height:${w}%;min-height:4px"></div>
            ...
            </div>`}).join("")}`}if(m.length>0){const B=u.type,A=(EXAM_DEFS[B]||[]).map(C=>{var P;const L=m.filter(j=>j.type===B).map(j=>{var Y;return Number(((Y=j.nets)==null?void 0:Y[C])||0)}),w=L.length?L.reduce((j,Y)=>j+Y,0)/L.length:0,D=Number(((P=u.nets)==null?void 0:P[C])||0);return{f:C,avg:w.toFixed(1),last:D,color:qt(D)}});`${B}${A.map(C=>`
            ...
            </div>`).join("")}`}const z=l.appointments.filter(B=>B.studentId===e.id&&B.date>=ue()).sort((B,E)=>B.date.localeCompare(E.date)).slice(0,3),h=r||d;n!=null&&n.motivation;const S=m.slice(-7),I=Math.max(...S.map(B=>(EXAM_DEFS[B.type]||[]).reduce((A,C)=>{var L;return A+Number(((L=B.nets)==null?void 0:L[C])||0)},0)),1);t.innerHTML=`
    <!-- HERO -->
    ...
    <div class="card cp" style="margin-bottom:14px">
      ...
      <div style="position:relative;height:160px;display:flex;align-items:flex-end;gap:6px;padding-bottom:28px">
        ...
        ${[.25,.5,.75,1].map(B=>`
          <div style="position:absolute;left:0;right:0;bottom:${28+Math.round(B*132)}px;border-top:1px dashed var(--border);display:flex;align-items:center">
            <span style="position:absolute;right:0;font-size:9px;color:var(--text-dim);background:var(--surface);padding:0 2px;line-height:1">${Math.round(I*B)}</span>
          </div>`).join("")}
        ${S.map((B,E)=>{const C=(EXAM_DEFS[B.type]||[]).reduce((F,V)=>{var Z;return F+Number(((Z=B.nets)==null?void 0:Z[V])||0)},0),L=Math.max(Math.round(C/I*132),4),w=S[E-1],D=w?(EXAM_DEFS[w.type]||[]).reduce((F,V)=>{var Z;return F+Number(((Z=w.nets)==null?void 0:Z[V])||0)},0):C,P=C>D,j=C<D,Y=P?"var(--green)":j?"var(--red)":e.color,H=v(B.name.replace(/deneme|tyt|ayt/gi,"").trim()).slice(0,10)||"#"+(E+1);return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:0;position:relative">
    ...
    <div class="card cp" style="margin-bottom:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${(()=>{const B=EXAM_DEFS[u.type]||[],E=m.filter(C=>C.type===u.type),A=Math.max(...B.map(C=>Math.max(...E.map(L=>{var w;return Number(((w=L.nets)==null?void 0:w[C])||0)}))),1);return B.map(C=>{var Y;const L=Number(((Y=u.nets)==null?void 0:Y[C])||0),w=E.map(H=>{var F;return Number(((F=H.nets)==null?void 0:F[C])||0)}),D=w.length?w.reduce((H,F)=>H+F,0)/w.length:0,P=Math.round(L/A*100),j=L>=D*1.1?"var(--green)":L<D*.9?"var(--red)":e.color;return`<div style="display:flex;align-items:center;gap:10px">
              ...
              <div style="flex:1;height:8px;background:var(--surface2);border-radius:99px;overflow:hidden">
                <div style="height:100%;width:${P}%;background:${j};border-radius:99px;transition:width .5s"></div>
              </div>
              <div style="width:36px;text-align:right;font-size:13px;font-weight:800;color:${j};flex-shrink:0">${L.toFixed(1)}</div>
      ...
      ${z.map(B=>`
        <div style="display:flex;align-items:center;gap:12px;background:var(--surface2);border-left:3px solid ${e.color};border-radius:9px;padding:12px;margin-bottom:6px">
          <div style="text-align:center;flex-shrink:0">
            <div style="font-size:18px;font-weight:800;color:var(--text)">${new Date(B.date+"T12:00").getDate()}</div>
            <div style="font-size:9px;font-weight:700;color:var(--text-dim);text-transform:uppercase">${new Date(B.date+"T12:00").toLocaleDateString("tr-TR",{month:"short"})}</div>
          </div>
          <div style="flex:1">
            <div style="font-size:13px;font-weight:700">${v(B.type)}</div>
            <div style="font-size:11px;color:var(--text-mid);margin-top:2px">${B.time} · ${B.duration} dk</div>
          </div>
          ${B.meet_link?`<a href="${v(B.meet_link)}" target="_blank" style="font-size:11px;background:var(--blue-dim);color:var(--blue);padding:4px 10px;border-radius:8px;text-decoration:none;font-weight:700">Katıl</a>`:""}
        </div>`).join("")}
    </div>`:""}
    ...
    <div class="card cp" style="margin-bottom:14px" id="spViewCard">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
        ${[["Okul",o],["Sınıf",s],["Hedef Üniversite",r],["Hedef Bölüm",d],["Zorlandığım Dersler",c],["Günlük Kapasite",p?p+" saat":""]].map(([B,E])=>`
          <div>
            <div style="font-size:10px;font-weight:700;color:var(--text-dim);text-transform:uppercase;letter-spacing:.04em;margin-bottom:3px">${B}</div>
    ...
    <div class="card cp" style="margin-bottom:14px;display:none" id="spEditCard">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px">
        ${[["spSchool","Okul","text",o,"Okulunuz"],["spGrade","Sınıf / Seviye","text",s,"12. Sınıf, Mezun"],["spTargetUni","Hedef Üniversite","text",r,"Boğaziçi Üniversitesi"],["spTargetDept","Hedef Bölüm","text",d,"Bilgisayar Mühendisliği"],["spStruggling","Zorlandığım Dersler","text",c,"Fizik, Geometri"],["spCapacity","Günlük Kapasite (Saat)","number",p,"6"]].map(([B,E,A,C,L])=>`
          <div>
            <label style="display:block;font-size:11px;font-weight:700;color:var(--text-mid);margin-bottom:4px">${E}</label>
            <input type="${A}" id="${B}" value="${v(String(C))}" placeholder="${L}" style="width:100%;background:var(--surface2);border:1.5px solid var(--border);border-radius:9px;padding:10px 13px;font-size:14px;color:var(--text);outline:none;box-sizing:border-box">
          </div>`).join("")}
      </div>
      <div style="margin-bottom:12px">
    ...
    <div style="max-width:480px;margin:0 auto;padding:16px">
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:16px">
        ${[{icon:"🎓",label:"Koçum",value:(n==null?void 0:n.full_name)||"—"},{icon:"📅",label:"Kayıt Tarihi",value:u(a)},{icon:"⏳",label:"Kullanım Süresi",value:m!==null?m+" gün":"—"},{icon:"📆",label:"Üyelik Sona Erme",value:u(c)},{icon:"⌛",label:"Kalan Süre",value:p!==null?`<span style="color:${g};font-weight:700">${p} gün</span>`:"—"}].map(({icon:f,label:$,value:k},z,h)=>`
          <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;${z<h.length-1?"border-bottom:1px solid var(--border)":""}">
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:18px;margin-bottom:16px">
        ...
        ${(()=>{const f=c&&a?Math.max(1,Math.ceil((c-a)/864e5)):14,$=Math.min(f,f-p),k=Math.min(100,Math.round($/f*100)),z=p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444";return`
            ...
            <div style="background:var(--surface2);border-radius:6px;height:10px;overflow:hidden">
              <div style="width:${k}%;height:100%;background:${z};border-radius:6px;transition:width .5s ease"></div>
            </div>
          ...
          <div style="background:var(--surface); border:1px solid var(--border); border-radius:12px; padding:24px; box-shadow:var(--shadow-sm);">
            ...
            <div style="margin-bottom:20px;">
              ...
              <div id="cpPhotoDrop" onclick="document.getElementById('cpPhotoFile').click()"
                ...
                <div id="cpPhotoThumb" style="width:60px; height:60px; border-radius:50%; flex-shrink:0; background:${c?`url('${v(c)}') center/cover`:"var(--accent-dim)"}; display:flex; align-items:center; justify-content:center; font-size:22px;">${c?"":"📷"}</div>
                <div style="min-width:0;">
                  <div id="cpPhotoDropText" style="font-size:13px; font-weight:700; color:var(--text);">${c?"Fotoğraf yüklendi ✓":"Sürükleyin veya Dosya Seçin"}</div>
            ...
            <div>
              ...
              <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                ...
                <a href="${g}" id="cpSlugBrowseBtn" target="_blank" class="btn btn-accent" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center; height:37px; padding:0 14px; border-radius:9px; font-size:13px; font-weight:700;" onclick="return browseCoachLink(event)">👁 Gözat</a>
              </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
              <div>
                ...
                <div style="display:flex; align-items:center; background:var(--surface2); border:1.5px solid var(--border); border-radius:9px; padding:0 12px;">
                  ...
                  <input type="text" id="cpInstagram" value="${v(p)}" placeholder="kullaniciadi" oninput="updateProfilePreview()" style="flex:1; background:none; border:none; padding:10px 0; font-size:13.5px; color:var(--text); outline:none;">
                </div>
              </div>
              <div>
                ...
                <input type="text" id="cpLinkedin" value="${v(m)}" placeholder="https://linkedin.com/in/..." oninput="updateProfilePreview()" style="width:100%; background:var(--surface2); border:1.5px solid var(--border); border-radius:9px; padding:10px 13px; font-size:13.5px; color:var(--text); outline:none;">
              </div>
            </div>
          </div>
  ...
  `,cn(),Ke(),document.getElementById("cpEducation")&&(document.getElementById("cpEducation").value=r),document.getElementById("cpExperience")&&(document.getElementById("cpExperience").value=d)}const Bn=["YKS","TYT","AYT","LGS","Sayısal","Eşit Ağırlık","Sözel","Dil","Matematik","Geometri","Fizik","Kimya","Biyoloji","Türkçe","Edebiyat","Tarih","Coğrafya"];function dn(){var e;return(((e=document.getElementById("cpSubjects"))==null?void 0:e.value)||"").split(",").map(t=>t.trim()).filter(Boolean)}function Ks(e){e.stopPropagation();const t=document.getElementById("cpTagDropdownMenu");if(!t)return;const n=t.style.display==="block";t.style.display=n?"none":"block"}window._tagDropdownListenerAdded||(document.addEventListener("click",e=>{const t=document.getElementById("cpTagDropdownMenu"),n=document.getElementById("cpTagSelectBox");t&&t.style.display==="block"&&n&&!n.contains(e.target)&&!t.contains(e.target)&&(t.style.display="none")}),window._tagDropdownListenerAdded=!0);function cn(){const e=document.getElementById("cpSelectedTags"),t=document.getElementById("cpDropdownPresets");if(!e||!t)return;const n=dn();n.length===0?e.innerHTML='<span style="font-size:13px; color:var(--text-dim);">Etiket seçmek için tıklayın...</span>':e.innerHTML=n.map(i=>`
        <span style="display:inline-flex; align-items:center; gap:5px; background:var(--accent); color:#fff; padding:4px 10px; border-radius:99px; font-size:12px; font-weight:700;">
          ${v(i)}
          <span onclick="event.stopPropagation(); toggleCoachTag('${v(i).replace(/'/g,"\\'")}')" style="cursor:pointer; font-weight:800; font-size:10px; opacity:0.8; padding:0 2px;">✕</span>
        </span>
      `).join("");const a=n.filter(i=>!Bn.includes(i));t.innerHTML=[...Bn,...a].map(i=>{const o=n.includes(i);return`
      <button type="button" onclick="toggleCoachTag('${v(i).replace(/'/g,"\\'")}')"
    ...
    `}).join("")}function za(e){const t=document.getElementById("cpSubjects");if(!t)return;let n=dn();n=n.includes(e)?n.filter(a=>a!==e):[...n,e],t.value=n.join(", "),cn(),Ke()}function Ma(){const e=document.getElementById("cpTagCustom");if(!e)return;const t=(e.value||"").trim();if(!t)return;const n=dn();n.includes(t)||(document.getElementById("cpSubjects").value=[...n,t].join(", ")),e.value="",cn(),Ke()}window.toggleTagDropdown=Ks;window.toggleCoachTag=za;window.addCustomCoachTag=Ma;async function Os(e){if(!e)return;if(!e.type.startsWith("image/"))return x("Lütfen bir görsel dosyası seçin");if(e.size>3*1024*1024)return x("Dosya 3 MB'den büyük — daha küçük bir görsel seçin");const t=document.getElementById("cpPhotoDropText"),n=document.getElementById("cpPhotoThumb");t&&(t.textContent="Yükleniyor…");try{const a=(e.name.split(".").pop()||"jpg").toLowerCase().replace(/[^a-z0-9]/g,"")||"jpg",i=`${b.dbUser.id}/avatar_${Date.now()}.${a}`,{error:o}=await y.storage.from("coach-photos").upload(i,e,{upsert:!0,contentType:e.type});if(o)throw o;const{data:s}=y.storage.from("coach-photos").getPublicUrl(i),r=s==null?void 0:s.publicUrl;if(!r)throw new Error("URL alınamadı");document.getElementById("cpPhotoUrl").value=r,n&&(n.style.background=`url('${r}') center/cover`,n.textContent=""),t&&(t.textContent="Fotoğraf yüklendi ✓ — değiştirmek için tıkla"),Ke(),x("Fotoğraf yüklendi ✓")}catch(a){t&&(t.textContent="Yüklenemedi — tekrar dene"),x("Yükleme hatası: "+(a.message||a)+(String(a.message||"").includes("bucket")?" (migration_v26 çalıştırıldı mı?)":""))}}let Ne="",zn=null,Ge=!0;function Fs(){const e=document.getElementById("cpSlug"),t=document.getElementById("cpSlugStatus");let n=(e.value||"").toLowerCase().replace(/ğ/g,"g").replace(/ü/g,"u").replace(/ş/g,"s").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ç/g,"c").replace(/[^a-z0-9-]/g,"-").replace(/-+/g,"-");if(e.value=n,clearTimeout(zn),Ge=!1,!n||n===Ne){t.textContent="",Ge=!0;return}if(n.length<3){t.textContent="en az 3 karakter",t.style.color="var(--text-dim)";return}t.textContent="kontrol ediliyor…",t.style.color="var(--text-dim)",zn=setTimeout(async()=>{try{const{data:a,error:i}=await y.rpc("check_coach_slug",{p_slug:n});if(i){t.textContent="",Ge=!0;return}Ge=!!a,t.textContent=a?"✓ müsait — linki etkinleştirmek için Kaydet'e bas":"✗ bu link alınmış, başka dene",t.style.color=a?"var(--green)":"var(--red)"}catch{t.textContent="",Ge=!0}},450)}function pn(){return Ne?`${window.location.origin}/koc/${Ne}`:`${window.location.origin}/koc_bul.html?coach=${b.dbUser.id}`}function Da(){var t;const e=(((t=document.getElementById("cpSlug"))==null?void 0:t.value)||"").trim().toLowerCase();return e&&e!==(Ne||"")}function Us(){if(Da())return x("Yeni linki önce Kaydet'e basarak etkinleştir");navigator.clipboard.writeText(pn()).then(()=>x("Link kopyalandı ✓")).catch(()=>x("Kopyalanamadı"))}function Gs(e){if(Da())return e&&e.preventDefault(),x("Yeni linki önce Kaydet'e basarak etkinleştir"),!1;const t=document.getElementById("cpSlugBrowseBtn");return t&&(t.href=pn()),!0}function qs(){const e=document.getElementById("cpSlugBrowseBtn");e&&(e.href=pn());const t=document.getElementById("cpSlugStatus");t&&Ne&&(t.textContent="✓ link aktif",t.style.color="var(--green)")}async function Ws(){var o,s,r,d;const e=document.getElementById("cpAiBioBtn"),t=((o=b.dbUser)==null?void 0:o.full_name)||"Koç",n=((s=document.getElementById("cpSubjects"))==null?void 0:s.value)||"",a=((r=document.getElementById("cpEducation"))==null?void 0:r.value)||"",i=((d=document.getElementById("cpExperience"))==null?void 0:d.value)||"";if(!n&&!a&&!i)return ge("AI'nın malzemeye ihtiyacı var — önce uzmanlık, eğitim veya deneyim alanlarından en az birini doldur.");e&&(e.disabled=!0,e.textContent="🤖 Yazıyor…");try{const c=await fetch("/api/ai-chat",{method:"POST",headers:await rt(),body:JSON.stringify({userRole:"coach",messages:[{role:"user",content:`Koç Bul sayfamdaki kamuya açık profilim için "Hakkımda" biyografisi yaz.
Bilgilerim — İsim: ${t}. Uzmanlık: ${n||"-"}. Eğitim: ${a||"-"}. Deneyim/Başarılar: ${i||"-"}.
Kurallar: 1. tekil şahıs ("...yım/...yorum"), veli ve öğrenciye güven veren sıcak-profesyonel ton, 60-90 kelime, tek paragraf, emoji ve başlık YOK, abartılı/uydurma iddia YOK (sadece verdiğim bilgileri kullan). Yalnızca biyografi metnini yaz, başka hiçbir şey ekleme.`}]})}),p=await c.json();if(!c.ok||!p.reply)throw new Error(p.error||"Yanıt alınamadı");document.getElementById("cpBio").value=p.reply.trim().replace(/^["']|["']$/g,""),Ke(),x("Biyografi taslağı hazır — dilediğin gibi düzenleyebilirsin ✓")}catch(c){ge("AI biyografi üretilemedi: "+(c.message||c))}e&&(e.disabled=!1,e.textContent="🤖 AI ile Oluştur")}function ge(e){const t=document.getElementById("cpErr");if(!t)return x(e);t.textContent=e,t.style.display="block",t.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{t.style.display="none"},6e3)}let xt="bio";function Ke(){var u,g,_,T,f,$,k,z;const e=((u=document.getElementById("cpPhotoUrl"))==null?void 0:u.value.trim())||"",t=((g=document.getElementById("cpSubjects"))==null?void 0:g.value.trim())||"",n=((_=document.getElementById("cpBio"))==null?void 0:_.value.trim())||"",a=((T=document.getElementById("cpEducation"))==null?void 0:T.value.trim())||"",i=((f=document.getElementById("cpExperience"))==null?void 0:f.value.trim())||"",o=(($=document.getElementById("cpInstagram"))==null?void 0:$.value.trim())||"",s=((k=document.getElementById("cpLinkedin"))==null?void 0:k.value.trim())||"",r=((z=b.dbUser)==null?void 0:z.full_name)||"Koç",d=document.getElementById("prevAvatar");if(d)if(e)d.style.backgroundImage=`url('${e}')`,d.style.backgroundColor="transparent",d.innerHTML="";else{d.style.backgroundImage="",d.style.backgroundColor="var(--accent-dim)";const h=r.split(" ").map(S=>S[0]).join("").slice(0,2).toUpperCase();d.innerHTML=h||"?"}const c=document.getElementById("prevSocials");if(c){let h="";if(o&&(h+=`<a href="https://instagram.com/${o}" target="_blank" class="preview-social-link" title="Instagram">📸 @${o}</a>`),s){let S="LinkedIn";s.includes("/in/")&&(S="in/"+s.split("/in/")[1].split("/")[0]),h+=`<a href="${s}" target="_blank" class="preview-social-link" title="LinkedIn">💼 ${S}</a>`}c.innerHTML=h}const p=document.getElementById("prevSubjects");if(p)if(t){const h=t.split(",").map(S=>S.trim()).filter(Boolean);p.innerHTML=h.map(S=>`<span class="preview-tag">${v(S)}</span>`).join("")}else p.innerHTML='<span class="preview-tag" style="background:none; border:1px dashed var(--border); color:var(--text-dim)">Ders / Uzmanlık Belirtilmedi</span>';const m=document.getElementById("prevTabContent");if(m){let h="";xt==="bio"?h=n||"Biyografi bilgisi henüz girilmedi.":xt==="edu"?h=a||"Eğitim bilgisi henüz girilmedi.":xt==="exp"&&(h=i||"Deneyim/başarılar henüz girilmedi."),m.innerHTML=Aa(v(h))}}function Vs(e){xt=e;const t=document.getElementById("btn-prev-bio"),n=document.getElementById("btn-prev-edu"),a=document.getElementById("btn-prev-exp");t&&t.classList.toggle("active",e==="bio"),n&&n.classList.toggle("active",e==="edu"),a&&a.classList.toggle("active",e==="exp"),Ke()}function Aa(e){return e.replace(/\n/g,"<br>")}async function Zs(){var m;const e=b.dbUser.id,t=document.getElementById("cpBio").value.trim(),n=document.getElementById("cpSubjects").value.trim(),a=document.getElementById("cpEducation").value.trim(),i=document.getElementById("cpExperience").value.trim(),o=document.getElementById("cpPhotoUrl").value.trim(),s=document.getElementById("cpInstagram").value.trim(),r=document.getElementById("cpLinkedin").value.trim(),d=(((m=document.getElementById("cpSlug"))==null?void 0:m.value)||"").trim();if(!o)return ge("Profil fotoğrafı zorunlu — velilerin en çok baktığı güven sinyali.");if(!n)return ge("En az bir uzmanlık etiketi seç.");if(t.length<30)return ge('Biyografi en az 30 karakter olmalı — "AI ile Oluştur" butonunu kullanabilirsin.');if(!a)return ge("Eğitim bilgini gir (örn: Muğla Sıtkı Koçman Üniversitesi - Tıp Fakültesi).");if(!i)return ge("Deneyim/başarı bilgini gir (örn: YKS 2025 Sayısal 9.805.lik).");if(d&&d.length<3)return ge("Profil linki en az 3 karakter olmalı.");if(d&&!Ge)return ge("Bu profil linki alınmış — başka bir tane dene.");const c={id:e,bio:t,subjects:n,education:a,experience:i,photo_url:o,instagram:s,linkedin:r,slug:d||null,updated_at:new Date().toISOString()};localStorage.setItem(`coach_profile_${e}`,JSON.stringify(c));let{error:p}=await y.from("coach_profiles").upsert(c);if(p&&/slug/i.test(p.message||"")&&/column/i.test(p.message||"")){const{slug:u,...g}=c;({error:p}=await y.from("coach_profiles").upsert(g)),p||x("Profil kaydedildi — link için migration_v26 gerekli")}if(p){if(/duplicate|unique/i.test(p.message||""))return ge("Bu profil linki az önce başkası tarafından alındı — farklı bir tane dene.");console.warn("Database save failed, profile saved locally in localStorage:",p),x("Profil yerel tarayıcıya kaydedildi (Veritabanı hatası: "+p.message+")")}else Ne=(d||"").toLowerCase(),qs(),x("Profil başarıyla güncellendi ✓")}async function mn(){const e=document.getElementById("view-dev-matches");if(!e)return;e.innerHTML='<div class="loading">Eşleşmeler yükleniyor...</div>';const{data:t,error:n}=await y.from("match_requests").select("*, matched_coach:matched_coach_id(full_name, username)").order("created_at",{ascending:!1});if(n){e.innerHTML=`<div style="padding:20px;color:var(--red)">Eşleşme başvuruları yüklenirken hata oluştu: ${v(n.message)}</div>`;return}const a={pending:"⏳ Bekliyor",matched:"🤝 Eşleştirildi",completed:"✅ Tamamlandı"},i={pending:"rgba(240, 165, 0, 0.15)",matched:"rgba(96, 180, 255, 0.15)",completed:"rgba(62, 207, 142, 0.15)"},o={pending:"var(--accent)",matched:"var(--accent4)",completed:"var(--green)"};e.innerHTML=`
  ...
  `}async function Js(e,t){const{error:n}=await y.from("match_requests").update({status:t}).eq("id",e);n?x("Durum güncellenirken hata: "+n.message):(x("Durum güncellendi ✓"),mn())}async function Xs(e){const t=l.students.find(s=>s.id===e);if(!t)return;const{data:n}=await y.from("student_speeds").select("*").eq("student_id",e),a={};(n||[]).forEach(s=>{a[`${s.exam_type}_${s.subject}`]=s.secs_per_question});const i=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];let o=document.getElementById("speedModal");o||(o=document.createElement("div"),o.id="speedModal",o.className="modal-bg",document.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&o.classList.remove("open")})),o.innerHTML=`<div class="modal modal-lg">
  ...
  </div>`,G("speedModal")}async function Qs(e){const t=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];for(const{exam:n,sub:a}of t){const i=`${n}_${a}`,o=document.getElementById("spd_"+i);if(!o)continue;const s=parseInt(o.value)||180;await oa(e,n,a,s)}q("speedModal"),x("Hız ayarları kaydedildi ✓")}async function er(e){const t=l.students.find(o=>o.id===e);if(!t)return;const{data:n}=await y.from("student_notes").select("notes").eq("coach_id",b.coachId).eq("student_id",e).maybeSingle(),a=(n==null?void 0:n.notes)||"";let i=document.getElementById("studentNotesModal");i||(i=document.createElement("div"),i.id="studentNotesModal",i.className="modal-bg",document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")})),i.innerHTML=`<div class="modal">
  ...
  </div>`,G("studentNotesModal")}async function tr(e){const t=document.getElementById("studentNoteText").value,{error:n}=await y.from("student_notes").upsert({coach_id:b.coachId,student_id:e,notes:t,updated_at:new Date().toISOString()},{onConflict:"coach_id,student_id"});if(n){x("Not kaydedilemedi: "+n.message);return}x("Not kaydedildi ✓"),q("studentNotesModal")}function nr(e){let t=document.getElementById("reportModal");t||(t=document.createElement("div"),t.id="reportModal",t.className="modal-bg",t.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.classList.remove("open")}),document.getElementById("rpPeriod").addEventListener("change",function(){document.getElementById("rpCustomDates").style.display=this.value==="custom"?"":"none"})),document.getElementById("rpStuId").value=e;const n=new Date,a=new Date(n.getFullYear(),n.getMonth(),1);document.getElementById("rpStart").value=O(a),document.getElementById("rpEnd").value=O(n),document.getElementById("rpNote").value="",G("reportModal")}function un(){const e=document.getElementById("rpPeriod").value,t=new Date;if(e==="weekly"){const n=ne(0,0);return{start:O(n),end:O(J(n,6))}}else return e==="monthly"?{start:O(new Date(t.getFullYear(),t.getMonth(),1)),end:O(t)}:{start:document.getElementById("rpStart").value,end:document.getElementById("rpEnd").value}}function gn(e,t=!1){var h,S,I,B;const n=l.students.find(E=>E.id===e);if(!n)return"";const{start:a,end:i}=un(),o=document.getElementById("rpNote").value.trim(),s=((h=l.workspace)==null?void 0:h.brand_name)||"Rostrum Akademi",r=((S=l.workspace)==null?void 0:S.brand_color)||"#E8613A",d=((I=b.dbUser)==null?void 0:I.full_name)||"Koç",c=[],p=new Date(a);for(;O(p)<=i;){const E=`${e}_${O(p)}`;(l.tasks[E]||[]).forEach(A=>c.push({...A,date:O(p)})),p.setDate(p.getDate()+1)}const m=c.length,u=c.filter(E=>E.done).length,g=m>0?Math.round(u/m*100):0,_=c.filter(E=>E.done).reduce((E,A)=>E+Number(A.duration||0),0),T={};c.forEach(E=>{const A=E.subject||"Diğer";T[A]||(T[A]={total:0,done:0}),T[A].total++,E.done&&T[A].done++});const f=l.exams.filter(E=>E.studentId===e&&E.date>=a&&E.date<=i).sort((E,A)=>E.date.localeCompare(A.date)),$=l.appointments.filter(E=>E.studentId===e&&E.date>=a&&E.date<=i).sort((E,A)=>E.date.localeCompare(A.date)),k=`${new Date(a+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})} – ${new Date(i+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})}`;let z="";if(f.length>1){const E=Math.max(...f.map(w=>(EXAM_DEFS[w.type]||[]).reduce((D,P)=>{var j;return D+Number(((j=w.nets)==null?void 0:j[P])||0)},0)),1),A=400,C=80,L=Math.min(40,(A-20)/f.length-4);z=`<svg width="${A}" height="${C+30}" style="overflow:visible">
      ${f.map((w,D)=>{const P=(EXAM_DEFS[w.type]||[]).reduce((H,F)=>{var V;return H+Number(((V=w.nets)==null?void 0:V[F])||0)},0),j=Math.max(Math.round(P/E*(C-10)),4),Y=10+D*((A-20)/f.length);return`<rect x="${Y}" y="${C-j}" width="${L}" height="${j}" rx="3" fill="${r}" opacity="0.85"/>
          <text x="${Y+L/2}" y="${C-j-4}" text-anchor="middle" font-size="10" fill="#333">${P.toFixed(0)}</text>
          <text x="${Y+L/2}" y="${C+14}" text-anchor="middle" font-size="9" fill="#666">${v(w.name.replace("Deneme","").replace("TYT","").replace("AYT","").trim()||String(D+1))}</text>`}).join("")}
...
<div class="page">
  ...
  <div class="section">
    ...
    ${z?`<div style="margin-bottom:16px;padding:12px;background:#f8f8f8;border-radius:8px">${z}</div>`:""}
    <table>
      <thead><tr><th>Sınav</th><th>Tarih</th><th>Tür</th>${(EXAM_DEFS[(B=f[0])==null?void 0:B.type]||[]).map(E=>`<th>${E}</th>`).join("")}<th>Toplam</th></tr></thead>
      <tbody>
        ${f.map(E=>{const A=EXAM_DEFS[E.type]||[],C=A.reduce((L,w)=>{var D;return L+Number(((D=E.nets)==null?void 0:D[w])||0)},0).toFixed(1);return`<tr>
            <td><strong>${v(E.name)}</strong></td>
            <td>${new Date(E.date+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"short"})}</td>
            <td>${v(E.type)}</td>
            ${A.map(L=>{var D;const w=Number(((D=E.nets)==null?void 0:D[L])||0);return`<td><span class="badge ${w>=20?"badge-green":w>=12?"badge-yellow":"badge-red"}">${w}</span></td>`}).join("")}
...
</html>`}function ar(){const e=document.getElementById("rpStuId").value,t=gn(e,!0),n=window.open("","_blank","width=900,height=700");n.document.write(t),n.document.close()}function ir(){const e=document.getElementById("rpStuId").value;l.students.find(a=>a.id===e);const t=gn(e,!1),n=window.open("","_blank");n.document.write(t),n.document.close(),setTimeout(()=>{n.focus(),n.print()},500),q("reportModal"),x('PDF oluşturuluyor — "PDF olarak kaydet" seçin')}async function or(){const e=document.getElementById("rpStuId").value,t=l.students.find(s=>s.id===e);if(!t)return;const n=`${window.location.origin}/api/generate-pdf-report?studentId=${e}`,a=`Merhaba, ${t.name} isimli öğrencimizin bu dönemki performans ve gelişim raporu hazırlandı. Aşağıdaki bağlantıdan raporu detaylıca görüntüleyebilirsiniz:

🔗 ${n}`,o=`https://api.whatsapp.com/send?text=${encodeURIComponent(a)}`;window.open(o,"_blank"),q("reportModal"),x("WhatsApp yönlendirmesi açıldı ✓")}function sr(){let e=document.getElementById("weeklyPDFModal");e||(e=document.createElement("div"),e.id="weeklyPDFModal",e.className="modal-bg",e.innerHTML=`<div class="modal">
      ...
      <button class="btn btn-accent" style="width:100%;justify-content:center;padding:12px" onclick="generateWeeklyPDF()">PDF Oluştur →</button>
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pdfNote").value="",G("weeklyPDFModal")}function rr(){const e=document.getElementById("pdfNote").value.trim();q("weeklyPDFModal"),Ca(l.activeStuId,e)}function Ca(e,t){var C,L;const n=l.students.find(w=>w.id===e);if(!n)return;const a=(n==null?void 0:n.weekStart)??0,i=ne(l.weekOffset,a),o=J(i,6),s=((C=l.workspace)==null?void 0:C.brand_name)||"Rostrum Akademi",r=((L=l.workspace)==null?void 0:L.brand_color)||"#E8613A",d=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"],c=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],p={deneme:"#f59e0b",soru:"#3b82f6",konu:"#10b981",diger:"#8b5cf6"},m={deneme:"Deneme",soru:"Soru Bankası",konu:"Konu Anlatımı",diger:"Diğer"};let u=0,g=0,_=0;const T=[];for(let w=0;w<7;w++){const D=J(i,w),P=O(D),j=l.tasks[`${e}_${P}`]||[];u+=j.length,g+=j.filter(Y=>Y.done).length,_+=j.reduce((Y,H)=>Y+Number(H.duration||0),0),j.length>0&&T.push({d:D,ds:P,tasks:j,dayName:d[(a+w)%7]})}const f=u>0?Math.round(g/u*100):0,$=163.36,k=($*(1-f/100)).toFixed(1),z=(w,D=5)=>{let P="";for(let j=1;j<=D;j++)P+=`<span style="display:inline-block;width:6px;height:6px;border-radius:50%;margin-right:2px;background:${j<=w?r:"#E8E6DE"}"></span>`;return P},h=w=>w?'<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;border-radius:50%;background:#22C55E;flex-shrink:0"><svg width="8" height="6" viewBox="0 0 8 6"><path d="M1 3L3 5L7 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></span>':'<span style="display:inline-block;width:15px;height:15px;border-radius:50%;border:1.5px solid #D1D0DC;flex-shrink:0"></span>';let S="";for(const{d:w,tasks:D,dayName:P}of T){const j=D.reduce((H,F)=>H+Number(F.duration||0),0),Y=D.map(H=>{const F=p[H.type]||"#94a3b8",V=m[H.type]||"Diğer",Z=H.done,te=H.student_result||null,Q=H.student_feedback||null,R=te&&(te.dogru!=null||te.yanlis!=null||te.bos!=null)?`
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:3px;margin-top:6px">
          ${Q.difficulty?`<div style="white-space:nowrap"><span style="font-size:8px;color:#C4C3D0">Zorluk </span>${z(Q.difficulty)}</div>`:""}
          ${Q.focus?`<div style="white-space:nowrap"><span style="font-size:8px;color:#C4C3D0">Odak </span>${z(Q.focus)}</div>`:""}
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:7px">
        <span style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#111118">${P}</span>
        <span style="font-size:10px;color:#6B6A7A">${w.getDate()} ${c[w.getMonth()]}</span>
        <div style="flex:1;height:1px;background:#E8E6DE"></div>
        <span style="font-size:9px;color:#9998AA">${D.length} görev · ${j} dk</span>
      </div>
      ${Y}
    </div>`}const B=[{val:g,lbl:"Tamamlanan",col:"#22C55E"},{val:u-g,lbl:"Bekleyen",col:"#C4C3D0"},{val:Math.round(_/60)+" sa",lbl:"Toplam Süre",col:r},{val:u,lbl:"Toplam Görev",col:"#C4C3D0"}].map((w,D)=>`<div style="flex:1;${D>0?"border-left:1px solid rgba(255,255,255,.06);padding-left:16px;":""}padding-right:16px">
  ...
  <div class="page">
    <div style="background:#111118;padding:24px 28px 20px;position:relative;overflow:hidden">
      ...
      <div style="display:flex;gap:0;margin-top:16px;border-top:1px solid rgba(255,255,255,.06);padding-top:14px">${B}</div>
    </div>
  ...
  </body></html>`,A=window.open("","_blank","width=1000,height=850");A.document.write(E),A.document.close(),setTimeout(()=>A.focus(),300)}async function lr(){var s,r;G("inviteCodeModal");const e=document.getElementById("invCodeBox");let t=(s=l.workspace)==null?void 0:s.invite_code;if(!t){e.textContent="……";try{const{data:d,error:c}=await y.rpc("ensure_invite_code");!c&&d&&(t=d,l.workspace&&(l.workspace.invite_code=t))}catch{}}if(!t){e.textContent="—",x("Kod alınamadı — sayfayı yenileyip tekrar dene");return}e.textContent=t;const n=`https://rostrumakademi.com/app.html?davet=${t}`,i=`Merhaba! ${((r=l.workspace)==null?void 0:r.brand_name)||"koçun"} koçluk platformuna davetlisin. 🎓

Kayıt linki: ${n}
(Davet kodun: ${t})

Linke tıkla, hesabını oluştur — otomatik olarak bana bağlanacaksın.`,o=document.getElementById("invWaBtn");o&&(o.href="https://wa.me/?text="+encodeURIComponent(i))}function dr(){var t,n;const e=(n=(t=document.getElementById("invCodeBox"))==null?void 0:t.textContent)==null?void 0:n.trim();e&&e.length===6&&vn(e)}function cr(){var t,n;const e=(n=(t=document.getElementById("invCodeBox"))==null?void 0:t.textContent)==null?void 0:n.trim();e&&e.length===6&&vn(`https://rostrumakademi.com/app.html?davet=${e}`)}function vn(e){navigator.clipboard.writeText(e).then(()=>x("Link kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),x("Link kopyalandı ✓")})}const La=[{name:"Terrakota",val:"#e8613a",dim:"rgba(232,97,58,.12)"},{name:"Altın",val:"#f0a500",dim:"rgba(240,165,0,.12)"},{name:"Mavi",val:"#4da6ff",dim:"rgba(77,166,255,.12)"},{name:"Yeşil",val:"#3ecf8e",dim:"rgba(62,207,142,.12)"},{name:"Mor",val:"#c084fc",dim:"rgba(192,132,252,.12)"},{name:"Pembe",val:"#f472b6",dim:"rgba(244,114,182,.12)"},{name:"Kırmızı",val:"#ff5c5c",dim:"rgba(255,92,92,.12)"},{name:"Turkuaz",val:"#06b6d4",dim:"rgba(6,182,212,.12)"}];function Pa(){try{const e=JSON.parse(localStorage.getItem("ba_theme")||"{}");e.theme==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),e.accent&&ja(e.accent,e.accentDim,!1)}catch{}}function ja(e,t,n=!0){if(document.documentElement.style.setProperty("--accent",e),document.documentElement.style.setProperty("--accent-dim",t||"rgba(240,165,0,.12)"),n)try{const a=JSON.parse(localStorage.getItem("ba_theme")||"{}");a.accent=e,a.accentDim=t,localStorage.setItem("ba_theme",JSON.stringify(a))}catch{}}function pr(e){e==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{const t=JSON.parse(localStorage.getItem("ba_theme")||"{}");t.theme=e,localStorage.setItem("ba_theme",JSON.stringify(t))}catch{}document.querySelectorAll(".theme-btn").forEach(t=>{const n=t.dataset.theme===e;t.style.background=n?"var(--accent-dim)":"",t.style.borderColor=n?"var(--accent)":"",t.style.color=n?"var(--accent)":""})}function mr(){let e=document.getElementById("themePanel");if(e){e.remove();return}e=document.createElement("div"),e.id="themePanel";const t=document.documentElement.getAttribute("data-theme")!=="light";e.style.cssText="position:fixed;top:60px;right:12px;background:var(--surface);border:1px solid var(--border2);border-radius:14px;padding:18px;z-index:300;box-shadow:var(--shadow-lg);min-width:230px;animation:fadeUp .2s ease",e.innerHTML=`
    ...
    <div style="display:flex;gap:7px;flex-wrap:wrap;margin-bottom:14px">
      ${La.map(n=>`<div onclick="applyAccent('${n.val}','${n.dim}');document.getElementById('themePanel').remove()" title="${n.name}"
    ...
    `)}function ur(){const e=document.getElementById("aiChatPanel"),t=document.getElementById("aiChatBubble");if(e.classList.contains("open"))e.classList.remove("open"),t.style.display="flex";else{e.classList.add("open"),t.style.display="none";const n=document.getElementById("aiMessages");n.scrollTop=n.scrollHeight,document.getElementById("aiInput").focus()}}function gr(e){document.getElementById("aiInput").value=e,Na()}function Gt(){var t;const e={};try{const n=l.students.find(s=>s.id===l.activeStuId);n&&(e.studentName=n.name,e.target=n.target||""),b.role==="parent"&&b.childName&&(e.studentName=b.childName);const a=(l.exams||[]).filter(s=>s.studentId===l.activeStuId).slice(-5);a.length&&(e.recentExams=a.map(s=>({name:s.type+" "+(s.name||""),date:s.date||"",nets:s.nets||{}})));let i=[];if(Object.entries(l.tasks||{}).forEach(([s,r])=>{s.startsWith(l.activeStuId+"_")&&(i=i.concat(r))}),i.length){const s=i.filter(r=>r.done).length;e.taskCompletionRate=Math.round(s/i.length*100),e.weeklyTaskCount=i.length}const o=Object.keys(EXAM_DEFS);a.length&&(e.examProfile=((t=a[0])==null?void 0:t.type)||o[0])}catch(n){console.warn("AI context error:",n)}return e}async function rt(){const e={"Content-Type":"application/json"};try{const{data:{session:t}}=await y.auth.getSession();t!=null&&t.access_token&&(e.Authorization="Bearer "+t.access_token)}catch{}return e}function be(e,t){st.push({role:e,content:t});const n=document.getElementById("aiMessages"),a=n.querySelector(".ai-welcome");a&&a.remove();const i=new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),o=document.createElement("div");o.className=`ai-msg ${e}`,o.innerHTML=`${v(t).replace(/\n/g,"<br>")}<div class="ai-msg-time">${i}</div>`,n.appendChild(o),n.scrollTop=n.scrollHeight}let fn=null;window._pickAiImg=function(e){const t=e.files[0];if(!t)return;if(t.size>8*1024*1024){x("Dosya max 8 MB olabilir"),e.value="";return}const n=new FileReader;n.onload=a=>{fn={base64:a.target.result.split(",")[1],mimeType:t.type,name:t.name};const o=document.getElementById("aiImgPreview"),s=document.getElementById("aiImgThumb"),r=document.getElementById("aiImgName");s.src=a.target.result,s.style.display="block",r.textContent=t.name,o.style.display="flex"},n.readAsDataURL(t),e.value=""};window._cancelAiImg=function(){fn=null;const e=document.getElementById("aiImgPreview");e&&(e.style.display="none")};async function Na(){if(Nt)return;const e=document.getElementById("aiInput"),t=e.value.trim(),n=fn;if(!(!t&&!n)){if(e.value="",n){window._cancelAiImg();const a=document.getElementById("aiMessages"),i=a.querySelector(".ai-welcome");i&&i.remove();const o=document.createElement("div");o.className="ai-msg user",o.innerHTML=`<img src="data:${n.mimeType};base64,${n.base64}" style="max-width:180px;max-height:180px;border-radius:10px;display:block" />${t?`<div style="margin-top:6px">${v(t)}</div>`:""}<div class="ai-msg-time">${new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}</div>`,a.appendChild(o),a.scrollTop=a.scrollHeight,st.push({role:"user",content:t||"Fotoğraftaki soruyu çöz.",image:n})}else be("user",t);Nt=!0,document.getElementById("aiTyping").classList.add("show"),document.getElementById("aiSendBtn").disabled=!0;try{const a=Gt(),i=b.role||"student";if(n){const o=await fetch("/api/ai-chat",{method:"POST",headers:await rt(),body:JSON.stringify({imageBase64:n.base64,mimeType:n.mimeType,text:t||"Bu soruyu çöz.",context:a,userRole:i})});if(o.ok){const s=await o.json();be("assistant",s.reply||"Yanıt alınamadı.")}else{const s=await Te(t,a,i,n);be("assistant",s)}}else{const s=await fetch("/api/ai-chat",{method:"POST",headers:await rt(),body:JSON.stringify({messages:st.slice(-10),context:a,userRole:i})});if(s.ok){const r=await s.json();be("assistant",r.reply||"Yanıt alınamadı.")}else{const r=await Te(t,a,i,null);be("assistant",r)}}}catch(a){console.error("AI error:",a);try{const i=Gt(),o=await Te(t,i,b.role||"student",n);be("assistant",o)}catch{const o=localStorage.getItem("gemini_api_key");be("assistant","🔒 Bu özellik ileride aktif olacaktır. Yakında kullanıma açılacak.")}}finally{Nt=!1,document.getElementById("aiTyping").classList.remove("show"),document.getElementById("aiSendBtn").disabled=!1}}}let Ht=null;async function Ha(e){try{const t=await fetch(`https://generativelanguage.googleapis.com/v1beta/models?key=${e}`);if(!t.ok)return null;const a=(await t.json()).models||[];let i=a.find(o=>o.name.toLowerCase().includes("flash")&&o.supportedGenerationMethods.includes("generateContent"));if(i||(i=a.find(o=>o.supportedGenerationMethods.includes("generateContent"))),i)return i.name.replace("models/","")}catch(t){console.warn("Auto-detect model failed:",t)}return null}async function Te(e,t,n,a){var _,T,f,$,k,z;let i=localStorage.getItem("gemini_api_key");if(!i)try{const{data:h}=await y.from("platform_settings").select("value").eq("key","ai_settings").maybeSingle();h&&h.value&&h.value.gemini_api_key&&(i=h.value.gemini_api_key)}catch(h){console.warn("DB Gemini API key load error:",h)}const o=i;if(!o)throw new Error("API anahtarı eksik.");let s="gemini-1.5-flash";if(o)if(Ht)s=Ht;else{const h=await Ha(o);h&&(Ht=h,s=h,console.log("[Gemini API] Otomatik model tespiti başarılı:",s))}let r=`Sen "Rostrum Akademi Yapay Zeka Asistanı"sın. Türkiye eğitim sistemine (YKS, LGS) hakim, rolüne göre öğrencilere, velilere veya koçlara destek veren bir yapay zekasın.
...
5. Güncel Paket Fiyatları:
   ...
   - Kurumsal Paket (Enterprise): Aylık 1499 TL`;const d=b.dbUser;if(d){const h=d.plan||"trial",S={trial:"Deneme",starter:"Başlangıç",pro:"Pro",enterprise:"Kurumsal"}[h]||h;if(h==="trial"){const I=d.trial_ends_at?new Date(d.trial_ends_at):new Date(new Date(d.created_at).getTime()+12096e5),B=Math.max(0,Math.ceil((I-Date.now())/864e5));r+=`
KULLANICI BİLGİSİ: Ad=${d.full_name||d.username}, Plan=${S}, Deneme süresi kalan=${B} gün (bitiş: ${I.toLocaleDateString("tr-TR")}).`}else r+=`
...
[TASLAK]
(Öğrenciye gönderilecek haftalık değerlendirme taslağı)`;let u="";const g={studentName:t.name,target:t.target,recentExams:c,taskCompletionRate:r,weeklyTaskCount:i};try{const k=await fetch("/api/ai-chat",{method:"POST",headers:await rt(),body:JSON.stringify({messages:[{role:"user",content:m}],context:g,userRole:"coach"})});k.ok?u=(await k.json()).reply:u=await Te(m,g,"coach")}catch{u=await Te(m,g,"coach")}let _="Analiz üretilemedi.",T="Taslak üretilemedi.";const f=u.indexOf("[ANALİZ]"),$=u.indexOf("[TASLAK]");f!==-1&&$!==-1?f<$?(_=u.substring(f+8,$).trim(),T=u.substring($+8).trim()):(T=u.substring($+8,f).trim(),_=u.substring(f+8).trim()):T=u,document.getElementById("aiCopilotAnalysisBox").innerHTML=`<b>📊 Yapay Zeka Durum Analizi:</b><br>${_.replace(/\n/g,"<br>")}`,document.getElementById("aiCopilotTextarea").value=T,yn=T,document.getElementById("aiCopilotResultArea").style.display="block",document.getElementById("aiCopilotSendBtn").disabled=!0,document.getElementById("aiCopilotEditWarning").style.display="inline"}catch(a){console.error("generateAICopilotDraft error:",a),x("Taslak oluşturulurken hata: "+a.message)}finally{n.disabled=!1,n.textContent="🤖 Durum Analizi Yap ve Taslak Oluştur"}}function fr(){var t;const e=(((t=document.getElementById("aiCopilotTextarea"))==null?void 0:t.value)||"").trim();if(!e){x("Önce taslak oluşturun");return}window.open("https://wa.me/?text="+encodeURIComponent(e),"_blank")}function yr(){const e=document.getElementById("aiCopilotTextarea").value.trim(),t=document.getElementById("aiCopilotSendBtn"),n=document.getElementById("aiCopilotEditWarning");e&&e!==yn?(t.disabled=!1,n.style.display="none"):(t.disabled=!0,n.style.display="inline")}async function xr(e){var a;const t=document.getElementById("aiCopilotTextarea").value.trim();if(!t)return;const n=document.getElementById("aiCopilotSendBtn");n.disabled=!0,n.textContent="Gönderiliyor...";try{const i=b.coachId||((a=l.students.find(r=>r.id===e))==null?void 0:a.coachId),{data:o,error:s}=await y.from("messages").insert({student_id:e,coach_id:i,from_role:"coach",text:t,read:!1}).select().single();if(s)throw s;await y.from("reports").insert({student_id:e,coach_id:i,type:"ai_copilot",title:"Yapay Zeka Copilot Değerlendirmesi",content:t,start_date:ue(),end_date:ue()}),l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:o.id,from:"coach",text:t,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),x("Taslak mesaj başarıyla düzenlendi, öğrenciye gönderildi ve arşive kaydedildi! ✓"),document.getElementById("aiCopilotResultArea").style.display="none",document.getElementById("aiCopilotTextarea").value="",yn=""}catch(i){console.error("sendCopilotDraft error:",i),x("Gönderim hatası: "+i.message),n.disabled=!1}finally{n.textContent="✍️ Düzenlemeyi Kaydet ve Öğrenciye Gönder"}}function Ya(){const e=l.students.find(r=>r.id===l.activeStuId),t=b.childName||(e==null?void 0:e.name)||"Öğrenci",n=document.getElementById("view-parent-home");if(!n)return;let a=[];Object.entries(l.tasks||{}).forEach(([r,d])=>{r.startsWith(l.activeStuId+"_")&&(a=a.concat(d))});const i=a.filter(r=>r.done).length,o=a.length?Math.round(i/a.length*100):0,s=(l.exams||[]).filter(r=>r.studentId===l.activeStuId).slice(-3);n.innerHTML=`
    ...
    </div>`}function Ka(){const e=document.getElementById("view-parent-progress");if(!e)return;const t=l.students.find(o=>o.id===l.activeStuId),n=b.childName||(t==null?void 0:t.name)||"Öğrenci",a=(l.exams||[]).filter(o=>o.studentId===l.activeStuId);let i=[];Object.entries(l.tasks||{}).forEach(([o,s])=>{o.startsWith(l.activeStuId+"_")&&(i=i.concat(s))}),e.innerHTML=`
    <div style="padding:24px;max-width:800px;margin:0 auto">
      ...
      <div class="card" style="padding:20px;margin-bottom:16px">
        ...
        ${i.length?i.slice(-10).map(o=>`
          <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--border)">
            ...
            <div style="flex:1;font-size:13px">${v(o.subject)} <span style="font-size:11px;color:var(--text-dim)">(${dt(o.type)})</span></div>
    ...
    </div>`}function Oa(){const e=document.getElementById("view-parent-ai");e&&(e.innerHTML=`
    ...
    </div>`)}async function br(){var u;const e=document.getElementById("smId").value,t=document.getElementById("smName").value.trim(),n=je(document.getElementById("smUsername").value.trim()),a=document.getElementById("smPass").value,i=document.getElementById("smRole").value,o=document.getElementById("smTarget").value.trim(),s=((u=document.querySelector(".color-opt.sel"))==null?void 0:u.dataset.c)||"#e8622a",r=Number(document.getElementById("smWeekStart").value),d=Number(document.getElementById("smProg").value);if(!t||!n||!a)return x("Ad, kullanıcı adı ve şifre zorunlu!");const c=a.length===64?a:await Ye(a),p=n+"@rostrumakademi.com",m={full_name:t,username:n,password_hash:c,role:i,target:o,color:s,week_start:r,progress:d};if(M(!0),e){const{error:g}=await y.from("users").update(m).eq("id",e);if(M(!1),g)return x("Hata: "+g.message);x("Kullanıcı güncellendi ✓")}else{const{data:g,error:_}=await y.rpc("create_new_user",{p_email:p,p_password:a,p_full_name:t,p_username:n,p_role:i,p_target:o,p_color:s,p_progress:d,p_week_start:r,p_coach_id:null,p_institution_id:null,p_exam_profile:"YKS"});if(M(!1),_)return x("Hata: "+_.message);x("Kullanıcı başarıyla oluşturuldu ✓")}q("studentModal"),Xe()}let ke=[],he={search:"",exam:"",subject:""},Fa=null;function hr(e){const t=ke.find(o=>o.id===e);if(!t)return x("Kaynak bulunamadı");if(!l.students.length)return x("Önce öğrenci ekleyin");Fa=t;let n=document.getElementById("assignResModal");n||(n=document.createElement("div"),n.className="modal-bg",n.id="assignResModal",document.body.appendChild(n));const a=new Date,i=Array.from({length:7},(o,s)=>{const r=J(a,s),d=s===0?"Bugün":s===1?"Yarın":["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"][r.getDay()]+` (${r.getDate()}.${r.getMonth()+1})`;return`<option value="${O(r)}|${d}">${d}</option>`}).join("");n.innerHTML=`<div class="modal" style="max-width:380px">
    ...
    <button class="btn btn-accent" style="width:100%;justify-content:center;padding:11px" onclick="confirmAssignResource()">Görevi Hazırla →</button>
      ...
      <div class="analytics-grid">
        ${Ua(t).map(d=>{const c=d.totalCount>0?Math.round(d.doneCount/d.totalCount*100):0,p=c>=80?"var(--green)":c>=50?"var(--accent)":"var(--text-dim)";return`<div class="analytics-card">
...
Paylaşılan şablonlar değerlendirilerek tüm koçlara önerilebilir.`)&&y.auth.getSession().then(({data:{session:r}})=>{const d=r==null?void 0:r.access_token;d&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({type:"template_share",template_name:e,task_count:i.length,tasks_json:JSON.stringify(i,null,2)})}).then(()=>x("Şablon Rostrum ekibiyle paylaşıldı ✓")).catch(()=>x("Şablon kaydedildi, paylaşım gönderilemedi."))})}async function Dr(){M(!0);const{data:e,error:t}=await y.from("program_templates").select("*").eq("coach_id",b.coachId);if(M(!1),t)return x("Şablonlar yüklenemedi.");if(!e||e.length===0)return x("Kayıtlı şablonunuz bulunmuyor. Önce haftayı şablon olarak kaydedin.");let n=document.getElementById("applyTemplateModal");n||(n=document.createElement("div"),n.id="applyTemplateModal",n.className="modal-bg",n.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(n),n.addEventListener("click",a=>{a.target===n&&n.classList.remove("open")})),document.getElementById("atmSelect").innerHTML=e.map(a=>`<option value="${a.id}">${v(a.name)} (${a.tasks.length} Görev)</option>`).join(""),G("applyTemplateModal")}async function Ar(){const e=document.getElementById("atmSelect").value;if(!e)return;M(!0);const{data:t,error:n}=await y.from("program_templates").select("*").eq("id",e).single();if(n||!t)return M(!1),x("Şablon yüklenemedi.");const a=l.students.find(s=>s.id===l.activeStuId),i=(a==null?void 0:a.weekStart)??0,o=ne(l.weekOffset,i);for(const s of t.tasks){const r=O(J(o,s.day_index)),d={student_id:l.activeStuId,coach_id:b.coachId,date:r,type:s.type,exam_type:s.exam_type,subject:s.subject,duration:s.duration,note:s.note,done:!1,task_items:s.task_items},{data:c,error:p}=await y.from("tasks").insert(d).select().single();if(!p&&c){const m=`${l.activeStuId}_${r}`;l.tasks[m]||(l.tasks[m]=[]),l.tasks[m].push({_id:c.id,type:c.type,exam:c.exam_type,subject:c.subject,duration:c.duration,note:c.note,done:!1,student_note:"",task_items:c.task_items})}}M(!1),q("applyTemplateModal"),X(),x("Şablon başarıyla uygulandı ✓")}function Cr(e,t){var o;const a=`${l.activeStuId}_${e}`,i=(o=l.tasks[a])==null?void 0:o[t];i&&(_clipboardTask={type:i.type,exam:i.exam,subject:i.subject,duration:i.duration,note:i.note,task_items:i.task_items},x("Görev panoya kopyalandı ✓"),X())}async function Lr(e){if(!_clipboardTask)return;const t={student_id:l.activeStuId,coach_id:b.coachId,date:e,type:_clipboardTask.type,exam_type:_clipboardTask.exam||null,subject:_clipboardTask.subject,duration:_clipboardTask.duration,note:_clipboardTask.note,done:!1,task_items:_clipboardTask.task_items};M(!0);const{data:n,error:a}=await y.from("tasks").insert(t).select().single();if(M(!1),a)return x("Hata: "+a.message);const i=`${l.activeStuId}_${e}`;l.tasks[i]||(l.tasks[i]=[]),l.tasks[i].push({_id:n.id,type:n.type,exam:n.exam_type,subject:n.subject,duration:n.duration,note:n.note,done:!1,student_note:"",task_items:n.task_items}),X(),x("Görev yapıştırıldı ✓")}async function Pr(e,t){var p;const n=`${l.activeStuId}_${e}`,a=(p=l.tasks[n])==null?void 0:p[t];if(!a)return;const i=l.students.find(m=>m.id===l.activeStuId),o=(i==null?void 0:i.weekStart)??0,s=ne(l.weekOffset,o),r=[];for(let m=0;m<7;m++){const u=J(s,m),g=O(u);g!==e&&r.push({student_id:l.activeStuId,coach_id:b.coachId,date:g,type:a.type,exam_type:a.exam||null,subject:a.subject,duration:a.duration,note:a.note,done:!1,task_items:a.task_items})}if(r.length===0)return;M(!0);const{data:d,error:c}=await y.from("tasks").insert(r).select();if(M(!1),c)return x("Hata: "+c.message);(d||[]).forEach(m=>{const u=`${l.activeStuId}_${m.date}`;l.tasks[u]||(l.tasks[u]=[]),l.tasks[u].push({_id:m.id,type:m.type,exam:m.exam_type,subject:m.subject,duration:m.duration,note:m.note,done:!1,student_note:"",task_items:m.task_items})}),X(),x("Görev tüm haftaya kopyalandı ✓")}async function jr(){if(!_clipboardTask)return;const e=l.students.find(s=>s.id===l.activeStuId),t=(e==null?void 0:e.weekStart)??0,n=ne(l.weekOffset,t),a=[];for(let s=0;s<7;s++){const r=J(n,s),d=O(r);a.push({student_id:l.activeStuId,coach_id:b.coachId,date:d,type:_clipboardTask.type,exam_type:_clipboardTask.exam||null,subject:_clipboardTask.subject,duration:_clipboardTask.duration,note:_clipboardTask.note,done:!1,task_items:_clipboardTask.task_items})}M(!0);const{data:i,error:o}=await y.from("tasks").insert(a).select();if(M(!1),o)return x("Hata: "+o.message);(i||[]).forEach(s=>{const r=`${l.activeStuId}_${s.date}`;l.tasks[r]||(l.tasks[r]=[]),l.tasks[r].push({_id:s.id,type:s.type,exam:s.exam_type,subject:s.subject,duration:s.duration,note:s.note,done:!1,student_note:"",task_items:s.task_items})}),_clipboardTask=null,X(),x("Görev tüm haftaya yapıştırıldı ✓")}Pa();sn();window.addEventListener("hashchange",()=>{let e=window.location.hash.substring(1);if(document.getElementById("appShell").classList.contains("visible")&&e!==currentTab){if(!e){e={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[b.role]||"portal",window.location.hash=e;return}document.getElementById("view-"+e)&&se(e,!1)}});async function bn(){const e=document.getElementById("view-coach-applications");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:800px;margin:0 auto">
    ...
    </div>`).join("");const s=t.filter(d=>d.status==="pending").length,r=document.getElementById("sbi_coach-applications");if(r){const d=r.querySelector(".sb-badge");if(d&&d.remove(),s>0){const c=document.createElement("span");c.className="sb-badge",c.textContent=s,r.appendChild(c)}}}async function Rr(e,t,n,a){var o;const{error:i}=await y.from("match_requests").update({status:t}).eq("id",e);if(i)return x("Hata: "+i.message);x(t==="accepted"?"✓ Başvuru kabul edildi":"Başvuru reddedildi"),n&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"application_update",to:n,student_name:a||"",status:t,coach_name:((o=l.workspace)==null?void 0:o.brand_name)||"Koçunuz"})}).catch(s=>console.warn("[updateApplication] mail error:",s.message)),bn()}let He=null;async function qa(){var a;const e=document.getElementById("view-coach-notes");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:860px;margin:0 auto">
  ...
  </div>`;const t=`coach_notes_${b.coachId}`,{data:n}=await y.from("platform_settings").select("value").eq("key",t).maybeSingle();He=((a=n==null?void 0:n.value)==null?void 0:a.notes)||[],hn()}function hn(){const e=document.getElementById("coachNotesList");if(!e)return;const t=He;if(!t.length){e.innerHTML=`<div style="grid-column:1/-1;text-align:center;padding:48px;color:var(--text-dim)">
      <div style="font-size:36px;margin-bottom:12px">📝</div>
    ...
    </div>`).join("")}function Nr(e){const t=e!==null?He[e]||{}:{};let n=document.getElementById("coachNoteModal");n||(n=document.createElement("div"),n.id="coachNoteModal",n.className="modal-bg",document.body.appendChild(n)),n.innerHTML=`<div class="modal" style="max-width:520px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
  ...
  </div>`,n.style.display="flex"}async function Hr(e){const t=document.getElementById("noteEditorTitle").value.trim(),n=document.getElementById("noteEditorBody").value.trim();if(!t&&!n)return x("Not boş olamaz");const a={title:t||"Başlıksız",body:n,updated:new Date().toISOString()};e===null?He.unshift(a):He[e]=a,await Wa(),document.getElementById("coachNoteModal").style.display="none",hn(),x("Not kaydedildi ✓")}async function Yr(e){await ie("Bu notu silmek istiyor musun?")&&(He.splice(e,1),await Wa(),hn(),x("Not silindi"))}async function Wa(){const e=`coach_notes_${b.coachId}`;await y.from("platform_settings").upsert({key:e,value:{notes:He}},{onConflict:"key"})}function Ct(){if(b.role!=="student")return;const e=(l.messages[b.studentId]||[]).filter(t=>t.from==="coach"&&!t.read).length;["sbi_smessages","mntab_smessages"].forEach(t=>{const n=document.getElementById(t);if(!n)return;n.style.position="relative";const a=n.querySelector(".msg-nav-badge");if(a&&a.remove(),e>0){const i=document.createElement("span");i.className="msg-nav-badge",i.style.cssText="position:absolute;top:3px;right:3px;background:#ef4444;color:#fff;border-radius:100px;min-width:14px;height:14px;font-size:9px;font-weight:800;display:flex;align-items:center;justify-content:center;padding:0 3px;pointer-events:none;line-height:1",i.textContent=e>9?"9+":e,n.appendChild(i)}})}window.updateMsgBadge=Ct;window.toggleSidebar=hi;window.setupShell=wi;window.switchTab=se;window.renderHome=qn;window.renderCoachApplications=bn;window.updateApplication=Rr;window.renderCoachNotes=qa;window.openNoteEditor=Nr;window.toggleNewResourceMode=Gi;window.addManualTest=qi;window.removeManualTest=Wi;window.saveCoachNote=Hr;window.deleteCoachNote=Yr;window.renderStudentsSearch=ct;window.filterStudentSearch=$i;window.openStudentDetail=Wn;window.openKonuHaritasi=Ti;window.openStudentProgram=Qt;window.openStudentExams=Si;window.openStudentAppointments=Ii;window.renderProfile=Jn;window.saveProfile=Ci;window.renderSettings=Xn;window.saveGeminiKey=Li;window.renderProgram=X;window.selectStu=Pi;window.chWeek=ji;window.goToday=Ri;window.openClearWeekModal=Hi;window.toggleDaySel=Yi;window.toggleAllDays=Ki;window.confirmClearDays=Oi;window.openTaskModal=ta;window.loadResources=aa;window.updateSubjectList=Tt;window.updateBookList=Vi;window.renderBookList=St;window.filterBooks=Zi;window.selectBook=Ji;window.renderTestList=It;window.selectAllTests=Xi;window.clearAllTests=Qi;window.updateTestSummary=Ve;window.selectModalSpeed=eo;window.applyDuration=to;window.scheduleSmartBadge=Bt;window.applySmartDuration=ao;window.loadStudentSpeeds=ia;window.saveStudentSpeed=oa;window.saveTask=io;window.toggleTask=oo;window.closeTaskMenu=tn;window.showTaskMenu=so;window.copyTask=ro;window.deleteTask=lo;window.renderTodoList=da;window.renderStudents=pa;window.goProgram=ho;window.openStudentModal=ko;window.saveStudent=wo;window.showInviteInfo=ma;window.deleteStu=Eo;window.renderAppointments=Ze;window.renderCalDays=zt;window.selCalDay=To;window.chCalMonth=So;window.renderApptList=nn;window.openApptModal=Io;window.saveAppt=Bo;window.deleteAppt=Do;window.renderExams=Je;window.openCommentModal=Ro;window.saveComment=No;window.deleteExam=Ho;window.renderMessages=xa;window.selectThread=Yo;window.renderThreadHTML=Se;window.sendMsg=Ko;window.scrollMsgs=Ie;window.renderPortal=Mt;window.stuToggleTask=Oo;window.renderSPortal=Be;window.stuToggleTask2=Fo;window.chWeekS=Go;window.openTaskDetail=an;window.toggleTaskDetail=Vo;window.toggleDetailItem=Zo;window.selectVideoSpeed=Jo;window.saveTaskDetail=Xo;window.renderSExams=on;window.openStudentExamModal=ba;window.openExamModal=Qo;window.renderNetInputs=sn;window.saveExam=ns;window.renderSMessages=Ft;window.initRealtime=rn;window.destroyRealtime=ln;window.renderDevDashboard=ka;window.renderDevUsers=Xe;window.openDevUserModal=os;window.devDeleteUser=ss;window.openPlanModal=rs;window.savePlan=ls;window.renderDevResources=pt;window.openPlaylistModal=ds;window.fetchYouTubePlaylist=cs;window.savePlaylist=ps;window.openResourceModal=ms;window.saveResource=us;window.devDeleteResource=gs;window.renderDevFinance=mt;window.openPaymentModal=fs;window.verifyPayment=vs;window.setDevUserFilter=is;window.savePayment=ys;window.openSubModal=xs;window.saveSub=bs;window.renderDevAnnounce=ut;window.openAnnounceModal=hs;window.saveAnnounce=ks;window.toggleAnnounce=ws;window.devDeleteAnnounce=$s;window.renderDevTickets=Qe;window.updateTicketStatus=Is;window.devDeleteTicket=Bs;window.selectDevTicket=Es;window.sendDevReply=Ss;window.openSupportTicket=zs;window.openSupportChat=Dt;window.closeSupportChat=wa;window.startAISupportChat=Ms;window.startEminSupportChat=Ds;window.submitEminInitialMessage=As;window.sendSupportMessage=Cs;window.openSupportChatDirect=Dt;window.checkCoachSubscription=Xt;window.showTrialExpiredScreen=bt;window.loadAnnouncements=$a;window.saveStudentDev=br;window.showOnboarding=Ta;window.showOnboardingWidget=js;window.showStudentWelcome=Rs;window.renderSProfil=Ia;window.saveStudentProfile=Ns;window.changePassword=Hs;window.renderCoachProfile=Ba;window.updateProfilePreview=Ke;window.switchPreviewTab=Vs;window.toggleCoachTag=za;window.addCustomCoachTag=Ma;window.uploadCoachPhoto=Os;window.onCoachSlugInput=Fs;window.copyCoachLink=Us;window.browseCoachLink=Gs;window.generateCoachBio=Ws;window.nl2br=Aa;window.saveCoachProfile=Zs;window.renderDevMatches=mn;window.updateMatchRequestStatus=Js;window.openSpeedModal=Xs;window.saveAllSpeeds=Qs;window.openStudentNotes=er;window.saveStudentNote=tr;window.openReportModal=nr;window.getReportDates=un;window.buildReportHTML=gn;window.previewReport=ar;window.generatePDF=ir;window.openWeeklyPDFModal=sr;window.generateWeeklyPDF=rr;window.printWeeklyProgramWithNote=Ca;window.openInviteCodeModal=lr;window.copyInviteCode=dr;window.copyInviteLink=cr;window.copyToClipboard=vn;window.loadTheme=Pa;window.applyAccent=ja;window.setTheme=pr;window.openThemePanel=mr;window.initAIChatForRole=Ra;window.toggleAIChat=ur;window.aiQuickSend=gr;window.buildAIContext=Gt;window.addAIMessage=be;window.sendAIMessage=Na;window.autoDetectModel=Ha;window.callGeminiFallback=Te;window.generateAICopilotDraft=vr;window.checkCopilotDraftEdited=yr;window.shareCopilotWhatsApp=fr;window.assignResourceAsTask=hr;window.confirmAssignResource=kr;window.sendCopilotDraft=xr;window.renderParentHome=Ya;window.renderParentProgress=Ka;window.renderParentAI=Oa;window.applyResFilter=xn;window.updateCRFilter=wr;window.buildCRContent=At;window.renderCoachResources=gt;window.switchCRTab=$r;window.compileResourceStats=Ua;window.openResourceModalCoach=Er;window.fetchYtPlaylistCoach=_r;window.saveResourceCoach=Tr;window.deleteResourceCoach=Sr;window.importResourcesFromExcel=Ir;window.importStudentsFromExcel=Br;window.getTestStatus=Ga;window.openCoachTaskEdit=zr;window.saveWeekAsTemplate=Mr;window.applyTemplateToWeek=Dr;window.downloadICS=Ao;window.confirmApplyTemplate=Ar;window.copyTaskToClipboard=Cr;window.pasteTaskFromClipboard=Lr;window.copyTaskToWholeWeek=Pr;window.pasteTaskToWholeWeek=jr;window.sendWhatsAppReport=or;window.toggleUserMenu=ki;window.closeUserMenu=Gn;window.renderAgenda=$e;window.openAgendaApptModal=ca;window.deleteAgendaAppt=bo;window.agendaPrev=uo;window.agendaNext=go;window.agendaToday=vo;window.agendaSetFilter=fo;window.exportAgendaICS=yo;window.openApptPopup=la;window.handleApptDrop=xo;window.openStudentKaynaklar=Bi;window.addStudentBook=zi;window.editStudentBook=Mi;window.sbUpdatePct=Zn;window.saveStudentBook=Di;window.deleteStudentBook=Ai;async function Kr(){const e=document.getElementById("rpStuId").value,t=l.students.find(m=>m.id===e);if(!t)return;const n=document.getElementById("rpPeriod").value,{start:a,end:i}=un(),o=document.getElementById("rpNote").value.trim();let s="Performans Raporu";n==="weekly"?s="Haftalık Performans Raporu":n==="monthly"?s="Aylık Performans Raporu":s="Özel Dönem Performans Raporu";const r=`${s} (${a} - ${i})`,d=o||"Değerlendirme notu eklenmedi.";M(!0);const c=b.coachId||t.coachId,{error:p}=await y.from("reports").insert({student_id:e,coach_id:c,type:"performance",title:r,content:d,start_date:a,end_date:i});M(!1),p?x("Rapor kaydedilirken hata oluştu: "+p.message):(x("Rapor başarıyla geçmişe kaydedildi! ✓"),q("reportModal"))}async function Va(e){const t=l.students.find(s=>s.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&se("student-detail");const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button>
  ...
  `,G("viewReportDetailModal")}function Fr(){const e=document.getElementById("viewReportDetailModal");if(!e)return;const t=e.querySelector("h3").textContent,n=e.querySelector("div div").textContent,a=e.querySelector('div[style*="pre-wrap"]').textContent,i=window.open("","_blank");i.document.write(`
    <html>
      <head>
        <title>${t}</title>
        <style>
