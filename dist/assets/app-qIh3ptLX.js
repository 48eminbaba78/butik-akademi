(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const l={students:[],tasks:{},appointments:[],exams:[],messages:{},coachTodos:{},weekOffset:0,calMonth:new Date().getMonth(),calYear:new Date().getFullYear(),calSelDay:null,activeStuId:null,msgThread:null,workspace:null,studentSpeeds:[],konuHaftaSoru:[]},b={role:null,studentId:null,dbUser:null,coachId:null,childName:null};window.S=l;window.session=b;window._loginMode="email";window.STU_DEFAULT_PASS="Rostrum"+Math.floor(1e3+Math.random()*9e3);window.DAYS_TR=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"];window.MONTHS_TR=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"];window.EXAM_DEFS={TYT:["Türkçe","Matematik","Fen","Sosyal"],"AYT-SAY":["Matematik","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Edebiyat","Tarih","Coğrafya"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.EXAM_SORU={TYT:{Türkçe:40,Matematik:40,Fen:20,Sosyal:20},"AYT-SAY":{Matematik:40,Fizik:14,Kimya:13,Biyoloji:13},"AYT-EA":{Matematik:40,Edebiyat:24,Tarih:10,Coğrafya:6},"AYT-SOZ":{Edebiyat:24,Tarih1:10,Tarih2:11,Coğrafya1:6,Coğrafya2:11,Felsefe:12,Din:6}};window.EXAM_KONU_MAP={TYT_Türkçe:["Dil Bilgisi"],TYT_Matematik:["TYT Matematik","Geometri"],TYT_Fen:["TYT Fizik","TYT Kimya","TYT Biyoloji"],TYT_Sosyal:[],"AYT-SAY_Matematik":["AYT Matematik","Geometri"],"AYT-SAY_Fizik":["AYT Fizik"],"AYT-SAY_Kimya":["AYT Kimya"],"AYT-SAY_Biyoloji":["AYT Biyoloji"],"AYT-EA_Matematik":["AYT Matematik","Geometri"],"AYT-EA_Edebiyat":["Dil Bilgisi"]};window.SUBJECT_MAP={TYT:["Türkçe","Matematik","Geometri","Fizik","Kimya","Biyoloji","Tarih","Coğrafya","Felsefe","Din"],"AYT-SAY":["Matematik","Geometri","Fizik","Kimya","Biyoloji"],"AYT-EA":["Matematik","Geometri","Edebiyat","Tarih","Coğrafya","Felsefe"],"AYT-SOZ":["Edebiyat","Tarih1","Tarih2","Coğrafya1","Coğrafya2","Felsefe","Din"]};window.currentTab="";window._clipboardTask=null;window._editingTaskId=null;window._regRole=null;window._onbRole=null;window._oauthUser=null;const Va="https://imyhenrwmsmyikpollur.supabase.co",Za="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlteWhlbnJ3bXNteWlrcG9sbHVyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODAxNDE3ODYsImV4cCI6MjA5NTcxNzc4Nn0._ySJ5ArD1GYthyitHjdyEjLaUhextIwEqpRoF5ScI34",y=supabase.createClient(Va,Za);window.db=y;function we(){var e;try{localStorage.setItem("ba_ui_"+(((e=b.dbUser)==null?void 0:e.id)||"x"),JSON.stringify({weekOffset:l.weekOffset,activeStuId:l.activeStuId,calMonth:l.calMonth,calYear:l.calYear}))}catch{}}function rt(){we()}function M(e,t){let n=document.getElementById("loadingOverlay");if(document.querySelectorAll(".btn-login, .btn-accent, .btn").forEach(i=>{e?(i.setAttribute("disabled","true"),i.style.opacity="0.6",i.style.pointerEvents="none"):(i.removeAttribute("disabled"),i.style.opacity="",i.style.pointerEvents="")}),e&&!n){n=document.createElement("div"),n.id="loadingOverlay",n.style.cssText="position:fixed;inset:0;background:rgba(15,14,12,.82);z-index:9999;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:14px;backdrop-filter:blur(6px)";const i=t||"Yükleniyor...",o=t?'<div style="font-size:36px;animation:overlayPop .3s cubic-bezier(.34,1.56,.64,1) both">🗑️</div>':'<div style="width:38px;height:38px;border:3px solid rgba(255,255,255,.12);border-top-color:var(--accent);border-radius:50%;animation:spin .7s linear infinite"></div>';if(n.innerHTML=`${o}<div style="font-size:14px;font-weight:600;color:#fff;letter-spacing:.2px">${i}</div>`,!document.getElementById("spinStyle")){const s=document.createElement("style");s.id="spinStyle",s.textContent="@keyframes spin{to{transform:rotate(360deg)}}@keyframes overlayPop{from{transform:scale(.6);opacity:0}to{transform:scale(1);opacity:1}}",document.head.appendChild(s)}document.body.appendChild(n)}else!e&&n&&n.remove()}function v(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function O(e){return e instanceof Date?e.toISOString().split("T")[0]:e}function J(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function ue(){return O(new Date)}function Gt(e){return e>=20?"good":e>=12?"mid":"low"}function lt(e){return{deneme:"📊 Deneme",soru:"📚 Soru",konu:"🎯 Konu",diger:"⭐ Diğer"}[e]||e}function G(e){document.getElementById(e).classList.add("open")}function q(e){document.getElementById(e).classList.remove("open")}function x(e){const t=document.getElementById("toast");t.textContent=e,t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),2300)}document.addEventListener("click",e=>{e.target.classList.contains("modal-bg")&&e.target.id!=="trialExpiredModal"&&e.target.classList.remove("open")});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.querySelectorAll(".modal-bg.open").forEach(t=>{t.id!=="trialExpiredModal"&&t.classList.remove("open")})});function Ja(e){let t=e.value.replace(/\D/g,"");t.startsWith("0")&&(t=t.slice(1)),t=t.slice(0,10);let n="";t.length>0&&(n="0 ("+t.slice(0,3)),t.length>=3&&(n+=") "+t.slice(3,6)),t.length>=6&&(n+=" "+t.slice(6,8)),t.length>=8&&(n+=" "+t.slice(8,10)),e.value=n}function qt(){const e=new Date;let t=e.getFullYear(),n=new Date(t,5,14);return e>n&&(t+=1,n=new Date(t,5,14)),{year:t,days:Math.max(1,Math.ceil((n-e)/864e5))}}function ne(e,t=0){const n=new Date,a=n.getDay(),o=(a===0?6:a-1)-t,s=new Date(n);return s.setDate(n.getDate()-(o+7)%7+e*7),s.setHours(0,0,0,0),s}function Xa(){const e=l.students.find(t=>t.id===l.activeStuId);return(e==null?void 0:e.weekStart)??0}async function He(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return[...new Uint8Array(t)].map(n=>n.toString(16).padStart(2,"0")).join("")}function Pe(e){return e?e.trim().toLowerCase().replace(/ç/g,"c").replace(/ğ/g,"g").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ş/g,"s").replace(/ü/g,"u").replace(/i̇/g,"i").replace(/ı/g,"i").replace(/i/g,"i").replace(/\s+/g,"").replace(/\u0307/g,""):""}function Qa(){if(!("Notification"in window)){console.log("Bu tarayıcı anlık bildirimleri desteklemiyor.");return}Notification.permission!=="granted"&&Notification.permission!=="denied"?Notification.requestPermission().then(e=>{e==="granted"&&x("Bildirim izinleri onaylandı ✓")}):Notification.permission==="granted"?x("Bildirim izinleri zaten açık ✓"):x("Bildirim izinleri tarayıcı ayarlarından engellenmiş.")}window.saveUI=we;window.saveS=rt;window.showLoading=M;window.esc=v;window.fmtDate=O;window.addDays=J;window.todayStr=ue;window.netColor=Gt;window.typeLabel=lt;window.om=G;window.cm=q;window.showToast=x;window.getWeekStart=ne;window.getNextYks=qt;window.maskPhoneTR=Ja;window.getStudentWeekStart=Xa;window.sha256=He;window.normalizeUsername=Pe;window.requestNotificationPermission=Qa;async function ei(e,t={}){let n=y.from(e).select("*");Object.entries(t).forEach(([o,s])=>{n=n.eq(o,s)});const{data:a,error:i}=await n;return i&&console.error(e,i),a||[]}const ti=4*60*1e3;function Wt(){return"ra_d_"+(b.coachId||b.studentId||"x")}function Cn(){try{localStorage.removeItem(Wt())}catch{}}function kn(){try{localStorage.setItem(Wt(),JSON.stringify({ts:Date.now(),students:l.students,tasks:l.tasks,appointments:l.appointments,exams:l.exams,messages:l.messages,coachTodos:l.coachTodos,studentSpeeds:l.studentSpeeds,workspace:l.workspace,konuHaftaSoru:l.konuHaftaSoru}))}catch{}}function ni(){try{const e=localStorage.getItem(Wt());if(!e)return!1;const t=JSON.parse(e);return!t.ts||Date.now()-t.ts>ti?!1:(t.students&&(l.students=t.students),t.tasks&&(l.tasks=t.tasks),t.appointments&&(l.appointments=t.appointments),t.exams&&(l.exams=t.exams),t.messages&&(l.messages=t.messages),t.coachTodos&&(l.coachTodos=t.coachTodos),t.studentSpeeds&&(l.studentSpeeds=t.studentSpeeds),t.workspace&&(l.workspace=t.workspace),t.konuHaftaSoru&&(l.konuHaftaSoru=t.konuHaftaSoru),!0)}catch{return!1}}async function wn(){var L;const e=b.coachId,t=b.role,n=t==="coach"||t==="developer"?y.from("workspaces").select("*").eq("coach_id",e).single():Promise.resolve({data:null});let a=y.from("users").select("*").eq("role","student");t==="student"?a=a.eq("id",b.studentId):(t==="coach"||t==="developer")&&(a=a.eq("coach_id",e));const i=a,o=new Date;o.setDate(o.getDate()-60);const s=o.toISOString().split("T")[0],r=new Date;r.setDate(r.getDate()-30);const d=r.toISOString().split("T")[0],c=t==="student"?y.from("tasks").select("*").eq("student_id",b.studentId).gte("date",s):t==="coach"||t==="developer"?y.from("tasks").select("*").eq("coach_id",e).gte("date",s):y.from("tasks").select("*").gte("date",s),p=t==="student"?y.from("appointments").select("*").eq("student_id",b.studentId).gte("date",d):t==="coach"||t==="developer"?y.from("appointments").select("*").eq("coach_id",e).gte("date",d):y.from("appointments").select("*").gte("date",d),m=t==="student"?y.from("exams").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?y.from("exams").select("*").eq("coach_id",e):y.from("exams").select("*"),u=t==="student"?y.from("messages").select("*").eq("student_id",b.studentId).order("created_at",{ascending:!1}).limit(200):t==="coach"||t==="developer"?y.from("messages").select("*").eq("coach_id",e).order("created_at",{ascending:!1}).limit(200):y.from("messages").select("*").order("created_at",{ascending:!1}).limit(200),g=t==="coach"||t==="developer"?y.from("coach_todos").select("*").eq("coach_id",e):Promise.resolve({data:[]}),_=t==="student"?y.from("student_speeds").select("*").eq("student_id",b.studentId):t==="coach"||t==="developer"?y.from("student_speeds").select("*").eq("coach_id",e):y.from("student_speeds").select("*"),T=t==="coach"||t==="developer"?y.from("konu_mastery").select("*").eq("coach_id",e):t==="student"?y.from("konu_mastery").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),f=t==="coach"||t==="developer"?y.from("konu_tekrar_log").select("*").eq("coach_id",e):t==="student"?y.from("konu_tekrar_log").select("*").eq("student_id",b.studentId):Promise.resolve({data:[]}),[$,k,B,h,S,I,z,E,A,C]=await Promise.all([n,i,c,p,m,u,g,_,T,f]);(t==="coach"||t==="developer")&&(l.workspace=$.data||null),l.students=(k.data||[]).map(w=>({id:w.id,name:w.full_name||w.username||"Öğrenci",target:w.target||"",color:w.color||"#4da6ff",progress:w.progress||0,weekStart:w.week_start||0,username:w.username,coachId:w.coach_id,yksArea:w.yks_area||"SAY"})),l.tasks={},(B.data||[]).forEach(w=>{const D=`${w.student_id}_${w.date}`;l.tasks[D]||(l.tasks[D]=[]),l.tasks[D].push({_id:w.id,type:w.type,exam:w.exam_type,subject:w.subject,duration:w.duration,note:w.note,done:w.done,student_note:w.student_note||"",student_result:w.student_result||null,student_feedback:w.student_feedback||null,task_items:w.task_items,start_time:w.start_time})}),l.appointments=(h.data||[]).map(w=>({id:w.id,studentId:w.student_id,date:w.date,time:w.time,duration:w.duration,type:w.type,note:w.note,meetLink:w.meet_link,google_event_id:w.google_event_id||null})),l.exams=(S.data||[]).map(w=>({id:w.id,studentId:w.student_id,name:w.name,date:w.date,type:w.exam_type,nets:w.nets||{},examDetails:w.exam_details||{},note:w.student_note,coachComment:w.coach_comment})),l.messages={},(I.data||[]).forEach(w=>{l.messages[w.student_id]||(l.messages[w.student_id]=[]),l.messages[w.student_id].push({_id:w.id,from:w.from_role,text:w.text||"",image_url:w.image_url||null,read:w.read,time:new Date(w.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})})}),Object.keys(l.messages).forEach(w=>l.messages[w].sort((D,j)=>D._id>j._id?1:-1)),l.coachTodos={},(z.data||[]).forEach(w=>{l.coachTodos[w.date]||(l.coachTodos[w.date]=[]),l.coachTodos[w.date].push({_id:w.id,task:w.task,note:w.note,done:w.done})}),l.studentSpeeds=E.data||[],l.konuMastery={},(A.data||[]).forEach(w=>{l.konuMastery[w.student_id]||(l.konuMastery[w.student_id]={}),l.konuMastery[w.student_id][w.subject]||(l.konuMastery[w.student_id][w.subject]={}),l.konuMastery[w.student_id][w.subject][w.konu]=w}),l.konuTekrarLog={},(C.data||[]).forEach(w=>{l.konuTekrarLog[w.student_id]||(l.konuTekrarLog[w.student_id]={}),l.konuTekrarLog[w.student_id][w.subject]||(l.konuTekrarLog[w.student_id][w.subject]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu]||(l.konuTekrarLog[w.student_id][w.subject][w.konu]={}),l.konuTekrarLog[w.student_id][w.subject][w.konu][w.period_start]=w});try{const w=JSON.parse(localStorage.getItem("ba_ui_"+((L=b.dbUser)==null?void 0:L.id))||"{}");w.weekOffset!==void 0&&(l.weekOffset=w.weekOffset),w.activeStuId&&(l.activeStuId=w.activeStuId),w.calMonth!==void 0&&(l.calMonth=w.calMonth,l.calYear=w.calYear)}catch{}}async function Ln(){if(ni()){wn().then(()=>{if(kn(),window.currentTab)try{window.switchTab(window.currentTab)}catch{}}).catch(t=>console.error("Arka plan yenileme hatası:",t));return}M(!0);try{await wn(),kn()}catch(t){console.error("loadAllData error",t)}M(!1)}window.dbQ=ei;window.loadAllData=Ln;window.invalidateCache=Cn;let Be=!1;function oe(e){const t=document.getElementById("loginErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Me(e){const t=document.getElementById("regErr");t.textContent=e,t.style.display="block",setTimeout(()=>t.style.display="none",5e3)}function Vt(e){document.getElementById("loginPanel").style.display=e==="login"?"block":"none",document.getElementById("registerPanel").style.display=e==="register"?"block":"none",document.getElementById("lmtLogin").classList.toggle("active",e==="login"),document.getElementById("lmtRegister").classList.toggle("active",e==="register")}function ai(e){window._loginMode=e,document.querySelectorAll("#loginTabs .login-tab").forEach((t,n)=>t.classList.toggle("active",n===(e==="email"?0:1))),document.getElementById("loginEmailField").style.display=e==="email"?"block":"none",document.getElementById("loginUserField").style.display=e==="username"?"block":"none"}function jn(e){window._regRole=e,[["rrbCoach","coach"],["rrbStudent","student"]].forEach(([t,n])=>{const a=document.getElementById(t);if(!a)return;const i=e===n;a.classList.toggle("sel",i),a.style.borderColor=i?"var(--accent)":"var(--border)",a.style.background=i?"var(--accent-dim)":"var(--surface2)",a.style.boxShadow=i?"0 0 0 1px var(--accent)":"none"})}function ii(e){window._onbRole=e,document.getElementById("onbRoleCoach").classList.toggle("sel",e==="coach"),document.getElementById("onbRoleStudent").classList.toggle("sel",e==="student")}async function oi(){if(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"||window.location.protocol==="file:"){Rn();return}await Pn()}async function Pn(){Zt(),M(!0);try{const{error:e}=await y.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin+"/app.html",queryParams:{access_type:"offline",prompt:"select_account"}}});e&&(M(!0),console.warn("Google Auth failed:",e),oe("Google Girişi Başlatılamadı: "+e.message))}catch(e){M(!1),oe("Google Girişi Başlatılamadı: "+e.message)}}function Rn(){document.getElementById("googleSimulatorModal").style.display="flex"}function Zt(){document.getElementById("googleSimulatorModal").style.display="none"}async function si(e){if(Zt(),M(!0),e==="demokoc"){const{data:t,error:n}=await y.from("users").select("*").eq("username","demokoc").maybeSingle();if(n||!t){M(!1),oe("Demo koç profili bulunamadı!");return}await Re(t)}else if(e==="demoogrenci"){const{data:t,error:n}=await y.from("users").select("*").eq("username","demoogrenci").maybeSingle();if(n||!t){M(!1),oe("Demo öğrenci profili bulunamadı!");return}await Re(t)}else if(e==="new"){M(!1),document.getElementById("newUserOnboarding").style.display="flex";const t=Math.floor(1e3+Math.random()*9e3),n=`yeni.kullanici${t}@gmail.com`;document.getElementById("onbEmail").textContent=n,document.getElementById("onbName").value=`Yeni Kullanıcı ${t}`,window._oauthUser={id:`mock-google-id-${t}`,email:n,user_metadata:{full_name:`Yeni Kullanıcı ${t}`}}}}async function Nn(){var t,n,a;if(window.location.hash.includes("type=recovery")){console.log("[Auth] Recovery session active, skipping checkOAuthSession");return}if(Be)return;Be=!0;let e=null;try{console.log("[Auth] 1/4 getSession...");const{data:{session:i}}=await y.auth.getSession();if(console.log("[Auth] 2/4 session:",((t=i==null?void 0:i.user)==null?void 0:t.email)||"yok"),!(i!=null&&i.user)){Be=!1;return}if((n=document.getElementById("appShell"))!=null&&n.classList.contains("visible")){Be=!1;return}M(!0),e=setTimeout(()=>{console.warn("[Auth] timeout — Supabase yanıt vermedi, spinner kapatılıyor"),Be=!1,M(!1)},1e4),console.log("[Auth] 3/4 profil yükleniyor...");const{data:o,error:s}=await y.from("users").select("*").eq("id",i.user.id).maybeSingle();console.log("[Auth] 4/4 profil:",o==null?void 0:o.role,(s==null?void 0:s.message)||""),clearTimeout(e);let r=!1;if(o){if(o.role==="coach"){const{data:d}=await y.from("workspaces").select("*").eq("coach_id",o.id).maybeSingle();(!d||!d.onboarding_done)&&(r=!0)}}else r=!0;if(o&&!r){if(o.active===!1){M(!1),y.auth.signOut(),alert("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");return}await Re(o)}else M(!1),document.getElementById("newUserOnboarding").style.display="flex",document.getElementById("onbEmail").textContent=i.user.email,document.getElementById("onbName").value=((a=i.user.user_metadata)==null?void 0:a.full_name)||"",window._oauthUser=i.user}catch(i){clearTimeout(e),Be=!1,M(!1),console.warn("[checkOAuthSession]",i)}}async function ri(){const e=document.getElementById("onbName").value.trim();if(!e){document.getElementById("onbErr").textContent="Ad soyad zorunlu",document.getElementById("onbErr").style.display="block";return}if(!window._onbRole){document.getElementById("onbErr").textContent="Hesap türü seçin",document.getElementById("onbErr").style.display="block";return}document.getElementById("onbErr").style.display="none",M(!0);const t=window._oauthUser,n=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""),a={id:t.id,full_name:e,email:t.email,role:window._onbRole,username:n+"_"+Math.random().toString(36).slice(2,6),password_hash:"supabase_managed",color:window._onbRole==="coach"?"#f0a500":"#4da6ff",week_start:0,progress:0,target:""},{data:i,error:o}=await y.from("users").upsert(a).select().single();if(o){M(!1),document.getElementById("onbErr").textContent="Hata: "+o.message,document.getElementById("onbErr").style.display="block";return}document.getElementById("newUserOnboarding").style.display="none",await Re(i)}let ee=0;function li(e,t){document.getElementById("regBrandColor").value=e,t.parentElement.querySelectorAll("div").forEach(n=>n.style.outline="none"),t.style.outline="3px solid white"}function di(){const e=document.getElementById("regErr0");if(e&&(e.style.display="none"),ee===0){if(!window._regRole){e&&(e.textContent="Lütfen bir hesap türü seçin.",e.style.display="block");return}window._regRole==="student"?ee=3:ee=1}else if(ee===1){if(!document.getElementById("regBrandName").value.trim()){alert("Lütfen akademi / koçluk adını girin.");return}ee=2}else ee===2&&(ee=3);Et(ee)}function ci(){ee===3?window._regRole==="student"?ee=0:ee=2:ee===2?ee=1:ee===1&&(ee=0),Et(ee)}function Et(e){document.getElementById("regWizardStep0").style.display=e===0?"block":"none",document.getElementById("regWizardStepCoach1").style.display=e===1?"block":"none",document.getElementById("regWizardStepCoach2").style.display=e===2?"block":"none",document.getElementById("regWizardStepFinal").style.display=e===3?"block":"none";const t=document.getElementById("regInviteWrap");t&&(t.style.display=e===3&&window._regRole==="student"?"block":"none")}function pi(e){if(e=(e||"").toUpperCase().replace(/[^0-9A-Z]/g,"").slice(0,6),e.length!==6)return;Vt("register"),jn("student"),ee=3,Et(3);const t=document.getElementById("regInviteCode");t&&(t.value=e,t.readOnly=!0,t.style.opacity=".75",Hn(),t.readOnly=!0)}let $n=null,Ht=!1;function Hn(){const e=document.getElementById("regInviteCode"),t=document.getElementById("regInviteStatus"),n=(e.value||"").toUpperCase().replace(/[^0-9A-Z]/g,"");if(e.value=n,Ht=!1,clearTimeout($n),n.length<6){t.style.display="none";return}t.style.display="block",t.style.background="var(--surface2)",t.style.color="var(--text-mid)",t.textContent="Kod kontrol ediliyor…",$n=setTimeout(async()=>{try{const{data:a,error:i}=await y.rpc("check_invite_code",{p_code:n}),o=!i&&a&&a.length?a[0].brand_name:null;o?(Ht=!0,t.style.background="rgba(5,150,105,.1)",t.style.color="var(--green)",t.textContent="✓ "+o+" akademisine katılacaksın"):(t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="✗ Kod bulunamadı — koçundan doğru kodu iste")}catch{t.style.display="none"}},450)}async function mi(){var i;const e=document.getElementById("regName").value.trim(),t=document.getElementById("regEmail").value.trim().toLowerCase(),n=document.getElementById("regPass").value;if(!e||!t||!n)return Me("Tüm hesap bilgileri zorunludur");if(n.length<8)return Me("Şifre en az 8 karakter olmalıdır");let a="";if(window._regRole==="student"){if(a=(((i=document.getElementById("regInviteCode"))==null?void 0:i.value)||"").toUpperCase().trim(),a.length!==6)return Me("Koç davet kodu gerekli — 6 haneli kodu koçundan iste.");if(!Ht)try{const{data:o}=await y.rpc("check_invite_code",{p_code:a});if(!o||!o.length)return Me("Davet kodu geçersiz — koçundan doğru kodu iste.")}catch{return Me("Kod doğrulanamadı, tekrar dene.")}}M(!0);try{let o={full_name:e,role:window._regRole};if(a&&(o.invite_code=a),window._regRole==="coach"){const d=document.getElementById("regBrandName").value.trim(),c=document.getElementById("regBrandColor").value||"#f0a500",p=document.getElementById("regPhone").value.trim(),m=[...document.querySelectorAll("#regExamTypesWrap .ob-exam-sel input")].map(_=>_.value),u=m.length>0?m.join(","):"YKS",g=document.getElementById("regStudentCountRange").value||"1-5";o.ob_brand=d,o.ob_color=c,o.ob_phone=p,o.ob_examtypes=u,o.ob_studentcount=g}const{data:s,error:r}=await y.auth.signUp({email:t,password:n,options:{data:o}});if(r)throw r;if(s!=null&&s.user){M(!1),document.getElementById("regName").value="",document.getElementById("regEmail").value="",document.getElementById("regPass").value="",document.getElementById("regBrandName")&&(document.getElementById("regBrandName").value=""),document.getElementById("regPhone")&&(document.getElementById("regPhone").value="");const d=document.getElementById("regSuccess");d.textContent="Kayıt başarılı! E-posta adresinize bir doğrulama bağlantısı gönderildi. Lütfen doğrulama yaptıktan sonra giriş yapın.",d.style.display="block",setTimeout(()=>d.style.display="none",1e4),ee=0,Et(0),Vt("login")}}catch(o){M(!1),Me("Kayıt Hatası: "+o.message)}}async function ui(){const e=(document.getElementById("loginEmail").value||document.getElementById("loginUser").value||"").trim(),t=document.getElementById("loginPass").value;if(!e||!t)return oe("Kullanıcı adı ve şifre zorunlu");M(!0);const n=setTimeout(()=>{M(!1),oe("Bağlantı zaman aşımına uğradı. Supabase yanıt vermiyor — lütfen tekrar deneyin.")},15e3);try{let a=e;a.includes("@")?a=a.toLowerCase():a=Pe(e)+"@rostrumakademi.com";const{data:i,error:o}=await y.auth.signInWithPassword({email:a,password:t});if(!o&&(i!=null&&i.user)){const{data:s,error:r}=await y.from("users").select("*").eq("id",i.user.id).maybeSingle();if(r&&console.error("Profile fetch error:",r),s){if(s.active===!1)return M(!1),y.auth.signOut(),oe("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");clearTimeout(n),await Re(s);return}return M(!1),oe("Hesabınız veritabanında aktif değil.")}try{const s=Pe(e.includes("@")?e.split("@")[0]:e),r=await He(t),{data:d}=await y.rpc("get_user_by_credentials",{p_username:s,p_password_hash:r}),c=Array.isArray(d)?d[0]:d;if(c){if(c.active===!1)return M(!1),oe("Hesabınız askıya alınmıştır. Lütfen yöneticiyle iletişime geçin.");clearTimeout(n),await Re(c);return}}catch(s){console.warn("Fallback RPC error:",s)}return M(!1),oe(o?"Giriş başarısız: "+o.message:"Kullanıcı adı veya şifre hatalı.")}catch(a){return M(!1),console.error("[doLogin]",a),oe("Giriş hatası: "+a.message)}finally{clearTimeout(n)}}async function Re(e){var n,a,i,o,s;M(!1);const t=e.role==="coach"||e.role==="developer"?e.id:e.role==="student"||e.role==="parent"?e.coach_id:null;b.role=e.role,b.studentId=e.role==="student"?e.id:null,b.dbUser=e,b.coachId=t,document.getElementById("loginScreen").style.display="none",document.getElementById("appShell").classList.add("visible");try{if(await Ln(),(b.role==="coach"||b.role==="developer")&&!l.workspace){console.log("[Auth] Workspace not found, auto-creating from signup metadata...");const{data:{user:m}}=await y.auth.getUser();if(m){const u=((n=m.user_metadata)==null?void 0:n.ob_brand)||"Akademi",g=((a=m.user_metadata)==null?void 0:a.ob_color)||"#f0a500",_=((i=m.user_metadata)==null?void 0:i.ob_phone)||null,T=((o=m.user_metadata)==null?void 0:o.ob_examtypes)||"YKS",f=((s=m.user_metadata)==null?void 0:s.ob_studentcount)||"1-5",$={coach_id:e.id,brand_name:u,brand_color:g,phone:_,exam_types:T,student_count_range:f,onboarding_done:!1},{data:k,error:B}=await y.from("workspaces").upsert($,{onConflict:"coach_id"}).select().maybeSingle();B?console.error("[finishLogin] Create workspace error:",B):k&&(l.workspace=k)}}if(b.role==="student"&&(l.activeStuId=e.id,b.studentId=e.id,l.students.find(m=>m.id===e.id)||l.students.push({id:e.id,name:e.full_name||e.username||"Öğrenci",target:e.target||"",color:e.color||"#4da6ff",progress:e.progress||0,weekStart:e.week_start||0,username:e.username,coachId:e.coach_id})),b.role==="parent"){const{data:m}=await y.from("users").select("*").eq("parent_id",e.id).single();m&&(l.activeStuId=m.id,b.studentId=m.id,b.childName=m.full_name||m.username)}window.setupShell();const r=new URLSearchParams(window.location.search);if(r.get("state")==="google_calendar"&&r.get("code")&&(b.role==="coach"||b.role==="developer")){const m=r.get("code");window.history.replaceState({},"",window.location.pathname+window.location.hash),document.getElementById("aiChatBubble").style.display="flex",setTimeout(()=>window.switchTab("appointments"),50),y.auth.getSession().then(({data:{session:u}})=>{u!=null&&u.access_token&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${u.access_token}`},body:JSON.stringify({type:"google_oauth_exchange",code:m})}).then(g=>g.json()).then(g=>{g.success?(l.workspace&&(l.workspace.google_calendar_connected=!0),x("Google Takvim bağlandı ✓"),window.renderAppointments&&window.renderAppointments()):x("Google bağlanamadı: "+(g.error||"Bilinmeyen hata"))}).catch(()=>x("Google Takvim bağlanamadı"))});return}if(document.getElementById("aiChatBubble").style.display="flex",(b.role==="coach"||b.role==="developer")&&(!l.workspace||!l.workspace.onboarding_done)){window.switchTab("home"),window.showOnboarding();return}if(b.role==="student"){const{data:m}=await y.from("student_profiles").select("onboarding_done").eq("id",b.studentId||e.id).maybeSingle();if(!m||!m.onboarding_done){const u=window.location.hash.substring(1),g=u&&document.getElementById("view-"+u)?u:"portal";setTimeout(()=>{window.switchTab(g),window.showStudentWelcome&&window.showStudentWelcome()},100);return}}const d=window.location.hash.substring(1),c={coach:"home",student:"portal",developer:"home",parent:"parent-home"}[b.role]||"portal",p=d&&document.getElementById("view-"+d)?d:c;setTimeout(()=>window.switchTab(p),50)}catch(r){M(!1),console.error("[doLogin] HATA:",r),oe("Hata: "+r.message),document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible")}}function gi(){window._fcInstance&&(window._fcInstance.destroy(),window._fcInstance=null),window.destroyRealtime&&window.destroyRealtime(),y.auth.signOut().catch(()=>{}),Cn(),b.role=null,b.studentId=null,b.dbUser=null,b.coachId=null,b.childName=null,l.workspace=null,document.getElementById("loginScreen").style.display="flex",document.getElementById("appShell").classList.remove("visible"),document.getElementById("aiChatBubble").style.display="none",document.getElementById("aiChatPanel").classList.remove("open"),document.getElementById("loginEmail")&&(document.getElementById("loginEmail").value=""),document.getElementById("loginUser")&&(document.getElementById("loginUser").value=""),document.getElementById("loginPass").value="",window.location.hash=""}function vi(){window.om("forgotPassModal")}async function fi(){const e=document.getElementById("forgotEmail").value.trim();if(!e)return;const t=document.getElementById("forgotMsg");try{const n=await fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"password_reset",email:e})}),a=await n.json();if(!n.ok)throw new Error(a.error||"Sunucu hatası");t.style.display="block",t.style.background="var(--green-dim)",t.style.color="var(--green)",t.textContent="Sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin."}catch(n){t.style.display="block",t.style.background="var(--red-dim)",t.style.color="var(--red)",t.textContent="Hata: "+(n.message||"Bir sorun oluştu.")}}async function yi(){const e=document.getElementById("newPasswordInput").value;if(!e||e.length<8){alert("Şifre en az 8 karakter olmalıdır.");return}M(!0);try{const{error:t}=await y.auth.updateUser({password:e});if(t)throw t;const n=await He(e),{data:{user:a}}=await y.auth.getUser();a&&await y.from("users").update({password_hash:n}).eq("id",a.id),alert("Şifreniz başarıyla güncellendi! Lütfen yeni şifrenizle giriş yapın."),window.cm("resetPasswordModal"),await y.auth.signOut(),window.location.hash="",window.location.reload()}catch(t){alert("Şifre güncellenirken hata oluştu: "+t.message)}finally{M(!1)}}window.loginErr=oe;window.regErr=Me;window.setAuthMode=Vt;window.setLoginMode=ai;window.setRegRole=jn;window.setOnbRole=ii;window.loginWithGoogle=oi;window.triggerRealGoogleLogin=Pn;window.showGoogleSimulator=Rn;window.closeGoogleSimulator=Zt;window.simOAuthLogin=si;window.checkOAuthSession=Nn;window.completeOnboarding=ri;window.doRegister=mi;window.doLogin=ui;window.finishLogin=Re;window.doLogout=gi;window.showForgotPassword=vi;window.sendResetEmail=fi;window.updateUserPassword=yi;window.nextRegWizardStep=di;window.prevRegWizardStep=ci;window.setRegBrandColor=li;window.onInviteCodeInput=Hn;window.applyInviteFromUrl=pi;y.auth.onAuthStateChange(async(e,t)=>{var a;if(e==="PASSWORD_RECOVERY"||window.location.hash.includes("type=recovery")){console.log("[Auth] Password recovery flow active, showing resetPasswordModal"),M(!1),window.om("resetPasswordModal");return}if(e==="SIGNED_IN"&&(t!=null&&t.user)){if((a=document.getElementById("appShell"))!=null&&a.classList.contains("visible"))return;await Nn()}e==="SIGNED_OUT"&&(Be=!1,M(!1))});function En(){const e=document.getElementById("loginEmail"),t=document.getElementById("loginUser");e&&t&&(e.addEventListener("input",n=>{t.value=n.target.value}),t.addEventListener("input",n=>{e.value=n.target.value}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",En):En();if(new URLSearchParams(window.location.search).get("new_coach")==="1"){const e=sessionStorage.getItem("ra_new_coach_email"),t=sessionStorage.getItem("ra_new_coach_pass");if(e&&t){sessionStorage.removeItem("ra_new_coach_email"),sessionStorage.removeItem("ra_new_coach_pass");const n=()=>{const a=document.getElementById("loginEmail"),i=document.getElementById("loginPass");a&&i&&(a.value=e,i.value=t,setTimeout(()=>window.doLogin&&window.doLogin(),400))};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}}function nt(e){if(!e||e<=0)return"0 sa";const t=Math.floor(e/60),n=e%60;return t>0&&n>0?`${t} sa ${n} dk`:t>0?`${t} sa`:`${n} dk`}window.formatMinToHours=nt;function ie(e){return new Promise(t=>{let n=document.getElementById("customConfirmModal");n||(n=document.createElement("div"),n.id="customConfirmModal",n.className="modal-bg",n.style.zIndex="999999",n.innerHTML=`
    ...
    <button class="mnav-btn" id="mntab_${m.id}" onclick="switchTab('${m.id}')">${m.lbl}<span style="font-size:9px;display:block">${m.name}</span></button>`).join(""),document.getElementById("mainContent").innerHTML=[...e,{id:"student-detail"},{id:"profile"},{id:"settings"},{id:"coach-resources"},{id:"coach-applications"},{id:"coach-notes"},{id:"coach-profile"},{id:"messages"},{id:"todolist"},{id:"suyelik"},{id:"program"},{id:"appointments"},{id:"exams"}].map(m=>`<div class="view" id="view-${m.id}"></div>`).join("");const t=b.dbUser,n=b.role==="student"?l.students.find(m=>m.id===b.studentId):null,a=(t==null?void 0:t.full_name)||(n==null?void 0:n.name)||"",i=a.split(" ").map(m=>m[0]).join("").slice(0,2).toUpperCase(),o={coach:"#E8613A",student:(n==null?void 0:n.color)||"#4da6ff",developer:"#c084fc",parent:"#3ecf8e"},s={coach:"KOÇ",student:"ÖĞRENCİ",developer:"DEV",parent:"VELİ"};if(document.getElementById("sbAv").textContent=i,document.getElementById("sbAv").style.background=o[b.role]||"#888",document.getElementById("sbName").textContent=a,document.getElementById("sbRole").textContent=s[b.role]||b.role,(b.role==="coach"||b.role==="developer")&&((p=l.workspace)!=null&&p.brand_name)){const m=document.querySelector(".sb-logo-text");m&&(m.textContent=l.workspace.brand_name);const u=document.querySelector(".tn-logo .sb-logo-icon");u&&u.tagName!=="IMG"&&(u.textContent=l.workspace.brand_name.slice(0,1).toUpperCase())}const r=document.getElementById("sb-site-admin");r&&(r.style.display=b.role==="developer"?"flex":"none");const d=document.getElementById("tnCoachProfileItem");d&&(d.style.display=b.role==="coach"||b.role==="developer"?"flex":"none");const c=document.getElementById("tnUyelikItem");c&&(c.style.display=b.role==="coach"||b.role==="developer"?"flex":"none"),setTimeout(At,200),ja(),setTimeout(wa,600),(b.role==="coach"||b.role==="developer")&&y.from("match_requests").select("id",{count:"exact",head:!0}).eq("matched_coach_id",b.coachId).eq("status","pending").then(({count:m})=>{if(m>0){const u=document.getElementById("sbi_coach-applications");if(u&&!u.querySelector(".sb-badge")){const g=document.createElement("span");g.className="sb-badge",g.textContent=m,u.appendChild(g)}}})}function se(e,t=!0){var p,m,u;if(!e)return;currentTab=e,t&&(window.location.hash=e),document.querySelectorAll(".tn-nav-item").forEach(g=>g.classList.remove("active"));const n=document.getElementById("sbi_"+e)||document.getElementById("sb-"+e);n&&n.classList.add("active"),document.querySelectorAll(".mnav-btn").forEach(g=>g.classList.remove("active"));const a=document.getElementById("mntab_"+e);a&&a.classList.add("active"),document.querySelectorAll(".view").forEach(g=>g.classList.remove("active"));const i=document.getElementById("view-"+e);i&&i.classList.add("active");const s=[...Yt,...Kn,...On,...Fn,{id:"profile",name:"Profil"},{id:"settings",name:"Ayarlar"},{id:"student-detail",name:((p=l.students.find(g=>g.id===l.activeStuId))==null?void 0:p.name)||"Öğrenci"},{id:"program",name:"Program"},{id:"appointments",name:"Randevular"},{id:"exams",name:"Denemeler"}].find(g=>g.id===e),r=document.getElementById("tbarTitle");r&&(r.textContent=(s==null?void 0:s.name)||e);const d={home:Gn,students:dt,messages:ya,"coach-applications":xn,"coach-notes":Ua,todolist:la,portal:Bt,sportal:ze,sexams:an,smessages:Ot,suyelik:Ns,sprofil:Sa,profile:Zn,settings:Jn,"student-detail":()=>{l.activeStuId?qn(l.activeStuId):se("students")},program:()=>{l.activeStuId?Xt(l.activeStuId):se("students")},exams:()=>{l.activeStuId?Ze():se("students")},appointments:()=>{l.activeStuId?Ve():se("students")},"dev-dashboard":ha,"dev-users":Je,"dev-resources":ct,"dev-finance":pt,"dev-announce":mt,"dev-tickets":Xe,"parent-home":Na,"parent-progress":Ha,"parent-messages":Ot,"parent-ai":Ya,"coach-profile":Ia,"dev-matches":pn,"coach-resources":ut};try{(m=d[e])==null||m.call(d)}catch(g){console.error("[switchTab] Render error for tab:",e,g),i&&(i.innerHTML=`<div style="padding:24px;color:var(--text)"><b>Hata Oluştu ⚠️</b><p style="color:var(--text-mid);margin-top:6px">${v(g.message)}</p><pre style="font-size:10px;color:var(--text-dim);white-space:pre-wrap;margin-top:8px">${v((g.stack||"").slice(0,400))}</pre></div>`)}e==="messages"||e==="smessages"?sn():rn();const c=document.getElementById("aiChatBubble");c&&(e==="dev-tickets"||e.startsWith("dev-")||e==="messages"||e==="smessages"?(c.style.display="none",(u=document.getElementById("aiChatPanel"))==null||u.classList.remove("open")):(b.role==="student"||b.role==="coach"||b.role==="parent")&&(c.style.display="flex"))}function Gn(){var t,n;const e=document.getElementById("view-home");if(e)try{const a=new Date,i=["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],o=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],s=O(a);let r=0;Object.values(l.messages).forEach(I=>{r+=I.filter(z=>z.from==="student"&&!z.read).length});const d=l.appointments.filter(I=>I.date===s).sort((I,z)=>I.time.localeCompare(z.time)),c=[],p=ne(0,0);(l.students||[]).forEach(I=>{let z=0,E=0;for(let D=0;D<7;D++){const j=O(J(p,D)),P=l.tasks[`${I.id}_${j}`]||[];z+=P.length,E+=P.filter(Y=>Y.done).length}const A=z>0?Math.round(E/z*100):0;z>0&&A<30&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"tasks",icon:"📋",title:"Düşük Görev",desc:`Bu haftaki görev tamamlama oranı <b>%${A}</b>'de kaldı (${E}/${z} görev tamamlandı).`});const C=(l.exams||[]).filter(D=>D.studentId===I.id).sort((D,j)=>new Date(j.date).getTime()-new Date(D.date).getTime()),L={};if(C.forEach(D=>{L[D.type]||(L[D.type]=[]),L[D.type].push(D)}),Object.entries(L).forEach(([D,j])=>{if(j.length>=2){const P=j[0],Y=j[1],H=Object.values(P.nets||{}).reduce((Z,te)=>Z+Number(te||0),0),F=Object.values(Y.nets||{}).reduce((Z,te)=>Z+Number(te||0),0),V=H-F;V<-5&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"exams",icon:"📉",title:`Net Düşüşü (${D})`,desc:`Son denemede <b>${H} net</b> yaptı. Önceki denemesine (${F} net) göre <b>${Math.abs(V).toFixed(1)} net düşüş</b>.`})}}),z===0&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"noplan",icon:"📭",title:"Program Yok",desc:"Bu hafta için henüz hiç görev eklenmemiş."}),z>0&&E===0){let D=!1;for(let j=0;j<3;j++){const P=O(J(a,-j));if((l.tasks[`${I.id}_${P}`]||[]).length>0){D=!0;break}}D&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"inactive",icon:"💤",title:"3 Gündür Pasif",desc:"Son 3 gündür hiçbir görev tamamlanmadı. İletişime geç!"})}z>0&&E===z&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"perfect",icon:"🏆",title:"Harika Hafta!",desc:`Bu haftaki tüm ${z} görevi tamamladı! Tebrik et.`}),(l.studentSpeeds||[]).filter(D=>D.student_id===I.id).forEach(D=>{let j=120;D.exam_type==="TYT"?["Türkçe","Sosyal"].includes(D.subject)?j=100:["Matematik","Fen"].includes(D.subject)&&(j=130):D.exam_type&&D.exam_type.startsWith("AYT")&&(j=180),D.secs_per_question>j&&c.push({studentId:I.id,studentName:I.name,color:I.color,type:"speed",icon:"⚡",title:`Hız Aşımı (${D.exam_type} - ${D.subject})`,desc:`Soru çözüm hızı <b>${D.secs_per_question} sn/soru</b> (Limit: ${j} sn).`})})});let m="";if(c.length===0)l.students.length===0?m=`
        ...
        ${L}
      </div>`}).join("")}const u=a.getHours(),g=u<6?"İyi geceler":u<12?"Günaydın":u<18?"İyi günler":"İyi akşamlar",_=`${String(u).padStart(2,"0")}:${String(a.getMinutes()).padStart(2,"0")}`,T=d.find(I=>I.time>=_),f=qt(),$=f.days,k=ne(0,0);let B=0,h=0;l.students.forEach(I=>{for(let z=0;z<7;z++){const E=l.tasks[`${I.id}_${O(J(k,z))}`]||[];B+=E.length,h+=E.filter(A=>A.done).length}});const S=B>0?Math.round(h/B*100):0;e.innerHTML=`
    <!-- HERO -->
    <div class="home-hero">
    ...
    <div class="home-bottom-grid">
      ...
      <div class="home-section-card">
        ...
        <div class="hsc-body">
          ...
          ${d.map(I=>{const z=l.students.find(F=>F.id===I.studentId),E=I.time<_,[A,C]=I.time.split(":").map(Number),L=A*60+C,[w,D]=_.split(":").map(Number),j=w*60+D,P=L-j,Y=P>=-(I.duration||60)&&P<=15,H=Y&&I.meet_link?`<a href="${v(I.meet_link)}" target="_blank" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;background:${P<=0?"var(--red)":"var(--accent)"};color:#fff;font-size:11px;font-weight:800;text-decoration:none;animation:${P<=0?"pulse 1.5s infinite":"none"};white-space:nowrap;flex-shrink:0">${P<=0?"🔴 Ders Sürüyor":"🟡 Derse Gir"}</a>`:"";return`<div class="hsc-appt-row ${E&&!Y?"hsc-appt-past":""}">
    ...
    <div class="card" style="margin-top:16px; border: 1px dashed var(--accent); padding: 18px; border-radius: 14px; background: var(--surface)">
    ...
    </div>`,currentTab!=="student-detail"&&se("student-detail");const c=document.getElementById("tbarTitle");c&&(c.textContent=t.name)}const Ke=[{stars:0,label:"Başlanmadı",color:"#6b7280",bg:"rgba(107,114,128,.08)",border:"rgba(107,114,128,.2)"},{stars:1,label:"Anlamadım",color:"#ef4444",bg:"rgba(239,68,68,.08)",border:"rgba(239,68,68,.2)"},{stars:2,label:"Temel Zorluk",color:"#f97316",bg:"rgba(249,115,22,.08)",border:"rgba(249,115,22,.2)"},{stars:3,label:"Temel OK",color:"#eab308",bg:"rgba(234,179,8,.08)",border:"rgba(234,179,8,.2)"},{stars:4,label:"Orta Seviye",color:"#84cc16",bg:"rgba(132,204,22,.08)",border:"rgba(132,204,22,.2)"},{stars:5,label:"İleri Seviye",color:"#22c55e",bg:"rgba(34,197,94,.08)",border:"rgba(34,197,94,.2)"},{stars:6,label:"Uzman",color:"#10b981",bg:"rgba(16,185,129,.08)",border:"rgba(16,185,129,.2)"},{stars:7,label:"Tekrar Dışı (TD)",color:"#3b82f6",bg:"rgba(59,130,246,.1)",border:"rgba(59,130,246,.3)"}];function Wn(e){const t=new Date(e),n=t.getDate(),a=n<=10?1:n<=20?11:21;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function wi(e=6){const t=[],n=new Date;let a=new Date(n);for(let i=0;i<e;i++){const o=Wn(a);t.find(c=>c.start===o)||t.unshift({start:o,label:$i(o)});const[s,r,d]=o.split("-").map(Number);if(d===21?a=new Date(s,r-1,11):d===11?a=new Date(s,r-1,1):a=new Date(s,r-2,21),t.length>=e)break}return t.slice(-e)}function $i(e){const[t,n,a]=e.split("-").map(Number),i=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],o=a===1?10:a===11?20:new Date(t,n,0).getDate();return`${a}-${o} ${i[n-1]}`}const _n={SAY:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","TYT Fizik","AYT Fizik","TYT Kimya","AYT Kimya","TYT Biyoloji","AYT Biyoloji"],EA:["Dil Bilgisi","TYT Matematik","AYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],SOZ:["Dil Bilgisi","TYT Matematik","Geometri","AYT Edebiyat","Tarih (TYT-AYT)","Coğrafya (TYT-AYT)","Felsefe Grubu & Din"],DIL:["Dil Bilgisi","TYT Matematik","Geometri","YDT İngilizce"]};async function Ei(e){const t=l.students.find(f=>f.id===e);if(!t)return;const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button><div style="padding:20px;color:var(--text-dim);font-size:13px">Yükleniyor…</div>`;const a=b.role==="coach"||b.role==="developer",i=t.yksArea||"SAY",o=_n[i]||_n.SAY;let s=o[0],r="mastery";function d(f,$){var k,B;return((B=(k=l.konuMastery[e])==null?void 0:k[f])==null?void 0:B[$])||null}function c(f,$){var k,B;return((B=(k=l.konuTekrarLog[e])==null?void 0:k[f])==null?void 0:B[$])||{}}async function p(f,$,k,B){const h=d(f,$),S=new Date().toISOString(),I=B||(k>=7?"td":k>0?"active":"not_started"),z={student_id:e,coach_id:b.coachId,subject:f,konu:$,stars:k,status:I,updated_at:S,...I==="active"&&!(h!=null&&h.ka_date)?{ka_date:S}:{},...I==="td"&&!(h!=null&&h.td_date)?{td_date:S}:{},...I==="active"&&(h==null?void 0:h.status)==="td"?{td_date:null}:{}},{data:E,error:A}=await y.from("konu_mastery").upsert(z,{onConflict:"student_id,subject,konu"}).select().single();if(A){x("Hata: "+A.message);return}return l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][$]=E,E}async function m(f,$,k,B){const h=new Date().toISOString(),S={student_id:e,coach_id:b.coachId,subject:f,konu:$,period_start:k,review_count:B,updated_at:h},{data:I,error:z}=await y.from("konu_tekrar_log").upsert(S,{onConflict:"student_id,subject,konu,period_start"}).select().single();if(z){x("Hata: "+z.message);return}return l.konuTekrarLog[e]||(l.konuTekrarLog[e]={}),l.konuTekrarLog[e][f]||(l.konuTekrarLog[e][f]={}),l.konuTekrarLog[e][f][$]||(l.konuTekrarLog[e][f][$]={}),l.konuTekrarLog[e][f][$][k]=I,I}function u(f){const $=at[f]||[],k=$.map((E,A)=>{const C=d(f,E),L=(C==null?void 0:C.stars)||0,w=(C==null?void 0:C.status)||"not_started",D=Ke[L],j=w==="td",P=A%2===0?"var(--surface)":"var(--surface2)",Y=c(f,E),H=Object.values(Y).reduce((Q,R)=>Q+(R.review_count||0),0),F=C!=null&&C.last_review_date?new Date(C.last_review_date).toLocaleDateString("tr-TR",{day:"2-digit",month:"short"}):"—",V=a?Array.from({length:7},(Q,R)=>{const N=R+1,K=N<=L,re=f.replace(/'/g,"\\'"),xe=E.replace(/'/g,"\\'");return`<span class="km-star${K?" km-star-on":""}" data-stars="${N}" 
    ...
    </div>`}function g(f){const $=at[f]||[],k=wi(6),B=Wn(new Date),h=`<tr style="background:var(--surface2)">
      <th style="padding:8px 14px;text-align:left;font-size:10px;font-weight:800;color:var(--text-dim);border-right:1px solid var(--border);position:sticky;left:0;z-index:2;background:var(--surface2);white-space:nowrap;min-width:200px">KONU</th>
    ...
    </tr>`,S=$.map((I,z)=>{const E=d(f,I),A=(E==null?void 0:E.stars)||0,L=((E==null?void 0:E.status)||"not_started")==="td",w=Ke[A],D=z%2===0?"var(--surface)":"var(--surface2)",j=c(f,I);let P=0;const Y=k.map(F=>{const V=j[F.start],Z=(V==null?void 0:V.review_count)||0;P+=Z;const te=F.start===B;if(a){const Q=Array.from({length:6},(R,N)=>{const K=N<Z,re=f.replace(/'/g,"\\'"),xe=I.replace(/'/g,"\\'");return`<span class="kt-box${K?" kt-box-on":""}"
      ...
      </tr>`}).join("");return`<div style="overflow-x:auto"><table style="border-collapse:collapse;width:max-content;min-width:100%"><thead>${h}</thead><tbody>${S}</tbody></table></div>`}window._kmSetStars=async function(f,$,k){const B=d(f,$),h=(B==null?void 0:B.status)==="td"&&k<7?"active":null;await p(f,$,k,h);const S="km_"+btoa(encodeURIComponent(f+"|"+$)).replace(/[^a-zA-Z0-9]/g,"");if(document.getElementById(S)){const z=u(f);document.getElementById("khTable").innerHTML=z}x(`${$}: ${Ke[k].label} ✓`)},window._kmToggleKA=async function(f,$){const k=d(f,$),B=new Date().toISOString(),h=!!(k!=null&&k.ka_date),S={student_id:e,coach_id:b.coachId,subject:f,konu:$,stars:(k==null?void 0:k.stars)||1,status:(k==null?void 0:k.status)||"active",ka_date:h?null:B,updated_at:B},{data:I,error:z}=await y.from("konu_mastery").upsert(S,{onConflict:"student_id,subject,konu"}).select().single();if(z){x("Hata: "+z.message);return}l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][$]=I,document.getElementById("khTable").innerHTML=u(f),x(h?"KA tarihi kaldırıldı":"KA ✓ tamamlandı olarak işaretlendi")},window._kmToggleTD=async function(f,$){const k=d(f,$),B=(k==null?void 0:k.status)==="td",h=B?(k==null?void 0:k.stars)>=7?5:k==null?void 0:k.stars:7;await p(f,$,h,B?"active":"td"),document.getElementById("khTable").innerHTML=r==="mastery"?u(f):g(f),x(B?`${$} tekrar listesine geri döndü`:`${$} → TD ✓`)},window._ktToggleBox=async function(f,$,k,B){const S=c(f,$)[k],z=((S==null?void 0:S.review_count)||0)>=B?B-1:B;if(await m(f,$,k,z),z>0){const E=d(f,$),A=new Date().toISOString(),C={student_id:e,coach_id:b.coachId,subject:f,konu:$,stars:(E==null?void 0:E.stars)||0,status:(E==null?void 0:E.status)||"active",last_review_date:A,review_count:((E==null?void 0:E.review_count)||0)+1,updated_at:A},{data:L}=await y.from("konu_mastery").upsert(C,{onConflict:"student_id,subject,konu"}).select().single();L&&(l.konuMastery[e]||(l.konuMastery[e]={}),l.konuMastery[e][f]||(l.konuMastery[e][f]={}),l.konuMastery[e][f][$]=L)}document.getElementById("khTable").innerHTML=g(f)};function _(){const f=window._khActiveSub||s;document.getElementById("khTable").innerHTML=r==="mastery"?u(f):g(f)}const T=o.map(f=>`<button class="kh-tab" onclick="window._khActiveSub='${f}';document.querySelectorAll('.kh-tab').forEach(b=>{b.style.color='var(--text-mid)';b.style.borderBottom='2px solid transparent';b.style.fontWeight='600'});this.style.color='var(--accent)';this.style.borderBottom='2px solid var(--accent)';this.style.fontWeight='700';window._khRefresh()"
    ...
    ${c}`}function Ii(e){document.getElementById("sbModalTitle").textContent="Kaynak Ekle",document.getElementById("sbId").value="",document.getElementById("sbStuId").value=e,document.getElementById("sbName").value="",document.getElementById("sbTotal").value="0",document.getElementById("sbCompleted").value="0",document.getElementById("sbPctPreview").innerHTML="",G("sbModal")}function zi(e,t){const n=(ye[e]||[]).find(a=>a.id===t);n&&(document.getElementById("sbModalTitle").textContent="Kaynağı Düzenle",document.getElementById("sbId").value=t,document.getElementById("sbStuId").value=e,document.getElementById("sbName").value=n.name,document.getElementById("sbTotal").value=n.total_tests,document.getElementById("sbCompleted").value=n.completed_tests,Vn(),G("sbModal"))}function Vn(){var o,s;const e=parseInt((o=document.getElementById("sbTotal"))==null?void 0:o.value)||0,t=parseInt((s=document.getElementById("sbCompleted"))==null?void 0:s.value)||0,n=document.getElementById("sbPctPreview");if(!n||!e){n&&(n.innerHTML="");return}const a=Math.min(100,Math.round(t/e*100)),i=a>=75?"var(--green)":a>=40?"var(--accent)":"var(--red)";n.innerHTML=`<div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;height:8px;background:var(--surface3);border-radius:99px;overflow:hidden">
      ...
      <div class="settings-block">
        ...
        <div class="setting-item">
          ...
          <div class="accent-palette">
            ${Aa.map(a=>`<div class="ac-dot" onclick="applyAccent('${a.val}','${a.dim}')" style="background:${a.val}" title="${a.name}"></div>`).join("")}
          </div>
        </div>
      </div>
    ...
    <div class="week-grid">${r}</div>`}function Ci(e){l.activeStuId=e||null,rt(),X()}function Li(e){l.weekOffset+=e,rt(),X()}function ji(){l.weekOffset=0,rt(),X()}function Pi(e){localStorage.setItem("ra_program_mode",e),b.role==="student"?ze():X()}window.setProgramMode=Pi;(()=>{const e=document.createElement("style");e.textContent=`
    .tc-time-badge {
      font-size: 11px;
      font-weight: 800;
      color: var(--accent);
...
`)],{type:"text/calendar;charset=utf-8"}),a=URL.createObjectURL(n),i=document.createElement("a");i.href=a,i.download="rostrum-ajanda.ics",i.click(),URL.revokeObjectURL(a),x("Ajanda indirildi ✓")}function ra(e,t){t.stopPropagation();const n=document.getElementById("apptDetailPopup");if(n){const g=n.dataset.id;if(n.remove(),g===e)return}const a=l.appointments.find(g=>g.id===e);if(!a)return;const i=l.students.find(g=>g.id===a.studentId),o=sa(a.type),s=document.createElement("div");s.id="apptDetailPopup",s.dataset.id=e;const r=window.innerWidth,d=window.innerHeight,c=264;let p=Math.min(t.clientX+12,r-c-12),m=Math.min(t.clientY+12,d-220);s.style.cssText=`position:fixed;left:${p}px;top:${m}px;z-index:600;width:${c}px;background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:14px 16px;box-shadow:0 8px 32px rgba(0,0,0,.18);animation:viewIn .15s ease`;const u=a.meetLink||a.meet_link;s.innerHTML=`
    ...
    <div style="display:flex;gap:6px;flex-wrap:wrap">
      ...
      <a href="${co(a)}" target="_blank" style="font-size:11px;font-weight:700;color:var(--green);background:var(--green-dim);padding:4px 10px;border-radius:99px;text-decoration:none">📅 GCal</a>
    ...
    </div>`,document.body.appendChild(s),setTimeout(()=>{document.addEventListener("click",function g(_){s.contains(_.target)||(s.remove(),document.removeEventListener("click",g))})},50)}async function fo(e,t){e.preventDefault();const n=window._draggingApptId;if(!n)return;window._draggingApptId=null;const a=e.currentTarget,i=a.getBoundingClientRect(),o=a.closest("[data-tl-scroll]"),s=o?o.scrollTop:0,d=(e.clientY-i.top+s)/lo*60+Sn*60,c=Math.max(Sn,Math.min(ro-1,Math.floor(d/60))),p=Math.round(d%60/15)*15,m=p>=60?0:p,u=`${String(c).padStart(2,"0")}:${String(m).padStart(2,"0")}`,{error:g}=await y.from("appointments").update({date:t,time:u}).eq("id",n);if(g){x("Hata: "+g.message);return}const _=l.appointments.find(T=>T.id===n);_&&(_.date=t,_.time=u),$e(),x("Randevu taşındı ✓")}function la(){$e()}function $e(){const e=document.getElementById("view-todolist");if(!e)return;if(!document.getElementById("fc-styles")){const r=document.createElement("style");r.id="fc-styles",r.textContent=`
      .fc {
...
🔗 Davet Linki: ${n}`);a.innerHTML=`<div class="modal" style="max-width:480px">
  ...
  </div>`,window._pendingInvite={name:e,email:t,inviteUrl:n},G("inviteModal")}function ko(e){navigator.clipboard.writeText(e).then(()=>x("Bağlantı kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),x("Bağlantı kopyalandı ✓")})}async function wo(e){var a;if(!await ie("Bu öğrenciyi silmek istediğinizden emin misiniz?"))return;const t=document.getElementById(`sturow_${e}`);t&&(t.style.transition="all 0.3s ease",t.style.opacity="0",t.style.transform="translateX(30px)",t.innerHTML='<div style="color:var(--red); font-weight:700; font-size:13px; display:flex; align-items:center; gap:6px">🗑️ Siliniyor...</div>'),await new Promise(i=>setTimeout(i,300));const{error:n}=await y.from("users").delete().eq("id",e);if(n)return x("Hata: "+n.message);l.students=l.students.filter(i=>i.id!==e),l.activeStuId===e&&(l.activeStuId=((a=l.students[0])==null?void 0:a.id)||null),we(),ca(),x("Silindi")}function $o(){const e="217851738834-1cp3fk66hfhm0mr2aklsk3jphqmub2s3.apps.googleusercontent.com",t=encodeURIComponent("https://www.rostrumakademi.com/app.html"),n=encodeURIComponent("https://www.googleapis.com/auth/calendar.events"),a=`https://accounts.google.com/o/oauth2/v2/auth?client_id=${e}&redirect_uri=${t}&response_type=code&scope=${n}&access_type=offline&prompt=consent&state=google_calendar`;window.location.href=a}window.connectGoogleCalendar=$o;function Ve(){var a,i;const e=document.getElementById("view-appointments"),n=((a=l.workspace)==null?void 0:a.google_calendar_connected)?'<span style="font-size:12px;color:var(--green);font-weight:600;display:flex;align-items:center;gap:4px">✓ Google Takvim</span>':'<button class="btn btn-ghost btn-sm" onclick="connectGoogleCalendar()">🔗 Google Takvim Bağla</button>';e.innerHTML=`
...
`)],{type:"text/calendar;charset=utf-8"}),o=URL.createObjectURL(i),s=document.createElement("a");s.href=o,s.download="rostrum-randevular.ics",s.click(),setTimeout(()=>URL.revokeObjectURL(o),1e3),x(`${t.length} randevu takvim dosyasına aktarıldı ✓`)}function ht(e){return 100+(Number(e.Türkçe||0)+Number(e.Matematik||0)+Number(e.Fen||0)+Number(e.Sosyal||0))*(400/120)}function ma(e,t){const n=a=>Number(t[a]||0);return e==="AYT-SAY"?100+(n("Matematik")+n("Fizik")+n("Kimya")+n("Biyoloji"))*5:e==="AYT-EA"?100+(n("Matematik")+n("Edebiyat")+n("Tarih")+n("Coğrafya"))*5:e==="AYT-SOZ"?100+(n("Edebiyat")+n("Tarih1")+n("Tarih2")+n("Coğrafya1")+n("Coğrafya2")+n("Felsefe")+n("Din"))*5:null}const ua={"AYT-SAY":"SAY","AYT-EA":"EA","AYT-SOZ":"SÖZ"},kt={TYT:"#3B82F6",SAY:"#8B5CF6",EA:"#10B981",SÖZ:"#F59E0B"};function ga(e,t){const{type:n,nets:a}=e;if(n==="TYT"){const d=ht(a),c=kt.TYT;return`<div style="margin-top:10px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
    ...
    </div>`}const i=ua[n];if(!i)return"";const o=kt[i]||"#64748B",s=ma(n,a),r=t.filter(d=>d.type==="TYT"&&d.date<=e.date).sort((d,c)=>c.date.localeCompare(d.date))[0];if(r){const d=ht(r.nets),c=d*.4+s*.6;return`<div style="margin-top:10px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">
    ...
    </div>`;return}const a=ua[t],i=kt[a]||"#64748B",o=ma(t,n);if(o===null){e.innerHTML="";return}const s=(c=document.getElementById("emStudent"))==null?void 0:c.value,r=s?[...l.exams].filter(p=>p.studentId===s&&p.type==="TYT").sort((p,m)=>m.date.localeCompare(p.date))[0]:null;if(r){const p=ht(r.nets),m=p*.4+o*.6;e.innerHTML=`<div style="background:${i}12;border:1px solid ${i}35;border-radius:10px;padding:10px 14px">
  ...
  ${V}${Z}
    ...
    ${o}`}window._krRenderBody=fa;function Lo(e){va=e;const t=l.exams.find(n=>n.studentId===e&&n.examDetails&&Object.keys(n.examDetails).length);De=(t==null?void 0:t.type)||"TYT",fa(),G("konuRaporuModal")}window.openKonuRaporu=Lo;function jo(e){const t=l.exams.find(n=>n.id===e);document.getElementById("cmExamId").value=e,document.getElementById("cmText").value=(t==null?void 0:t.coachComment)||"",G("commentModal")}async function Po(){const e=document.getElementById("cmExamId").value,t=document.getElementById("cmText").value.trim();await y.from("exams").update({coach_comment:t}).eq("id",e);const n=l.exams.find(a=>a.id===e);n&&(n.coachComment=t),q("commentModal"),Ze(),x("Yorum kaydedildi ✓")}async function Ro(e){await ie("Bu denemeyi silmek istediğinizden emin misiniz?")&&(await y.from("exams").delete().eq("id",e),l.exams=l.exams.filter(t=>t.id!==e),Ze(),x("Silindi"))}function ya(){const e=document.getElementById("view-messages");e.innerHTML=`<div class="sh" style="margin-bottom:14px"><h2>Mesajlar</h2></div>
  ...
  <div class="msg-input-area">
    ...
    </div>`}async function Yo(e,t){var s;const n=l.students.find(r=>r.id===b.studentId);if(!n)return;const a=`${n.id}_${e}`,i=(s=l.tasks[a])==null?void 0:s[t];if(!i)return;const o=!i.done;await y.from("tasks").update({done:o}).eq("id",i._id),i.done=o,Bt()}function ze(){const e=l.students.find(p=>p.id===b.studentId);if(!e)return;const t=document.getElementById("view-sportal"),n=e.weekStart??0,a=ne(l.weekOffset,n),i=J(a,6),o=ue(),s=localStorage.getItem("ra_program_mode")||"weekly";let r="";for(let p=0;p<7;p++){const m=J(a,p),u=O(m),g=u===o,_=`${e.id}_${u}`,T=l.tasks[_]||[],f=T.reduce((S,I)=>S+Number(I.duration),0),$=T.reduce((S,I)=>S+(I.done?Number(I.duration):0),0);DAYS_TR[(n+p)%7];const k=[...T];s==="hourly"&&k.sort((S,I)=>S.start_time&&!I.start_time?-1:!S.start_time&&I.start_time?1:S.start_time&&I.start_time?S.start_time.localeCompare(I.start_time):0);const B=k.map(S=>{const I=T.indexOf(S),z=S.start_time?`<div class="tc-time-badge">🕒 ${S.start_time}</div>`:"";return`
  ...
  </div>`}function Go(e){const t=e.student_feedback||{};if(!(t.status||t.focus||t.difficulty||t.time_spent>0||t.blocker))return"";const a={completed:{l:"Tamamladı",c:"#3ecf8e",bg:"rgba(62,207,142,.1)"},partial:{l:"Kısmen Tamamladı",c:"#f0a500",bg:"rgba(240,165,0,.1)"},failed:{l:"Yapamadı",c:"#ef4444",bg:"rgba(239,68,68,.1)"}},i={1:"Çok Kolay",2:"Kolay",3:"Orta",4:"Zor",5:"Çok Zor"},o={time:"Zamanı yetmedi",topic:"Konuyu anlayamadı",hard:"Kaynak çok zordu",moti:"Motivasyon yok"},s=a[t.status],r=t.time_spent,d=r>0?(Math.floor(r/60)>0?Math.floor(r/60)+"sa ":"")+(r%60>0?r%60+"dk":""):null,c=t.focus?"★".repeat(t.focus)+"☆".repeat(5-t.focus):null,p={1:"#3ecf8e",2:"#86efac",3:"#f0a500",4:"#fb923c",5:"#ef4444"},m=t.difficulty?p[t.difficulty]:"var(--text-mid)";return`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:12px 16px;margin-bottom:14px">
    ...
    ${(()=>{var k;const $=Ki(o.exam,o.subject);return $?(pe=[...((k=o.student_result)==null?void 0:k.yanlis_konular)||[]],`<div style="background:var(--surface2);border:1px solid var(--border);border-radius:11px;padding:14px 16px;margin-bottom:14px">
    ...
    ${a}${i}`}function xa(e){var n;const t=e?l.exams.find(a=>a.id===e):null;document.getElementById("emTitle").textContent=t?"Sonucu Düzenle":"Deneme Sonucu Gir",document.getElementById("emId").value=e||"",document.getElementById("emName").value=(t==null?void 0:t.name)||"",document.getElementById("emDate").value=(t==null?void 0:t.date)||O(new Date),document.getElementById("emStudentWrap").style.display="none",document.getElementById("emStudent").innerHTML=`<option value="${b.studentId}">${v(((n=l.students.find(a=>a.id===b.studentId))==null?void 0:n.name)||"")}</option>`,document.getElementById("emExamType").value=(t==null?void 0:t.type)||"TYT",document.getElementById("emNote").value=(t==null?void 0:t.note)||"",on(),t!=null&&t.examDetails&&Object.entries(t.examDetails).forEach(([a,i])=>{const o=document.getElementById(`ed_${a}_d`),s=document.getElementById(`ed_${a}_y`),r=document.getElementById(`ed_${a}_b`);o&&(o.value=i.dogru||0,s.value=i.yanlis||0,r.value=i.bos||0),ae[a]={...i},ba(a),(i.yanlis_konular||[]).forEach(d=>{document.querySelectorAll(`#konu_acc_${a.replace(/\s/g,"_")} span`).forEach(p=>{p.textContent.trim()===d&&(p.style.borderColor="var(--red)",p.style.background="rgba(255,92,122,.12)",p.style.color="var(--red)")})})}),G("examModal")}function Jo(e){document.getElementById("emStudentWrap").style.display="",document.getElementById("emStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),xa(e),document.getElementById("emStudentWrap").style.display=""}let ae={};function Xo(e,t,n){ae[t]||(ae[t]={dogru:0,yanlis:0,bos:0,yanlis_konular:[]});const a=ae[t].yanlis_konular,i=a.indexOf(n);i===-1?(a.push(n),e.style.borderColor="var(--red)",e.style.background="rgba(255,92,122,.12)",e.style.color="var(--red)"):(a.splice(i,1),e.style.borderColor="var(--border)",e.style.background="var(--surface)",e.style.color="var(--text-mid)")}window.toggleExamKonuChip=Xo;function ba(e){var c,p,m,u;const t=parseInt((c=document.getElementById(`ed_${e}_d`))==null?void 0:c.value)||0,n=parseInt((p=document.getElementById(`ed_${e}_y`))==null?void 0:p.value)||0,a=parseInt((m=document.getElementById(`ed_${e}_b`))==null?void 0:m.value)||0;ae[e]||(ae[e]={yanlis_konular:[]}),ae[e].dogru=t,ae[e].yanlis=n,ae[e].bos=a;const i=document.getElementById("emExamType").value,o=((u=EXAM_SORU[i])==null?void 0:u[e])||40,s=t+n+a,r=document.getElementById(`ed_${e}_net`),d=document.getElementById(`ed_${e}_warn`);r&&(r.textContent=Math.max(0,t-n/4).toFixed(2)),d&&(d.style.display=s>o?"":"none"),Do()}window.updateExamNet=ba;function Qo(e){const t=document.getElementById(`konu_acc_${e.replace(/\s/g,"_")}`);t&&(t.style.display=t.style.display==="none"?"":"none")}window.toggleKonuAccordion=Qo;function on(){const e=document.getElementById("emExamType").value,t=EXAM_DEFS[e]||[];ae={};const n=document.getElementById("emPuanDisplay");n&&(n.innerHTML=""),document.getElementById("netInputsWrap").innerHTML=t.map(a=>{var d;const i=((d=EXAM_SORU[e])==null?void 0:d[a])||40,s=(EXAM_KONU_MAP[`${e}_${a}`]||[]).flatMap(c=>at[c]||[]),r=s.length?`
    ...
    </div>`,Ie()}let ft=null;function sn(){rn();const e=b.role==="coach"||b.role==="developer"?l.msgThread:b.studentId;e&&(ft=y.channel("messages_"+e).on("postgres_changes",{event:"INSERT",schema:"public",table:"messages",filter:`student_id=eq.${e}`},t=>{const n=t.new;l.messages[e]||(l.messages[e]=[]),!l.messages[e].find(a=>a._id===n.id)&&(l.messages[e].push({_id:n.id,from:n.from_role,text:n.text||"",image_url:n.image_url||null,read:n.read,time:new Date(n.created_at).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}),b.role==="student"&&n.from_role==="coach"&&currentTab!=="smessages"&&At(),currentTab==="messages"&&l.msgThread===e&&(document.getElementById("msgMain").innerHTML=Se(e,"coach"),Ie()),currentTab==="smessages"&&(document.getElementById("msgMain").innerHTML=Se(e,"student"),Ie()))}).subscribe())}function rn(){ft&&(y.removeChannel(ft),ft=null)}async function ts(){var e,t;await y.from("workspaces").upsert({coach_id:b.coachId,brand_name:((e=l.workspace)==null?void 0:e.brand_name)||"Akademi",brand_color:((t=l.workspace)==null?void 0:t.brand_color)||"#E8613A",onboarding_done:!1},{onConflict:"coach_id"}),l.workspace&&(l.workspace.onboarding_done=!1),_a()}window.devResetOnboarding=ts;async function ha(){const e=document.getElementById("view-dev-dashboard");e.innerHTML='<div class="sh"><h2>🖥️ Sistem Dashboard</h2></div><div class="empty"><p>Yükleniyor...</p></div>';const[t,n,a,i,o,s]=await Promise.all([y.from("users").select("id,role,created_at"),y.from("tasks").select("id,done,created_at"),y.from("exams").select("id,created_at"),y.from("messages").select("id,created_at"),y.from("tickets").select("id,status,created_at"),y.from("payments").select("id,amount,status,payment_date")]),r=t.data||[],d=n.data||[],c=a.data||[],p=i.data||[],m=o.data||[],u=s.data||[],g=r.filter(h=>h.role==="coach").length,_=r.filter(h=>h.role==="student").length,T=u.filter(h=>h.status==="completed").reduce((h,S)=>h+Number(S.amount),0),f=m.filter(h=>h.status==="open").length,$=Array.from({length:7},(h,S)=>{const I=new Date;return I.setDate(I.getDate()-6+S),O(I)}),k=$.map(h=>d.filter(S=>{var I;return(I=S.created_at)==null?void 0:I.startsWith(h)}).length),B=Math.max(...k,1);e.innerHTML=`
...
Bu işlem geri alınamaz.`)){M(!0);try{const{data:{session:n}}=await y.auth.getSession(),a=await fetch("/api/delete-user",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${(n==null?void 0:n.access_token)||""}`},body:JSON.stringify({targetUserId:e})}),i=await a.json();if(!a.ok)throw new Error(i.error||"Sunucu hatası");x(`🗑 ${t} silindi`),Je()}catch(n){x("Hata: "+n.message)}finally{M(!1)}}}function os(e,t,n,a){let i=document.getElementById("planMgmtModal");i||(i=document.createElement("div"),i.id="planMgmtModal",i.className="modal-bg",i.innerHTML=`<div class="modal" style="max-width:400px">
    ...
    </div>`}function rs(){let e=document.getElementById("playlistModal");e||(e=document.createElement("div"),e.id="playlistModal",e.className="modal-bg",document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),e.innerHTML=`<div class="modal modal-lg">
...
`).map(r=>r.trim()).filter(Boolean);let o=[];a?o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",url:d[1]||"",topic:"",soru:parseInt(d[2])||0}}):o=i.map(r=>{const d=r.split("|").map(c=>c.trim());return{label:d[0]||"",soru:parseInt(d[1])||0}});const s={exam_type:document.getElementById("rmExam").value,subject:t,publisher:document.getElementById("rmPublisher").value.trim(),year:new Date().getFullYear(),name:e,tests:o,active:document.getElementById("rmActive").value==="true",resource_type:a?"playlist":"book"};n?(await y.from("resources").update(s).eq("id",n),x("Güncellendi ✓")):(await y.from("resources").insert(s),x("Kaynak eklendi ✓")),q("resourceModal"),ct()}async function ms(e){await ie("Bu kaynağı silmek istediğinizden emin misiniz?")&&(await y.from("resources").delete().eq("id",e),x("Silindi"),ct())}async function pt(){const e=document.getElementById("view-dev-finance"),[{data:t},{data:n}]=await Promise.all([y.from("subscriptions").select("*,users(full_name,color)").order("created_at",{ascending:!1}),y.from("payments").select("*,users(full_name)").order("payment_date",{ascending:!1}).limit(20)]),a=(n||[]).filter(o=>o.status==="completed").reduce((o,s)=>o+Number(s.amount),0),i=(t||[]).filter(o=>o.status==="active").length;e.innerHTML=`
    ...
    </div>`}async function us(e){const{error:t}=await y.from("payments").update({verified:!0}).eq("id",e);if(t){x("Onaylanamadı: "+t.message);return}x("✓ Ödeme doğrulandı"),pt()}function gs(){let e=document.getElementById("paymentModal");e||(e=document.createElement("div"),e.id="paymentModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('paymentModal')">×</button>
      <h2>Ödeme Ekle</h2>
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pmStudent").innerHTML=l.students.map(t=>`<option value="${t.id}">${v(t.name)}</option>`).join(""),G("paymentModal")}async function vs(){const e=parseFloat(document.getElementById("pmAmount").value);if(!e)return x("Tutar girin!");await y.from("payments").insert({student_id:document.getElementById("pmStudent").value,amount:e,method:document.getElementById("pmMethod").value,payment_date:document.getElementById("pmDate").value,description:document.getElementById("pmDesc").value,status:"completed"}),x("Ödeme kaydedildi ✓"),q("paymentModal"),pt()}function fs(){let e=document.getElementById("subModal");e||(e=document.createElement("div"),e.id="subModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('subModal')">×</button>
      <h2>Abonelik Ekle</h2>
    ...
    ${(t||[]).map(a=>`
      ...
      </div>`).join("")}`}function xs(){let e=document.getElementById("announceModal");e||(e=document.createElement("div"),e.id="announceModal",e.className="modal-bg",e.innerHTML=`<div class="modal"><button class="modal-close" onclick="cm('announceModal')">×</button>
      <h2>Yeni Duyuru</h2>
  ...
  `,Es(),jt&&clearInterval(jt),jt=setInterval($s,4e3)}function ws(e){me=e,Xe()}async function $s(){if(!me||!document.getElementById("devChatArea"))return;const{data:t,error:n}=await y.from("tickets").select("*,users!tickets_user_id_fkey(full_name,role)").eq("id",me).single();if(n||!t)return;let a=[];try{a=JSON.parse(t.body),Array.isArray(a)||(a=[{sender:"user",text:t.body,time:t.created_at}])}catch{a=[{sender:"user",text:t.body,time:t.created_at}]}const i=document.getElementById("devChatMessages");if(i){const o=i.scrollTop,s=i.scrollHeight-i.clientHeight-o<40;i.innerHTML=a.map(r=>{const d=r.sender==="emin",c=d?"Kurucu / Destek":r.sender==="ai"?"Yapay Zeka":r.name||"Kullanıcı",p=d?"var(--blue)":r.sender==="ai"?"var(--surface2)":"var(--accent)",m=d?"#fff":r.sender==="ai"?"var(--text)":"var(--on-accent)",u=d?"flex-end":"flex-start",g=d?"14px 14px 4px 14px":"14px 14px 14px 4px",_=new Date(r.time).toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"});return`
      ...
      `}).join(""),s&&(i.scrollTop=i.scrollHeight)}}function Es(){var s,r,d;const e=document.getElementById("devChatArea");if(!e)return;const t=Fe.find(c=>c.id===me);if(!t){e.innerHTML=`
  ...
  `;const o=document.getElementById("devChatMessages");o&&(o.scrollTop=o.scrollHeight)}async function _s(){const e=document.getElementById("devReplyInput"),t=e.value.trim();if(!t||!me)return;e.value="",M(!0);const{data:n}=await y.from("tickets").select("body").eq("id",me).single();let a=[];if(n&&n.body)try{a=JSON.parse(n.body)}catch{a=[{sender:"user",text:n.body,time:new Date().toISOString()}]}const i={sender:"emin",text:t,time:new Date().toISOString(),name:"Kurucu / Destek"};a.push(i);const{error:o}=await y.from("tickets").update({body:JSON.stringify(a),reply:t,status:"resolved",updated_at:new Date().toISOString()}).eq("id",me);if(M(!1),o){x("Hata: "+o.message);return}x("Yanıt gönderildi ✓"),Xe()}async function Ts(e,t){await y.from("tickets").update({status:t,updated_at:new Date().toISOString()}).eq("id",e),x("Durum güncellendi ✓"),Xe()}async function Ss(e){await ie("Bu talebi silmek istediğinizden emin misiniz?")&&(await y.from("tickets").delete().eq("id",e),x("Silindi"),me=null,Xe())}function Is(){Mt()}async function Mt(){let e=document.getElementById("supportChatModal");e||(e=document.createElement("div"),e.id="supportChatModal",e.className="modal-bg",e.style.zIndex="99999999",e.innerHTML=`
    ...
    `}).join(""),a&&(t.scrollTop=t.scrollHeight)}function zs(){_e="ai",ve=[{sender:"ai",text:"Merhaba! Ben Rostrum Akademi Yapay Zeka Asistanıyım. 🤖 Size nasıl yardımcı olabilirim?",time:new Date().toISOString()}],it(ve)}function Bs(){_e="emin_start";const e=document.getElementById("supportMessages");e&&(e.innerHTML=`
      <div style="text-align:center;padding:40px 20px">
    ...
    </div>`,i.appendChild(s)}),document.body.appendChild(i),setTimeout(()=>i.remove(),8e3)}(()=>{const e=document.createElement("style");e.textContent=".role-dev{background:rgba(192,132,252,.15);color:#c084fc;}",document.head.appendChild(e)})();function $a(e){return`ra_ob_${b.coachId}_${e}`}function Ft(e){return localStorage.getItem($a(e))==="1"}function As(e){localStorage.setItem($a(e),"1"),Ea(),["student","program","report"].every(n=>Ft(n))&&Cs()}async function Cs(){const e=document.getElementById("obWidget");e&&(e.innerHTML=`<div style="padding:20px;text-align:center">
  ...
  </div>`}let je=0;const U={};async function js(){const e=l.students.find(i=>i.id===b.studentId);if(!e)return;const t=e.name.split(" ")[0],n=e.color||"var(--accent)";U={};try{const{data:i}=await y.from("student_profiles").select("*").eq("id",b.studentId).maybeSingle();i&&(U.parent_email=i.parent_email||"",U.parent_phone=i.parent_phone||"",U.target_rank=i.target_rank||"",U.target_university=i.target_university||"",U.target_department=i.target_department||"",U.struggling_subjects=i.struggling_subjects||"",U.daily_capacity=i.daily_capacity||8)}catch{}U.yks_area=e.yks_area||"SAY",U.daily_capacity===void 0&&(U.daily_capacity=8);let a=document.getElementById("stuWelcomeModal");a||(a=document.createElement("div"),a.id="stuWelcomeModal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.85);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(8px)",document.body.appendChild(a)),je=0,Ta(a,t,n,e)}function Ee(e){const t=document.getElementById("sw_err");t&&(t.textContent=e,t.style.display="block",setTimeout(()=>{t&&(t.style.display="none")},5e3))}function Ta(e,t,n,a){const i="width:100%;padding:12px 14px;background:var(--surface2);border:1.5px solid var(--border);border-radius:10px;color:var(--text);font-size:14px;outline:none;font-family:inherit;box-sizing:border-box",o="font-size:11px;font-weight:700;color:var(--text-mid);display:block;margin-bottom:5px;text-transform:uppercase;letter-spacing:.05em",s="font-size:11px;color:var(--text-dim);margin-top:5px;line-height:1.5",r=[{v:"SAY",ico:"🔬",name:"Sayısal",sub:"Mat · Fen"},{v:"EA",ico:"⚖️",name:"Eşit Ağırlık",sub:"Mat · Edb"},{v:"SOZ",ico:"📖",name:"Sözel",sub:"Edb · Sosyal"},{v:"DIL",ico:"🌍",name:"Dil",sub:"Yabancı Dil"}],d=[()=>`<div style="text-align:center">
    ...
    ${d[je]()}
      ...
      <div style="display:flex;flex-direction:column;gap:10px;text-align:left">
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px 16px;font-size:13px;display:flex;align-items:center;gap:12px"><span style="font-size:20px">📈</span><span>Deneme netlerini girdikçe grafiklerin oluşacak</span></div>
    ...
    </div>`;return}if(m.length>0){const z=m.slice(-6),E=Math.max(...z.map(A=>(EXAM_DEFS[A.type]||[]).reduce((L,w)=>{var D;return L+Number(((D=A.nets)==null?void 0:D[w])||0)},0)),1);`${z.map(A=>{const L=(EXAM_DEFS[A.type]||[]).reduce((H,F)=>{var V;return H+Number(((V=A.nets)==null?void 0:V[F])||0)},0),w=Math.max(Math.round(L/E*100),4),D=z[z.indexOf(A)-1],j=D?(EXAM_DEFS[D.type]||[]).reduce((H,F)=>{var V;return H+Number(((V=D.nets)==null?void 0:V[F])||0)},0):L,P=L>j?"↑":L<j?"↓":"",Y=L>j?"var(--green)":L<j?"var(--red)":"var(--text-dim)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
            ...
            </div>`}).join("")}`}if(m.length>0){const z=u.type,A=(EXAM_DEFS[z]||[]).map(C=>{var j;const L=m.filter(P=>P.type===z).map(P=>{var Y;return Number(((Y=P.nets)==null?void 0:Y[C])||0)}),w=L.length?L.reduce((P,Y)=>P+Y,0)/L.length:0,D=Number(((j=u.nets)==null?void 0:j[C])||0);return{f:C,avg:w.toFixed(1),last:D,color:Gt(D)}});`${z}${A.map(C=>`
    ...
    <div class="card cp" style="margin-bottom:14px">
      ...
      <div style="position:relative;height:160px;display:flex;align-items:flex-end;gap:6px;padding-bottom:28px">
        ...
        ${S.map((z,E)=>{const C=(EXAM_DEFS[z.type]||[]).reduce((F,V)=>{var Z;return F+Number(((Z=z.nets)==null?void 0:Z[V])||0)},0),L=Math.max(Math.round(C/I*132),4),w=S[E-1],D=w?(EXAM_DEFS[w.type]||[]).reduce((F,V)=>{var Z;return F+Number(((Z=w.nets)==null?void 0:Z[V])||0)},0):C,j=C>D,P=C<D,Y=j?"var(--green)":P?"var(--red)":e.color,H=v(z.name.replace(/deneme|tyt|ayt/gi,"").trim()).slice(0,10)||"#"+(E+1);return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:0;position:relative">
    ...
    <div class="card cp" style="margin-bottom:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:10px">
        ${(()=>{const z=EXAM_DEFS[u.type]||[],E=m.filter(C=>C.type===u.type),A=Math.max(...z.map(C=>Math.max(...E.map(L=>{var w;return Number(((w=L.nets)==null?void 0:w[C])||0)}))),1);return z.map(C=>{var Y;const L=Number(((Y=u.nets)==null?void 0:Y[C])||0),w=E.map(H=>{var F;return Number(((F=H.nets)==null?void 0:F[C])||0)}),D=w.length?w.reduce((H,F)=>H+F,0)/w.length:0,j=Math.round(L/A*100),P=L>=D*1.1?"var(--green)":L<D*.9?"var(--red)":e.color;return`<div style="display:flex;align-items:center;gap:10px">
    ...
    </div>`}async function Ps(){const e=b.dbUser.id,t=document.getElementById("spBio").value.trim(),n=document.getElementById("spSchool").value.trim(),a=document.getElementById("spGrade").value.trim(),i=document.getElementById("spTargetUni").value.trim(),o=document.getElementById("spTargetDept").value.trim(),s=document.getElementById("spStruggling").value.trim(),r=parseInt(document.getElementById("spCapacity").value)||null,d={id:e,bio:t,school:n,grade:a,target_university:i,target_department:o,struggling_subjects:s,daily_capacity:r,updated_at:new Date().toISOString()},{error:c}=await y.from("student_profiles").upsert(d);x(c?"Profil kaydedilemedi: "+c.message:"Profil başarıyla güncellendi ✓")}async function Rs(){const e=document.getElementById("newPass1").value,t=document.getElementById("newPass2").value;if(!e)return x("Şifre girin!");if(e!==t)return x("Şifreler uyuşmuyor!");if(e.length<4)return x("En az 4 karakter olmalı");const{error:n}=await y.from("users").update({password_hash:e}).eq("id",b.studentId);if(n)return x("Hata: "+n.message);x("Şifre güncellendi ✓"),document.getElementById("newPass1").value="",document.getElementById("newPass2").value=""}async function Ns(){const e=document.getElementById("view-suyelik");if(!e)return;e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;height:200px"><div style="width:32px;height:32px;border:3px solid var(--accent);border-top-color:transparent;border-radius:50%;animation:spin .7s linear infinite"></div></div>',l.students.find(f=>f.id===b.studentId);const t=b.dbUser;let n=null;if(b.coachId){const{data:f}=await y.from("users").select("full_name,plan,trial_ends_at,created_at,email").eq("id",b.coachId).maybeSingle();n=f}const a=t!=null&&t.created_at?new Date(t.created_at):null,i=new Date,o=(n==null?void 0:n.plan)||"trial",s=o==="trial"?"Deneme Dönemi":o==="pro"?"Pro Üyelik":o==="premium"?"Premium Üyelik":o.charAt(0).toUpperCase()+o.slice(1),r=o==="trial"?"#f0a500":o==="pro"?"#3ecf8e":o==="premium"?"#8b5cf6":"#3ecf8e",d=o==="trial"?"#fff8e6":o==="pro"?"#e6faf3":o==="premium"?"#f3e8ff":"#e6faf3";let c=null;n!=null&&n.trial_ends_at?c=new Date(n.trial_ends_at):n!=null&&n.created_at&&(c=new Date(new Date(n.created_at).getTime()+14*24*60*60*1e3));const p=c?Math.max(0,Math.ceil((c-i)/(1e3*60*60*24))):null,m=a?Math.floor((i-a)/(1e3*60*60*24)):null,u=f=>f?f.toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"}):"—",g=p===null?"#888":p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444",_=p===null?"❓":p>7?"✅":p>3?"⚠️":"🔴",T=p===null?"Durum bilinmiyor":p>7?"Aktif":p>3?"Yakında Sona Eriyor":p===0?"Bugün Sona Eriyor":"Kritik — "+p+" gün";e.innerHTML=`
    <div style="max-width:480px;margin:0 auto;padding:16px">
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:16px">
        ${[{icon:"🎓",label:"Koçum",value:(n==null?void 0:n.full_name)||"—"},{icon:"📅",label:"Kayıt Tarihi",value:u(a)},{icon:"⏳",label:"Kullanım Süresi",value:m!==null?m+" gün":"—"},{icon:"📆",label:"Üyelik Sona Erme",value:u(c)},{icon:"⌛",label:"Kalan Süre",value:p!==null?`<span style="color:${g};font-weight:700">${p} gün</span>`:"—"}].map(({icon:f,label:$,value:k},B,h)=>`
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:18px;margin-bottom:16px">
        ...
        ${(()=>{const f=c&&a?Math.max(1,Math.ceil((c-a)/864e5)):14,$=Math.min(f,f-p),k=Math.min(100,Math.round($/f*100)),B=p>7?"#3ecf8e":p>3?"#f0a500":"#ef4444";return`
            ...
            <div>
              ...
              <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                ...
                <input type="text" id="cpSlug" value="${v(u)}" placeholder="ad-soyad" maxlength="40" autocomplete="off"
                  ...
                  onfocus="this.style.borderColor='var(--accent)'" onblur="this.style.borderColor='var(--border)'">
                <button class="btn btn-ghost" style="padding: 8px 12px; height: 37px;" onclick="const sl=document.getElementById('cpSlug').value.trim(); const url=sl ? 'https://rostrumakademi.com/koc/'+sl : '${g}'; navigator.clipboard.writeText(url); showToast('Link kopyalandı ✓')">🔗 Kopyala</button>
                <a href="${u?`https://rostrumakademi.com/koc/${u}`:g}" id="cpSlugBrowseBtn" target="_blank" class="btn btn-accent" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center; height:37px; padding:0 14px; border-radius:9px; font-size:13px; font-weight:700;">👁 Gözat</a>
              </div>
  ...
  `,dn(),Ye(),document.getElementById("cpEducation")&&(document.getElementById("cpEducation").value=r),document.getElementById("cpExperience")&&(document.getElementById("cpExperience").value=d)}const In=["YKS","TYT","AYT","LGS","Sayısal","Eşit Ağırlık","Sözel","Dil","Matematik","Geometri","Fizik","Kimya","Biyoloji","Türkçe","Edebiyat","Tarih","Coğrafya"];function ln(){var e;return(((e=document.getElementById("cpSubjects"))==null?void 0:e.value)||"").split(",").map(t=>t.trim()).filter(Boolean)}function Hs(e){e.stopPropagation();const t=document.getElementById("cpTagDropdownMenu");if(!t)return;const n=t.style.display==="block";t.style.display=n?"none":"block"}window._tagDropdownListenerAdded||(document.addEventListener("click",e=>{const t=document.getElementById("cpTagDropdownMenu"),n=document.getElementById("cpTagSelectBox");t&&t.style.display==="block"&&n&&!n.contains(e.target)&&!t.contains(e.target)&&(t.style.display="none")}),window._tagDropdownListenerAdded=!0);function dn(){const e=document.getElementById("cpSelectedTags"),t=document.getElementById("cpDropdownPresets");if(!e||!t)return;const n=ln();n.length===0?e.innerHTML='<span style="font-size:13px; color:var(--text-dim);">Etiket seçmek için tıklayın...</span>':e.innerHTML=n.map(i=>`
      ...
      `).join("");const a=n.filter(i=>!In.includes(i));t.innerHTML=[...In,...a].map(i=>{const o=n.includes(i);return`
...
Kurallar: 1. tekil şahıs ("...yım/...yorum"), veli ve öğrenciye güven veren sıcak-profesyonel ton, 60-90 kelime, tek paragraf, emoji ve başlık YOK, abartılı/uydurma iddia YOK (sadece verdiğim bilgileri kullan). Yalnızca biyografi metnini yaz, başka hiçbir şey ekleme.`}]})}),p=await c.json();if(!c.ok||!p.reply)throw new Error(p.error||"Yanıt alınamadı");document.getElementById("cpBio").value=p.reply.trim().replace(/^["']|["']$/g,""),Ye(),x("Biyografi taslağı hazır — dilediğin gibi düzenleyebilirsin ✓")}catch(c){ge("AI biyografi üretilemedi: "+(c.message||c))}e&&(e.disabled=!1,e.textContent="🤖 AI ile Oluştur")}function ge(e){const t=document.getElementById("cpErr");if(!t)return x(e);t.textContent=e,t.style.display="block",t.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{t.style.display="none"},6e3)}let yt="bio";function Ye(){var u,g,_,T,f,$,k,B;const e=((u=document.getElementById("cpPhotoUrl"))==null?void 0:u.value.trim())||"",t=((g=document.getElementById("cpSubjects"))==null?void 0:g.value.trim())||"",n=((_=document.getElementById("cpBio"))==null?void 0:_.value.trim())||"",a=((T=document.getElementById("cpEducation"))==null?void 0:T.value.trim())||"",i=((f=document.getElementById("cpExperience"))==null?void 0:f.value.trim())||"",o=(($=document.getElementById("cpInstagram"))==null?void 0:$.value.trim())||"",s=((k=document.getElementById("cpLinkedin"))==null?void 0:k.value.trim())||"",r=((B=b.dbUser)==null?void 0:B.full_name)||"Koç",d=document.getElementById("prevAvatar");if(d)if(e)d.style.backgroundImage=`url('${e}')`,d.style.backgroundColor="transparent",d.innerHTML="";else{d.style.backgroundImage="",d.style.backgroundColor="var(--accent-dim)";const h=r.split(" ").map(S=>S[0]).join("").slice(0,2).toUpperCase();d.innerHTML=h||"?"}const c=document.getElementById("prevSocials");if(c){let h="";if(o&&(h+=`<a href="https://instagram.com/${o}" target="_blank" class="preview-social-link" title="Instagram">📸 @${o}</a>`),s){let S="LinkedIn";s.includes("/in/")&&(S="in/"+s.split("/in/")[1].split("/")[0]),h+=`<a href="${s}" target="_blank" class="preview-social-link" title="LinkedIn">💼 ${S}</a>`}c.innerHTML=h}const p=document.getElementById("prevSubjects");if(p)if(t){const h=t.split(",").map(S=>S.trim()).filter(Boolean);p.innerHTML=h.map(S=>`<span class="preview-tag">${v(S)}</span>`).join("")}else p.innerHTML='<span class="preview-tag" style="background:none; border:1px dashed var(--border); color:var(--text-dim)">Ders / Uzmanlık Belirtilmedi</span>';const m=document.getElementById("prevTabContent");if(m){let h="";yt==="bio"?h=n||"Biyografi bilgisi henüz girilmedi.":yt==="edu"?h=a||"Eğitim bilgisi henüz girilmedi.":yt==="exp"&&(h=i||"Deneyim/başarılar henüz girilmedi."),m.innerHTML=Ma(v(h))}}function Fs(e){yt=e;const t=document.getElementById("btn-prev-bio"),n=document.getElementById("btn-prev-edu"),a=document.getElementById("btn-prev-exp");t&&t.classList.toggle("active",e==="bio"),n&&n.classList.toggle("active",e==="edu"),a&&a.classList.toggle("active",e==="exp"),Ye()}function Ma(e){return e.replace(/\n/g,"<br>")}async function Us(){var m;const e=b.dbUser.id,t=document.getElementById("cpBio").value.trim(),n=document.getElementById("cpSubjects").value.trim(),a=document.getElementById("cpEducation").value.trim(),i=document.getElementById("cpExperience").value.trim(),o=document.getElementById("cpPhotoUrl").value.trim(),s=document.getElementById("cpInstagram").value.trim(),r=document.getElementById("cpLinkedin").value.trim(),d=(((m=document.getElementById("cpSlug"))==null?void 0:m.value)||"").trim();if(!o)return ge("Profil fotoğrafı zorunlu — velilerin en çok baktığı güven sinyali.");if(!n)return ge("En az bir uzmanlık etiketi seç.");if(t.length<30)return ge('Biyografi en az 30 karakter olmalı — "AI ile Oluştur" butonunu kullanabilirsin.');if(!a)return ge("Eğitim bilgini gir (örn: Muğla Sıtkı Koçman Üniversitesi - Tıp Fakültesi).");if(!i)return ge("Deneyim/başarı bilgini gir (örn: YKS 2025 Sayısal 9.805.lik).");if(d&&d.length<3)return ge("Profil linki en az 3 karakter olmalı.");if(d&&!Ue)return ge("Bu profil linki alınmış — başka bir tane dene.");const c={id:e,bio:t,subjects:n,education:a,experience:i,photo_url:o,instagram:s,linkedin:r,slug:d||null,updated_at:new Date().toISOString()};localStorage.setItem(`coach_profile_${e}`,JSON.stringify(c));let{error:p}=await y.from("coach_profiles").upsert(c);if(p&&/slug/i.test(p.message||"")&&/column/i.test(p.message||"")){const{slug:u,...g}=c;({error:p}=await y.from("coach_profiles").upsert(g)),p||x("Profil kaydedildi — link için migration_v26 gerekli")}if(p){if(/duplicate|unique/i.test(p.message||""))return ge("Bu profil linki az önce başkası tarafından alındı — farklı bir tane dene.");console.warn("Database save failed, profile saved locally in localStorage:",p),x("Profil yerel tarayıcıya kaydedildi (Veritabanı hatası: "+p.message+")")}else{cn=d;const u=document.getElementById("cpSlugBrowseBtn");u&&(u.href=d?`https://rostrumakademi.com/koc/${d}`:`${window.location.origin}/koc_bul.html?coach=${e}`),x("Profil başarıyla güncellendi ✓")}}async function pn(){const e=document.getElementById("view-dev-matches");if(!e)return;e.innerHTML='<div class="loading">Eşleşmeler yükleniyor...</div>';const{data:t,error:n}=await y.from("match_requests").select("*, matched_coach:matched_coach_id(full_name, username)").order("created_at",{ascending:!1});if(n){e.innerHTML=`<div style="padding:20px;color:var(--red)">Eşleşme başvuruları yüklenirken hata oluştu: ${v(n.message)}</div>`;return}const a={pending:"⏳ Bekliyor",matched:"🤝 Eşleştirildi",completed:"✅ Tamamlandı"},i={pending:"rgba(240, 165, 0, 0.15)",matched:"rgba(96, 180, 255, 0.15)",completed:"rgba(62, 207, 142, 0.15)"},o={pending:"var(--accent)",matched:"var(--accent4)",completed:"var(--green)"};e.innerHTML=`
  ...
  `}async function Gs(e,t){const{error:n}=await y.from("match_requests").update({status:t}).eq("id",e);n?x("Durum güncellenirken hata: "+n.message):(x("Durum güncellendi ✓"),pn())}async function qs(e){const t=l.students.find(s=>s.id===e);if(!t)return;const{data:n}=await y.from("student_speeds").select("*").eq("student_id",e),a={};(n||[]).forEach(s=>{a[`${s.exam_type}_${s.subject}`]=s.secs_per_question});const i=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];let o=document.getElementById("speedModal");o||(o=document.createElement("div"),o.id="speedModal",o.className="modal-bg",document.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&o.classList.remove("open")})),o.innerHTML=`<div class="modal modal-lg">
  ...
  </div>`,G("speedModal")}async function Ws(e){const t=[{exam:"TYT",sub:"Matematik"},{exam:"TYT",sub:"Türkçe"},{exam:"TYT",sub:"Fizik"},{exam:"TYT",sub:"Kimya"},{exam:"TYT",sub:"Biyoloji"},{exam:"TYT",sub:"Geometri"},{exam:"AYT-SAY",sub:"Matematik"},{exam:"AYT-SAY",sub:"Fizik"},{exam:"AYT-SAY",sub:"Kimya"},{exam:"AYT-SAY",sub:"Biyoloji"}];for(const{exam:n,sub:a}of t){const i=`${n}_${a}`,o=document.getElementById("spd_"+i);if(!o)continue;const s=parseInt(o.value)||180;await ia(e,n,a,s)}q("speedModal"),x("Hız ayarları kaydedildi ✓")}async function Vs(e){const t=l.students.find(o=>o.id===e);if(!t)return;const{data:n}=await y.from("student_notes").select("notes").eq("coach_id",b.coachId).eq("student_id",e).maybeSingle(),a=(n==null?void 0:n.notes)||"";let i=document.getElementById("studentNotesModal");i||(i=document.createElement("div"),i.id="studentNotesModal",i.className="modal-bg",document.body.appendChild(i),i.addEventListener("click",o=>{o.target===i&&i.classList.remove("open")})),i.innerHTML=`<div class="modal">
  ...
  </div>`,G("studentNotesModal")}async function Zs(e){const t=document.getElementById("studentNoteText").value,{error:n}=await y.from("student_notes").upsert({coach_id:b.coachId,student_id:e,notes:t,updated_at:new Date().toISOString()},{onConflict:"coach_id,student_id"});if(n){x("Not kaydedilemedi: "+n.message);return}x("Not kaydedildi ✓"),q("studentNotesModal")}function Js(e){let t=document.getElementById("reportModal");t||(t=document.createElement("div"),t.id="reportModal",t.className="modal-bg",t.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.classList.remove("open")}),document.getElementById("rpPeriod").addEventListener("change",function(){document.getElementById("rpCustomDates").style.display=this.value==="custom"?"":"none"})),document.getElementById("rpStuId").value=e;const n=new Date,a=new Date(n.getFullYear(),n.getMonth(),1);document.getElementById("rpStart").value=O(a),document.getElementById("rpEnd").value=O(n),document.getElementById("rpNote").value="",G("reportModal")}function mn(){const e=document.getElementById("rpPeriod").value,t=new Date;if(e==="weekly"){const n=ne(0,0);return{start:O(n),end:O(J(n,6))}}else return e==="monthly"?{start:O(new Date(t.getFullYear(),t.getMonth(),1)),end:O(t)}:{start:document.getElementById("rpStart").value,end:document.getElementById("rpEnd").value}}function un(e,t=!1){var h,S,I,z;const n=l.students.find(E=>E.id===e);if(!n)return"";const{start:a,end:i}=mn(),o=document.getElementById("rpNote").value.trim(),s=((h=l.workspace)==null?void 0:h.brand_name)||"Rostrum Akademi",r=((S=l.workspace)==null?void 0:S.brand_color)||"#E8613A",d=((I=b.dbUser)==null?void 0:I.full_name)||"Koç",c=[],p=new Date(a);for(;O(p)<=i;){const E=`${e}_${O(p)}`;(l.tasks[E]||[]).forEach(A=>c.push({...A,date:O(p)})),p.setDate(p.getDate()+1)}const m=c.length,u=c.filter(E=>E.done).length,g=m>0?Math.round(u/m*100):0,_=c.filter(E=>E.done).reduce((E,A)=>E+Number(A.duration||0),0),T={};c.forEach(E=>{const A=E.subject||"Diğer";T[A]||(T[A]={total:0,done:0}),T[A].total++,E.done&&T[A].done++});const f=l.exams.filter(E=>E.studentId===e&&E.date>=a&&E.date<=i).sort((E,A)=>E.date.localeCompare(A.date)),$=l.appointments.filter(E=>E.studentId===e&&E.date>=a&&E.date<=i).sort((E,A)=>E.date.localeCompare(A.date)),k=`${new Date(a+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})} – ${new Date(i+"T12:00").toLocaleDateString("tr-TR",{day:"numeric",month:"long",year:"numeric"})}`;let B="";if(f.length>1){const E=Math.max(...f.map(w=>(EXAM_DEFS[w.type]||[]).reduce((D,j)=>{var P;return D+Number(((P=w.nets)==null?void 0:P[j])||0)},0)),1),A=400,C=80,L=Math.min(40,(A-20)/f.length-4);B=`<svg width="${A}" height="${C+30}" style="overflow:visible">
      ${f.map((w,D)=>{const j=(EXAM_DEFS[w.type]||[]).reduce((H,F)=>{var V;return H+Number(((V=w.nets)==null?void 0:V[F])||0)},0),P=Math.max(Math.round(j/E*(C-10)),4),Y=10+D*((A-20)/f.length);return`<rect x="${Y}" y="${C-P}" width="${L}" height="${P}" rx="3" fill="${r}" opacity="0.85"/>
...
</html>`}function Xs(){const e=document.getElementById("rpStuId").value,t=un(e,!0),n=window.open("","_blank","width=900,height=700");n.document.write(t),n.document.close()}function Qs(){const e=document.getElementById("rpStuId").value;l.students.find(a=>a.id===e);const t=un(e,!1),n=window.open("","_blank");n.document.write(t),n.document.close(),setTimeout(()=>{n.focus(),n.print()},500),q("reportModal"),x('PDF oluşturuluyor — "PDF olarak kaydet" seçin')}async function er(){const e=document.getElementById("rpStuId").value,t=l.students.find(s=>s.id===e);if(!t)return;const n=`${window.location.origin}/api/generate-pdf-report?studentId=${e}`,a=`Merhaba, ${t.name} isimli öğrencimizin bu dönemki performans ve gelişim raporu hazırlandı. Aşağıdaki bağlantıdan raporu detaylıca görüntüleyebilirsiniz:

🔗 ${n}`,o=`https://api.whatsapp.com/send?text=${encodeURIComponent(a)}`;window.open(o,"_blank"),q("reportModal"),x("WhatsApp yönlendirmesi açıldı ✓")}function tr(){let e=document.getElementById("weeklyPDFModal");e||(e=document.createElement("div"),e.id="weeklyPDFModal",e.className="modal-bg",e.innerHTML=`<div class="modal">
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.remove("open")})),document.getElementById("pdfNote").value="",G("weeklyPDFModal")}function nr(){const e=document.getElementById("pdfNote").value.trim();q("weeklyPDFModal"),Da(l.activeStuId,e)}function Da(e,t){var C,L;const n=l.students.find(w=>w.id===e);if(!n)return;const a=(n==null?void 0:n.weekStart)??0,i=ne(l.weekOffset,a),o=J(i,6),s=((C=l.workspace)==null?void 0:C.brand_name)||"Rostrum Akademi",r=((L=l.workspace)==null?void 0:L.brand_color)||"#E8613A",d=["Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi","Pazar"],c=["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],p={deneme:"#f59e0b",soru:"#3b82f6",konu:"#10b981",diger:"#8b5cf6"},m={deneme:"Deneme",soru:"Soru Bankası",konu:"Konu Anlatımı",diger:"Diğer"};let u=0,g=0,_=0;const T=[];for(let w=0;w<7;w++){const D=J(i,w),j=O(D),P=l.tasks[`${e}_${j}`]||[];u+=P.length,g+=P.filter(Y=>Y.done).length,_+=P.reduce((Y,H)=>Y+Number(H.duration||0),0),P.length>0&&T.push({d:D,ds:j,tasks:P,dayName:d[(a+w)%7]})}const f=u>0?Math.round(g/u*100):0,$=163.36,k=($*(1-f/100)).toFixed(1),B=(w,D=5)=>{let j="";for(let P=1;P<=D;P++)j+=`<span style="display:inline-block;width:6px;height:6px;border-radius:50%;margin-right:2px;background:${P<=w?r:"#E8E6DE"}"></span>`;return j},h=w=>w?'<span style="display:inline-flex;align-items:center;justify-content:center;width:15px;height:15px;border-radius:50%;background:#22C55E;flex-shrink:0"><svg width="8" height="6" viewBox="0 0 8 6"><path d="M1 3L3 5L7 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></span>':'<span style="display:inline-block;width:15px;height:15px;border-radius:50%;border:1.5px solid #D1D0DC;flex-shrink:0"></span>';let S="";for(const{d:w,tasks:D,dayName:j}of T){const P=D.reduce((H,F)=>H+Number(F.duration||0),0),Y=D.map(H=>{const F=p[H.type]||"#94a3b8",V=m[H.type]||"Diğer",Z=H.done,te=H.student_result||null,Q=H.student_feedback||null,R=te&&(te.dogru!=null||te.yanlis!=null||te.bos!=null)?`
      ...
      ${Y}
    </div>`}const z=[{val:g,lbl:"Tamamlanan",col:"#22C55E"},{val:u-g,lbl:"Bekleyen",col:"#C4C3D0"},{val:Math.round(_/60)+" sa",lbl:"Toplam Süre",col:r},{val:u,lbl:"Toplam Görev",col:"#C4C3D0"}].map((w,D)=>`<div style="flex:1;${D>0?"border-left:1px solid rgba(255,255,255,.06);padding-left:16px;":""}padding-right:16px">
  ...
  </body></html>`,A=window.open("","_blank","width=1000,height=850");A.document.write(E),A.document.close(),setTimeout(()=>A.focus(),300)}async function ar(){var s,r;G("inviteCodeModal");const e=document.getElementById("invCodeBox");let t=(s=l.workspace)==null?void 0:s.invite_code;if(!t){e.textContent="……";try{const{data:d,error:c}=await y.rpc("ensure_invite_code");!c&&d&&(t=d,l.workspace&&(l.workspace.invite_code=t))}catch{}}if(!t){e.textContent="—",x("Kod alınamadı — sayfayı yenileyip tekrar dene");return}e.textContent=t;const n=`https://rostrumakademi.com/app.html?davet=${t}`,i=`Merhaba! ${((r=l.workspace)==null?void 0:r.brand_name)||"koçun"} koçluk platformuna davetlisin. 🎓

Kayıt linki: ${n}
(Davet kodun: ${t})

Linke tıkla, hesabını oluştur — otomatik olarak bana bağlanacaksın.`,o=document.getElementById("invWaBtn");o&&(o.href="https://wa.me/?text="+encodeURIComponent(i))}function ir(){var t,n;const e=(n=(t=document.getElementById("invCodeBox"))==null?void 0:t.textContent)==null?void 0:n.trim();e&&e.length===6&&gn(e)}function or(){var t,n;const e=(n=(t=document.getElementById("invCodeBox"))==null?void 0:t.textContent)==null?void 0:n.trim();e&&e.length===6&&gn(`https://rostrumakademi.com/app.html?davet=${e}`)}function gn(e){navigator.clipboard.writeText(e).then(()=>x("Link kopyalandı ✓")).catch(()=>{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),x("Link kopyalandı ✓")})}const Aa=[{name:"Terrakota",val:"#e8613a",dim:"rgba(232,97,58,.12)"},{name:"Altın",val:"#f0a500",dim:"rgba(240,165,0,.12)"},{name:"Mavi",val:"#4da6ff",dim:"rgba(77,166,255,.12)"},{name:"Yeşil",val:"#3ecf8e",dim:"rgba(62,207,142,.12)"},{name:"Mor",val:"#c084fc",dim:"rgba(192,132,252,.12)"},{name:"Pembe",val:"#f472b6",dim:"rgba(244,114,182,.12)"},{name:"Kırmızı",val:"#ff5c5c",dim:"rgba(255,92,92,.12)"},{name:"Turkuaz",val:"#06b6d4",dim:"rgba(6,182,212,.12)"}];function Ca(){try{const e=JSON.parse(localStorage.getItem("ba_theme")||"{}");e.theme==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme"),e.accent&&La(e.accent,e.accentDim,!1)}catch{}}function La(e,t,n=!0){if(document.documentElement.style.setProperty("--accent",e),document.documentElement.style.setProperty("--accent-dim",t||"rgba(240,165,0,.12)"),n)try{const a=JSON.parse(localStorage.getItem("ba_theme")||"{}");a.accent=e,a.accentDim=t,localStorage.setItem("ba_theme",JSON.stringify(a))}catch{}}function sr(e){e==="dark"?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.removeAttribute("data-theme");try{const t=JSON.parse(localStorage.getItem("ba_theme")||"{}");t.theme=e,localStorage.setItem("ba_theme",JSON.stringify(t))}catch{}document.querySelectorAll(".theme-btn").forEach(t=>{const n=t.dataset.theme===e;t.style.background=n?"var(--accent-dim)":"",t.style.borderColor=n?"var(--accent)":"",t.style.color=n?"var(--accent)":""})}function rr(){let e=document.getElementById("themePanel");if(e){e.remove();return}e=document.createElement("div"),e.id="themePanel";const t=document.documentElement.getAttribute("data-theme")!=="light";e.style.cssText="position:fixed;top:60px;right:12px;background:var(--surface);border:1px solid var(--border2);border-radius:14px;padding:18px;z-index:300;box-shadow:var(--shadow-lg);min-width:230px;animation:fadeUp .2s ease",e.innerHTML=`
    ...
    <div style="display:flex;gap:7px;flex-wrap:wrap;margin-bottom:14px">
      ${Aa.map(n=>`<div onclick="applyAccent('${n.val}','${n.dim}');document.getElementById('themePanel').remove()" title="${n.name}"
...
(Öğrenciye gönderilecek haftalık değerlendirme taslağı)`;let u="";const g={studentName:t.name,target:t.target,recentExams:c,taskCompletionRate:r,weeklyTaskCount:i};try{const k=await fetch("/api/ai-chat",{method:"POST",headers:await st(),body:JSON.stringify({messages:[{role:"user",content:m}],context:g,userRole:"coach"})});k.ok?u=(await k.json()).reply:u=await Te(m,g,"coach")}catch{u=await Te(m,g,"coach")}let _="Analiz üretilemedi.",T="Taslak üretilemedi.";const f=u.indexOf("[ANALİZ]"),$=u.indexOf("[TASLAK]");f!==-1&&$!==-1?f<$?(_=u.substring(f+8,$).trim(),T=u.substring($+8).trim()):(T=u.substring($+8,f).trim(),_=u.substring(f+8).trim()):T=u,document.getElementById("aiCopilotAnalysisBox").innerHTML=`<b>📊 Yapay Zeka Durum Analizi:</b><br>${_.replace(/\n/g,"<br>")}`,document.getElementById("aiCopilotTextarea").value=T,fn=T,document.getElementById("aiCopilotResultArea").style.display="block",document.getElementById("aiCopilotSendBtn").disabled=!0,document.getElementById("aiCopilotEditWarning").style.display="inline"}catch(a){console.error("generateAICopilotDraft error:",a),x("Taslak oluşturulurken hata: "+a.message)}finally{n.disabled=!1,n.textContent="🤖 Durum Analizi Yap ve Taslak Oluştur"}}function pr(){var t;const e=(((t=document.getElementById("aiCopilotTextarea"))==null?void 0:t.value)||"").trim();if(!e){x("Önce taslak oluşturun");return}window.open("https://wa.me/?text="+encodeURIComponent(e),"_blank")}function mr(){const e=document.getElementById("aiCopilotTextarea").value.trim(),t=document.getElementById("aiCopilotSendBtn"),n=document.getElementById("aiCopilotEditWarning");e&&e!==fn?(t.disabled=!1,n.style.display="none"):(t.disabled=!0,n.style.display="inline")}async function ur(e){var a;const t=document.getElementById("aiCopilotTextarea").value.trim();if(!t)return;const n=document.getElementById("aiCopilotSendBtn");n.disabled=!0,n.textContent="Gönderiliyor...";try{const i=b.coachId||((a=l.students.find(r=>r.id===e))==null?void 0:a.coachId),{data:o,error:s}=await y.from("messages").insert({student_id:e,coach_id:i,from_role:"coach",text:t,read:!1}).select().single();if(s)throw s;await y.from("reports").insert({student_id:e,coach_id:i,type:"ai_copilot",title:"Yapay Zeka Copilot Değerlendirmesi",content:t,start_date:ue(),end_date:ue()}),l.messages[e]||(l.messages[e]=[]),l.messages[e].push({_id:o.id,from:"coach",text:t,time:new Date().toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"}),read:!1}),x("Taslak mesaj başarıyla düzenlendi, öğrenciye gönderildi ve arşive kaydedildi! ✓"),document.getElementById("aiCopilotResultArea").style.display="none",document.getElementById("aiCopilotTextarea").value="",fn=""}catch(i){console.error("sendCopilotDraft error:",i),x("Gönderim hatası: "+i.message),n.disabled=!1}finally{n.textContent="✍️ Düzenlemeyi Kaydet ve Öğrenciye Gönder"}}function Na(){const e=l.students.find(r=>r.id===l.activeStuId),t=b.childName||(e==null?void 0:e.name)||"Öğrenci",n=document.getElementById("view-parent-home");if(!n)return;let a=[];Object.entries(l.tasks||{}).forEach(([r,d])=>{r.startsWith(l.activeStuId+"_")&&(a=a.concat(d))});const i=a.filter(r=>r.done).length,o=a.length?Math.round(i/a.length*100):0,s=(l.exams||[]).filter(r=>r.studentId===l.activeStuId).slice(-3);n.innerHTML=`
    ...
    </div>`}function Ha(){const e=document.getElementById("view-parent-progress");if(!e)return;const t=l.students.find(o=>o.id===l.activeStuId),n=b.childName||(t==null?void 0:t.name)||"Öğrenci",a=(l.exams||[]).filter(o=>o.studentId===l.activeStuId);let i=[];Object.entries(l.tasks||{}).forEach(([o,s])=>{o.startsWith(l.activeStuId+"_")&&(i=i.concat(s))}),e.innerHTML=`
    <div style="padding:24px;max-width:800px;margin:0 auto">
    ...
    </div>`}function Ya(){const e=document.getElementById("view-parent-ai");e&&(e.innerHTML=`
    ...
    <button class="btn btn-accent" style="width:100%;justify-content:center;padding:11px" onclick="confirmAssignResource()">Görevi Hazırla →</button>
      ...
      <div class="analytics-grid">
        ${Oa(t).map(d=>{const c=d.totalCount>0?Math.round(d.doneCount/d.totalCount*100):0,p=c>=80?"var(--green)":c>=50?"var(--accent)":"var(--text-dim)";return`<div class="analytics-card">
...
Paylaşılan şablonlar değerlendirilerek tüm koçlara önerilebilir.`)&&y.auth.getSession().then(({data:{session:r}})=>{const d=r==null?void 0:r.access_token;d&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${d}`},body:JSON.stringify({type:"template_share",template_name:e,task_count:i.length,tasks_json:JSON.stringify(i,null,2)})}).then(()=>x("Şablon Rostrum ekibiyle paylaşıldı ✓")).catch(()=>x("Şablon kaydedildi, paylaşım gönderilemedi."))})}async function Sr(){M(!0);const{data:e,error:t}=await y.from("program_templates").select("*").eq("coach_id",b.coachId);if(M(!1),t)return x("Şablonlar yüklenemedi.");if(!e||e.length===0)return x("Kayıtlı şablonunuz bulunmuyor. Önce haftayı şablon olarak kaydedin.");let n=document.getElementById("applyTemplateModal");n||(n=document.createElement("div"),n.id="applyTemplateModal",n.className="modal-bg",n.innerHTML=`<div class="modal">
    ...
    </div>`).join("");const s=t.filter(d=>d.status==="pending").length,r=document.getElementById("sbi_coach-applications");if(r){const d=r.querySelector(".sb-badge");if(d&&d.remove(),s>0){const c=document.createElement("span");c.className="sb-badge",c.textContent=s,r.appendChild(c)}}}async function Ar(e,t,n,a){var o;const{error:i}=await y.from("match_requests").update({status:t}).eq("id",e);if(i)return x("Hata: "+i.message);x(t==="accepted"?"✓ Başvuru kabul edildi":"Başvuru reddedildi"),n&&fetch("/api/mailer",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"application_update",to:n,student_name:a||"",status:t,coach_name:((o=l.workspace)==null?void 0:o.brand_name)||"Koçunuz"})}).catch(s=>console.warn("[updateApplication] mail error:",s.message)),xn()}let Ne=null;async function Ua(){var a;const e=document.getElementById("view-coach-notes");if(!e)return;e.innerHTML=`<div style="padding:24px;max-width:860px;margin:0 auto">
    ...
    </div>`).join("")}function Cr(e){const t=e!==null?Ne[e]||{}:{};let n=document.getElementById("coachNoteModal");n||(n=document.createElement("div"),n.id="coachNoteModal",n.className="modal-bg",document.body.appendChild(n)),n.innerHTML=`<div class="modal" style="max-width:520px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
  ...
  </div>`,n.style.display="flex"}async function Lr(e){const t=document.getElementById("noteEditorTitle").value.trim(),n=document.getElementById("noteEditorBody").value.trim();if(!t&&!n)return x("Not boş olamaz");const a={title:t||"Başlıksız",body:n,updated:new Date().toISOString()};e===null?Ne.unshift(a):Ne[e]=a,await Ga(),document.getElementById("coachNoteModal").style.display="none",bn(),x("Not kaydedildi ✓")}async function jr(e){await ie("Bu notu silmek istiyor musun?")&&(Ne.splice(e,1),await Ga(),bn(),x("Not silindi"))}async function Ga(){const e=`coach_notes_${b.coachId}`;await y.from("platform_settings").upsert({key:e,value:{notes:Ne}},{onConflict:"key"})}function At(){if(b.role!=="student")return;const e=(l.messages[b.studentId]||[]).filter(t=>t.from==="coach"&&!t.read).length;["sbi_smessages","mntab_smessages"].forEach(t=>{const n=document.getElementById(t);if(!n)return;n.style.position="relative";const a=n.querySelector(".msg-nav-badge");if(a&&a.remove(),e>0){const i=document.createElement("span");i.className="msg-nav-badge",i.style.cssText="position:absolute;top:3px;right:3px;background:#ef4444;color:#fff;border-radius:100px;min-width:14px;height:14px;font-size:9px;font-weight:800;display:flex;align-items:center;justify-content:center;padding:0 3px;pointer-events:none;line-height:1",i.textContent=e>9?"9+":e,n.appendChild(i)}})}window.updateMsgBadge=At;window.toggleSidebar=xi;window.setupShell=hi;window.switchTab=se;window.renderHome=Gn;window.renderCoachApplications=xn;window.updateApplication=Ar;window.renderCoachNotes=Ua;window.openNoteEditor=Cr;window.toggleNewResourceMode=Fi;window.addManualTest=Ui;window.removeManualTest=Gi;window.saveCoachNote=Lr;window.deleteCoachNote=jr;window.renderStudentsSearch=dt;window.filterStudentSearch=ki;window.openStudentDetail=qn;window.openKonuHaritasi=Ei;window.openStudentProgram=Xt;window.openStudentExams=_i;window.openStudentAppointments=Ti;window.renderProfile=Zn;window.saveProfile=Di;window.renderSettings=Jn;window.saveGeminiKey=Ai;window.renderProgram=X;window.selectStu=Ci;window.chWeek=Li;window.goToday=ji;window.openClearWeekModal=Ri;window.toggleDaySel=Ni;window.toggleAllDays=Hi;window.confirmClearDays=Yi;window.openTaskModal=ea;window.loadResources=na;window.updateSubjectList=_t;window.updateBookList=qi;window.renderBookList=Tt;window.filterBooks=Wi;window.selectBook=Vi;window.renderTestList=St;window.selectAllTests=Zi;window.clearAllTests=Ji;window.updateTestSummary=We;window.selectModalSpeed=Xi;window.applyDuration=Qi;window.scheduleSmartBadge=It;window.applySmartDuration=to;window.loadStudentSpeeds=aa;window.saveStudentSpeed=ia;window.saveTask=no;window.toggleTask=ao;window.closeTaskMenu=en;window.showTaskMenu=io;window.copyTask=oo;window.deleteTask=so;window.renderTodoList=la;window.renderStudents=ca;window.goProgram=xo;window.openStudentModal=bo;window.saveStudent=ho;window.showInviteInfo=pa;window.deleteStu=wo;window.renderAppointments=Ve;window.renderCalDays=zt;window.selCalDay=Eo;window.chCalMonth=_o;window.renderApptList=tn;window.openApptModal=To;window.saveAppt=So;window.deleteAppt=Bo;window.renderExams=Ze;window.openCommentModal=jo;window.saveComment=Po;window.deleteExam=Ro;window.renderMessages=ya;window.selectThread=No;window.renderThreadHTML=Se;window.sendMsg=Ho;window.scrollMsgs=Ie;window.renderPortal=Bt;window.stuToggleTask=Yo;window.renderSPortal=ze;window.stuToggleTask2=Ko;window.chWeekS=Fo;window.openTaskDetail=nn;window.toggleTaskDetail=qo;window.toggleDetailItem=Wo;window.selectVideoSpeed=Vo;window.saveTaskDetail=Zo;window.renderSExams=an;window.openStudentExamModal=xa;window.openExamModal=Jo;window.renderNetInputs=on;window.saveExam=es;window.renderSMessages=Ot;window.initRealtime=sn;window.destroyRealtime=rn;window.renderDevDashboard=ha;window.renderDevUsers=Je;window.openDevUserModal=as;window.devDeleteUser=is;window.openPlanModal=os;window.savePlan=ss;window.renderDevResources=ct;window.openPlaylistModal=rs;window.fetchYouTubePlaylist=ls;window.savePlaylist=ds;window.openResourceModal=cs;window.saveResource=ps;window.devDeleteResource=ms;window.renderDevFinance=pt;window.openPaymentModal=gs;window.verifyPayment=us;window.setDevUserFilter=ns;window.savePayment=vs;window.openSubModal=fs;window.saveSub=ys;window.renderDevAnnounce=mt;window.openAnnounceModal=xs;window.saveAnnounce=bs;window.toggleAnnounce=hs;window.devDeleteAnnounce=ks;window.renderDevTickets=Xe;window.updateTicketStatus=Ts;window.devDeleteTicket=Ss;window.selectDevTicket=ws;window.sendDevReply=_s;window.openSupportTicket=Is;window.openSupportChat=Mt;window.closeSupportChat=ka;window.startAISupportChat=zs;window.startEminSupportChat=Bs;window.submitEminInitialMessage=Ms;window.sendSupportMessage=Ds;window.openSupportChatDirect=Mt;window.checkCoachSubscription=Jt;window.showTrialExpiredScreen=xt;window.loadAnnouncements=wa;window.saveStudentDev=gr;window.showOnboarding=_a;window.showOnboardingWidget=Ls;window.showStudentWelcome=js;window.renderSProfil=Sa;window.saveStudentProfile=Ps;window.changePassword=Rs;window.renderCoachProfile=Ia;window.updateProfilePreview=Ye;window.switchPreviewTab=Fs;window.toggleCoachTag=za;window.addCustomCoachTag=Ba;window.uploadCoachPhoto=Ys;window.onCoachSlugInput=Ks;window.generateCoachBio=Os;window.nl2br=Ma;window.saveCoachProfile=Us;window.renderDevMatches=pn;window.updateMatchRequestStatus=Gs;window.openSpeedModal=qs;window.saveAllSpeeds=Ws;window.openStudentNotes=Vs;window.saveStudentNote=Zs;window.openReportModal=Js;window.getReportDates=mn;window.buildReportHTML=un;window.previewReport=Xs;window.generatePDF=Qs;window.openWeeklyPDFModal=tr;window.generateWeeklyPDF=nr;window.printWeeklyProgramWithNote=Da;window.openInviteCodeModal=ar;window.copyInviteCode=ir;window.copyInviteLink=or;window.copyToClipboard=gn;window.loadTheme=Ca;window.applyAccent=La;window.setTheme=sr;window.openThemePanel=rr;window.initAIChatForRole=ja;window.toggleAIChat=lr;window.aiQuickSend=dr;window.buildAIContext=Ut;window.addAIMessage=be;window.sendAIMessage=Pa;window.autoDetectModel=Ra;window.callGeminiFallback=Te;window.generateAICopilotDraft=cr;window.checkCopilotDraftEdited=mr;window.shareCopilotWhatsApp=pr;window.assignResourceAsTask=vr;window.confirmAssignResource=fr;window.sendCopilotDraft=ur;window.renderParentHome=Na;window.renderParentProgress=Ha;window.renderParentAI=Ya;window.applyResFilter=yn;window.updateCRFilter=yr;window.buildCRContent=Dt;window.renderCoachResources=ut;window.switchCRTab=xr;window.compileResourceStats=Oa;window.openResourceModalCoach=br;window.fetchYtPlaylistCoach=hr;window.saveResourceCoach=kr;window.deleteResourceCoach=wr;window.importResourcesFromExcel=$r;window.importStudentsFromExcel=Er;window.getTestStatus=Fa;window.openCoachTaskEdit=_r;window.saveWeekAsTemplate=Tr;window.applyTemplateToWeek=Sr;window.downloadICS=Mo;window.confirmApplyTemplate=Ir;window.copyTaskToClipboard=zr;window.pasteTaskFromClipboard=Br;window.copyTaskToWholeWeek=Mr;window.pasteTaskToWholeWeek=Dr;window.sendWhatsAppReport=er;window.toggleUserMenu=bi;window.closeUserMenu=Un;window.renderAgenda=$e;window.openAgendaApptModal=da;window.deleteAgendaAppt=yo;window.agendaPrev=po;window.agendaNext=mo;window.agendaToday=uo;window.agendaSetFilter=go;window.exportAgendaICS=vo;window.openApptPopup=ra;window.handleApptDrop=fo;window.openStudentKaynaklar=Si;window.addStudentBook=Ii;window.editStudentBook=zi;window.sbUpdatePct=Vn;window.saveStudentBook=Bi;window.deleteStudentBook=Mi;async function Pr(){const e=document.getElementById("rpStuId").value,t=l.students.find(m=>m.id===e);if(!t)return;const n=document.getElementById("rpPeriod").value,{start:a,end:i}=mn(),o=document.getElementById("rpNote").value.trim();let s="Performans Raporu";n==="weekly"?s="Haftalık Performans Raporu":n==="monthly"?s="Aylık Performans Raporu":s="Özel Dönem Performans Raporu";const r=`${s} (${a} - ${i})`,d=o||"Değerlendirme notu eklenmedi.";M(!0);const c=b.coachId||t.coachId,{error:p}=await y.from("reports").insert({student_id:e,coach_id:c,type:"performance",title:r,content:d,start_date:a,end_date:i});M(!1),p?x("Rapor kaydedilirken hata oluştu: "+p.message):(x("Rapor başarıyla geçmişe kaydedildi! ✓"),q("reportModal"))}async function qa(e){const t=l.students.find(s=>s.id===e);if(!t)return;l.activeStuId=e,currentTab!=="student-detail"&&se("student-detail");const n=document.getElementById("view-student-detail");n.innerHTML=`<button class="back-link" onclick="openStudentDetail('${e}')">← ${v(t.name)}</button>
  ...
  `,G("viewReportDetailModal")}function Nr(){const e=document.getElementById("viewReportDetailModal");if(!e)return;const t=e.querySelector("h3").textContent,n=e.querySelector("div div").textContent,a=e.querySelector('div[style*="pre-wrap"]').textContent,i=window.open("","_blank");i.document.write(`
    <html>
      <head>
        <title>${t}</title>
        <style>
