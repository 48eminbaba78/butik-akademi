...
function svgRules(type) {
  ...
  return '\n## PRO USTA GRAFİKER & INSTAGRAM UZMANI GÖRSEL ŞABLON KURALLARI (3X SEKTÖR LİDERİ KALİTE)\n' +
    ...
    '### 2. KUSURSUZ GÖRSEL DİZİLİM VE BÖLÜMLER:\n' +
    '  A) ÜST KATEGORİ ROZETİ (Pill Badge):\n' +
    '     - Top-Left (y=75, x=60): `<rect x="60" y="75" width="380" height="54" rx="27" fill="url(#goldGrad)"/><text x="250" y="111" font-size="22" font-weight="900" fill="#080710" text-anchor="middle" letter-spacing="1">⚡ YKS KOÇLUK STRATEJİSİ</text>`\n' +
    ...
    '     - `<rect x="60" y="300" width="960" height="' + cardHeight + '" rx="36" fill="#120e24" fill-opacity="0.88" stroke="url(#cardBorder)" stroke-width="2.5"/>`\n' +
    '     - Kart içinde **Vurgu Bloğu** (Dev Rakam/Sayaç) veya **3 Adım / Madde Kutuları**.\n' +
    '     - Her maddenin soluna renkli ikon dairesi (`<circle cx="120" cy="..." r="22" fill="#3ecf8e"/>`) ve yanına kalın başlık (`font-size="36px"`, `fill="#ffffff"`) + açıklama (`font-size="28px"`, `fill="#94a3b8"`) hizala.\n' +
    '  D) ALT PREMİUM MARKA BANNERI (Gold Call-To-Action Banner):\n' +
    '     - (y="' + maxY + '"): `<rect x="60" y="' + maxY + '" width="960" height="96" rx="24" fill="url(#goldGrad)"/><text x="540" y="' + (maxY + 58) + '" font-size="32" font-weight="900" fill="#080710" text-anchor="middle">ROSTRUM AKADEMİ · Öğrenci & Velilerini Profesyonel Yönet</text>`\n\n' +
    '### 3. PUNTO VE BASELINE HİZALAMA DİSİPLİNİ:\n' +
    ...
    '- TÜRKÇE HARFLER: ç, ğ, ı, İ, ö, ş, ü harflerini eksiksiz ve %100 doğru Türkçe olarak yaz.\n';
}
