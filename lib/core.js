...
function svgRules(type) {
  ...
  return '\n## PRO USTA GRAFİKER & INSTAGRAM UZMANI GÖRSEL ŞABLON KURALLARI (3X SEKTÖR LİDERİ KALİTE)\n' +
    ...
    '     - Top-Left (y=75, x=80): `<rect x="80" y="75" width="380" height="54" rx="27" fill="url(#goldGrad)"/><g transform="translate(105, 91)"><path d="M7 0L0 10h6v7l8-10h-6z" fill="#080710"/></g><text x="270" y="111" font-size="22" font-weight="900" fill="#080710" text-anchor="middle" letter-spacing="1">YKS KOÇLUK STRATEJİSİ</text>`\n' +
